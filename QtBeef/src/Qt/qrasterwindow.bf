...
class QRasterWindow : IQRasterWindow, IQPaintDeviceWindow, IQWindow, IQObject, IQSurface, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QRasterWindow_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QRasterWindow_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QRasterWindow_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return CQt.QRasterWindow_Metric((.)this.ptr.Ptr, metric);
	}
	public QPaintDevice_Ptr Redirected(IQPoint param1)
	{
		return QPaintDevice_Ptr(CQt.QRasterWindow_Redirected((.)this.ptr.Ptr, (.)param1?.ObjectPtr));
	}
