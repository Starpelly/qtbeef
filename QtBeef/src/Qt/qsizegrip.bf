...
class QSizeGrip : IQSizeGrip, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QSizeGrip_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QSizeGrip_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QSizeGrip_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return QSize_Ptr(CQt.QSizeGrip_SizeHint((.)this.ptr.Ptr));
	}
	public void SetVisible(bool visible)
	{
		CQt.QSizeGrip_SetVisible((.)this.ptr.Ptr, visible);
	}
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QSizeGrip_PaintEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void MousePressEvent(IQMouseEvent param1)
	{
		CQt.QSizeGrip_MousePressEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void MouseMoveEvent(IQMouseEvent param1)
	{
		CQt.QSizeGrip_MouseMoveEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void MouseReleaseEvent(IQMouseEvent mouseEvent)
	{
		CQt.QSizeGrip_MouseReleaseEvent((.)this.ptr.Ptr, (.)mouseEvent?.ObjectPtr);
	}
	public void MoveEvent(IQMoveEvent moveEvent)
	{
		CQt.QSizeGrip_MoveEvent((.)this.ptr.Ptr, (.)moveEvent?.ObjectPtr);
	}
	public void ShowEvent(IQShowEvent showEvent)
	{
		CQt.QSizeGrip_ShowEvent((.)this.ptr.Ptr, (.)showEvent?.ObjectPtr);
	}
	public void HideEvent(IQHideEvent hideEvent)
	{
		CQt.QSizeGrip_HideEvent((.)this.ptr.Ptr, (.)hideEvent?.ObjectPtr);
	}
	public bool EventFilter(IQObject param1, IQEvent param2)
	{
		return CQt.QSizeGrip_EventFilter((.)this.ptr.Ptr, (.)param1?.ObjectPtr, (.)param2?.ObjectPtr);
	}
	public bool Event(IQEvent param1)
	{
		return CQt.QSizeGrip_Event((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
