...
class QTextEdit : IQTextEdit, IQAbstractScrollArea, IQFrame, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QTextEdit_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QTextEdit_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QTextEdit_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return QVariant_Ptr(CQt.QTextEdit_LoadResource((.)this.ptr.Ptr, type, (.)name?.ObjectPtr));
	}
	...
	{
		return CQt.QTextEdit_Event((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	...
	{
		CQt.QTextEdit_KeyPressEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	...
	{
		CQt.QTextEdit_PaintEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void MousePressEvent(IQMouseEvent e)
	{
		CQt.QTextEdit_MousePressEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void MouseMoveEvent(IQMouseEvent e)
	{
		CQt.QTextEdit_MouseMoveEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void MouseReleaseEvent(IQMouseEvent e)
	{
		CQt.QTextEdit_MouseReleaseEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	...
	{
		return CQt.QTextEdit_FocusNextPrevChild((.)this.ptr.Ptr, next);
	}
	...
	{
		CQt.QTextEdit_FocusOutEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
...
class QTextEdit_ExtraSelection : IQTextEdit_ExtraSelection
{
	...
	{
		return QTextCursor_Ptr(CQt.QTextEdit_ExtraSelection_Cursor((.)this.ptr.Ptr));
	}
	public void SetCursor(IQTextCursor cursor)
	{
		CQt.QTextEdit_ExtraSelection_SetCursor((.)this.ptr.Ptr, (.)cursor?.ObjectPtr);
	}
	public QTextCharFormat_Ptr Format()
	{
		return QTextCharFormat_Ptr(CQt.QTextEdit_ExtraSelection_Format((.)this.ptr.Ptr));
	}
	public void SetFormat(IQTextCharFormat format)
	{
		CQt.QTextEdit_ExtraSelection_SetFormat((.)this.ptr.Ptr, (.)format?.ObjectPtr);
	}
}
