...
class QTabWidget : IQTabWidget, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QTabWidget_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QTabWidget_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QTabWidget_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return CQt.QTabWidget_AddTab((.)this.ptr.Ptr, (.)widget?.ObjectPtr, libqt_string(param2));
	}
	public c_int AddTab2(IQWidget widget, IQIcon icon, String label)
	{
		return CQt.QTabWidget_AddTab2((.)this.ptr.Ptr, (.)widget?.ObjectPtr, (.)icon?.ObjectPtr, libqt_string(label));
	}
	public c_int InsertTab(c_int index, IQWidget widget, String param3)
	{
		return CQt.QTabWidget_InsertTab((.)this.ptr.Ptr, index, (.)widget?.ObjectPtr, libqt_string(param3));
	}
	public c_int InsertTab2(c_int index, IQWidget widget, IQIcon icon, String label)
	{
		return CQt.QTabWidget_InsertTab2((.)this.ptr.Ptr, index, (.)widget?.ObjectPtr, (.)icon?.ObjectPtr, libqt_string(label));
	}
	public void RemoveTab(c_int index)
	{
		CQt.QTabWidget_RemoveTab((.)this.ptr.Ptr, index);
	}
	public bool IsTabEnabled(c_int index)
	{
		return CQt.QTabWidget_IsTabEnabled((.)this.ptr.Ptr, index);
	}
	public void SetTabEnabled(c_int index, bool enabled)
	{
		CQt.QTabWidget_SetTabEnabled((.)this.ptr.Ptr, index, enabled);
	}
	public bool IsTabVisible(c_int index)
	{
		return CQt.QTabWidget_IsTabVisible((.)this.ptr.Ptr, index);
	}
	public void SetTabVisible(c_int index, bool visible)
	{
		CQt.QTabWidget_SetTabVisible((.)this.ptr.Ptr, index, visible);
	}
	public void TabText(String outStr, c_int index)
	{
		CQt.QTabWidget_TabText((.)this.ptr.Ptr, index);
	}
	public void SetTabText(c_int index, String text)
	{
		CQt.QTabWidget_SetTabText((.)this.ptr.Ptr, index, libqt_string(text));
	}
	public QIcon_Ptr TabIcon(c_int index)
	{
		return QIcon_Ptr(CQt.QTabWidget_TabIcon((.)this.ptr.Ptr, index));
	}
	public void SetTabIcon(c_int index, IQIcon icon)
	{
		CQt.QTabWidget_SetTabIcon((.)this.ptr.Ptr, index, (.)icon?.ObjectPtr);
	}
	public void SetTabToolTip(c_int index, String tip)
	{
		CQt.QTabWidget_SetTabToolTip((.)this.ptr.Ptr, index, libqt_string(tip));
	}
	public void TabToolTip(String outStr, c_int index)
	{
		CQt.QTabWidget_TabToolTip((.)this.ptr.Ptr, index);
	}
	public void SetTabWhatsThis(c_int index, String text)
	{
		CQt.QTabWidget_SetTabWhatsThis((.)this.ptr.Ptr, index, libqt_string(text));
	}
	public void TabWhatsThis(String outStr, c_int index)
	{
		CQt.QTabWidget_TabWhatsThis((.)this.ptr.Ptr, index);
	}
	public c_int CurrentIndex()
	{
		return CQt.QTabWidget_CurrentIndex((.)this.ptr.Ptr);
	}
	public QWidget_Ptr CurrentWidget()
	{
		return QWidget_Ptr(CQt.QTabWidget_CurrentWidget((.)this.ptr.Ptr));
	}
	public QWidget_Ptr Widget(c_int index)
	{
		return QWidget_Ptr(CQt.QTabWidget_Widget((.)this.ptr.Ptr, index));
	}
	public c_int IndexOf(IQWidget widget)
	{
		return CQt.QTabWidget_IndexOf((.)this.ptr.Ptr, (.)widget?.ObjectPtr);
	}
	public c_int Count()
	{
		return CQt.QTabWidget_Count((.)this.ptr.Ptr);
	}
	public QTabWidget_TabPosition TabPosition()
	{
		return CQt.QTabWidget_TabPosition((.)this.ptr.Ptr);
	}
	public void SetTabPosition(QTabWidget_TabPosition position)
	{
		CQt.QTabWidget_SetTabPosition((.)this.ptr.Ptr, position);
	}
	public bool TabsClosable()
	{
		return CQt.QTabWidget_TabsClosable((.)this.ptr.Ptr);
	}
	public void SetTabsClosable(bool closeable)
	{
		CQt.QTabWidget_SetTabsClosable((.)this.ptr.Ptr, closeable);
	}
	public bool IsMovable()
	{
		return CQt.QTabWidget_IsMovable((.)this.ptr.Ptr);
	}
	public void SetMovable(bool movable)
	{
		CQt.QTabWidget_SetMovable((.)this.ptr.Ptr, movable);
	}
	public QTabWidget_TabShape TabShape()
	{
		return CQt.QTabWidget_TabShape((.)this.ptr.Ptr);
	}
	public void SetTabShape(QTabWidget_TabShape s)
	{
		CQt.QTabWidget_SetTabShape((.)this.ptr.Ptr, s);
	}
	public QSize_Ptr SizeHint()
	{
		return QSize_Ptr(CQt.QTabWidget_SizeHint((.)this.ptr.Ptr));
	}
	public QSize_Ptr MinimumSizeHint()
	{
		return QSize_Ptr(CQt.QTabWidget_MinimumSizeHint((.)this.ptr.Ptr));
	}
	public c_int HeightForWidth(c_int width)
	{
		return CQt.QTabWidget_HeightForWidth((.)this.ptr.Ptr, width);
	}
	public bool HasHeightForWidth()
	{
		return CQt.QTabWidget_HasHeightForWidth((.)this.ptr.Ptr);
	}
	public void SetCornerWidget(IQWidget w)
	{
		CQt.QTabWidget_SetCornerWidget((.)this.ptr.Ptr, (.)w?.ObjectPtr);
	}
	public QWidget_Ptr CornerWidget()
	{
		return QWidget_Ptr(CQt.QTabWidget_CornerWidget((.)this.ptr.Ptr));
	}
	public Qt_TextElideMode ElideMode()
	{
		return CQt.QTabWidget_ElideMode((.)this.ptr.Ptr);
	}
	public void SetElideMode(Qt_TextElideMode mode)
	{
		CQt.QTabWidget_SetElideMode((.)this.ptr.Ptr, mode);
	}
	public QSize_Ptr IconSize()
	{
		return QSize_Ptr(CQt.QTabWidget_IconSize((.)this.ptr.Ptr));
	}
	public void SetIconSize(IQSize size)
	{
		CQt.QTabWidget_SetIconSize((.)this.ptr.Ptr, (.)size?.ObjectPtr);
	}
	public bool UsesScrollButtons()
	{
		return CQt.QTabWidget_UsesScrollButtons((.)this.ptr.Ptr);
	}
	public void SetUsesScrollButtons(bool useButtons)
	{
		CQt.QTabWidget_SetUsesScrollButtons((.)this.ptr.Ptr, useButtons);
	}
	public bool DocumentMode()
	{
		return CQt.QTabWidget_DocumentMode((.)this.ptr.Ptr);
	}
	public void SetDocumentMode(bool set)
	{
		CQt.QTabWidget_SetDocumentMode((.)this.ptr.Ptr, set);
	}
	public bool TabBarAutoHide()
	{
		return CQt.QTabWidget_TabBarAutoHide((.)this.ptr.Ptr);
	}
	public void SetTabBarAutoHide(bool enabled)
	{
		CQt.QTabWidget_SetTabBarAutoHide((.)this.ptr.Ptr, enabled);
	}
	public void Clear()
	{
		CQt.QTabWidget_Clear((.)this.ptr.Ptr);
	}
	public QTabBar_Ptr TabBar()
	{
		return QTabBar_Ptr(CQt.QTabWidget_TabBar((.)this.ptr.Ptr));
	}
	public void SetCurrentIndex(c_int index)
	{
		CQt.QTabWidget_SetCurrentIndex((.)this.ptr.Ptr, index);
	}
	public void SetCurrentWidget(IQWidget widget)
	{
		CQt.QTabWidget_SetCurrentWidget((.)this.ptr.Ptr, (.)widget?.ObjectPtr);
	}
	public void CurrentChanged(c_int index)
	{
		CQt.QTabWidget_CurrentChanged((.)this.ptr.Ptr, index);
	}
	public void TabCloseRequested(c_int index)
	{
		CQt.QTabWidget_TabCloseRequested((.)this.ptr.Ptr, index);
	}
	public void TabBarClicked(c_int index)
	{
		CQt.QTabWidget_TabBarClicked((.)this.ptr.Ptr, index);
	}
	public void TabBarDoubleClicked(c_int index)
	{
		CQt.QTabWidget_TabBarDoubleClicked((.)this.ptr.Ptr, index);
	}
	public void TabInserted(c_int index)
	{
		CQt.QTabWidget_TabInserted((.)this.ptr.Ptr, index);
	}
	public void TabRemoved(c_int index)
	{
		CQt.QTabWidget_TabRemoved((.)this.ptr.Ptr, index);
	}
	public void ShowEvent(IQShowEvent param1)
	{
		CQt.QTabWidget_ShowEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void ResizeEvent(IQResizeEvent param1)
	{
		CQt.QTabWidget_ResizeEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void KeyPressEvent(IQKeyEvent param1)
	{
		CQt.QTabWidget_KeyPressEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QTabWidget_PaintEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void SetTabBar(IQTabBar tabBar)
	{
		CQt.QTabWidget_SetTabBar((.)this.ptr.Ptr, (.)tabBar?.ObjectPtr);
	}
	public void ChangeEvent(IQEvent param1)
	{
		CQt.QTabWidget_ChangeEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public bool Event(IQEvent param1)
	{
		return CQt.QTabWidget_Event((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void InitStyleOption(IQStyleOptionTabWidgetFrame option)
	{
		CQt.QTabWidget_InitStyleOption((.)this.ptr.Ptr, (.)option?.ObjectPtr);
	}
	...
	{
		CQt.QTabWidget_SetCornerWidget2((.)this.ptr.Ptr, (.)w?.ObjectPtr, corner);
	}
	public QWidget_Ptr CornerWidget1(Qt_Corner corner)
	{
		return QWidget_Ptr(CQt.QTabWidget_CornerWidget1((.)this.ptr.Ptr, corner));
	}
