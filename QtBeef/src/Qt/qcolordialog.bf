...
class QColorDialog : IQColorDialog, IQDialog, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return CQt.QColorDialog_GetColor1((.)initial?.ObjectPtr);
	}
	public QColor_Ptr* GetColor2(IQColor initial, IQWidget parent)
	{
		return CQt.QColorDialog_GetColor2((.)initial?.ObjectPtr, (.)parent?.ObjectPtr);
	}
	public QColor_Ptr* GetColor3(IQColor initial, IQWidget parent, String title)
	{
		return CQt.QColorDialog_GetColor3((.)initial?.ObjectPtr, (.)parent?.ObjectPtr, libqt_string(title));
	}
	public QColor_Ptr* GetColor4(IQColor initial, IQWidget parent, String title, void* options)
	{
		return CQt.QColorDialog_GetColor4((.)initial?.ObjectPtr, (.)parent?.ObjectPtr, libqt_string(title), options);
	}
	public c_int Result()
	{
