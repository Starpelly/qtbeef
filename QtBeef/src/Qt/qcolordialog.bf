...
class QColorDialog : IQColorDialog, IQDialog, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		QColorDialog_currentColorChanged,
		QColorDialog_colorSelected,
		QColorDialog_finished,
		QColorDialog_accepted,
		QColorDialog_rejected,
		QColorDialog_windowTitleChanged,
		QColorDialog_windowIconChanged,
		QColorDialog_windowIconTextChanged,
		QColorDialog_customContextMenuRequested,
		QColorDialog_destroyed,
		QColorDialog_destroyed1,
	}
	
	static void QtBf_ConnectSignals(Self obj)
	{
		CQt.ObjectHandleMap[obj.ObjectPtr] = obj;
		CQt.QColorDialog_Connect_CurrentColorChanged(obj.ObjectPtr,  => QtBeef_QColorDialog_currentColorChanged);
		CQt.QColorDialog_Connect_ColorSelected(obj.ObjectPtr,  => QtBeef_QColorDialog_colorSelected);
	...
	static void QtBeef_QColorDialog_currentColorChanged(void* ptr, void** color)
	{
		let obj = CQt.ObjectHandleMap[ptr] as Self;
		obj.OnCurrentColorChanged.Invoke(color);
	}
	static void QtBeef_QColorDialog_colorSelected(void* ptr, void** color)
	{
		let obj = CQt.ObjectHandleMap[ptr] as Self;
...
extension CQt
{
	...
	public static extern void QColorDialog_Connect_CurrentColorChanged(void* self, QColorDialog_currentColorChanged_action _action);
	...
	public static extern void QColorDialog_Connect_ColorSelected(void* self, QColorDialog_colorSelected_action _action);
