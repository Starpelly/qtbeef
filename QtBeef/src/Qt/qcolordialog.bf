...
class QColorDialog : IQColorDialog, IQDialog, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QColorDialog_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QColorDialog_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QColorDialog_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		CQt.QColorDialog_SetCurrentColor((.)this.ptr.Ptr, (.)color?.ObjectPtr);
	}
	public QColor_Ptr CurrentColor()
	{
		return QColor_Ptr(CQt.QColorDialog_CurrentColor((.)this.ptr.Ptr));
	}
	public QColor_Ptr SelectedColor()
	{
		return QColor_Ptr(CQt.QColorDialog_SelectedColor((.)this.ptr.Ptr));
	}
	public void SetOption(QColorDialog_ColorDialogOption option)
	{
		CQt.QColorDialog_SetOption((.)this.ptr.Ptr, option);
	}
	public bool TestOption(QColorDialog_ColorDialogOption option)
	{
		return CQt.QColorDialog_TestOption((.)this.ptr.Ptr, option);
	}
	public void SetOptions(void* options)
	{
		CQt.QColorDialog_SetOptions((.)this.ptr.Ptr, options);
	}
	public void* Options()
	{
		return CQt.QColorDialog_Options((.)this.ptr.Ptr);
	}
	public void SetVisible(bool visible)
	{
		CQt.QColorDialog_SetVisible((.)this.ptr.Ptr, visible);
	}
	...
	{
		CQt.QColorDialog_CurrentColorChanged((.)this.ptr.Ptr, (.)color?.ObjectPtr);
	}
	public void ColorSelected(IQColor color)
	{
		CQt.QColorDialog_ColorSelected((.)this.ptr.Ptr, (.)color?.ObjectPtr);
	}
	public void ChangeEvent(IQEvent event)
	{
		CQt.QColorDialog_ChangeEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void Done(c_int result)
	{
		CQt.QColorDialog_Done((.)this.ptr.Ptr, result);
	}
	...
	{
		CQt.QColorDialog_SetOption2((.)this.ptr.Ptr, option, on);
	}
