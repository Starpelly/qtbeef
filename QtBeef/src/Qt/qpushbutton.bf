...
class QPushButton : IQPushButton, IQAbstractButton, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QPushButton_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QPushButton_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QPushButton_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return QSize_Ptr(CQt.QPushButton_SizeHint((.)this.ptr.Ptr));
	}
	public QSize_Ptr MinimumSizeHint()
	{
		return QSize_Ptr(CQt.QPushButton_MinimumSizeHint((.)this.ptr.Ptr));
	}
	...
	{
		return CQt.QPushButton_Event((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QPushButton_PaintEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	...
	{
		CQt.QPushButton_InitStyleOption((.)this.ptr.Ptr, (.)option?.ObjectPtr);
	}
