...
class QPushButton : IQPushButton, IQAbstractButton, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		QPushButton_pressed,
		QPushButton_released,
		QPushButton_clicked,
		QPushButton_toggled,
		QPushButton_clicked1,
		QPushButton_windowTitleChanged,
		QPushButton_windowIconChanged,
		QPushButton_windowIconTextChanged,
		QPushButton_customContextMenuRequested,
		QPushButton_destroyed,
		QPushButton_destroyed1,
	}
