...
class QToolBar : IQToolBar, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return CQt.QToolBar_InsertSeparator((.)this.ptr, (.)before?.ObjectPtr);
	}
	public QAction_Ptr** AddWidget(IQWidget widget)
	{
		return CQt.QToolBar_AddWidget((.)this.ptr, (.)widget?.ObjectPtr);
	}
	public QAction_Ptr** InsertWidget(IQAction before, IQWidget widget)
	{
		return CQt.QToolBar_InsertWidget((.)this.ptr, (.)before?.ObjectPtr, (.)widget?.ObjectPtr);
	}
	public QRect_Ptr* ActionGeometry(IQAction action)
	{
		return CQt.QToolBar_ActionGeometry((.)this.ptr, (.)action?.ObjectPtr);
	}
	public QAction_Ptr** ActionAt(IQPoint p)
	{
		return CQt.QToolBar_ActionAt((.)this.ptr, (.)p?.ObjectPtr);
	}
	...
	{
		return CQt.QToolBar_WidgetForAction((.)this.ptr, (.)action?.ObjectPtr);
	}
