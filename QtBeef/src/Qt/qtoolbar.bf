...
class QToolBar : IQToolBar, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QToolBar_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QToolBar_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QToolBar_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		CQt.QToolBar_SetMovable((.)this.ptr.Ptr, movable);
	}
	public bool IsMovable()
	{
		return CQt.QToolBar_IsMovable((.)this.ptr.Ptr);
	}
	public void SetAllowedAreas(void* areas)
	{
		CQt.QToolBar_SetAllowedAreas((.)this.ptr.Ptr, areas);
	}
	public void* AllowedAreas()
	{
		return CQt.QToolBar_AllowedAreas((.)this.ptr.Ptr);
	}
	public bool IsAreaAllowed(Qt_ToolBarArea area)
	{
		return CQt.QToolBar_IsAreaAllowed((.)this.ptr.Ptr, area);
	}
	public void SetOrientation(Qt_Orientation orientation)
	{
		CQt.QToolBar_SetOrientation((.)this.ptr.Ptr, orientation);
	}
	public Qt_Orientation Orientation()
	{
		return CQt.QToolBar_Orientation((.)this.ptr.Ptr);
	}
	public void Clear()
	{
		CQt.QToolBar_Clear((.)this.ptr.Ptr);
	}
	public QAction_Ptr AddSeparator()
	{
		return QAction_Ptr(CQt.QToolBar_AddSeparator((.)this.ptr.Ptr));
	}
	public QAction_Ptr InsertSeparator(IQAction before)
	{
		return QAction_Ptr(CQt.QToolBar_InsertSeparator((.)this.ptr.Ptr, (.)before?.ObjectPtr));
	}
	public QAction_Ptr AddWidget(IQWidget widget)
	{
		return QAction_Ptr(CQt.QToolBar_AddWidget((.)this.ptr.Ptr, (.)widget?.ObjectPtr));
	}
	public QAction_Ptr InsertWidget(IQAction before, IQWidget widget)
	{
		return QAction_Ptr(CQt.QToolBar_InsertWidget((.)this.ptr.Ptr, (.)before?.ObjectPtr, (.)widget?.ObjectPtr));
	}
	public QRect_Ptr ActionGeometry(IQAction action)
	{
		return QRect_Ptr(CQt.QToolBar_ActionGeometry((.)this.ptr.Ptr, (.)action?.ObjectPtr));
	}
	public QAction_Ptr ActionAt(IQPoint p)
	{
		return QAction_Ptr(CQt.QToolBar_ActionAt((.)this.ptr.Ptr, (.)p?.ObjectPtr));
	}
	public QAction_Ptr ActionAt2(c_int x, c_int y)
	{
		return QAction_Ptr(CQt.QToolBar_ActionAt2((.)this.ptr.Ptr, x, y));
	}
	public QAction_Ptr ToggleViewAction()
	{
		return QAction_Ptr(CQt.QToolBar_ToggleViewAction((.)this.ptr.Ptr));
	}
	public QSize_Ptr IconSize()
	{
		return QSize_Ptr(CQt.QToolBar_IconSize((.)this.ptr.Ptr));
	}
	public Qt_ToolButtonStyle ToolButtonStyle()
	{
		return CQt.QToolBar_ToolButtonStyle((.)this.ptr.Ptr);
	}
	public QWidget_Ptr WidgetForAction(IQAction action)
	{
		return QWidget_Ptr(CQt.QToolBar_WidgetForAction((.)this.ptr.Ptr, (.)action?.ObjectPtr));
	}
	public bool IsFloatable()
	{
		return CQt.QToolBar_IsFloatable((.)this.ptr.Ptr);
	}
	public void SetFloatable(bool floatable)
	{
		CQt.QToolBar_SetFloatable((.)this.ptr.Ptr, floatable);
	}
	public bool IsFloating()
	{
		return CQt.QToolBar_IsFloating((.)this.ptr.Ptr);
	}
	public void SetIconSize(IQSize iconSize)
	{
		CQt.QToolBar_SetIconSize((.)this.ptr.Ptr, (.)iconSize?.ObjectPtr);
	}
	public void SetToolButtonStyle(Qt_ToolButtonStyle toolButtonStyle)
	{
		CQt.QToolBar_SetToolButtonStyle((.)this.ptr.Ptr, toolButtonStyle);
	}
	public void ActionTriggered(IQAction action)
	{
		CQt.QToolBar_ActionTriggered((.)this.ptr.Ptr, (.)action?.ObjectPtr);
	}
	public void MovableChanged(bool movable)
	{
		CQt.QToolBar_MovableChanged((.)this.ptr.Ptr, movable);
	}
	public void AllowedAreasChanged(void* allowedAreas)
	{
		CQt.QToolBar_AllowedAreasChanged((.)this.ptr.Ptr, allowedAreas);
	}
	public void OrientationChanged(Qt_Orientation orientation)
	{
		CQt.QToolBar_OrientationChanged((.)this.ptr.Ptr, orientation);
	}
	public void IconSizeChanged(IQSize iconSize)
	{
		CQt.QToolBar_IconSizeChanged((.)this.ptr.Ptr, (.)iconSize?.ObjectPtr);
	}
	public void ToolButtonStyleChanged(Qt_ToolButtonStyle toolButtonStyle)
	{
		CQt.QToolBar_ToolButtonStyleChanged((.)this.ptr.Ptr, toolButtonStyle);
	}
	public void TopLevelChanged(bool topLevel)
	{
		CQt.QToolBar_TopLevelChanged((.)this.ptr.Ptr, topLevel);
	}
	public void VisibilityChanged(bool visible)
	{
		CQt.QToolBar_VisibilityChanged((.)this.ptr.Ptr, visible);
	}
	public void ActionEvent(IQActionEvent event)
	{
		CQt.QToolBar_ActionEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void ChangeEvent(IQEvent event)
	{
		CQt.QToolBar_ChangeEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent event)
	{
		CQt.QToolBar_PaintEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public bool Event(IQEvent event)
	{
		return CQt.QToolBar_Event((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void InitStyleOption(IQStyleOptionToolBar option)
	{
		CQt.QToolBar_InitStyleOption((.)this.ptr.Ptr, (.)option?.ObjectPtr);
	}
