...
class QMdiArea : IQMdiArea, IQAbstractScrollArea, IQFrame, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QMdiArea_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QMdiArea_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QMdiArea_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return QSize_Ptr(CQt.QMdiArea_SizeHint((.)this.ptr.Ptr));
	}
	public QSize_Ptr MinimumSizeHint()
	{
		return QSize_Ptr(CQt.QMdiArea_MinimumSizeHint((.)this.ptr.Ptr));
	}
	public QMdiSubWindow_Ptr CurrentSubWindow()
	{
		return QMdiSubWindow_Ptr(CQt.QMdiArea_CurrentSubWindow((.)this.ptr.Ptr));
	}
	public QMdiSubWindow_Ptr ActiveSubWindow()
	{
		return QMdiSubWindow_Ptr(CQt.QMdiArea_ActiveSubWindow((.)this.ptr.Ptr));
	}
	public void* SubWindowList()
	{
		return CQt.QMdiArea_SubWindowList((.)this.ptr.Ptr);
	}
	public QMdiSubWindow_Ptr AddSubWindow(IQWidget widget)
	{
		return QMdiSubWindow_Ptr(CQt.QMdiArea_AddSubWindow((.)this.ptr.Ptr, (.)widget?.ObjectPtr));
	}
	public void RemoveSubWindow(IQWidget widget)
	{
		CQt.QMdiArea_RemoveSubWindow((.)this.ptr.Ptr, (.)widget?.ObjectPtr);
	}
	public QBrush_Ptr Background()
	{
		return QBrush_Ptr(CQt.QMdiArea_Background((.)this.ptr.Ptr));
	}
	public void SetBackground(IQBrush background)
	{
		CQt.QMdiArea_SetBackground((.)this.ptr.Ptr, (.)background?.ObjectPtr);
	}
	public QMdiArea_WindowOrder ActivationOrder()
	{
		return CQt.QMdiArea_ActivationOrder((.)this.ptr.Ptr);
	}
	public void SetActivationOrder(QMdiArea_WindowOrder order)
	{
		CQt.QMdiArea_SetActivationOrder((.)this.ptr.Ptr, order);
	}
	public void SetOption(QMdiArea_AreaOption option)
	{
		CQt.QMdiArea_SetOption((.)this.ptr.Ptr, option);
	}
	public bool TestOption(QMdiArea_AreaOption opton)
	{
		return CQt.QMdiArea_TestOption((.)this.ptr.Ptr, opton);
	}
	public void SetViewMode(QMdiArea_ViewMode mode)
	{
		CQt.QMdiArea_SetViewMode((.)this.ptr.Ptr, mode);
	}
	public QMdiArea_ViewMode ViewMode()
	{
		return CQt.QMdiArea_ViewMode((.)this.ptr.Ptr);
	}
	public bool DocumentMode()
	{
		return CQt.QMdiArea_DocumentMode((.)this.ptr.Ptr);
	}
	public void SetDocumentMode(bool enabled)
	{
		CQt.QMdiArea_SetDocumentMode((.)this.ptr.Ptr, enabled);
	}
	public void SetTabsClosable(bool closable)
	{
		CQt.QMdiArea_SetTabsClosable((.)this.ptr.Ptr, closable);
	}
	public bool TabsClosable()
	{
		return CQt.QMdiArea_TabsClosable((.)this.ptr.Ptr);
	}
	public void SetTabsMovable(bool movable)
	{
		CQt.QMdiArea_SetTabsMovable((.)this.ptr.Ptr, movable);
	}
	public bool TabsMovable()
	{
		return CQt.QMdiArea_TabsMovable((.)this.ptr.Ptr);
	}
	public void SetTabShape(QTabWidget_TabShape shape)
	{
		CQt.QMdiArea_SetTabShape((.)this.ptr.Ptr, shape);
	}
	public QTabWidget_TabShape TabShape()
	{
		return CQt.QMdiArea_TabShape((.)this.ptr.Ptr);
	}
	public void SetTabPosition(QTabWidget_TabPosition position)
	{
		CQt.QMdiArea_SetTabPosition((.)this.ptr.Ptr, position);
	}
	public QTabWidget_TabPosition TabPosition()
	{
		return CQt.QMdiArea_TabPosition((.)this.ptr.Ptr);
	}
	public void SubWindowActivated(IQMdiSubWindow param1)
	{
		CQt.QMdiArea_SubWindowActivated((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void SetActiveSubWindow(IQMdiSubWindow window)
	{
		CQt.QMdiArea_SetActiveSubWindow((.)this.ptr.Ptr, (.)window?.ObjectPtr);
	}
	public void TileSubWindows()
	{
		CQt.QMdiArea_TileSubWindows((.)this.ptr.Ptr);
	}
	public void CascadeSubWindows()
	{
		CQt.QMdiArea_CascadeSubWindows((.)this.ptr.Ptr);
	}
	public void CloseActiveSubWindow()
	{
		CQt.QMdiArea_CloseActiveSubWindow((.)this.ptr.Ptr);
	}
	public void CloseAllSubWindows()
	{
		CQt.QMdiArea_CloseAllSubWindows((.)this.ptr.Ptr);
	}
	public void ActivateNextSubWindow()
	{
		CQt.QMdiArea_ActivateNextSubWindow((.)this.ptr.Ptr);
	}
	public void ActivatePreviousSubWindow()
	{
		CQt.QMdiArea_ActivatePreviousSubWindow((.)this.ptr.Ptr);
	}
	public void SetupViewport(IQWidget viewport)
	{
		CQt.QMdiArea_SetupViewport((.)this.ptr.Ptr, (.)viewport?.ObjectPtr);
	}
	public bool Event(IQEvent event)
	{
		return CQt.QMdiArea_Event((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public bool EventFilter(IQObject object, IQEvent event)
	{
		return CQt.QMdiArea_EventFilter((.)this.ptr.Ptr, (.)object?.ObjectPtr, (.)event?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent paintEvent)
	{
		CQt.QMdiArea_PaintEvent((.)this.ptr.Ptr, (.)paintEvent?.ObjectPtr);
	}
	public void ChildEvent(IQChildEvent childEvent)
	{
		CQt.QMdiArea_ChildEvent((.)this.ptr.Ptr, (.)childEvent?.ObjectPtr);
	}
	public void ResizeEvent(IQResizeEvent resizeEvent)
	{
		CQt.QMdiArea_ResizeEvent((.)this.ptr.Ptr, (.)resizeEvent?.ObjectPtr);
	}
	public void TimerEvent(IQTimerEvent timerEvent)
	{
		CQt.QMdiArea_TimerEvent((.)this.ptr.Ptr, (.)timerEvent?.ObjectPtr);
	}
	public void ShowEvent(IQShowEvent showEvent)
	{
		CQt.QMdiArea_ShowEvent((.)this.ptr.Ptr, (.)showEvent?.ObjectPtr);
	}
	public bool ViewportEvent(IQEvent event)
	{
		return CQt.QMdiArea_ViewportEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void ScrollContentsBy(c_int dx, c_int dy)
	{
		CQt.QMdiArea_ScrollContentsBy((.)this.ptr.Ptr, dx, dy);
	}
	...
	{
		return CQt.QMdiArea_SubWindowList1((.)this.ptr.Ptr, order);
	}
	public QMdiSubWindow_Ptr AddSubWindow2(IQWidget widget, void* flags)
	{
		return QMdiSubWindow_Ptr(CQt.QMdiArea_AddSubWindow2((.)this.ptr.Ptr, (.)widget?.ObjectPtr, flags));
	}
	public void SetOption2(QMdiArea_AreaOption option, bool on)
	{
		CQt.QMdiArea_SetOption2((.)this.ptr.Ptr, option, on);
	}
