...
class QMdiArea : IQMdiArea, IQAbstractScrollArea, IQFrame, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		QMdiArea_subWindowActivated,
		QMdiArea_windowTitleChanged,
		QMdiArea_windowIconChanged,
		QMdiArea_windowIconTextChanged,
		QMdiArea_customContextMenuRequested,
		QMdiArea_destroyed,
		QMdiArea_destroyed1,
	}
	...
	static void QtBf_ConnectSignals(Self obj)
	{
		...
		CQt.QMdiArea_Connect_SubWindowActivated(obj.ObjectPtr,  => QtBeef_QMdiArea_subWindowActivated);
	...
	static void QtBeef_QMdiArea_subWindowActivated(void* ptr, void** param1)
	{
	...
	public void PaintEvent(IQPaintEvent paintEvent)
	{
		this.ptr.PaintEvent(paintEvent);
	}
	public void ChildEvent(IQChildEvent childEvent)
	{
		this.ptr.ChildEvent(childEvent);
	}
	public void ResizeEvent(IQResizeEvent resizeEvent)
	{
		this.ptr.ResizeEvent(resizeEvent);
	}
	public void TimerEvent(IQTimerEvent timerEvent)
	{
		this.ptr.TimerEvent(timerEvent);
	}
	public void ShowEvent(IQShowEvent showEvent)
	{
		this.ptr.ShowEvent(showEvent);
	}
	public bool ViewportEvent(IQEvent event)
	{
	...
	public void DragEnterEvent(IQDragEnterEvent param1)
	{
		this.ptr.DragEnterEvent(param1);
	}
	public void DragMoveEvent(IQDragMoveEvent param1)
	{
		this.ptr.DragMoveEvent(param1);
	}
	public void DragLeaveEvent(IQDragLeaveEvent param1)
	{
		this.ptr.DragLeaveEvent(param1);
	}
	public void DropEvent(IQDropEvent param1)
	{
		this.ptr.DropEvent(param1);
	}
	public void KeyPressEvent(IQKeyEvent param1)
	{
...
extension CQt
{
	...
	public static extern void QMdiArea_Connect_SubWindowActivated(void* self, QMdiArea_subWindowActivated_action _action);
