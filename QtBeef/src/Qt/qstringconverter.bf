...
class QStringEncoder : IQStringEncoder
{
	...
	{
		return CQt.QStringEncoder_RequiredSpace((.)this.ptr.Ptr, inputLength);
	}
}
...
class QStringDecoder : IQStringDecoder
{
	...
	public void* RequiredSpace(void* inputLength)
	{
		return CQt.QStringDecoder_RequiredSpace((.)this.ptr.Ptr, inputLength);
	}
	public QChar_Ptr AppendToBuffer(IQChar _out, void* ba)
	{
		return QChar_Ptr(CQt.QStringDecoder_AppendToBuffer((.)this.ptr.Ptr, (.)_out?.ObjectPtr, ba));
	}
