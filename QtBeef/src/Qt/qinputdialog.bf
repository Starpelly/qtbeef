...
struct QInputDialog_Ptr
{
	...
	{
		return QMetaObject_Ptr(CQt.QInputDialog_MetaObject((.)this.Ptr));
	}
	...
	{
		CQt.QInputDialog_LabelText((.)this.Ptr);
	}
	...
	{
		CQt.QInputDialog_TextValue((.)this.Ptr);
	}
	...
	{
		CQt.QInputDialog_OkButtonText((.)this.Ptr);
	}
	...
	{
		CQt.QInputDialog_CancelButtonText((.)this.Ptr);
	}
	public QSize_Ptr MinimumSizeHint()
	{
		return QSize_Ptr(CQt.QInputDialog_MinimumSizeHint((.)this.Ptr));
	}
	public QSize_Ptr SizeHint()
	{
		return QSize_Ptr(CQt.QInputDialog_SizeHint((.)this.Ptr));
	}
	...
	{
		return CQt.QInputDialog_Event((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public bool EventFilter(IQObject watched, IQEvent event)
	{
		return CQt.QInputDialog_EventFilter((.)this.Ptr, (.)watched?.ObjectPtr, (.)event?.ObjectPtr);
	}
	...
	{
		CQt.QInputDialog_TimerEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ChildEvent(IQChildEvent event)
	{
		CQt.QInputDialog_ChildEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void CustomEvent(IQEvent event)
	{
		CQt.QInputDialog_CustomEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ConnectNotify(IQMetaMethod signal)
	{
		CQt.QInputDialog_ConnectNotify((.)this.Ptr, (.)signal?.ObjectPtr);
	}
	public void DisconnectNotify(IQMetaMethod signal)
	{
		CQt.QInputDialog_DisconnectNotify((.)this.Ptr, (.)signal?.ObjectPtr);
	}
	...
	{
		return CQt.QInputDialog_DevType((.)this.Ptr);
	}
	...
	{
		return QPaintEngine_Ptr(CQt.QInputDialog_PaintEngine((.)this.Ptr));
	}
	public c_int Width()
	{
	...
	{
		return CQt.QInputDialog_Metric((.)this.Ptr, metric);
	}
	public void InitPainter(IQPainter painter)
	{
		CQt.QInputDialog_InitPainter((.)this.Ptr, (.)painter?.ObjectPtr);
	}
	public QPaintDevice_Ptr Redirected(IQPoint offset)
	{
		return QPaintDevice_Ptr(CQt.QInputDialog_Redirected((.)this.Ptr, (.)offset?.ObjectPtr));
	}
	public QPainter_Ptr SharedPainter()
	{
		return QPainter_Ptr(CQt.QInputDialog_SharedPainter((.)this.Ptr));
	}
	public void* WinId()
	{
	...
	{
		return CQt.QInputDialog_HeightForWidth((.)this.Ptr, param1);
	}
	public bool HasHeightForWidth()
	{
		return CQt.QInputDialog_HasHeightForWidth((.)this.Ptr);
	}
	...
	{
		CQt.QInputDialog_MousePressEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void MouseReleaseEvent(IQMouseEvent event)
	{
		CQt.QInputDialog_MouseReleaseEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void MouseDoubleClickEvent(IQMouseEvent event)
	{
		CQt.QInputDialog_MouseDoubleClickEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void MouseMoveEvent(IQMouseEvent event)
	{
		CQt.QInputDialog_MouseMoveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void WheelEvent(IQWheelEvent event)
	{
		CQt.QInputDialog_WheelEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void KeyPressEvent(IQKeyEvent event)
	{
		CQt.QInputDialog_KeyPressEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void KeyReleaseEvent(IQKeyEvent event)
	{
		CQt.QInputDialog_KeyReleaseEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void FocusInEvent(IQFocusEvent event)
	{
		CQt.QInputDialog_FocusInEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void FocusOutEvent(IQFocusEvent event)
	{
		CQt.QInputDialog_FocusOutEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void EnterEvent(IQEnterEvent event)
	{
		CQt.QInputDialog_EnterEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void LeaveEvent(IQEvent event)
	{
		CQt.QInputDialog_LeaveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent event)
	{
		CQt.QInputDialog_PaintEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void MoveEvent(IQMoveEvent event)
	{
		CQt.QInputDialog_MoveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ResizeEvent(IQResizeEvent event)
	{
		CQt.QInputDialog_ResizeEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void CloseEvent(IQCloseEvent event)
	{
		CQt.QInputDialog_CloseEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ContextMenuEvent(IQContextMenuEvent event)
	{
		CQt.QInputDialog_ContextMenuEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void TabletEvent(IQTabletEvent event)
	{
		CQt.QInputDialog_TabletEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ActionEvent(IQActionEvent event)
	{
		CQt.QInputDialog_ActionEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void DragEnterEvent(IQDragEnterEvent event)
	{
		CQt.QInputDialog_DragEnterEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void DragMoveEvent(IQDragMoveEvent event)
	{
		CQt.QInputDialog_DragMoveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void DragLeaveEvent(IQDragLeaveEvent event)
	{
		CQt.QInputDialog_DragLeaveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void DropEvent(IQDropEvent event)
	{
		CQt.QInputDialog_DropEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ShowEvent(IQShowEvent event)
	{
		CQt.QInputDialog_ShowEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void HideEvent(IQHideEvent event)
	{
		CQt.QInputDialog_HideEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public bool NativeEvent(void** eventType, void* message, void** result)
	{
		return CQt.QInputDialog_NativeEvent((.)this.Ptr, eventType, message, result);
	}
	public void ChangeEvent(IQEvent param1)
	{
		CQt.QInputDialog_ChangeEvent((.)this.Ptr, (.)param1?.ObjectPtr);
	}
	public void InputMethodEvent(IQInputMethodEvent param1)
	{
		CQt.QInputDialog_InputMethodEvent((.)this.Ptr, (.)param1?.ObjectPtr);
	}
	public QVariant_Ptr InputMethodQuery(Qt_InputMethodQuery param1)
	{
		return QVariant_Ptr(CQt.QInputDialog_InputMethodQuery((.)this.Ptr, param1));
	}
	...
	{
		return CQt.QInputDialog_FocusNextPrevChild((.)this.Ptr, next);
	}
	...
	public void Open()
	{
		CQt.QInputDialog_Open((.)this.Ptr);
	}
	public c_int Exec()
	{
		return CQt.QInputDialog_Exec((.)this.Ptr);
	}
	public void Accept()
	{
		CQt.QInputDialog_Accept((.)this.Ptr);
	}
	public void Reject()
	{
		CQt.QInputDialog_Reject((.)this.Ptr);
	}
...
class QInputDialog : IQInputDialog, IQDialog, IQWidget, IQObject, IQPaintDevice
{
	...
	static void QtBf_ConnectSignals(Self obj)
	{
		...
		CQt.QInputDialog_Connect_TextValueChanged(obj.ObjectPtr,  => QtBeef_QInputDialog_Connect_TextValueChanged);
		CQt.QInputDialog_Connect_TextValueSelected(obj.ObjectPtr,  => QtBeef_QInputDialog_Connect_TextValueSelected);
		CQt.QInputDialog_Connect_IntValueChanged(obj.ObjectPtr,  => QtBeef_QInputDialog_Connect_IntValueChanged);
		CQt.QInputDialog_Connect_IntValueSelected(obj.ObjectPtr,  => QtBeef_QInputDialog_Connect_IntValueSelected);
		CQt.QInputDialog_Connect_DoubleValueChanged(obj.ObjectPtr,  => QtBeef_QInputDialog_Connect_DoubleValueChanged);
		CQt.QInputDialog_Connect_DoubleValueSelected(obj.ObjectPtr,  => QtBeef_QInputDialog_Connect_DoubleValueSelected);
	...
	static void QtBeef_QInputDialog_Connect_TextValueChanged(void* ptr, libqt_string text)
	{
		let obj = CQt.ObjectHandleMap[ptr] as Self;
		obj.OnTextValueChanged.Invoke(text);
	}
	static void QtBeef_QInputDialog_Connect_TextValueSelected(void* ptr, libqt_string text)
	{
		let obj = CQt.ObjectHandleMap[ptr] as Self;
		obj.OnTextValueSelected.Invoke(text);
	}
	static void QtBeef_QInputDialog_Connect_IntValueChanged(void* ptr, c_int value)
	{
		let obj = CQt.ObjectHandleMap[ptr] as Self;
		obj.OnIntValueChanged.Invoke(value);
	}
	static void QtBeef_QInputDialog_Connect_IntValueSelected(void* ptr, c_int value)
	{
		let obj = CQt.ObjectHandleMap[ptr] as Self;
		obj.OnIntValueSelected.Invoke(value);
	}
	static void QtBeef_QInputDialog_Connect_DoubleValueChanged(void* ptr, double value)
	{
		let obj = CQt.ObjectHandleMap[ptr] as Self;
		obj.OnDoubleValueChanged.Invoke(value);
	}
	static void QtBeef_QInputDialog_Connect_DoubleValueSelected(void* ptr, double value)
	{
		let obj = CQt.ObjectHandleMap[ptr] as Self;
	...
	public void SetInputMode(QInputDialog_InputMode mode)
	{
		this.ptr.SetInputMode(mode);
	}
	public QInputDialog_InputMode InputMode()
	{
		return this.ptr.InputMode();
	}
	public void SetLabelText(String text)
	{
	...
	public void SetTextValue(String text)
	{
		this.ptr.SetTextValue(text);
	}
	public void TextValue(String outStr)
	{
		this.ptr.TextValue(outStr);
	}
	public void SetTextEchoMode(QLineEdit_EchoMode mode)
	{
		this.ptr.SetTextEchoMode(mode);
	}
	public QLineEdit_EchoMode TextEchoMode()
	{
		return this.ptr.TextEchoMode();
	}
	public void SetComboBoxEditable(bool editable)
	{
		this.ptr.SetComboBoxEditable(editable);
	}
	public bool IsComboBoxEditable()
	{
		return this.ptr.IsComboBoxEditable();
	}
	public void SetComboBoxItems(void** items)
	{
		this.ptr.SetComboBoxItems(items);
	}
	public void* ComboBoxItems()
	{
		return this.ptr.ComboBoxItems();
	}
	public void SetIntValue(c_int value)
	{
		this.ptr.SetIntValue(value);
	}
	public c_int IntValue()
	{
	...
	public void SetIntMinimum(c_int min)
	{
		this.ptr.SetIntMinimum(min);
	}
	public c_int IntMinimum()
	{
		return this.ptr.IntMinimum();
	}
	public void SetIntMaximum(c_int max)
	{
		this.ptr.SetIntMaximum(max);
	}
	public c_int IntMaximum()
	{
		return this.ptr.IntMaximum();
	}
	public void SetIntRange(c_int min, c_int max)
	{
		this.ptr.SetIntRange(min, max);
	}
	public void SetIntStep(c_int step)
	{
		this.ptr.SetIntStep(step);
	}
	public c_int IntStep()
	{
		return this.ptr.IntStep();
	}
	public void SetDoubleValue(double value)
	{
		this.ptr.SetDoubleValue(value);
	}
	public double DoubleValue()
	{
		return this.ptr.DoubleValue();
	}
	public void SetDoubleMinimum(double min)
	{
		this.ptr.SetDoubleMinimum(min);
	}
	public double DoubleMinimum()
	{
		return this.ptr.DoubleMinimum();
	}
	public void SetDoubleMaximum(double max)
	{
		this.ptr.SetDoubleMaximum(max);
	}
	public double DoubleMaximum()
	{
		return this.ptr.DoubleMaximum();
	}
	public void SetDoubleRange(double min, double max)
	{
		this.ptr.SetDoubleRange(min, max);
	}
	public void SetDoubleDecimals(c_int decimals)
	{
		this.ptr.SetDoubleDecimals(decimals);
	}
	public c_int DoubleDecimals()
	{
		return this.ptr.DoubleDecimals();
	}
	public void SetOkButtonText(String text)
	{
		this.ptr.SetOkButtonText(text);
	}
	public void OkButtonText(String outStr)
	{
		this.ptr.OkButtonText(outStr);
	}
	public void SetCancelButtonText(String text)
	{
	...
	public void CancelButtonText(String outStr)
	{
		this.ptr.CancelButtonText(outStr);
	}
	...
	public void GetText(String outStr, IQWidget parent, String title, String label)
	{
		this.ptr.GetText(outStr, parent, title, label);
	}
	public void GetMultiLineText(String outStr, IQWidget parent, String title, String label)
	{
		this.ptr.GetMultiLineText(outStr, parent, title, label);
	}
	public void GetItem(String outStr, IQWidget parent, String title, String label, void** items)
	{
		this.ptr.GetItem(outStr, parent, title, label, items);
	}
	public c_int GetInt(IQWidget parent, String title, String label)
	{
		return this.ptr.GetInt(parent, title, label);
	}
	public double GetDouble(IQWidget parent, String title, String label)
	{
		return this.ptr.GetDouble(parent, title, label);
	}
	public void SetDoubleStep(double step)
	{
		this.ptr.SetDoubleStep(step);
	}
	public double DoubleStep()
	{
		return this.ptr.DoubleStep();
	}
	public void TextValueChanged(String text)
	{
		this.ptr.TextValueChanged(text);
	}
	public void TextValueSelected(String text)
	{
		this.ptr.TextValueSelected(text);
	}
	public void IntValueChanged(c_int value)
	{
		this.ptr.IntValueChanged(value);
	}
	public void IntValueSelected(c_int value)
	{
		this.ptr.IntValueSelected(value);
	}
	public void DoubleValueChanged(double value)
	{
		this.ptr.DoubleValueChanged(value);
	}
	public void DoubleValueSelected(double value)
	{
		this.ptr.DoubleValueSelected(value);
	}
	...
	public void GetText4(String outStr, IQWidget parent, String title, String label, QLineEdit_EchoMode echo)
	{
		this.ptr.GetText4(outStr, parent, title, label, echo);
	}
	public void GetText5(String outStr, IQWidget parent, String title, String label, QLineEdit_EchoMode echo, String text)
	{
		this.ptr.GetText5(outStr, parent, title, label, echo, text);
	}
	public void GetText6(String outStr, IQWidget parent, String title, String label, QLineEdit_EchoMode echo, String text, bool* ok)
	{
		this.ptr.GetText6(outStr, parent, title, label, echo, text, ok);
	}
	public void GetText7(String outStr, IQWidget parent, String title, String label, QLineEdit_EchoMode echo, String text, bool* ok, void* flags)
	{
		this.ptr.GetText7(outStr, parent, title, label, echo, text, ok, flags);
	}
	public void GetText8(String outStr, IQWidget parent, String title, String label, QLineEdit_EchoMode echo, String text, bool* ok, void* flags, void* inputMethodHints)
	{
		this.ptr.GetText8(outStr, parent, title, label, echo, text, ok, flags, inputMethodHints);
	}
	public void GetMultiLineText4(String outStr, IQWidget parent, String title, String label, String text)
	{
		this.ptr.GetMultiLineText4(outStr, parent, title, label, text);
	}
	public void GetMultiLineText5(String outStr, IQWidget parent, String title, String label, String text, bool* ok)
	{
		this.ptr.GetMultiLineText5(outStr, parent, title, label, text, ok);
	}
	public void GetMultiLineText6(String outStr, IQWidget parent, String title, String label, String text, bool* ok, void* flags)
	{
		this.ptr.GetMultiLineText6(outStr, parent, title, label, text, ok, flags);
	}
	public void GetMultiLineText7(String outStr, IQWidget parent, String title, String label, String text, bool* ok, void* flags, void* inputMethodHints)
	{
		this.ptr.GetMultiLineText7(outStr, parent, title, label, text, ok, flags, inputMethodHints);
	}
	public void GetItem5(String outStr, IQWidget parent, String title, String label, void** items, c_int current)
	{
		this.ptr.GetItem5(outStr, parent, title, label, items, current);
	}
	public void GetItem6(String outStr, IQWidget parent, String title, String label, void** items, c_int current, bool editable)
	{
		this.ptr.GetItem6(outStr, parent, title, label, items, current, editable);
	}
	public void GetItem7(String outStr, IQWidget parent, String title, String label, void** items, c_int current, bool editable, bool* ok)
	{
		this.ptr.GetItem7(outStr, parent, title, label, items, current, editable, ok);
	}
	public void GetItem8(String outStr, IQWidget parent, String title, String label, void** items, c_int current, bool editable, bool* ok, void* flags)
	{
		this.ptr.GetItem8(outStr, parent, title, label, items, current, editable, ok, flags);
	}
	public void GetItem9(String outStr, IQWidget parent, String title, String label, void** items, c_int current, bool editable, bool* ok, void* flags, void* inputMethodHints)
	{
		this.ptr.GetItem9(outStr, parent, title, label, items, current, editable, ok, flags, inputMethodHints);
	}
	public c_int GetInt4(IQWidget parent, String title, String label, c_int value)
	{
		return this.ptr.GetInt4(parent, title, label, value);
	}
	public c_int GetInt5(IQWidget parent, String title, String label, c_int value, c_int minValue)
	{
		return this.ptr.GetInt5(parent, title, label, value, minValue);
	}
	public c_int GetInt6(IQWidget parent, String title, String label, c_int value, c_int minValue, c_int maxValue)
	{
		return this.ptr.GetInt6(parent, title, label, value, minValue, maxValue);
	}
	public c_int GetInt7(IQWidget parent, String title, String label, c_int value, c_int minValue, c_int maxValue, c_int step)
	{
		return this.ptr.GetInt7(parent, title, label, value, minValue, maxValue, step);
	}
	public c_int GetInt8(IQWidget parent, String title, String label, c_int value, c_int minValue, c_int maxValue, c_int step, bool* ok)
	{
		return this.ptr.GetInt8(parent, title, label, value, minValue, maxValue, step, ok);
	}
	public c_int GetInt9(IQWidget parent, String title, String label, c_int value, c_int minValue, c_int maxValue, c_int step, bool* ok, void* flags)
	{
		return this.ptr.GetInt9(parent, title, label, value, minValue, maxValue, step, ok, flags);
	}
	public double GetDouble4(IQWidget parent, String title, String label, double value)
	{
		return this.ptr.GetDouble4(parent, title, label, value);
	}
	public double GetDouble5(IQWidget parent, String title, String label, double value, double minValue)
	{
		return this.ptr.GetDouble5(parent, title, label, value, minValue);
	}
	public double GetDouble6(IQWidget parent, String title, String label, double value, double minValue, double maxValue)
	{
		return this.ptr.GetDouble6(parent, title, label, value, minValue, maxValue);
	}
	public double GetDouble7(IQWidget parent, String title, String label, double value, double minValue, double maxValue, c_int decimals)
	{
		return this.ptr.GetDouble7(parent, title, label, value, minValue, maxValue, decimals);
	}
	public double GetDouble8(IQWidget parent, String title, String label, double value, double minValue, double maxValue, c_int decimals, bool* ok)
	{
		return this.ptr.GetDouble8(parent, title, label, value, minValue, maxValue, decimals, ok);
	}
	public double GetDouble9(IQWidget parent, String title, String label, double value, double minValue, double maxValue, c_int decimals, bool* ok, void* flags)
	{
		return this.ptr.GetDouble9(parent, title, label, value, minValue, maxValue, decimals, ok, flags);
	}
	public double GetDouble10(IQWidget parent, String title, String label, double value, double minValue, double maxValue, c_int decimals, bool* ok, void* flags, double step)
	{
		return this.ptr.GetDouble10(parent, title, label, value, minValue, maxValue, decimals, ok, flags, step);
	}
...
extension CQt
{
	...
	public function void QInputDialog_Connect_TextValueChanged_action(void* self, libqt_string text);
	[LinkName("QInputDialog_Connect_TextValueChanged")]
	public static extern void QInputDialog_Connect_TextValueChanged(void* self, QInputDialog_Connect_TextValueChanged_action _action);
	...
	public function void QInputDialog_Connect_TextValueSelected_action(void* self, libqt_string text);
	[LinkName("QInputDialog_Connect_TextValueSelected")]
	public static extern void QInputDialog_Connect_TextValueSelected(void* self, QInputDialog_Connect_TextValueSelected_action _action);
	[LinkName("QInputDialog_IntValueChanged")]
	public static extern void QInputDialog_IntValueChanged(void* self, c_int value);
	
	public function void QInputDialog_Connect_IntValueChanged_action(void* self, c_int value);
	[LinkName("QInputDialog_Connect_IntValueChanged")]
	public static extern void QInputDialog_Connect_IntValueChanged(void* self, QInputDialog_Connect_IntValueChanged_action _action);
	[LinkName("QInputDialog_IntValueSelected")]
	public static extern void QInputDialog_IntValueSelected(void* self, c_int value);
	
	public function void QInputDialog_Connect_IntValueSelected_action(void* self, c_int value);
	[LinkName("QInputDialog_Connect_IntValueSelected")]
	public static extern void QInputDialog_Connect_IntValueSelected(void* self, QInputDialog_Connect_IntValueSelected_action _action);
	[LinkName("QInputDialog_DoubleValueChanged")]
	public static extern void QInputDialog_DoubleValueChanged(void* self, double value);
	
	public function void QInputDialog_Connect_DoubleValueChanged_action(void* self, double value);
	[LinkName("QInputDialog_Connect_DoubleValueChanged")]
	public static extern void QInputDialog_Connect_DoubleValueChanged(void* self, QInputDialog_Connect_DoubleValueChanged_action _action);
	...
	public function void QInputDialog_Connect_DoubleValueSelected_action(void* self, double value);
	[LinkName("QInputDialog_Connect_DoubleValueSelected")]
	public static extern void QInputDialog_Connect_DoubleValueSelected(void* self, QInputDialog_Connect_DoubleValueSelected_action _action);
	...
	[LinkName("QInputDialog_Event")]
	public static extern bool QInputDialog_Event(void* self, void** event);
