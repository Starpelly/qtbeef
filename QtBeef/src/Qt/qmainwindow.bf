...
class QMainWindow : IQMainWindow, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QMainWindow_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QMainWindow_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QMainWindow_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return QSize_Ptr(CQt.QMainWindow_IconSize((.)this.ptr.Ptr));
	}
	public void SetIconSize(IQSize iconSize)
	{
		CQt.QMainWindow_SetIconSize((.)this.ptr.Ptr, (.)iconSize?.ObjectPtr);
	}
	public Qt_ToolButtonStyle ToolButtonStyle()
	{
		return CQt.QMainWindow_ToolButtonStyle((.)this.ptr.Ptr);
	}
	public void SetToolButtonStyle(Qt_ToolButtonStyle toolButtonStyle)
	{
		CQt.QMainWindow_SetToolButtonStyle((.)this.ptr.Ptr, toolButtonStyle);
	}
	public bool IsAnimated()
	{
		return CQt.QMainWindow_IsAnimated((.)this.ptr.Ptr);
	}
	public bool IsDockNestingEnabled()
	{
		return CQt.QMainWindow_IsDockNestingEnabled((.)this.ptr.Ptr);
	}
	public bool DocumentMode()
	{
		return CQt.QMainWindow_DocumentMode((.)this.ptr.Ptr);
	}
	public void SetDocumentMode(bool enabled)
	{
		CQt.QMainWindow_SetDocumentMode((.)this.ptr.Ptr, enabled);
	}
	public QTabWidget_TabShape TabShape()
	{
		return CQt.QMainWindow_TabShape((.)this.ptr.Ptr);
	}
	public void SetTabShape(QTabWidget_TabShape tabShape)
	{
		CQt.QMainWindow_SetTabShape((.)this.ptr.Ptr, tabShape);
	}
	public QTabWidget_TabPosition TabPosition(Qt_DockWidgetArea area)
	{
		return CQt.QMainWindow_TabPosition((.)this.ptr.Ptr, area);
	}
	public void SetTabPosition(void* areas, QTabWidget_TabPosition tabPosition)
	{
		CQt.QMainWindow_SetTabPosition((.)this.ptr.Ptr, areas, tabPosition);
	}
	public void SetDockOptions(void* options)
	{
		CQt.QMainWindow_SetDockOptions((.)this.ptr.Ptr, options);
	}
	public void* DockOptions()
	{
		return CQt.QMainWindow_DockOptions((.)this.ptr.Ptr);
	}
	public bool IsSeparator(IQPoint pos)
	{
		return CQt.QMainWindow_IsSeparator((.)this.ptr.Ptr, (.)pos?.ObjectPtr);
	}
	public QMenuBar_Ptr MenuBar()
	{
		return QMenuBar_Ptr(CQt.QMainWindow_MenuBar((.)this.ptr.Ptr));
	}
	public void SetMenuBar(IQMenuBar menubar)
	{
		CQt.QMainWindow_SetMenuBar((.)this.ptr.Ptr, (.)menubar?.ObjectPtr);
	}
	public QWidget_Ptr MenuWidget()
	{
		return QWidget_Ptr(CQt.QMainWindow_MenuWidget((.)this.ptr.Ptr));
	}
	public void SetMenuWidget(IQWidget menubar)
	{
		CQt.QMainWindow_SetMenuWidget((.)this.ptr.Ptr, (.)menubar?.ObjectPtr);
	}
	public QStatusBar_Ptr StatusBar()
	{
		return QStatusBar_Ptr(CQt.QMainWindow_StatusBar((.)this.ptr.Ptr));
	}
	public void SetStatusBar(IQStatusBar statusbar)
	{
		CQt.QMainWindow_SetStatusBar((.)this.ptr.Ptr, (.)statusbar?.ObjectPtr);
	}
	public QWidget_Ptr CentralWidget()
	{
		return QWidget_Ptr(CQt.QMainWindow_CentralWidget((.)this.ptr.Ptr));
	}
	public void SetCentralWidget(IQWidget widget)
	{
		CQt.QMainWindow_SetCentralWidget((.)this.ptr.Ptr, (.)widget?.ObjectPtr);
	}
	public QWidget_Ptr TakeCentralWidget()
	{
		return QWidget_Ptr(CQt.QMainWindow_TakeCentralWidget((.)this.ptr.Ptr));
	}
	public void SetCorner(Qt_Corner corner, Qt_DockWidgetArea area)
	{
		CQt.QMainWindow_SetCorner((.)this.ptr.Ptr, corner, area);
	}
	public Qt_DockWidgetArea Corner(Qt_Corner corner)
	{
		return CQt.QMainWindow_Corner((.)this.ptr.Ptr, corner);
	}
	public void AddToolBarBreak()
	{
		CQt.QMainWindow_AddToolBarBreak((.)this.ptr.Ptr);
	}
	public void InsertToolBarBreak(IQToolBar before)
	{
		CQt.QMainWindow_InsertToolBarBreak((.)this.ptr.Ptr, (.)before?.ObjectPtr);
	}
	public void AddToolBar(Qt_ToolBarArea area, IQToolBar toolbar)
	{
		CQt.QMainWindow_AddToolBar((.)this.ptr.Ptr, area, (.)toolbar?.ObjectPtr);
	}
	public void AddToolBar2(IQToolBar toolbar)
	{
		CQt.QMainWindow_AddToolBar2((.)this.ptr.Ptr, (.)toolbar?.ObjectPtr);
	}
	public QToolBar_Ptr AddToolBar3(String title)
	{
		return QToolBar_Ptr(CQt.QMainWindow_AddToolBar3((.)this.ptr.Ptr, libqt_string(title)));
	}
	public void InsertToolBar(IQToolBar before, IQToolBar toolbar)
	{
		CQt.QMainWindow_InsertToolBar((.)this.ptr.Ptr, (.)before?.ObjectPtr, (.)toolbar?.ObjectPtr);
	}
	public void RemoveToolBar(IQToolBar toolbar)
	{
		CQt.QMainWindow_RemoveToolBar((.)this.ptr.Ptr, (.)toolbar?.ObjectPtr);
	}
	public void RemoveToolBarBreak(IQToolBar before)
	{
		CQt.QMainWindow_RemoveToolBarBreak((.)this.ptr.Ptr, (.)before?.ObjectPtr);
	}
	public bool UnifiedTitleAndToolBarOnMac()
	{
		return CQt.QMainWindow_UnifiedTitleAndToolBarOnMac((.)this.ptr.Ptr);
	}
	public Qt_ToolBarArea ToolBarArea(IQToolBar toolbar)
	{
		return CQt.QMainWindow_ToolBarArea((.)this.ptr.Ptr, (.)toolbar?.ObjectPtr);
	}
	public bool ToolBarBreak(IQToolBar toolbar)
	{
		return CQt.QMainWindow_ToolBarBreak((.)this.ptr.Ptr, (.)toolbar?.ObjectPtr);
	}
	public void AddDockWidget(Qt_DockWidgetArea area, IQDockWidget dockwidget)
	{
		CQt.QMainWindow_AddDockWidget((.)this.ptr.Ptr, area, (.)dockwidget?.ObjectPtr);
	}
	public void AddDockWidget2(Qt_DockWidgetArea area, IQDockWidget dockwidget, Qt_Orientation orientation)
	{
		CQt.QMainWindow_AddDockWidget2((.)this.ptr.Ptr, area, (.)dockwidget?.ObjectPtr, orientation);
	}
	public void SplitDockWidget(IQDockWidget after, IQDockWidget dockwidget, Qt_Orientation orientation)
	{
		CQt.QMainWindow_SplitDockWidget((.)this.ptr.Ptr, (.)after?.ObjectPtr, (.)dockwidget?.ObjectPtr, orientation);
	}
	public void TabifyDockWidget(IQDockWidget first, IQDockWidget second)
	{
		CQt.QMainWindow_TabifyDockWidget((.)this.ptr.Ptr, (.)first?.ObjectPtr, (.)second?.ObjectPtr);
	}
	public void* TabifiedDockWidgets(IQDockWidget dockwidget)
	{
		return CQt.QMainWindow_TabifiedDockWidgets((.)this.ptr.Ptr, (.)dockwidget?.ObjectPtr);
	}
	public void RemoveDockWidget(IQDockWidget dockwidget)
	{
		CQt.QMainWindow_RemoveDockWidget((.)this.ptr.Ptr, (.)dockwidget?.ObjectPtr);
	}
	public bool RestoreDockWidget(IQDockWidget dockwidget)
	{
		return CQt.QMainWindow_RestoreDockWidget((.)this.ptr.Ptr, (.)dockwidget?.ObjectPtr);
	}
	public Qt_DockWidgetArea DockWidgetArea(IQDockWidget dockwidget)
	{
		return CQt.QMainWindow_DockWidgetArea((.)this.ptr.Ptr, (.)dockwidget?.ObjectPtr);
	}
	public void ResizeDocks(void** docks, void** sizes, Qt_Orientation orientation)
	{
		CQt.QMainWindow_ResizeDocks((.)this.ptr.Ptr, docks, sizes, orientation);
	}
	public void* SaveState()
	{
		return CQt.QMainWindow_SaveState((.)this.ptr.Ptr);
	}
	public bool RestoreState(void** state)
	{
		return CQt.QMainWindow_RestoreState((.)this.ptr.Ptr, state);
	}
	public QMenu_Ptr CreatePopupMenu()
	{
		return QMenu_Ptr(CQt.QMainWindow_CreatePopupMenu((.)this.ptr.Ptr));
	}
	public void SetAnimated(bool enabled)
	{
		CQt.QMainWindow_SetAnimated((.)this.ptr.Ptr, enabled);
	}
	public void SetDockNestingEnabled(bool enabled)
	{
		CQt.QMainWindow_SetDockNestingEnabled((.)this.ptr.Ptr, enabled);
	}
	public void SetUnifiedTitleAndToolBarOnMac(bool set)
	{
		CQt.QMainWindow_SetUnifiedTitleAndToolBarOnMac((.)this.ptr.Ptr, set);
	}
	public void IconSizeChanged(IQSize iconSize)
	{
		CQt.QMainWindow_IconSizeChanged((.)this.ptr.Ptr, (.)iconSize?.ObjectPtr);
	}
	public void ToolButtonStyleChanged(Qt_ToolButtonStyle toolButtonStyle)
	{
		CQt.QMainWindow_ToolButtonStyleChanged((.)this.ptr.Ptr, toolButtonStyle);
	}
	public void TabifiedDockWidgetActivated(IQDockWidget dockWidget)
	{
		CQt.QMainWindow_TabifiedDockWidgetActivated((.)this.ptr.Ptr, (.)dockWidget?.ObjectPtr);
	}
	public void ContextMenuEvent(IQContextMenuEvent event)
	{
		CQt.QMainWindow_ContextMenuEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public bool Event(IQEvent event)
	{
		return CQt.QMainWindow_Event((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	...
	{
		CQt.QMainWindow_AddToolBarBreak1((.)this.ptr.Ptr, area);
	}
	public void* SaveState1(c_int version)
	{
		return CQt.QMainWindow_SaveState1((.)this.ptr.Ptr, version);
	}
	public bool RestoreState2(void** state, c_int version)
	{
		return CQt.QMainWindow_RestoreState2((.)this.ptr.Ptr, state, version);
	}
