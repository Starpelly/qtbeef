...
class QToolButton : IQToolButton, IQAbstractButton, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QToolButton_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QToolButton_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QToolButton_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return QSize_Ptr(CQt.QToolButton_SizeHint((.)this.ptr.Ptr));
	}
	public QSize_Ptr MinimumSizeHint()
	{
		return QSize_Ptr(CQt.QToolButton_MinimumSizeHint((.)this.ptr.Ptr));
	}
	public Qt_ToolButtonStyle ToolButtonStyle()
	{
		return CQt.QToolButton_ToolButtonStyle((.)this.ptr.Ptr);
	}
	public Qt_ArrowType ArrowType()
	{
		return CQt.QToolButton_ArrowType((.)this.ptr.Ptr);
	}
	public void SetArrowType(Qt_ArrowType type)
	{
		CQt.QToolButton_SetArrowType((.)this.ptr.Ptr, type);
	}
	public void SetMenu(IQMenu menu)
	{
		CQt.QToolButton_SetMenu((.)this.ptr.Ptr, (.)menu?.ObjectPtr);
	}
	public QMenu_Ptr Menu()
	{
		return QMenu_Ptr(CQt.QToolButton_Menu((.)this.ptr.Ptr));
	}
	public void SetPopupMode(QToolButton_ToolButtonPopupMode mode)
	{
		CQt.QToolButton_SetPopupMode((.)this.ptr.Ptr, mode);
	}
	public QToolButton_ToolButtonPopupMode PopupMode()
	{
		return CQt.QToolButton_PopupMode((.)this.ptr.Ptr);
	}
	public QAction_Ptr DefaultAction()
	{
		return QAction_Ptr(CQt.QToolButton_DefaultAction((.)this.ptr.Ptr));
	}
	public void SetAutoRaise(bool enable)
	{
		CQt.QToolButton_SetAutoRaise((.)this.ptr.Ptr, enable);
	}
	public bool AutoRaise()
	{
		return CQt.QToolButton_AutoRaise((.)this.ptr.Ptr);
	}
	public void ShowMenu()
	{
		CQt.QToolButton_ShowMenu((.)this.ptr.Ptr);
	}
	public void SetToolButtonStyle(Qt_ToolButtonStyle style)
	{
		CQt.QToolButton_SetToolButtonStyle((.)this.ptr.Ptr, style);
	}
	public void SetDefaultAction(IQAction defaultAction)
	{
		CQt.QToolButton_SetDefaultAction((.)this.ptr.Ptr, (.)defaultAction?.ObjectPtr);
	}
	public void Triggered(IQAction param1)
	{
		CQt.QToolButton_Triggered((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public bool Event(IQEvent e)
	{
		return CQt.QToolButton_Event((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void MousePressEvent(IQMouseEvent param1)
	{
		CQt.QToolButton_MousePressEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void MouseReleaseEvent(IQMouseEvent param1)
	{
		CQt.QToolButton_MouseReleaseEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QToolButton_PaintEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void ActionEvent(IQActionEvent param1)
	{
		CQt.QToolButton_ActionEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void EnterEvent(IQEnterEvent param1)
	{
		CQt.QToolButton_EnterEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void LeaveEvent(IQEvent param1)
	{
		CQt.QToolButton_LeaveEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void TimerEvent(IQTimerEvent param1)
	{
		CQt.QToolButton_TimerEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void ChangeEvent(IQEvent param1)
	{
		CQt.QToolButton_ChangeEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public bool HitButton(IQPoint pos)
	{
		return CQt.QToolButton_HitButton((.)this.ptr.Ptr, (.)pos?.ObjectPtr);
	}
	public void CheckStateSet()
	{
		CQt.QToolButton_CheckStateSet((.)this.ptr.Ptr);
	}
	public void NextCheckState()
	{
		CQt.QToolButton_NextCheckState((.)this.ptr.Ptr);
	}
	public void InitStyleOption(IQStyleOptionToolButton option)
	{
		CQt.QToolButton_InitStyleOption((.)this.ptr.Ptr, (.)option?.ObjectPtr);
	}
