...
class QDialogButtonBox : IQDialogButtonBox, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QDialogButtonBox_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QDialogButtonBox_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QDialogButtonBox_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		CQt.QDialogButtonBox_SetOrientation((.)this.ptr.Ptr, orientation);
	}
	public Qt_Orientation Orientation()
	{
		return CQt.QDialogButtonBox_Orientation((.)this.ptr.Ptr);
	}
	public void AddButton(IQAbstractButton button, QDialogButtonBox_ButtonRole role)
	{
		CQt.QDialogButtonBox_AddButton((.)this.ptr.Ptr, (.)button?.ObjectPtr, role);
	}
	public QPushButton_Ptr AddButton2(String text, QDialogButtonBox_ButtonRole role)
	{
		return QPushButton_Ptr(CQt.QDialogButtonBox_AddButton2((.)this.ptr.Ptr, libqt_string(text), role));
	}
	public QPushButton_Ptr AddButton3(QDialogButtonBox_StandardButton button)
	{
		return QPushButton_Ptr(CQt.QDialogButtonBox_AddButton3((.)this.ptr.Ptr, button));
	}
	public void RemoveButton(IQAbstractButton button)
	{
		CQt.QDialogButtonBox_RemoveButton((.)this.ptr.Ptr, (.)button?.ObjectPtr);
	}
	public void Clear()
	{
		CQt.QDialogButtonBox_Clear((.)this.ptr.Ptr);
	}
	public void* Buttons()
	{
		return CQt.QDialogButtonBox_Buttons((.)this.ptr.Ptr);
	}
	public QDialogButtonBox_ButtonRole ButtonRole(IQAbstractButton button)
	{
		return CQt.QDialogButtonBox_ButtonRole((.)this.ptr.Ptr, (.)button?.ObjectPtr);
	}
	public void SetStandardButtons(void* buttons)
	{
		CQt.QDialogButtonBox_SetStandardButtons((.)this.ptr.Ptr, buttons);
	}
	public void* StandardButtons()
	{
		return CQt.QDialogButtonBox_StandardButtons((.)this.ptr.Ptr);
	}
	public QDialogButtonBox_StandardButton StandardButton(IQAbstractButton button)
	{
		return CQt.QDialogButtonBox_StandardButton((.)this.ptr.Ptr, (.)button?.ObjectPtr);
	}
	public QPushButton_Ptr Button(QDialogButtonBox_StandardButton which)
	{
		return QPushButton_Ptr(CQt.QDialogButtonBox_Button((.)this.ptr.Ptr, which));
	}
	public void SetCenterButtons(bool center)
	{
		CQt.QDialogButtonBox_SetCenterButtons((.)this.ptr.Ptr, center);
	}
	public bool CenterButtons()
	{
		return CQt.QDialogButtonBox_CenterButtons((.)this.ptr.Ptr);
	}
	public void Clicked(IQAbstractButton button)
	{
		CQt.QDialogButtonBox_Clicked((.)this.ptr.Ptr, (.)button?.ObjectPtr);
	}
	public void Accepted()
	{
		CQt.QDialogButtonBox_Accepted((.)this.ptr.Ptr);
	}
	public void HelpRequested()
	{
		CQt.QDialogButtonBox_HelpRequested((.)this.ptr.Ptr);
	}
	public void Rejected()
	{
		CQt.QDialogButtonBox_Rejected((.)this.ptr.Ptr);
	}
	public void ChangeEvent(IQEvent event)
	{
		CQt.QDialogButtonBox_ChangeEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public bool Event(IQEvent event)
	{
		return CQt.QDialogButtonBox_Event((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
