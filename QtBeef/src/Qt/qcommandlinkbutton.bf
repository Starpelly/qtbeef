...
class QCommandLinkButton : IQCommandLinkButton, IQPushButton, IQAbstractButton, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QCommandLinkButton_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QCommandLinkButton_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QCommandLinkButton_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		CQt.QCommandLinkButton_Description((.)this.ptr.Ptr);
	}
	public void SetDescription(String description)
	{
		CQt.QCommandLinkButton_SetDescription((.)this.ptr.Ptr, libqt_string(description));
	}
	public QSize_Ptr SizeHint()
	{
		return QSize_Ptr(CQt.QCommandLinkButton_SizeHint((.)this.ptr.Ptr));
	}
	public c_int HeightForWidth(c_int param1)
	{
		return CQt.QCommandLinkButton_HeightForWidth((.)this.ptr.Ptr, param1);
	}
	public QSize_Ptr MinimumSizeHint()
	{
		return QSize_Ptr(CQt.QCommandLinkButton_MinimumSizeHint((.)this.ptr.Ptr));
	}
	public void InitStyleOption(IQStyleOptionButton option)
	{
		CQt.QCommandLinkButton_InitStyleOption((.)this.ptr.Ptr, (.)option?.ObjectPtr);
	}
	public bool Event(IQEvent e)
	{
		return CQt.QCommandLinkButton_Event((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QCommandLinkButton_PaintEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	...
	{
		return CQt.QPushButton_AutoDefault((.)this.ptr.Ptr);
	}
	public void SetAutoDefault(bool autoDefault)
	{
		CQt.QPushButton_SetAutoDefault((.)this.ptr.Ptr, autoDefault);
	}
	public bool IsDefault()
	{
		return CQt.QPushButton_IsDefault((.)this.ptr.Ptr);
	}
	public void SetDefault(bool defaultVal)
	{
		CQt.QPushButton_SetDefault((.)this.ptr.Ptr, defaultVal);
	}
	public void SetMenu(IQMenu menu)
	{
		CQt.QPushButton_SetMenu((.)this.ptr.Ptr, (.)menu?.ObjectPtr);
	}
	public QMenu_Ptr Menu()
	{
		return QMenu_Ptr(CQt.QPushButton_Menu((.)this.ptr.Ptr));
	}
	public void SetFlat(bool flat)
	{
		CQt.QPushButton_SetFlat((.)this.ptr.Ptr, flat);
	}
	public bool IsFlat()
	{
		return CQt.QPushButton_IsFlat((.)this.ptr.Ptr);
	}
	public void ShowMenu()
	{
		CQt.QPushButton_ShowMenu((.)this.ptr.Ptr);
	}
	public void KeyPressEvent(IQKeyEvent param1)
	{
		CQt.QPushButton_KeyPressEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void FocusInEvent(IQFocusEvent param1)
	{
		CQt.QPushButton_FocusInEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void FocusOutEvent(IQFocusEvent param1)
	{
		CQt.QPushButton_FocusOutEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void MouseMoveEvent(IQMouseEvent param1)
	{
		CQt.QPushButton_MouseMoveEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public bool HitButton(IQPoint pos)
	{
		return CQt.QPushButton_HitButton((.)this.ptr.Ptr, (.)pos?.ObjectPtr);
	}
