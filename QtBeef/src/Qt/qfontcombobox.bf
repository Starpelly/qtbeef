...
class QFontComboBox : IQFontComboBox, IQComboBox, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QFontComboBox_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QFontComboBox_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QFontComboBox_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		CQt.QFontComboBox_SetWritingSystem((.)this.ptr.Ptr, writingSystem);
	}
	public QFontDatabase_WritingSystem WritingSystem()
	{
		return CQt.QFontComboBox_WritingSystem((.)this.ptr.Ptr);
	}
	public void SetFontFilters(void* filters)
	{
		CQt.QFontComboBox_SetFontFilters((.)this.ptr.Ptr, filters);
	}
	public void* FontFilters()
	{
		return CQt.QFontComboBox_FontFilters((.)this.ptr.Ptr);
	}
	public QFont_Ptr CurrentFont()
	{
		return QFont_Ptr(CQt.QFontComboBox_CurrentFont((.)this.ptr.Ptr));
	}
	public QSize_Ptr SizeHint()
	{
		return QSize_Ptr(CQt.QFontComboBox_SizeHint((.)this.ptr.Ptr));
	}
	public void SetSampleTextForSystem(QFontDatabase_WritingSystem writingSystem, String sampleText)
	{
		CQt.QFontComboBox_SetSampleTextForSystem((.)this.ptr.Ptr, writingSystem, libqt_string(sampleText));
	}
	public void SampleTextForSystem(String outStr, QFontDatabase_WritingSystem writingSystem)
	{
		CQt.QFontComboBox_SampleTextForSystem((.)this.ptr.Ptr, writingSystem);
	}
	public void SetSampleTextForFont(String fontFamily, String sampleText)
	{
		CQt.QFontComboBox_SetSampleTextForFont((.)this.ptr.Ptr, libqt_string(fontFamily), libqt_string(sampleText));
	}
	public void SampleTextForFont(String outStr, String fontFamily)
	{
		CQt.QFontComboBox_SampleTextForFont((.)this.ptr.Ptr, libqt_string(fontFamily));
	}
	public void SetDisplayFont(String fontFamily, IQFont font)
	{
		CQt.QFontComboBox_SetDisplayFont((.)this.ptr.Ptr, libqt_string(fontFamily), (.)font?.ObjectPtr);
	}
	public QFont_Ptr DisplayFont(String fontFamily)
	{
		return QFont_Ptr(CQt.QFontComboBox_DisplayFont((.)this.ptr.Ptr, libqt_string(fontFamily)));
	}
	public void SetCurrentFont(IQFont f)
	{
		CQt.QFontComboBox_SetCurrentFont((.)this.ptr.Ptr, (.)f?.ObjectPtr);
	}
	public void CurrentFontChanged(IQFont f)
	{
		CQt.QFontComboBox_CurrentFontChanged((.)this.ptr.Ptr, (.)f?.ObjectPtr);
	}
	public bool Event(IQEvent e)
	{
		return CQt.QFontComboBox_Event((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
