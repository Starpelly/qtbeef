...
class QFileSelector : IQFileSelector, IQObject
{
	...
	{
		return QMetaObject_Ptr(CQt.QFileSelector_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QFileSelector_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QFileSelector_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		CQt.QFileSelector_Select((.)this.ptr.Ptr, libqt_string(filePath));
	}
	public QUrl_Ptr Select2(IQUrl filePath)
	{
		return QUrl_Ptr(CQt.QFileSelector_Select2((.)this.ptr.Ptr, (.)filePath?.ObjectPtr));
	}
	public void* ExtraSelectors()
	{
		return CQt.QFileSelector_ExtraSelectors((.)this.ptr.Ptr);
	}
	public void SetExtraSelectors(void** list)
	{
		CQt.QFileSelector_SetExtraSelectors((.)this.ptr.Ptr, list);
	}
	public void* AllSelectors()
	{
		return CQt.QFileSelector_AllSelectors((.)this.ptr.Ptr);
	}
