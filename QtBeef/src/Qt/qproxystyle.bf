...
class QProxyStyle : IQProxyStyle, IQCommonStyle, IQStyle, IQObject
{
	...
	{
		return CQt.QProxyStyle_SizeFromContents((.)this.ptr, type, (.)option?.ObjectPtr, (.)size?.ObjectPtr, (.)widget?.ObjectPtr);
	}
	public QRect_Ptr* SubElementRect(QStyle_SubElement element, IQStyleOption option, IQWidget widget)
	{
		return CQt.QProxyStyle_SubElementRect((.)this.ptr, element, (.)option?.ObjectPtr, (.)widget?.ObjectPtr);
	}
	public QRect_Ptr* SubControlRect(QStyle_ComplexControl cc, IQStyleOptionComplex opt, QStyle_SubControl sc, IQWidget widget)
	{
		return CQt.QProxyStyle_SubControlRect((.)this.ptr, cc, (.)opt?.ObjectPtr, sc, (.)widget?.ObjectPtr);
	}
	public QRect_Ptr* ItemTextRect(IQFontMetrics fm, IQRect r, c_int flags, bool enabled, String text)
	{
		return CQt.QProxyStyle_ItemTextRect((.)this.ptr, (.)fm?.ObjectPtr, (.)r?.ObjectPtr, flags, enabled, libqt_string(text));
	}
	public QRect_Ptr* ItemPixmapRect(IQRect r, c_int flags, IQPixmap pixmap)
	{
		return CQt.QProxyStyle_ItemPixmapRect((.)this.ptr, (.)r?.ObjectPtr, flags, (.)pixmap?.ObjectPtr);
	}
	...
	{
		return CQt.QProxyStyle_StandardIcon((.)this.ptr, standardIcon, (.)option?.ObjectPtr, (.)widget?.ObjectPtr);
	}
	public QPixmap_Ptr* StandardPixmap(QStyle_StandardPixmap standardPixmap, IQStyleOption opt, IQWidget widget)
	{
		return CQt.QProxyStyle_StandardPixmap((.)this.ptr, standardPixmap, (.)opt?.ObjectPtr, (.)widget?.ObjectPtr);
	}
	public QPixmap_Ptr* GeneratedIconPixmap(QIcon_Mode iconMode, IQPixmap pixmap, IQStyleOption opt)
	{
		return CQt.QProxyStyle_GeneratedIconPixmap((.)this.ptr, iconMode, (.)pixmap?.ObjectPtr, (.)opt?.ObjectPtr);
	}
