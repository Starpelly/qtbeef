...
class QProxyStyle : IQProxyStyle, IQCommonStyle, IQStyle, IQObject
{
	...
	{
		return QMetaObject_Ptr(CQt.QProxyStyle_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QProxyStyle_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QProxyStyle_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return QStyle_Ptr(CQt.QProxyStyle_BaseStyle((.)this.ptr.Ptr));
	}
	public void SetBaseStyle(IQStyle style)
	{
		CQt.QProxyStyle_SetBaseStyle((.)this.ptr.Ptr, (.)style?.ObjectPtr);
	}
	public void DrawPrimitive(QStyle_PrimitiveElement element, IQStyleOption option, IQPainter painter, IQWidget widget)
	{
		CQt.QProxyStyle_DrawPrimitive((.)this.ptr.Ptr, element, (.)option?.ObjectPtr, (.)painter?.ObjectPtr, (.)widget?.ObjectPtr);
	}
	public void DrawControl(QStyle_ControlElement element, IQStyleOption option, IQPainter painter, IQWidget widget)
	{
		CQt.QProxyStyle_DrawControl((.)this.ptr.Ptr, element, (.)option?.ObjectPtr, (.)painter?.ObjectPtr, (.)widget?.ObjectPtr);
	}
	...
	{
		CQt.QProxyStyle_DrawComplexControl((.)this.ptr.Ptr, control, (.)option?.ObjectPtr, (.)painter?.ObjectPtr, (.)widget?.ObjectPtr);
	}
	...
	{
		CQt.QProxyStyle_DrawItemText((.)this.ptr.Ptr, (.)painter?.ObjectPtr, (.)rect?.ObjectPtr, flags, (.)pal?.ObjectPtr, enabled, libqt_string(text), textRole);
	}
	public void DrawItemPixmap(IQPainter painter, IQRect rect, c_int alignment, IQPixmap pixmap)
	{
		CQt.QProxyStyle_DrawItemPixmap((.)this.ptr.Ptr, (.)painter?.ObjectPtr, (.)rect?.ObjectPtr, alignment, (.)pixmap?.ObjectPtr);
	}
	public QSize_Ptr SizeFromContents(QStyle_ContentsType type, IQStyleOption option, IQSize size, IQWidget widget)
	{
		return QSize_Ptr(CQt.QProxyStyle_SizeFromContents((.)this.ptr.Ptr, type, (.)option?.ObjectPtr, (.)size?.ObjectPtr, (.)widget?.ObjectPtr));
	}
	public QRect_Ptr SubElementRect(QStyle_SubElement element, IQStyleOption option, IQWidget widget)
	{
		return QRect_Ptr(CQt.QProxyStyle_SubElementRect((.)this.ptr.Ptr, element, (.)option?.ObjectPtr, (.)widget?.ObjectPtr));
	}
	public QRect_Ptr SubControlRect(QStyle_ComplexControl cc, IQStyleOptionComplex opt, QStyle_SubControl sc, IQWidget widget)
	{
		return QRect_Ptr(CQt.QProxyStyle_SubControlRect((.)this.ptr.Ptr, cc, (.)opt?.ObjectPtr, sc, (.)widget?.ObjectPtr));
	}
	public QRect_Ptr ItemTextRect(IQFontMetrics fm, IQRect r, c_int flags, bool enabled, String text)
	{
		return QRect_Ptr(CQt.QProxyStyle_ItemTextRect((.)this.ptr.Ptr, (.)fm?.ObjectPtr, (.)r?.ObjectPtr, flags, enabled, libqt_string(text)));
	}
	public QRect_Ptr ItemPixmapRect(IQRect r, c_int flags, IQPixmap pixmap)
	{
		return QRect_Ptr(CQt.QProxyStyle_ItemPixmapRect((.)this.ptr.Ptr, (.)r?.ObjectPtr, flags, (.)pixmap?.ObjectPtr));
	}
	...
	{
		return CQt.QProxyStyle_HitTestComplexControl((.)this.ptr.Ptr, control, (.)option?.ObjectPtr, (.)pos?.ObjectPtr, (.)widget?.ObjectPtr);
	}
	public c_int StyleHint(QStyle_StyleHint hint, IQStyleOption option, IQWidget widget, IQStyleHintReturn returnData)
	{
		return CQt.QProxyStyle_StyleHint((.)this.ptr.Ptr, hint, (.)option?.ObjectPtr, (.)widget?.ObjectPtr, (.)returnData?.ObjectPtr);
	}
	public c_int PixelMetric(QStyle_PixelMetric metric, IQStyleOption option, IQWidget widget)
	{
		return CQt.QProxyStyle_PixelMetric((.)this.ptr.Ptr, metric, (.)option?.ObjectPtr, (.)widget?.ObjectPtr);
	}
	...
	{
		return CQt.QProxyStyle_LayoutSpacing((.)this.ptr.Ptr, control1, control2, orientation, (.)option?.ObjectPtr, (.)widget?.ObjectPtr);
	}
	public QIcon_Ptr StandardIcon(QStyle_StandardPixmap standardIcon, IQStyleOption option, IQWidget widget)
	{
		return QIcon_Ptr(CQt.QProxyStyle_StandardIcon((.)this.ptr.Ptr, standardIcon, (.)option?.ObjectPtr, (.)widget?.ObjectPtr));
	}
	public QPixmap_Ptr StandardPixmap(QStyle_StandardPixmap standardPixmap, IQStyleOption opt, IQWidget widget)
	{
		return QPixmap_Ptr(CQt.QProxyStyle_StandardPixmap((.)this.ptr.Ptr, standardPixmap, (.)opt?.ObjectPtr, (.)widget?.ObjectPtr));
	}
	public QPixmap_Ptr GeneratedIconPixmap(QIcon_Mode iconMode, IQPixmap pixmap, IQStyleOption opt)
	{
		return QPixmap_Ptr(CQt.QProxyStyle_GeneratedIconPixmap((.)this.ptr.Ptr, iconMode, (.)pixmap?.ObjectPtr, (.)opt?.ObjectPtr));
	}
	public QPalette_Ptr StandardPalette()
	{
		return QPalette_Ptr(CQt.QProxyStyle_StandardPalette((.)this.ptr.Ptr));
	}
	public void Polish(IQWidget widget)
	{
		CQt.QProxyStyle_Polish((.)this.ptr.Ptr, (.)widget?.ObjectPtr);
	}
	public void Polish2(IQPalette pal)
	{
		CQt.QProxyStyle_Polish2((.)this.ptr.Ptr, (.)pal?.ObjectPtr);
	}
	public void Polish3(IQApplication app)
	{
		CQt.QProxyStyle_Polish3((.)this.ptr.Ptr, (.)app?.ObjectPtr);
	}
	public void Unpolish(IQWidget widget)
	{
		CQt.QProxyStyle_Unpolish((.)this.ptr.Ptr, (.)widget?.ObjectPtr);
	}
	public void Unpolish2(IQApplication app)
	{
		CQt.QProxyStyle_Unpolish2((.)this.ptr.Ptr, (.)app?.ObjectPtr);
	}
	public bool Event(IQEvent e)
	{
		return CQt.QProxyStyle_Event((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
