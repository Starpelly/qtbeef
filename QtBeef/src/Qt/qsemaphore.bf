...
class QSemaphore : IQSemaphore
{
	...
	public bool TryAcquire()
	{
		return this.ptr.TryAcquire();
	}
	public bool TryAcquire2(c_int n, c_int timeout)
	{
		return this.ptr.TryAcquire2(n, timeout);
	}
	public void Release()
	{
		this.ptr.Release();
	...
	public c_int Available()
	{
		return this.ptr.Available();
	}
	public bool TryAcquire3()
	{
		return this.ptr.TryAcquire3();
	}
	public void Acquire1(c_int n)
	{
		this.ptr.Acquire1(n);
...
struct QSemaphoreReleaser_Ptr
{
	...
	{
		return QSemaphore_Ptr(CQt.QSemaphoreReleaser_Semaphore((.)this.Ptr));
	}
	public QSemaphore_Ptr Cancel()
	{
		return QSemaphore_Ptr(CQt.QSemaphoreReleaser_Cancel((.)this.Ptr));
	}
}
class QSemaphoreReleaser : IQSemaphoreReleaser
{
	...
	public QSemaphore_Ptr Semaphore()
	{
		return this.ptr.Semaphore();
	}
	public QSemaphore_Ptr Cancel()
	{
		return this.ptr.Cancel();
	}
}
