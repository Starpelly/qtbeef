...
class QProgressDialog : IQProgressDialog, IQDialog, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QProgressDialog_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QProgressDialog_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QProgressDialog_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		CQt.QProgressDialog_SetLabel((.)this.ptr.Ptr, (.)label?.ObjectPtr);
	}
	public void SetCancelButton(IQPushButton button)
	{
		CQt.QProgressDialog_SetCancelButton((.)this.ptr.Ptr, (.)button?.ObjectPtr);
	}
	public void SetBar(IQProgressBar bar)
	{
		CQt.QProgressDialog_SetBar((.)this.ptr.Ptr, (.)bar?.ObjectPtr);
	}
	public bool WasCanceled()
	{
		return CQt.QProgressDialog_WasCanceled((.)this.ptr.Ptr);
	}
	public c_int Minimum()
	{
		return CQt.QProgressDialog_Minimum((.)this.ptr.Ptr);
	}
	public c_int Maximum()
	{
		return CQt.QProgressDialog_Maximum((.)this.ptr.Ptr);
	}
	public c_int Value()
	{
		return CQt.QProgressDialog_Value((.)this.ptr.Ptr);
	}
	public QSize_Ptr SizeHint()
	{
		return QSize_Ptr(CQt.QProgressDialog_SizeHint((.)this.ptr.Ptr));
	}
	public void LabelText(String outStr)
	{
		CQt.QProgressDialog_LabelText((.)this.ptr.Ptr);
	}
	public c_int MinimumDuration()
	{
		return CQt.QProgressDialog_MinimumDuration((.)this.ptr.Ptr);
	}
	public void SetAutoReset(bool reset)
	{
		CQt.QProgressDialog_SetAutoReset((.)this.ptr.Ptr, reset);
	}
	public bool AutoReset()
	{
		return CQt.QProgressDialog_AutoReset((.)this.ptr.Ptr);
	}
	public void SetAutoClose(bool close)
	{
		CQt.QProgressDialog_SetAutoClose((.)this.ptr.Ptr, close);
	}
	public bool AutoClose()
	{
		return CQt.QProgressDialog_AutoClose((.)this.ptr.Ptr);
	}
	public void Cancel()
	{
		CQt.QProgressDialog_Cancel((.)this.ptr.Ptr);
	}
	public void Reset()
	{
		CQt.QProgressDialog_Reset((.)this.ptr.Ptr);
	}
	public void SetMaximum(c_int maximum)
	{
		CQt.QProgressDialog_SetMaximum((.)this.ptr.Ptr, maximum);
	}
	public void SetMinimum(c_int minimum)
	{
		CQt.QProgressDialog_SetMinimum((.)this.ptr.Ptr, minimum);
	}
	public void SetRange(c_int minimum, c_int maximum)
	{
		CQt.QProgressDialog_SetRange((.)this.ptr.Ptr, minimum, maximum);
	}
	public void SetValue(c_int progress)
	{
		CQt.QProgressDialog_SetValue((.)this.ptr.Ptr, progress);
	}
	public void SetLabelText(String text)
	{
		CQt.QProgressDialog_SetLabelText((.)this.ptr.Ptr, libqt_string(text));
	}
	public void SetCancelButtonText(String text)
	{
		CQt.QProgressDialog_SetCancelButtonText((.)this.ptr.Ptr, libqt_string(text));
	}
	public void SetMinimumDuration(c_int ms)
	{
		CQt.QProgressDialog_SetMinimumDuration((.)this.ptr.Ptr, ms);
	}
	public void Canceled()
	{
		CQt.QProgressDialog_Canceled((.)this.ptr.Ptr);
	}
	public void ResizeEvent(IQResizeEvent event)
	{
		CQt.QProgressDialog_ResizeEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void CloseEvent(IQCloseEvent event)
	{
		CQt.QProgressDialog_CloseEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void ChangeEvent(IQEvent event)
	{
		CQt.QProgressDialog_ChangeEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void ShowEvent(IQShowEvent event)
	{
		CQt.QProgressDialog_ShowEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void ForceShow()
	{
		CQt.QProgressDialog_ForceShow((.)this.ptr.Ptr);
	}
