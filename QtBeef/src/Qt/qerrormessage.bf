...
class QErrorMessage : IQErrorMessage, IQDialog, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QErrorMessage_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QErrorMessage_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QErrorMessage_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		CQt.QErrorMessage_ShowMessage((.)this.ptr.Ptr, libqt_string(message));
	}
	public void ShowMessage2(String message, String type)
	{
		CQt.QErrorMessage_ShowMessage2((.)this.ptr.Ptr, libqt_string(message), libqt_string(type));
	}
	public void Done(c_int param1)
	{
		CQt.QErrorMessage_Done((.)this.ptr.Ptr, param1);
	}
	public void ChangeEvent(IQEvent e)
	{
		CQt.QErrorMessage_ChangeEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
