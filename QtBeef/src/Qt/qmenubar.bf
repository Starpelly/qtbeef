...
class QMenuBar : IQMenuBar, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return CQt.QMenuBar_AddMenu((.)this.ptr, (.)menu?.ObjectPtr);
	}
	public QMenu_Ptr** AddMenu2(String title)
	{
		return CQt.QMenuBar_AddMenu2((.)this.ptr, libqt_string(title));
	}
	public QMenu_Ptr** AddMenu3(IQIcon icon, String title)
	{
		return CQt.QMenuBar_AddMenu3((.)this.ptr, (.)icon?.ObjectPtr, libqt_string(title));
	}
	...
	{
		return CQt.QMenuBar_InsertSeparator((.)this.ptr, (.)before?.ObjectPtr);
	}
	public QAction_Ptr** InsertMenu(IQAction before, IQMenu menu)
	{
		return CQt.QMenuBar_InsertMenu((.)this.ptr, (.)before?.ObjectPtr, (.)menu?.ObjectPtr);
	}
	public void Clear()
	{
	...
	{
		return CQt.QMenuBar_ActionGeometry((.)this.ptr, (.)param1?.ObjectPtr);
	}
	public QAction_Ptr** ActionAt(IQPoint param1)
	{
		return CQt.QMenuBar_ActionAt((.)this.ptr, (.)param1?.ObjectPtr);
	}
