...
class QTableWidgetSelectionRange : IQTableWidgetSelectionRange
{
	...
	public c_int TopRow()
	{
		return CQt.QTableWidgetSelectionRange_TopRow((.)this.ptr.Ptr);
	}
	public c_int BottomRow()
	{
		return CQt.QTableWidgetSelectionRange_BottomRow((.)this.ptr.Ptr);
	}
	public c_int LeftColumn()
	{
		return CQt.QTableWidgetSelectionRange_LeftColumn((.)this.ptr.Ptr);
	}
	public c_int RightColumn()
	{
		return CQt.QTableWidgetSelectionRange_RightColumn((.)this.ptr.Ptr);
	}
	public c_int RowCount()
	{
		return CQt.QTableWidgetSelectionRange_RowCount((.)this.ptr.Ptr);
	}
	public c_int ColumnCount()
	{
		return CQt.QTableWidgetSelectionRange_ColumnCount((.)this.ptr.Ptr);
	}
}
...
class QTableWidgetItem : IQTableWidgetItem
{
	...
	{
		return QTableWidgetItem_Ptr(CQt.QTableWidgetItem_Clone((.)this.ptr.Ptr));
	}
	public QTableWidget_Ptr TableWidget()
	{
		return QTableWidget_Ptr(CQt.QTableWidgetItem_TableWidget((.)this.ptr.Ptr));
	}
	public c_int Row()
	{
		return CQt.QTableWidgetItem_Row((.)this.ptr.Ptr);
	}
	public c_int Column()
	{
		return CQt.QTableWidgetItem_Column((.)this.ptr.Ptr);
	}
	public void SetSelected(bool selectVal)
	{
		CQt.QTableWidgetItem_SetSelected((.)this.ptr.Ptr, selectVal);
	}
	public bool IsSelected()
	{
		return CQt.QTableWidgetItem_IsSelected((.)this.ptr.Ptr);
	}
	public void* Flags()
	{
		return CQt.QTableWidgetItem_Flags((.)this.ptr.Ptr);
	}
	public void SetFlags(void* flags)
	{
		CQt.QTableWidgetItem_SetFlags((.)this.ptr.Ptr, flags);
	}
	public void Text(String outStr)
	{
		CQt.QTableWidgetItem_Text((.)this.ptr.Ptr);
	}
	public void SetText(String text)
	{
		CQt.QTableWidgetItem_SetText((.)this.ptr.Ptr, libqt_string(text));
	}
	public QIcon_Ptr Icon()
	{
		return QIcon_Ptr(CQt.QTableWidgetItem_Icon((.)this.ptr.Ptr));
	}
	public void SetIcon(IQIcon icon)
	{
		CQt.QTableWidgetItem_SetIcon((.)this.ptr.Ptr, (.)icon?.ObjectPtr);
	}
	public void StatusTip(String outStr)
	{
		CQt.QTableWidgetItem_StatusTip((.)this.ptr.Ptr);
	}
	public void SetStatusTip(String statusTip)
	{
		CQt.QTableWidgetItem_SetStatusTip((.)this.ptr.Ptr, libqt_string(statusTip));
	}
	public void ToolTip(String outStr)
	{
		CQt.QTableWidgetItem_ToolTip((.)this.ptr.Ptr);
	}
	public void SetToolTip(String toolTip)
	{
		CQt.QTableWidgetItem_SetToolTip((.)this.ptr.Ptr, libqt_string(toolTip));
	}
	public void WhatsThis(String outStr)
	{
		CQt.QTableWidgetItem_WhatsThis((.)this.ptr.Ptr);
	}
	public void SetWhatsThis(String whatsThis)
	{
		CQt.QTableWidgetItem_SetWhatsThis((.)this.ptr.Ptr, libqt_string(whatsThis));
	}
	public QFont_Ptr Font()
	{
		return QFont_Ptr(CQt.QTableWidgetItem_Font((.)this.ptr.Ptr));
	}
	public void SetFont(IQFont font)
	{
		CQt.QTableWidgetItem_SetFont((.)this.ptr.Ptr, (.)font?.ObjectPtr);
	}
	public c_int TextAlignment()
	{
		return CQt.QTableWidgetItem_TextAlignment((.)this.ptr.Ptr);
	}
	public void SetTextAlignment(c_int alignment)
	{
		CQt.QTableWidgetItem_SetTextAlignment((.)this.ptr.Ptr, alignment);
	}
	public void SetTextAlignment2(Qt_AlignmentFlag alignment)
	{
		CQt.QTableWidgetItem_SetTextAlignment2((.)this.ptr.Ptr, alignment);
	}
	public void SetTextAlignment3(void* alignment)
	{
		CQt.QTableWidgetItem_SetTextAlignment3((.)this.ptr.Ptr, alignment);
	}
	public QBrush_Ptr Background()
	{
		return QBrush_Ptr(CQt.QTableWidgetItem_Background((.)this.ptr.Ptr));
	}
	public void SetBackground(IQBrush brush)
	{
		CQt.QTableWidgetItem_SetBackground((.)this.ptr.Ptr, (.)brush?.ObjectPtr);
	}
	public QBrush_Ptr Foreground()
	{
		return QBrush_Ptr(CQt.QTableWidgetItem_Foreground((.)this.ptr.Ptr));
	}
	public void SetForeground(IQBrush brush)
	{
		CQt.QTableWidgetItem_SetForeground((.)this.ptr.Ptr, (.)brush?.ObjectPtr);
	}
	public Qt_CheckState CheckState()
	{
		return CQt.QTableWidgetItem_CheckState((.)this.ptr.Ptr);
	}
	public void SetCheckState(Qt_CheckState state)
	{
		CQt.QTableWidgetItem_SetCheckState((.)this.ptr.Ptr, state);
	}
	public QSize_Ptr SizeHint()
	{
		return QSize_Ptr(CQt.QTableWidgetItem_SizeHint((.)this.ptr.Ptr));
	}
	public void SetSizeHint(IQSize size)
	{
		CQt.QTableWidgetItem_SetSizeHint((.)this.ptr.Ptr, (.)size?.ObjectPtr);
	}
	public QVariant_Ptr Data(c_int role)
	{
		return QVariant_Ptr(CQt.QTableWidgetItem_Data((.)this.ptr.Ptr, role));
	}
	public void SetData(c_int role, IQVariant value)
	{
		CQt.QTableWidgetItem_SetData((.)this.ptr.Ptr, role, (.)value?.ObjectPtr);
	}
	public void Read(IQDataStream _in)
	{
		CQt.QTableWidgetItem_Read((.)this.ptr.Ptr, (.)_in?.ObjectPtr);
	}
	public void Write(IQDataStream _out)
	{
		CQt.QTableWidgetItem_Write((.)this.ptr.Ptr, (.)_out?.ObjectPtr);
	}
	public c_int Type()
	{
		return CQt.QTableWidgetItem_Type((.)this.ptr.Ptr);
	}
}
...
class QTableWidget : IQTableWidget, IQTableView, IQAbstractItemView, IQAbstractScrollArea, IQFrame, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QTableWidget_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QTableWidget_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QTableWidget_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		CQt.QTableWidget_SetRowCount((.)this.ptr.Ptr, rows);
	}
	public c_int RowCount()
	{
		return CQt.QTableWidget_RowCount((.)this.ptr.Ptr);
	}
	public void SetColumnCount(c_int columns)
	{
		CQt.QTableWidget_SetColumnCount((.)this.ptr.Ptr, columns);
	}
	public c_int ColumnCount()
	{
		return CQt.QTableWidget_ColumnCount((.)this.ptr.Ptr);
	}
	public c_int Row(IQTableWidgetItem item)
	{
		return CQt.QTableWidget_Row((.)this.ptr.Ptr, (.)item?.ObjectPtr);
	}
	public c_int Column(IQTableWidgetItem item)
	{
		return CQt.QTableWidget_Column((.)this.ptr.Ptr, (.)item?.ObjectPtr);
	}
	public QTableWidgetItem_Ptr Item(c_int row, c_int column)
	{
		return QTableWidgetItem_Ptr(CQt.QTableWidget_Item((.)this.ptr.Ptr, row, column));
	}
	public void SetItem(c_int row, c_int column, IQTableWidgetItem item)
	{
		CQt.QTableWidget_SetItem((.)this.ptr.Ptr, row, column, (.)item?.ObjectPtr);
	}
	public QTableWidgetItem_Ptr TakeItem(c_int row, c_int column)
	{
		return QTableWidgetItem_Ptr(CQt.QTableWidget_TakeItem((.)this.ptr.Ptr, row, column));
	}
	public void* Items(IQMimeData data)
	{
		return CQt.QTableWidget_Items((.)this.ptr.Ptr, (.)data?.ObjectPtr);
	}
	public QModelIndex_Ptr IndexFromItem(IQTableWidgetItem item)
	{
		return QModelIndex_Ptr(CQt.QTableWidget_IndexFromItem((.)this.ptr.Ptr, (.)item?.ObjectPtr));
	}
	public QTableWidgetItem_Ptr ItemFromIndex(IQModelIndex index)
	{
		return QTableWidgetItem_Ptr(CQt.QTableWidget_ItemFromIndex((.)this.ptr.Ptr, (.)index?.ObjectPtr));
	}
	public QTableWidgetItem_Ptr VerticalHeaderItem(c_int row)
	{
		return QTableWidgetItem_Ptr(CQt.QTableWidget_VerticalHeaderItem((.)this.ptr.Ptr, row));
	}
	public void SetVerticalHeaderItem(c_int row, IQTableWidgetItem item)
	{
		CQt.QTableWidget_SetVerticalHeaderItem((.)this.ptr.Ptr, row, (.)item?.ObjectPtr);
	}
	public QTableWidgetItem_Ptr TakeVerticalHeaderItem(c_int row)
	{
		return QTableWidgetItem_Ptr(CQt.QTableWidget_TakeVerticalHeaderItem((.)this.ptr.Ptr, row));
	}
	public QTableWidgetItem_Ptr HorizontalHeaderItem(c_int column)
	{
		return QTableWidgetItem_Ptr(CQt.QTableWidget_HorizontalHeaderItem((.)this.ptr.Ptr, column));
	}
	public void SetHorizontalHeaderItem(c_int column, IQTableWidgetItem item)
	{
		CQt.QTableWidget_SetHorizontalHeaderItem((.)this.ptr.Ptr, column, (.)item?.ObjectPtr);
	}
	public QTableWidgetItem_Ptr TakeHorizontalHeaderItem(c_int column)
	{
		return QTableWidgetItem_Ptr(CQt.QTableWidget_TakeHorizontalHeaderItem((.)this.ptr.Ptr, column));
	}
	public void SetVerticalHeaderLabels(void** labels)
	{
		CQt.QTableWidget_SetVerticalHeaderLabels((.)this.ptr.Ptr, labels);
	}
	public void SetHorizontalHeaderLabels(void** labels)
	{
		CQt.QTableWidget_SetHorizontalHeaderLabels((.)this.ptr.Ptr, labels);
	}
	public c_int CurrentRow()
	{
		return CQt.QTableWidget_CurrentRow((.)this.ptr.Ptr);
	}
	public c_int CurrentColumn()
	{
		return CQt.QTableWidget_CurrentColumn((.)this.ptr.Ptr);
	}
	public QTableWidgetItem_Ptr CurrentItem()
	{
		return QTableWidgetItem_Ptr(CQt.QTableWidget_CurrentItem((.)this.ptr.Ptr));
	}
	public void SetCurrentItem(IQTableWidgetItem item)
	{
		CQt.QTableWidget_SetCurrentItem((.)this.ptr.Ptr, (.)item?.ObjectPtr);
	}
	public void SetCurrentItem2(IQTableWidgetItem item, void* command)
	{
		CQt.QTableWidget_SetCurrentItem2((.)this.ptr.Ptr, (.)item?.ObjectPtr, command);
	}
	public void SetCurrentCell(c_int row, c_int column)
	{
		CQt.QTableWidget_SetCurrentCell((.)this.ptr.Ptr, row, column);
	}
	public void SetCurrentCell2(c_int row, c_int column, void* command)
	{
		CQt.QTableWidget_SetCurrentCell2((.)this.ptr.Ptr, row, column, command);
	}
	public void SortItems(c_int column)
	{
		CQt.QTableWidget_SortItems((.)this.ptr.Ptr, column);
	}
	public void SetSortingEnabled(bool enable)
	{
		CQt.QTableWidget_SetSortingEnabled((.)this.ptr.Ptr, enable);
	}
	public bool IsSortingEnabled()
	{
		return CQt.QTableWidget_IsSortingEnabled((.)this.ptr.Ptr);
	}
	public void EditItem(IQTableWidgetItem item)
	{
		CQt.QTableWidget_EditItem((.)this.ptr.Ptr, (.)item?.ObjectPtr);
	}
	public void OpenPersistentEditor(IQTableWidgetItem item)
	{
		CQt.QTableWidget_OpenPersistentEditor((.)this.ptr.Ptr, (.)item?.ObjectPtr);
	}
	public void ClosePersistentEditor(IQTableWidgetItem item)
	{
		CQt.QTableWidget_ClosePersistentEditor((.)this.ptr.Ptr, (.)item?.ObjectPtr);
	}
	public bool IsPersistentEditorOpen(IQTableWidgetItem item)
	{
		return CQt.QTableWidget_IsPersistentEditorOpen((.)this.ptr.Ptr, (.)item?.ObjectPtr);
	}
	public QWidget_Ptr CellWidget(c_int row, c_int column)
	{
		return QWidget_Ptr(CQt.QTableWidget_CellWidget((.)this.ptr.Ptr, row, column));
	}
	public void SetCellWidget(c_int row, c_int column, IQWidget widget)
	{
		CQt.QTableWidget_SetCellWidget((.)this.ptr.Ptr, row, column, (.)widget?.ObjectPtr);
	}
	public void RemoveCellWidget(c_int row, c_int column)
	{
		CQt.QTableWidget_RemoveCellWidget((.)this.ptr.Ptr, row, column);
	}
	public void SetRangeSelected(IQTableWidgetSelectionRange range, bool selectVal)
	{
		CQt.QTableWidget_SetRangeSelected((.)this.ptr.Ptr, (.)range?.ObjectPtr, selectVal);
	}
	public void* SelectedRanges()
	{
		return CQt.QTableWidget_SelectedRanges((.)this.ptr.Ptr);
	}
	public void* SelectedItems()
	{
		return CQt.QTableWidget_SelectedItems((.)this.ptr.Ptr);
	}
	public void* FindItems(String text, void* flags)
	{
		return CQt.QTableWidget_FindItems((.)this.ptr.Ptr, libqt_string(text), flags);
	}
	public c_int VisualRow(c_int logicalRow)
	{
		return CQt.QTableWidget_VisualRow((.)this.ptr.Ptr, logicalRow);
	}
	public c_int VisualColumn(c_int logicalColumn)
	{
		return CQt.QTableWidget_VisualColumn((.)this.ptr.Ptr, logicalColumn);
	}
	public QTableWidgetItem_Ptr ItemAt(IQPoint p)
	{
		return QTableWidgetItem_Ptr(CQt.QTableWidget_ItemAt((.)this.ptr.Ptr, (.)p?.ObjectPtr));
	}
	public QTableWidgetItem_Ptr ItemAt2(c_int x, c_int y)
	{
		return QTableWidgetItem_Ptr(CQt.QTableWidget_ItemAt2((.)this.ptr.Ptr, x, y));
	}
	public QRect_Ptr VisualItemRect(IQTableWidgetItem item)
	{
		return QRect_Ptr(CQt.QTableWidget_VisualItemRect((.)this.ptr.Ptr, (.)item?.ObjectPtr));
	}
	public QTableWidgetItem_Ptr ItemPrototype()
	{
		return QTableWidgetItem_Ptr(CQt.QTableWidget_ItemPrototype((.)this.ptr.Ptr));
	}
	public void SetItemPrototype(IQTableWidgetItem item)
	{
		CQt.QTableWidget_SetItemPrototype((.)this.ptr.Ptr, (.)item?.ObjectPtr);
	}
	public void ScrollToItem(IQTableWidgetItem item)
	{
		CQt.QTableWidget_ScrollToItem((.)this.ptr.Ptr, (.)item?.ObjectPtr);
	}
	public void InsertRow(c_int row)
	{
		CQt.QTableWidget_InsertRow((.)this.ptr.Ptr, row);
	}
	public void InsertColumn(c_int column)
	{
		CQt.QTableWidget_InsertColumn((.)this.ptr.Ptr, column);
	}
	public void RemoveRow(c_int row)
	{
		CQt.QTableWidget_RemoveRow((.)this.ptr.Ptr, row);
	}
	public void RemoveColumn(c_int column)
	{
		CQt.QTableWidget_RemoveColumn((.)this.ptr.Ptr, column);
	}
	public void Clear()
	{
		CQt.QTableWidget_Clear((.)this.ptr.Ptr);
	}
	public void ClearContents()
	{
		CQt.QTableWidget_ClearContents((.)this.ptr.Ptr);
	}
	public void ItemPressed(IQTableWidgetItem item)
	{
		CQt.QTableWidget_ItemPressed((.)this.ptr.Ptr, (.)item?.ObjectPtr);
	}
	public void ItemClicked(IQTableWidgetItem item)
	{
		CQt.QTableWidget_ItemClicked((.)this.ptr.Ptr, (.)item?.ObjectPtr);
	}
	public void ItemDoubleClicked(IQTableWidgetItem item)
	{
		CQt.QTableWidget_ItemDoubleClicked((.)this.ptr.Ptr, (.)item?.ObjectPtr);
	}
	public void ItemActivated(IQTableWidgetItem item)
	{
		CQt.QTableWidget_ItemActivated((.)this.ptr.Ptr, (.)item?.ObjectPtr);
	}
	public void ItemEntered(IQTableWidgetItem item)
	{
		CQt.QTableWidget_ItemEntered((.)this.ptr.Ptr, (.)item?.ObjectPtr);
	}
	public void ItemChanged(IQTableWidgetItem item)
	{
		CQt.QTableWidget_ItemChanged((.)this.ptr.Ptr, (.)item?.ObjectPtr);
	}
	public void CurrentItemChanged(IQTableWidgetItem current, IQTableWidgetItem previous)
	{
		CQt.QTableWidget_CurrentItemChanged((.)this.ptr.Ptr, (.)current?.ObjectPtr, (.)previous?.ObjectPtr);
	}
	public void ItemSelectionChanged()
	{
		CQt.QTableWidget_ItemSelectionChanged((.)this.ptr.Ptr);
	}
	public void CellPressed(c_int row, c_int column)
	{
		CQt.QTableWidget_CellPressed((.)this.ptr.Ptr, row, column);
	}
	public void CellClicked(c_int row, c_int column)
	{
		CQt.QTableWidget_CellClicked((.)this.ptr.Ptr, row, column);
	}
	public void CellDoubleClicked(c_int row, c_int column)
	{
		CQt.QTableWidget_CellDoubleClicked((.)this.ptr.Ptr, row, column);
	}
	public void CellActivated(c_int row, c_int column)
	{
		CQt.QTableWidget_CellActivated((.)this.ptr.Ptr, row, column);
	}
	public void CellEntered(c_int row, c_int column)
	{
		CQt.QTableWidget_CellEntered((.)this.ptr.Ptr, row, column);
	}
	public void CellChanged(c_int row, c_int column)
	{
		CQt.QTableWidget_CellChanged((.)this.ptr.Ptr, row, column);
	}
	public void CurrentCellChanged(c_int currentRow, c_int currentColumn, c_int previousRow, c_int previousColumn)
	{
		CQt.QTableWidget_CurrentCellChanged((.)this.ptr.Ptr, currentRow, currentColumn, previousRow, previousColumn);
	}
	public bool Event(IQEvent e)
	{
		return CQt.QTableWidget_Event((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void* MimeTypes()
	{
		return CQt.QTableWidget_MimeTypes((.)this.ptr.Ptr);
	}
	public QMimeData_Ptr MimeData(void** items)
	{
		return QMimeData_Ptr(CQt.QTableWidget_MimeData((.)this.ptr.Ptr, items));
	}
	public bool DropMimeData(c_int row, c_int column, IQMimeData data, Qt_DropAction action)
	{
		return CQt.QTableWidget_DropMimeData((.)this.ptr.Ptr, row, column, (.)data?.ObjectPtr, action);
	}
	public void* SupportedDropActions()
	{
		return CQt.QTableWidget_SupportedDropActions((.)this.ptr.Ptr);
	}
	public void DropEvent(IQDropEvent event)
	{
		CQt.QTableWidget_DropEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	...
	{
		CQt.QTableWidget_SortItems2((.)this.ptr.Ptr, column, order);
	}
	public void ScrollToItem2(IQTableWidgetItem item, QAbstractItemView_ScrollHint hint)
	{
		CQt.QTableWidget_ScrollToItem2((.)this.ptr.Ptr, (.)item?.ObjectPtr, hint);
	}
