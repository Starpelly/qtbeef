...
class QLCDNumber : IQLCDNumber, IQFrame, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QLCDNumber_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QLCDNumber_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QLCDNumber_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return CQt.QLCDNumber_SmallDecimalPoint((.)this.ptr.Ptr);
	}
	public c_int DigitCount()
	{
		return CQt.QLCDNumber_DigitCount((.)this.ptr.Ptr);
	}
	public void SetDigitCount(c_int nDigits)
	{
		CQt.QLCDNumber_SetDigitCount((.)this.ptr.Ptr, nDigits);
	}
	public bool CheckOverflow(double num)
	{
		return CQt.QLCDNumber_CheckOverflow((.)this.ptr.Ptr, num);
	}
	public bool CheckOverflow2(c_int num)
	{
		return CQt.QLCDNumber_CheckOverflow2((.)this.ptr.Ptr, num);
	}
	public QLCDNumber_Mode Mode()
	{
		return CQt.QLCDNumber_Mode((.)this.ptr.Ptr);
	}
	public void SetMode(QLCDNumber_Mode mode)
	{
		CQt.QLCDNumber_SetMode((.)this.ptr.Ptr, mode);
	}
	public QLCDNumber_SegmentStyle SegmentStyle()
	{
		return CQt.QLCDNumber_SegmentStyle((.)this.ptr.Ptr);
	}
	public void SetSegmentStyle(QLCDNumber_SegmentStyle segmentStyle)
	{
		CQt.QLCDNumber_SetSegmentStyle((.)this.ptr.Ptr, segmentStyle);
	}
	public double Value()
	{
		return CQt.QLCDNumber_Value((.)this.ptr.Ptr);
	}
	public c_int IntValue()
	{
		return CQt.QLCDNumber_IntValue((.)this.ptr.Ptr);
	}
	public QSize_Ptr SizeHint()
	{
		return QSize_Ptr(CQt.QLCDNumber_SizeHint((.)this.ptr.Ptr));
	}
	public void Display(String str)
	{
		CQt.QLCDNumber_Display((.)this.ptr.Ptr, libqt_string(str));
	}
	public void Display2(c_int num)
	{
		CQt.QLCDNumber_Display2((.)this.ptr.Ptr, num);
	}
	public void Display3(double num)
	{
		CQt.QLCDNumber_Display3((.)this.ptr.Ptr, num);
	}
	public void SetHexMode()
	{
		CQt.QLCDNumber_SetHexMode((.)this.ptr.Ptr);
	}
	public void SetDecMode()
	{
		CQt.QLCDNumber_SetDecMode((.)this.ptr.Ptr);
	}
	public void SetOctMode()
	{
		CQt.QLCDNumber_SetOctMode((.)this.ptr.Ptr);
	}
	public void SetBinMode()
	{
		CQt.QLCDNumber_SetBinMode((.)this.ptr.Ptr);
	}
	public void SetSmallDecimalPoint(bool smallDecimalPoint)
	{
		CQt.QLCDNumber_SetSmallDecimalPoint((.)this.ptr.Ptr, smallDecimalPoint);
	}
	public void Overflow()
	{
		CQt.QLCDNumber_Overflow((.)this.ptr.Ptr);
	}
	public bool Event(IQEvent e)
	{
		return CQt.QLCDNumber_Event((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QLCDNumber_PaintEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
