...
class QMdiSubWindow : IQMdiSubWindow, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QMdiSubWindow_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QMdiSubWindow_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QMdiSubWindow_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return QSize_Ptr(CQt.QMdiSubWindow_SizeHint((.)this.ptr.Ptr));
	}
	public QSize_Ptr MinimumSizeHint()
	{
		return QSize_Ptr(CQt.QMdiSubWindow_MinimumSizeHint((.)this.ptr.Ptr));
	}
	public void SetWidget(IQWidget widget)
	{
		CQt.QMdiSubWindow_SetWidget((.)this.ptr.Ptr, (.)widget?.ObjectPtr);
	}
	public QWidget_Ptr Widget()
	{
		return QWidget_Ptr(CQt.QMdiSubWindow_Widget((.)this.ptr.Ptr));
	}
	public QWidget_Ptr MaximizedButtonsWidget()
	{
		return QWidget_Ptr(CQt.QMdiSubWindow_MaximizedButtonsWidget((.)this.ptr.Ptr));
	}
	public QWidget_Ptr MaximizedSystemMenuIconWidget()
	{
		return QWidget_Ptr(CQt.QMdiSubWindow_MaximizedSystemMenuIconWidget((.)this.ptr.Ptr));
	}
	public bool IsShaded()
	{
		return CQt.QMdiSubWindow_IsShaded((.)this.ptr.Ptr);
	}
	public void SetOption(QMdiSubWindow_SubWindowOption option)
	{
		CQt.QMdiSubWindow_SetOption((.)this.ptr.Ptr, option);
	}
	public bool TestOption(QMdiSubWindow_SubWindowOption param1)
	{
		return CQt.QMdiSubWindow_TestOption((.)this.ptr.Ptr, param1);
	}
	public void SetKeyboardSingleStep(c_int step)
	{
		CQt.QMdiSubWindow_SetKeyboardSingleStep((.)this.ptr.Ptr, step);
	}
	public c_int KeyboardSingleStep()
	{
		return CQt.QMdiSubWindow_KeyboardSingleStep((.)this.ptr.Ptr);
	}
	public void SetKeyboardPageStep(c_int step)
	{
		CQt.QMdiSubWindow_SetKeyboardPageStep((.)this.ptr.Ptr, step);
	}
	public c_int KeyboardPageStep()
	{
		return CQt.QMdiSubWindow_KeyboardPageStep((.)this.ptr.Ptr);
	}
	public void SetSystemMenu(IQMenu systemMenu)
	{
		CQt.QMdiSubWindow_SetSystemMenu((.)this.ptr.Ptr, (.)systemMenu?.ObjectPtr);
	}
	public QMenu_Ptr SystemMenu()
	{
		return QMenu_Ptr(CQt.QMdiSubWindow_SystemMenu((.)this.ptr.Ptr));
	}
	public QMdiArea_Ptr MdiArea()
	{
		return QMdiArea_Ptr(CQt.QMdiSubWindow_MdiArea((.)this.ptr.Ptr));
	}
	public void WindowStateChanged(void* oldState, void* newState)
	{
		CQt.QMdiSubWindow_WindowStateChanged((.)this.ptr.Ptr, oldState, newState);
	}
	public void AboutToActivate()
	{
		CQt.QMdiSubWindow_AboutToActivate((.)this.ptr.Ptr);
	}
	public void ShowSystemMenu()
	{
		CQt.QMdiSubWindow_ShowSystemMenu((.)this.ptr.Ptr);
	}
	public void ShowShaded()
	{
		CQt.QMdiSubWindow_ShowShaded((.)this.ptr.Ptr);
	}
	public bool EventFilter(IQObject object, IQEvent event)
	{
		return CQt.QMdiSubWindow_EventFilter((.)this.ptr.Ptr, (.)object?.ObjectPtr, (.)event?.ObjectPtr);
	}
	public bool Event(IQEvent event)
	{
		return CQt.QMdiSubWindow_Event((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void ShowEvent(IQShowEvent showEvent)
	{
		CQt.QMdiSubWindow_ShowEvent((.)this.ptr.Ptr, (.)showEvent?.ObjectPtr);
	}
	public void HideEvent(IQHideEvent hideEvent)
	{
		CQt.QMdiSubWindow_HideEvent((.)this.ptr.Ptr, (.)hideEvent?.ObjectPtr);
	}
	public void ChangeEvent(IQEvent changeEvent)
	{
		CQt.QMdiSubWindow_ChangeEvent((.)this.ptr.Ptr, (.)changeEvent?.ObjectPtr);
	}
	public void CloseEvent(IQCloseEvent closeEvent)
	{
		CQt.QMdiSubWindow_CloseEvent((.)this.ptr.Ptr, (.)closeEvent?.ObjectPtr);
	}
	public void LeaveEvent(IQEvent leaveEvent)
	{
		CQt.QMdiSubWindow_LeaveEvent((.)this.ptr.Ptr, (.)leaveEvent?.ObjectPtr);
	}
	public void ResizeEvent(IQResizeEvent resizeEvent)
	{
		CQt.QMdiSubWindow_ResizeEvent((.)this.ptr.Ptr, (.)resizeEvent?.ObjectPtr);
	}
	public void TimerEvent(IQTimerEvent timerEvent)
	{
		CQt.QMdiSubWindow_TimerEvent((.)this.ptr.Ptr, (.)timerEvent?.ObjectPtr);
	}
	public void MoveEvent(IQMoveEvent moveEvent)
	{
		CQt.QMdiSubWindow_MoveEvent((.)this.ptr.Ptr, (.)moveEvent?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent paintEvent)
	{
		CQt.QMdiSubWindow_PaintEvent((.)this.ptr.Ptr, (.)paintEvent?.ObjectPtr);
	}
	public void MousePressEvent(IQMouseEvent mouseEvent)
	{
		CQt.QMdiSubWindow_MousePressEvent((.)this.ptr.Ptr, (.)mouseEvent?.ObjectPtr);
	}
	public void MouseDoubleClickEvent(IQMouseEvent mouseEvent)
	{
		CQt.QMdiSubWindow_MouseDoubleClickEvent((.)this.ptr.Ptr, (.)mouseEvent?.ObjectPtr);
	}
	public void MouseReleaseEvent(IQMouseEvent mouseEvent)
	{
		CQt.QMdiSubWindow_MouseReleaseEvent((.)this.ptr.Ptr, (.)mouseEvent?.ObjectPtr);
	}
	public void MouseMoveEvent(IQMouseEvent mouseEvent)
	{
		CQt.QMdiSubWindow_MouseMoveEvent((.)this.ptr.Ptr, (.)mouseEvent?.ObjectPtr);
	}
	public void KeyPressEvent(IQKeyEvent keyEvent)
	{
		CQt.QMdiSubWindow_KeyPressEvent((.)this.ptr.Ptr, (.)keyEvent?.ObjectPtr);
	}
	public void ContextMenuEvent(IQContextMenuEvent contextMenuEvent)
	{
		CQt.QMdiSubWindow_ContextMenuEvent((.)this.ptr.Ptr, (.)contextMenuEvent?.ObjectPtr);
	}
	public void FocusInEvent(IQFocusEvent focusInEvent)
	{
		CQt.QMdiSubWindow_FocusInEvent((.)this.ptr.Ptr, (.)focusInEvent?.ObjectPtr);
	}
	public void FocusOutEvent(IQFocusEvent focusOutEvent)
	{
		CQt.QMdiSubWindow_FocusOutEvent((.)this.ptr.Ptr, (.)focusOutEvent?.ObjectPtr);
	}
	public void ChildEvent(IQChildEvent childEvent)
	{
		CQt.QMdiSubWindow_ChildEvent((.)this.ptr.Ptr, (.)childEvent?.ObjectPtr);
	}
	...
	{
		CQt.QMdiSubWindow_SetOption2((.)this.ptr.Ptr, option, on);
	}
