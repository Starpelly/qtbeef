...
class QLabel : IQLabel, IQFrame, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QLabel_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QLabel_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QLabel_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		CQt.QLabel_Text((.)this.ptr.Ptr);
	}
	public QPixmap_Ptr Pixmap(Qt_ReturnByValueConstant param1)
	{
		return QPixmap_Ptr(CQt.QLabel_Pixmap((.)this.ptr.Ptr, param1));
	}
	public QPixmap_Ptr Pixmap2()
	{
		return QPixmap_Ptr(CQt.QLabel_Pixmap2((.)this.ptr.Ptr));
	}
	public QPicture_Ptr Picture(Qt_ReturnByValueConstant param1)
	{
		return QPicture_Ptr(CQt.QLabel_Picture((.)this.ptr.Ptr, param1));
	}
	public QPicture_Ptr Picture2()
	{
		return QPicture_Ptr(CQt.QLabel_Picture2((.)this.ptr.Ptr));
	}
	public QMovie_Ptr Movie()
	{
		return QMovie_Ptr(CQt.QLabel_Movie((.)this.ptr.Ptr));
	}
	public Qt_TextFormat TextFormat()
	{
		return CQt.QLabel_TextFormat((.)this.ptr.Ptr);
	}
	public void SetTextFormat(Qt_TextFormat textFormat)
	{
		CQt.QLabel_SetTextFormat((.)this.ptr.Ptr, textFormat);
	}
	public void SetResourceProvider(void** provider)
	{
		CQt.QLabel_SetResourceProvider((.)this.ptr.Ptr, provider);
	}
	public void* Alignment()
	{
		return CQt.QLabel_Alignment((.)this.ptr.Ptr);
	}
	public void SetAlignment(void* alignment)
	{
		CQt.QLabel_SetAlignment((.)this.ptr.Ptr, alignment);
	}
	public void SetWordWrap(bool on)
	{
		CQt.QLabel_SetWordWrap((.)this.ptr.Ptr, on);
	}
	public bool WordWrap()
	{
		return CQt.QLabel_WordWrap((.)this.ptr.Ptr);
	}
	public c_int Indent()
	{
		return CQt.QLabel_Indent((.)this.ptr.Ptr);
	}
	public void SetIndent(c_int indent)
	{
		CQt.QLabel_SetIndent((.)this.ptr.Ptr, indent);
	}
	public c_int Margin()
	{
		return CQt.QLabel_Margin((.)this.ptr.Ptr);
	}
	public void SetMargin(c_int margin)
	{
		CQt.QLabel_SetMargin((.)this.ptr.Ptr, margin);
	}
	public bool HasScaledContents()
	{
		return CQt.QLabel_HasScaledContents((.)this.ptr.Ptr);
	}
	public void SetScaledContents(bool scaledContents)
	{
		CQt.QLabel_SetScaledContents((.)this.ptr.Ptr, scaledContents);
	}
	public QSize_Ptr SizeHint()
	{
		return QSize_Ptr(CQt.QLabel_SizeHint((.)this.ptr.Ptr));
	}
	public QSize_Ptr MinimumSizeHint()
	{
		return QSize_Ptr(CQt.QLabel_MinimumSizeHint((.)this.ptr.Ptr));
	}
	public void SetBuddy(IQWidget buddy)
	{
		CQt.QLabel_SetBuddy((.)this.ptr.Ptr, (.)buddy?.ObjectPtr);
	}
	public QWidget_Ptr Buddy()
	{
		return QWidget_Ptr(CQt.QLabel_Buddy((.)this.ptr.Ptr));
	}
	public c_int HeightForWidth(c_int param1)
	{
		return CQt.QLabel_HeightForWidth((.)this.ptr.Ptr, param1);
	}
	public bool OpenExternalLinks()
	{
		return CQt.QLabel_OpenExternalLinks((.)this.ptr.Ptr);
	}
	public void SetOpenExternalLinks(bool open)
	{
		CQt.QLabel_SetOpenExternalLinks((.)this.ptr.Ptr, open);
	}
	public void SetTextInteractionFlags(void* flags)
	{
		CQt.QLabel_SetTextInteractionFlags((.)this.ptr.Ptr, flags);
	}
	public void* TextInteractionFlags()
	{
		return CQt.QLabel_TextInteractionFlags((.)this.ptr.Ptr);
	}
	public void SetSelection(c_int param1, c_int param2)
	{
		CQt.QLabel_SetSelection((.)this.ptr.Ptr, param1, param2);
	}
	public bool HasSelectedText()
	{
		return CQt.QLabel_HasSelectedText((.)this.ptr.Ptr);
	}
	public void SelectedText(String outStr)
	{
		CQt.QLabel_SelectedText((.)this.ptr.Ptr);
	}
	public c_int SelectionStart()
	{
		return CQt.QLabel_SelectionStart((.)this.ptr.Ptr);
	}
	public void SetText(String text)
	{
		CQt.QLabel_SetText((.)this.ptr.Ptr, libqt_string(text));
	}
	public void SetPixmap(IQPixmap pixmap)
	{
		CQt.QLabel_SetPixmap((.)this.ptr.Ptr, (.)pixmap?.ObjectPtr);
	}
	public void SetPicture(IQPicture picture)
	{
		CQt.QLabel_SetPicture((.)this.ptr.Ptr, (.)picture?.ObjectPtr);
	}
	public void SetMovie(IQMovie movie)
	{
		CQt.QLabel_SetMovie((.)this.ptr.Ptr, (.)movie?.ObjectPtr);
	}
	public void SetNum(c_int num)
	{
		CQt.QLabel_SetNum((.)this.ptr.Ptr, num);
	}
	public void SetNum2(double num)
	{
		CQt.QLabel_SetNum2((.)this.ptr.Ptr, num);
	}
	public void Clear()
	{
		CQt.QLabel_Clear((.)this.ptr.Ptr);
	}
	public void LinkActivated(String link)
	{
		CQt.QLabel_LinkActivated((.)this.ptr.Ptr, libqt_string(link));
	}
	public void LinkHovered(String link)
	{
		CQt.QLabel_LinkHovered((.)this.ptr.Ptr, libqt_string(link));
	}
	public bool Event(IQEvent e)
	{
		return CQt.QLabel_Event((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void KeyPressEvent(IQKeyEvent ev)
	{
		CQt.QLabel_KeyPressEvent((.)this.ptr.Ptr, (.)ev?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QLabel_PaintEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void ChangeEvent(IQEvent param1)
	{
		CQt.QLabel_ChangeEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void MousePressEvent(IQMouseEvent ev)
	{
		CQt.QLabel_MousePressEvent((.)this.ptr.Ptr, (.)ev?.ObjectPtr);
	}
	public void MouseMoveEvent(IQMouseEvent ev)
	{
		CQt.QLabel_MouseMoveEvent((.)this.ptr.Ptr, (.)ev?.ObjectPtr);
	}
	public void MouseReleaseEvent(IQMouseEvent ev)
	{
		CQt.QLabel_MouseReleaseEvent((.)this.ptr.Ptr, (.)ev?.ObjectPtr);
	}
	public void ContextMenuEvent(IQContextMenuEvent ev)
	{
		CQt.QLabel_ContextMenuEvent((.)this.ptr.Ptr, (.)ev?.ObjectPtr);
	}
	public void FocusInEvent(IQFocusEvent ev)
	{
		CQt.QLabel_FocusInEvent((.)this.ptr.Ptr, (.)ev?.ObjectPtr);
	}
	public void FocusOutEvent(IQFocusEvent ev)
	{
		CQt.QLabel_FocusOutEvent((.)this.ptr.Ptr, (.)ev?.ObjectPtr);
	}
	public bool FocusNextPrevChild(bool next)
	{
		return CQt.QLabel_FocusNextPrevChild((.)this.ptr.Ptr, next);
	}
