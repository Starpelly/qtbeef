...
class QAbstractButton : IQAbstractButton, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QAbstractButton_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QAbstractButton_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QAbstractButton_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		CQt.QAbstractButton_SetText((.)this.ptr.Ptr, libqt_string(text));
	}
	public void Text(String outStr)
	{
		CQt.QAbstractButton_Text((.)this.ptr.Ptr);
	}
	public void SetIcon(IQIcon icon)
	{
		CQt.QAbstractButton_SetIcon((.)this.ptr.Ptr, (.)icon?.ObjectPtr);
	}
	public QIcon_Ptr Icon()
	{
		return QIcon_Ptr(CQt.QAbstractButton_Icon((.)this.ptr.Ptr));
	}
	public QSize_Ptr IconSize()
	{
		return QSize_Ptr(CQt.QAbstractButton_IconSize((.)this.ptr.Ptr));
	}
	public void SetShortcut(IQKeySequence key)
	{
		CQt.QAbstractButton_SetShortcut((.)this.ptr.Ptr, (.)key?.ObjectPtr);
	}
	public QKeySequence_Ptr Shortcut()
	{
		return QKeySequence_Ptr(CQt.QAbstractButton_Shortcut((.)this.ptr.Ptr));
	}
	public void SetCheckable(bool checkable)
	{
		CQt.QAbstractButton_SetCheckable((.)this.ptr.Ptr, checkable);
	}
	public bool IsCheckable()
	{
		return CQt.QAbstractButton_IsCheckable((.)this.ptr.Ptr);
	}
	public bool IsChecked()
	{
		return CQt.QAbstractButton_IsChecked((.)this.ptr.Ptr);
	}
	public void SetDown(bool down)
	{
		CQt.QAbstractButton_SetDown((.)this.ptr.Ptr, down);
	}
	public bool IsDown()
	{
		return CQt.QAbstractButton_IsDown((.)this.ptr.Ptr);
	}
	public void SetAutoRepeat(bool autoRepeat)
	{
		CQt.QAbstractButton_SetAutoRepeat((.)this.ptr.Ptr, autoRepeat);
	}
	public bool AutoRepeat()
	{
		return CQt.QAbstractButton_AutoRepeat((.)this.ptr.Ptr);
	}
	public void SetAutoRepeatDelay(c_int autoRepeatDelay)
	{
		CQt.QAbstractButton_SetAutoRepeatDelay((.)this.ptr.Ptr, autoRepeatDelay);
	}
	public c_int AutoRepeatDelay()
	{
		return CQt.QAbstractButton_AutoRepeatDelay((.)this.ptr.Ptr);
	}
	public void SetAutoRepeatInterval(c_int autoRepeatInterval)
	{
		CQt.QAbstractButton_SetAutoRepeatInterval((.)this.ptr.Ptr, autoRepeatInterval);
	}
	public c_int AutoRepeatInterval()
	{
		return CQt.QAbstractButton_AutoRepeatInterval((.)this.ptr.Ptr);
	}
	public void SetAutoExclusive(bool autoExclusive)
	{
		CQt.QAbstractButton_SetAutoExclusive((.)this.ptr.Ptr, autoExclusive);
	}
	public bool AutoExclusive()
	{
		return CQt.QAbstractButton_AutoExclusive((.)this.ptr.Ptr);
	}
	public QButtonGroup_Ptr Group()
	{
		return QButtonGroup_Ptr(CQt.QAbstractButton_Group((.)this.ptr.Ptr));
	}
	public void SetIconSize(IQSize size)
	{
		CQt.QAbstractButton_SetIconSize((.)this.ptr.Ptr, (.)size?.ObjectPtr);
	}
	public void AnimateClick()
	{
		CQt.QAbstractButton_AnimateClick((.)this.ptr.Ptr);
	}
	public void Click()
	{
		CQt.QAbstractButton_Click((.)this.ptr.Ptr);
	}
	public void Toggle()
	{
		CQt.QAbstractButton_Toggle((.)this.ptr.Ptr);
	}
	public void SetChecked(bool _checked)
	{
		CQt.QAbstractButton_SetChecked((.)this.ptr.Ptr, _checked);
	}
	public void Pressed()
	{
		CQt.QAbstractButton_Pressed((.)this.ptr.Ptr);
	}
	public void Released()
	{
		CQt.QAbstractButton_Released((.)this.ptr.Ptr);
	}
	public void Clicked()
	{
		CQt.QAbstractButton_Clicked((.)this.ptr.Ptr);
	}
	public void Toggled(bool _checked)
	{
		CQt.QAbstractButton_Toggled((.)this.ptr.Ptr, _checked);
	}
	public void PaintEvent(IQPaintEvent e)
	{
		CQt.QAbstractButton_PaintEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public bool HitButton(IQPoint pos)
	{
		return CQt.QAbstractButton_HitButton((.)this.ptr.Ptr, (.)pos?.ObjectPtr);
	}
	public void CheckStateSet()
	{
		CQt.QAbstractButton_CheckStateSet((.)this.ptr.Ptr);
	}
	public void NextCheckState()
	{
		CQt.QAbstractButton_NextCheckState((.)this.ptr.Ptr);
	}
	public bool Event(IQEvent e)
	{
		return CQt.QAbstractButton_Event((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void KeyPressEvent(IQKeyEvent e)
	{
		CQt.QAbstractButton_KeyPressEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void KeyReleaseEvent(IQKeyEvent e)
	{
		CQt.QAbstractButton_KeyReleaseEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void MousePressEvent(IQMouseEvent e)
	{
		CQt.QAbstractButton_MousePressEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void MouseReleaseEvent(IQMouseEvent e)
	{
		CQt.QAbstractButton_MouseReleaseEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void MouseMoveEvent(IQMouseEvent e)
	{
		CQt.QAbstractButton_MouseMoveEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void FocusInEvent(IQFocusEvent e)
	{
		CQt.QAbstractButton_FocusInEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void FocusOutEvent(IQFocusEvent e)
	{
		CQt.QAbstractButton_FocusOutEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void ChangeEvent(IQEvent e)
	{
		CQt.QAbstractButton_ChangeEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void TimerEvent(IQTimerEvent e)
	{
		CQt.QAbstractButton_TimerEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	...
	{
		CQt.QAbstractButton_Clicked1((.)this.ptr.Ptr, _checked);
	}
