...
class QAccessibleBridge : IQAccessibleBridge
{
	...
	{
		CQt.QAccessibleBridge_SetRootObject((.)this.ptr.Ptr, (.)rootObject?.ObjectPtr);
	}
	public void NotifyAccessibilityUpdate(IQAccessibleEvent event)
	{
		CQt.QAccessibleBridge_NotifyAccessibilityUpdate((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
}
...
class QAccessibleBridgePlugin : IQAccessibleBridgePlugin, IQObject
{
	...
	{
		return QMetaObject_Ptr(CQt.QAccessibleBridgePlugin_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QAccessibleBridgePlugin_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QAccessibleBridgePlugin_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return QAccessibleBridge_Ptr(CQt.QAccessibleBridgePlugin_Create((.)this.ptr.Ptr, libqt_string(key)));
	}
