...
class QTabBar : IQTabBar, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QTabBar_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QTabBar_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QTabBar_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return CQt.QTabBar_Shape((.)this.ptr.Ptr);
	}
	public void SetShape(QTabBar_Shape shape)
	{
		CQt.QTabBar_SetShape((.)this.ptr.Ptr, shape);
	}
	public c_int AddTab(String text)
	{
		return CQt.QTabBar_AddTab((.)this.ptr.Ptr, libqt_string(text));
	}
	public c_int AddTab2(IQIcon icon, String text)
	{
		return CQt.QTabBar_AddTab2((.)this.ptr.Ptr, (.)icon?.ObjectPtr, libqt_string(text));
	}
	public c_int InsertTab(c_int index, String text)
	{
		return CQt.QTabBar_InsertTab((.)this.ptr.Ptr, index, libqt_string(text));
	}
	public c_int InsertTab2(c_int index, IQIcon icon, String text)
	{
		return CQt.QTabBar_InsertTab2((.)this.ptr.Ptr, index, (.)icon?.ObjectPtr, libqt_string(text));
	}
	public void RemoveTab(c_int index)
	{
		CQt.QTabBar_RemoveTab((.)this.ptr.Ptr, index);
	}
	public void MoveTab(c_int from, c_int to)
	{
		CQt.QTabBar_MoveTab((.)this.ptr.Ptr, from, to);
	}
	public bool IsTabEnabled(c_int index)
	{
		return CQt.QTabBar_IsTabEnabled((.)this.ptr.Ptr, index);
	}
	public void SetTabEnabled(c_int index, bool enabled)
	{
		CQt.QTabBar_SetTabEnabled((.)this.ptr.Ptr, index, enabled);
	}
	public bool IsTabVisible(c_int index)
	{
		return CQt.QTabBar_IsTabVisible((.)this.ptr.Ptr, index);
	}
	public void SetTabVisible(c_int index, bool visible)
	{
		CQt.QTabBar_SetTabVisible((.)this.ptr.Ptr, index, visible);
	}
	public void TabText(String outStr, c_int index)
	{
		CQt.QTabBar_TabText((.)this.ptr.Ptr, index);
	}
	public void SetTabText(c_int index, String text)
	{
		CQt.QTabBar_SetTabText((.)this.ptr.Ptr, index, libqt_string(text));
	}
	public QColor_Ptr TabTextColor(c_int index)
	{
		return QColor_Ptr(CQt.QTabBar_TabTextColor((.)this.ptr.Ptr, index));
	}
	public void SetTabTextColor(c_int index, IQColor color)
	{
		CQt.QTabBar_SetTabTextColor((.)this.ptr.Ptr, index, (.)color?.ObjectPtr);
	}
	public QIcon_Ptr TabIcon(c_int index)
	{
		return QIcon_Ptr(CQt.QTabBar_TabIcon((.)this.ptr.Ptr, index));
	}
	public void SetTabIcon(c_int index, IQIcon icon)
	{
		CQt.QTabBar_SetTabIcon((.)this.ptr.Ptr, index, (.)icon?.ObjectPtr);
	}
	public Qt_TextElideMode ElideMode()
	{
		return CQt.QTabBar_ElideMode((.)this.ptr.Ptr);
	}
	public void SetElideMode(Qt_TextElideMode mode)
	{
		CQt.QTabBar_SetElideMode((.)this.ptr.Ptr, mode);
	}
	public void SetTabToolTip(c_int index, String tip)
	{
		CQt.QTabBar_SetTabToolTip((.)this.ptr.Ptr, index, libqt_string(tip));
	}
	public void TabToolTip(String outStr, c_int index)
	{
		CQt.QTabBar_TabToolTip((.)this.ptr.Ptr, index);
	}
	public void SetTabWhatsThis(c_int index, String text)
	{
		CQt.QTabBar_SetTabWhatsThis((.)this.ptr.Ptr, index, libqt_string(text));
	}
	public void TabWhatsThis(String outStr, c_int index)
	{
		CQt.QTabBar_TabWhatsThis((.)this.ptr.Ptr, index);
	}
	public void SetTabData(c_int index, IQVariant data)
	{
		CQt.QTabBar_SetTabData((.)this.ptr.Ptr, index, (.)data?.ObjectPtr);
	}
	public QVariant_Ptr TabData(c_int index)
	{
		return QVariant_Ptr(CQt.QTabBar_TabData((.)this.ptr.Ptr, index));
	}
	public QRect_Ptr TabRect(c_int index)
	{
		return QRect_Ptr(CQt.QTabBar_TabRect((.)this.ptr.Ptr, index));
	}
	public c_int TabAt(IQPoint pos)
	{
		return CQt.QTabBar_TabAt((.)this.ptr.Ptr, (.)pos?.ObjectPtr);
	}
	public c_int CurrentIndex()
	{
		return CQt.QTabBar_CurrentIndex((.)this.ptr.Ptr);
	}
	public c_int Count()
	{
		return CQt.QTabBar_Count((.)this.ptr.Ptr);
	}
	public QSize_Ptr SizeHint()
	{
		return QSize_Ptr(CQt.QTabBar_SizeHint((.)this.ptr.Ptr));
	}
	public QSize_Ptr MinimumSizeHint()
	{
		return QSize_Ptr(CQt.QTabBar_MinimumSizeHint((.)this.ptr.Ptr));
	}
	public void SetDrawBase(bool drawTheBase)
	{
		CQt.QTabBar_SetDrawBase((.)this.ptr.Ptr, drawTheBase);
	}
	public bool DrawBase()
	{
		return CQt.QTabBar_DrawBase((.)this.ptr.Ptr);
	}
	public QSize_Ptr IconSize()
	{
		return QSize_Ptr(CQt.QTabBar_IconSize((.)this.ptr.Ptr));
	}
	public void SetIconSize(IQSize size)
	{
		CQt.QTabBar_SetIconSize((.)this.ptr.Ptr, (.)size?.ObjectPtr);
	}
	public bool UsesScrollButtons()
	{
		return CQt.QTabBar_UsesScrollButtons((.)this.ptr.Ptr);
	}
	public void SetUsesScrollButtons(bool useButtons)
	{
		CQt.QTabBar_SetUsesScrollButtons((.)this.ptr.Ptr, useButtons);
	}
	public bool TabsClosable()
	{
		return CQt.QTabBar_TabsClosable((.)this.ptr.Ptr);
	}
	public void SetTabsClosable(bool closable)
	{
		CQt.QTabBar_SetTabsClosable((.)this.ptr.Ptr, closable);
	}
	public void SetTabButton(c_int index, QTabBar_ButtonPosition position, IQWidget widget)
	{
		CQt.QTabBar_SetTabButton((.)this.ptr.Ptr, index, position, (.)widget?.ObjectPtr);
	}
	public QWidget_Ptr TabButton(c_int index, QTabBar_ButtonPosition position)
	{
		return QWidget_Ptr(CQt.QTabBar_TabButton((.)this.ptr.Ptr, index, position));
	}
	public QTabBar_SelectionBehavior SelectionBehaviorOnRemove()
	{
		return CQt.QTabBar_SelectionBehaviorOnRemove((.)this.ptr.Ptr);
	}
	public void SetSelectionBehaviorOnRemove(QTabBar_SelectionBehavior behavior)
	{
		CQt.QTabBar_SetSelectionBehaviorOnRemove((.)this.ptr.Ptr, behavior);
	}
	public bool Expanding()
	{
		return CQt.QTabBar_Expanding((.)this.ptr.Ptr);
	}
	public void SetExpanding(bool enabled)
	{
		CQt.QTabBar_SetExpanding((.)this.ptr.Ptr, enabled);
	}
	public bool IsMovable()
	{
		return CQt.QTabBar_IsMovable((.)this.ptr.Ptr);
	}
	public void SetMovable(bool movable)
	{
		CQt.QTabBar_SetMovable((.)this.ptr.Ptr, movable);
	}
	public bool DocumentMode()
	{
		return CQt.QTabBar_DocumentMode((.)this.ptr.Ptr);
	}
	public void SetDocumentMode(bool set)
	{
		CQt.QTabBar_SetDocumentMode((.)this.ptr.Ptr, set);
	}
	public bool AutoHide()
	{
		return CQt.QTabBar_AutoHide((.)this.ptr.Ptr);
	}
	public void SetAutoHide(bool hide)
	{
		CQt.QTabBar_SetAutoHide((.)this.ptr.Ptr, hide);
	}
	public bool ChangeCurrentOnDrag()
	{
		return CQt.QTabBar_ChangeCurrentOnDrag((.)this.ptr.Ptr);
	}
	public void SetChangeCurrentOnDrag(bool change)
	{
		CQt.QTabBar_SetChangeCurrentOnDrag((.)this.ptr.Ptr, change);
	}
	public void AccessibleTabName(String outStr, c_int index)
	{
		CQt.QTabBar_AccessibleTabName((.)this.ptr.Ptr, index);
	}
	public void SetAccessibleTabName(c_int index, String name)
	{
		CQt.QTabBar_SetAccessibleTabName((.)this.ptr.Ptr, index, libqt_string(name));
	}
	public void SetCurrentIndex(c_int index)
	{
		CQt.QTabBar_SetCurrentIndex((.)this.ptr.Ptr, index);
	}
	public void CurrentChanged(c_int index)
	{
		CQt.QTabBar_CurrentChanged((.)this.ptr.Ptr, index);
	}
	public void TabCloseRequested(c_int index)
	{
		CQt.QTabBar_TabCloseRequested((.)this.ptr.Ptr, index);
	}
	public void TabMoved(c_int from, c_int to)
	{
		CQt.QTabBar_TabMoved((.)this.ptr.Ptr, from, to);
	}
	public void TabBarClicked(c_int index)
	{
		CQt.QTabBar_TabBarClicked((.)this.ptr.Ptr, index);
	}
	public void TabBarDoubleClicked(c_int index)
	{
		CQt.QTabBar_TabBarDoubleClicked((.)this.ptr.Ptr, index);
	}
	public QSize_Ptr TabSizeHint(c_int index)
	{
		return QSize_Ptr(CQt.QTabBar_TabSizeHint((.)this.ptr.Ptr, index));
	}
	public QSize_Ptr MinimumTabSizeHint(c_int index)
	{
		return QSize_Ptr(CQt.QTabBar_MinimumTabSizeHint((.)this.ptr.Ptr, index));
	}
	public void TabInserted(c_int index)
	{
		CQt.QTabBar_TabInserted((.)this.ptr.Ptr, index);
	}
	public void TabRemoved(c_int index)
	{
		CQt.QTabBar_TabRemoved((.)this.ptr.Ptr, index);
	}
	public void TabLayoutChange()
	{
		CQt.QTabBar_TabLayoutChange((.)this.ptr.Ptr);
	}
	public bool Event(IQEvent param1)
	{
		return CQt.QTabBar_Event((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void ResizeEvent(IQResizeEvent param1)
	{
		CQt.QTabBar_ResizeEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void ShowEvent(IQShowEvent param1)
	{
		CQt.QTabBar_ShowEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void HideEvent(IQHideEvent param1)
	{
		CQt.QTabBar_HideEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QTabBar_PaintEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void MousePressEvent(IQMouseEvent param1)
	{
		CQt.QTabBar_MousePressEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void MouseMoveEvent(IQMouseEvent param1)
	{
		CQt.QTabBar_MouseMoveEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void MouseReleaseEvent(IQMouseEvent param1)
	{
		CQt.QTabBar_MouseReleaseEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void MouseDoubleClickEvent(IQMouseEvent param1)
	{
		CQt.QTabBar_MouseDoubleClickEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void WheelEvent(IQWheelEvent event)
	{
		CQt.QTabBar_WheelEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void KeyPressEvent(IQKeyEvent param1)
	{
		CQt.QTabBar_KeyPressEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void ChangeEvent(IQEvent param1)
	{
		CQt.QTabBar_ChangeEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void TimerEvent(IQTimerEvent event)
	{
		CQt.QTabBar_TimerEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void InitStyleOption(IQStyleOptionTab option, c_int tabIndex)
	{
		CQt.QTabBar_InitStyleOption((.)this.ptr.Ptr, (.)option?.ObjectPtr, tabIndex);
	}
