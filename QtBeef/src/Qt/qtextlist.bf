...
class QTextList : IQTextList, IQTextBlockGroup, IQTextObject, IQObject
{
	...
	{
		return QMetaObject_Ptr(CQt.QTextList_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QTextList_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QTextList_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	public c_int Count()
	{
		return CQt.QTextList_Count((.)this.ptr.Ptr);
	}
	public QTextBlock_Ptr Item(c_int i)
	{
		return QTextBlock_Ptr(CQt.QTextList_Item((.)this.ptr.Ptr, i));
	}
	public c_int ItemNumber(IQTextBlock param1)
	{
		return CQt.QTextList_ItemNumber((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void ItemText(String outStr, IQTextBlock param1)
	{
		CQt.QTextList_ItemText((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void RemoveItem(c_int i)
	{
		CQt.QTextList_RemoveItem((.)this.ptr.Ptr, i);
	}
	public void Remove(IQTextBlock param1)
	{
		CQt.QTextList_Remove((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void Add(IQTextBlock block)
	{
		CQt.QTextList_Add((.)this.ptr.Ptr, (.)block?.ObjectPtr);
	}
	public void SetFormat(IQTextListFormat format)
	{
		CQt.QTextList_SetFormat((.)this.ptr.Ptr, (.)format?.ObjectPtr);
	}
	public QTextListFormat_Ptr Format()
	{
		return QTextListFormat_Ptr(CQt.QTextList_Format((.)this.ptr.Ptr));
	}
