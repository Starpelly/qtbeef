...
class QTransposeProxyModel : IQTransposeProxyModel, IQAbstractProxyModel, IQAbstractItemModel, IQObject
{
	...
	{
		return CQt.QTransposeProxyModel_Span((.)this.ptr, (.)index?.ObjectPtr);
	}
	...
	{
		return CQt.QTransposeProxyModel_MapFromSource((.)this.ptr, (.)sourceIndex?.ObjectPtr);
	}
	public QModelIndex_Ptr* MapToSource(IQModelIndex proxyIndex)
	{
		return CQt.QTransposeProxyModel_MapToSource((.)this.ptr, (.)proxyIndex?.ObjectPtr);
	}
	public QModelIndex_Ptr* Parent(IQModelIndex index)
	{
		return CQt.QTransposeProxyModel_Parent((.)this.ptr, (.)index?.ObjectPtr);
	}
	public QModelIndex_Ptr* Index(c_int row, c_int column, IQModelIndex parent)
	{
		return CQt.QTransposeProxyModel_Index((.)this.ptr, row, column, (.)parent?.ObjectPtr);
	}
