...
class QMargins : IQMargins
{
	...
	public bool IsNull()
	{
		return CQt.QMargins_IsNull((.)this.ptr.Ptr);
	}
	public c_int Left()
	{
		return CQt.QMargins_Left((.)this.ptr.Ptr);
	}
	public c_int Top()
	{
		return CQt.QMargins_Top((.)this.ptr.Ptr);
	}
	public c_int Right()
	{
		return CQt.QMargins_Right((.)this.ptr.Ptr);
	}
	public c_int Bottom()
	{
		return CQt.QMargins_Bottom((.)this.ptr.Ptr);
	}
	public void SetLeft(c_int left)
	{
		CQt.QMargins_SetLeft((.)this.ptr.Ptr, left);
	}
	public void SetTop(c_int top)
	{
		CQt.QMargins_SetTop((.)this.ptr.Ptr, top);
	}
	public void SetRight(c_int right)
	{
		CQt.QMargins_SetRight((.)this.ptr.Ptr, right);
	}
	public void SetBottom(c_int bottom)
	{
		CQt.QMargins_SetBottom((.)this.ptr.Ptr, bottom);
	}
	public QMargins_Ptr OperatorPlusAssign2(c_int param1)
	{
		return QMargins_Ptr(CQt.QMargins_OperatorPlusAssign2((.)this.ptr.Ptr, param1));
	}
	public QMargins_Ptr OperatorMinusAssign2(c_int param1)
	{
		return QMargins_Ptr(CQt.QMargins_OperatorMinusAssign2((.)this.ptr.Ptr, param1));
	}
	public QMargins_Ptr OperatorMultiplyAssign2(double param1)
	{
		return QMargins_Ptr(CQt.QMargins_OperatorMultiplyAssign2((.)this.ptr.Ptr, param1));
	}
	public QMargins_Ptr OperatorDivideAssign2(double param1)
	{
		return QMargins_Ptr(CQt.QMargins_OperatorDivideAssign2((.)this.ptr.Ptr, param1));
	}
	public QMarginsF_Ptr ToMarginsF()
	{
		return QMarginsF_Ptr(CQt.QMargins_ToMarginsF((.)this.ptr.Ptr));
	}
}
...
class QMarginsF : IQMarginsF
{
	...
	public bool IsNull()
	{
		return CQt.QMarginsF_IsNull((.)this.ptr.Ptr);
	}
	public double Left()
	{
		return CQt.QMarginsF_Left((.)this.ptr.Ptr);
	}
	public double Top()
	{
		return CQt.QMarginsF_Top((.)this.ptr.Ptr);
	}
	public double Right()
	{
		return CQt.QMarginsF_Right((.)this.ptr.Ptr);
	}
	public double Bottom()
	{
		return CQt.QMarginsF_Bottom((.)this.ptr.Ptr);
	}
	public void SetLeft(double aleft)
	{
		CQt.QMarginsF_SetLeft((.)this.ptr.Ptr, aleft);
	}
	public void SetTop(double atop)
	{
		CQt.QMarginsF_SetTop((.)this.ptr.Ptr, atop);
	}
	public void SetRight(double aright)
	{
		CQt.QMarginsF_SetRight((.)this.ptr.Ptr, aright);
	}
	public void SetBottom(double abottom)
	{
		CQt.QMarginsF_SetBottom((.)this.ptr.Ptr, abottom);
	}
	public QMarginsF_Ptr OperatorPlusAssign2(double addend)
	{
		return QMarginsF_Ptr(CQt.QMarginsF_OperatorPlusAssign2((.)this.ptr.Ptr, addend));
	}
	public QMarginsF_Ptr OperatorMinusAssign2(double subtrahend)
	{
		return QMarginsF_Ptr(CQt.QMarginsF_OperatorMinusAssign2((.)this.ptr.Ptr, subtrahend));
	}
	public QMargins_Ptr ToMargins()
	{
		return QMargins_Ptr(CQt.QMarginsF_ToMargins((.)this.ptr.Ptr));
	}
}
