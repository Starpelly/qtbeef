...
// --------------------------------------------------------------
[CRepr]
struct QDeadlineTimer_Ptr: void
{
}
extension CQt
{
	[LinkName("QDeadlineTimer_new")]
	public static extern QDeadlineTimer_Ptr* QDeadlineTimer_new(QDeadlineTimer_Ptr* other);
	[LinkName("QDeadlineTimer_new2")]
	public static extern QDeadlineTimer_Ptr* QDeadlineTimer_new2(QDeadlineTimer_Ptr* other);
	...
	public static extern QDeadlineTimer_Ptr* QDeadlineTimer_new6(QDeadlineTimer_Ptr* param1);
	...
	public static extern void QDeadlineTimer_Swap(QDeadlineTimer_Ptr* self, QDeadlineTimer_Ptr* other);
	[LinkName("QDeadlineTimer_IsForever")]
	public static extern bool QDeadlineTimer_IsForever(QDeadlineTimer_Ptr* self);
	[LinkName("QDeadlineTimer_HasExpired")]
	public static extern bool QDeadlineTimer_HasExpired(QDeadlineTimer_Ptr* self);
	[LinkName("QDeadlineTimer_TimerType")]
	public static extern Qt_TimerType QDeadlineTimer_TimerType(QDeadlineTimer_Ptr* self);
	[LinkName("QDeadlineTimer_SetTimerType")]
	public static extern void QDeadlineTimer_SetTimerType(QDeadlineTimer_Ptr* self, Qt_TimerType type);
	[LinkName("QDeadlineTimer_RemainingTime")]
	public static extern c_longlong QDeadlineTimer_RemainingTime(QDeadlineTimer_Ptr* self);
	[LinkName("QDeadlineTimer_RemainingTimeNSecs")]
	public static extern c_longlong QDeadlineTimer_RemainingTimeNSecs(QDeadlineTimer_Ptr* self);
	[LinkName("QDeadlineTimer_SetRemainingTime")]
	public static extern void QDeadlineTimer_SetRemainingTime(QDeadlineTimer_Ptr* self, c_longlong msecs);
	[LinkName("QDeadlineTimer_SetPreciseRemainingTime")]
	public static extern void QDeadlineTimer_SetPreciseRemainingTime(QDeadlineTimer_Ptr* self, c_longlong secs);
	[LinkName("QDeadlineTimer_Deadline")]
	public static extern c_longlong QDeadlineTimer_Deadline(QDeadlineTimer_Ptr* self);
	[LinkName("QDeadlineTimer_DeadlineNSecs")]
	public static extern c_longlong QDeadlineTimer_DeadlineNSecs(QDeadlineTimer_Ptr* self);
	[LinkName("QDeadlineTimer_SetDeadline")]
	public static extern void QDeadlineTimer_SetDeadline(QDeadlineTimer_Ptr* self, c_longlong msecs);
	...
	public static extern QDeadlineTimer_Ptr* QDeadlineTimer_OperatorMinusAssign(QDeadlineTimer_Ptr* self, c_longlong msecs);
	[LinkName("QDeadlineTimer_RemainingTimeAsDuration")]
	public static extern void* QDeadlineTimer_RemainingTimeAsDuration(QDeadlineTimer_Ptr* self);
	[LinkName("QDeadlineTimer__Q_Data")]
	public static extern void* QDeadlineTimer__Q_Data(QDeadlineTimer_Ptr* self);
	[LinkName("QDeadlineTimer_OperatorAssign")]
	public static extern void QDeadlineTimer_OperatorAssign(QDeadlineTimer_Ptr* self, QDeadlineTimer_Ptr* param1);
	[LinkName("QDeadlineTimer_SetRemainingTime2")]
	public static extern void QDeadlineTimer_SetRemainingTime2(QDeadlineTimer_Ptr* self, c_longlong msecs, Qt_TimerType type);
	[LinkName("QDeadlineTimer_SetPreciseRemainingTime2")]
	public static extern void QDeadlineTimer_SetPreciseRemainingTime2(QDeadlineTimer_Ptr* self, c_longlong secs, c_longlong nsecs);
	[LinkName("QDeadlineTimer_SetPreciseRemainingTime3")]
	public static extern void QDeadlineTimer_SetPreciseRemainingTime3(QDeadlineTimer_Ptr* self, c_longlong secs, c_longlong nsecs, Qt_TimerType type);
	[LinkName("QDeadlineTimer_SetDeadline2")]
	public static extern void QDeadlineTimer_SetDeadline2(QDeadlineTimer_Ptr* self, c_longlong msecs, Qt_TimerType timerType);
	[LinkName("QDeadlineTimer_SetPreciseDeadline2")]
	public static extern void QDeadlineTimer_SetPreciseDeadline2(QDeadlineTimer_Ptr* self, c_longlong secs, c_longlong nsecs);
