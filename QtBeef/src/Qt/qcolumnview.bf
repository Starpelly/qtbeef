...
class QColumnView : IQColumnView, IQAbstractItemView, IQAbstractScrollArea, IQFrame, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QColumnView_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QColumnView_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QColumnView_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		CQt.QColumnView_UpdatePreviewWidget((.)this.ptr.Ptr, (.)index?.ObjectPtr);
	}
	public QModelIndex_Ptr IndexAt(IQPoint point)
	{
		return QModelIndex_Ptr(CQt.QColumnView_IndexAt((.)this.ptr.Ptr, (.)point?.ObjectPtr));
	}
	public void ScrollTo(IQModelIndex index, QAbstractItemView_ScrollHint hint)
	{
		CQt.QColumnView_ScrollTo((.)this.ptr.Ptr, (.)index?.ObjectPtr, hint);
	}
	public QSize_Ptr SizeHint()
	{
		return QSize_Ptr(CQt.QColumnView_SizeHint((.)this.ptr.Ptr));
	}
	public QRect_Ptr VisualRect(IQModelIndex index)
	{
		return QRect_Ptr(CQt.QColumnView_VisualRect((.)this.ptr.Ptr, (.)index?.ObjectPtr));
	}
	public void SetModel(IQAbstractItemModel model)
	{
		CQt.QColumnView_SetModel((.)this.ptr.Ptr, (.)model?.ObjectPtr);
	}
	public void SetSelectionModel(IQItemSelectionModel selectionModel)
	{
		CQt.QColumnView_SetSelectionModel((.)this.ptr.Ptr, (.)selectionModel?.ObjectPtr);
	}
	public void SetRootIndex(IQModelIndex index)
	{
		CQt.QColumnView_SetRootIndex((.)this.ptr.Ptr, (.)index?.ObjectPtr);
	}
	public void SelectAll()
	{
		CQt.QColumnView_SelectAll((.)this.ptr.Ptr);
	}
	public void SetResizeGripsVisible(bool visible)
	{
		CQt.QColumnView_SetResizeGripsVisible((.)this.ptr.Ptr, visible);
	}
	public bool ResizeGripsVisible()
	{
		return CQt.QColumnView_ResizeGripsVisible((.)this.ptr.Ptr);
	}
	public QWidget_Ptr PreviewWidget()
	{
		return QWidget_Ptr(CQt.QColumnView_PreviewWidget((.)this.ptr.Ptr));
	}
	public void SetPreviewWidget(IQWidget widget)
	{
		CQt.QColumnView_SetPreviewWidget((.)this.ptr.Ptr, (.)widget?.ObjectPtr);
	}
	public void SetColumnWidths(void** list)
	{
		CQt.QColumnView_SetColumnWidths((.)this.ptr.Ptr, list);
	}
	public void* ColumnWidths()
	{
		return CQt.QColumnView_ColumnWidths((.)this.ptr.Ptr);
	}
	public bool IsIndexHidden(IQModelIndex index)
	{
		return CQt.QColumnView_IsIndexHidden((.)this.ptr.Ptr, (.)index?.ObjectPtr);
	}
	public QModelIndex_Ptr MoveCursor(QAbstractItemView_CursorAction cursorAction, void* modifiers)
	{
		return QModelIndex_Ptr(CQt.QColumnView_MoveCursor((.)this.ptr.Ptr, cursorAction, modifiers));
	}
	public void ResizeEvent(IQResizeEvent event)
	{
		CQt.QColumnView_ResizeEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void SetSelection(IQRect rect, void* command)
	{
		CQt.QColumnView_SetSelection((.)this.ptr.Ptr, (.)rect?.ObjectPtr, command);
	}
	public QRegion_Ptr VisualRegionForSelection(IQItemSelection selection)
	{
		return QRegion_Ptr(CQt.QColumnView_VisualRegionForSelection((.)this.ptr.Ptr, (.)selection?.ObjectPtr));
	}
	public c_int HorizontalOffset()
	{
		return CQt.QColumnView_HorizontalOffset((.)this.ptr.Ptr);
	}
	public c_int VerticalOffset()
	{
		return CQt.QColumnView_VerticalOffset((.)this.ptr.Ptr);
	}
	public void RowsInserted(IQModelIndex parent, c_int start, c_int end)
	{
		CQt.QColumnView_RowsInserted((.)this.ptr.Ptr, (.)parent?.ObjectPtr, start, end);
	}
	public void CurrentChanged(IQModelIndex current, IQModelIndex previous)
	{
		CQt.QColumnView_CurrentChanged((.)this.ptr.Ptr, (.)current?.ObjectPtr, (.)previous?.ObjectPtr);
	}
	public void ScrollContentsBy(c_int dx, c_int dy)
	{
		CQt.QColumnView_ScrollContentsBy((.)this.ptr.Ptr, dx, dy);
	}
	public QAbstractItemView_Ptr CreateColumn(IQModelIndex rootIndex)
	{
		return QAbstractItemView_Ptr(CQt.QColumnView_CreateColumn((.)this.ptr.Ptr, (.)rootIndex?.ObjectPtr));
	}
	public void InitializeColumn(IQAbstractItemView column)
	{
		CQt.QColumnView_InitializeColumn((.)this.ptr.Ptr, (.)column?.ObjectPtr);
	}
