...
class QColumnView : IQColumnView, IQAbstractItemView, IQAbstractScrollArea, IQFrame, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return CQt.QColumnView_IndexAt((.)this.ptr, (.)point?.ObjectPtr);
	}
	...
	{
		return CQt.QColumnView_VisualRect((.)this.ptr, (.)index?.ObjectPtr);
	}
	...
	{
		return CQt.QColumnView_VisualRegionForSelection((.)this.ptr, (.)selection?.ObjectPtr);
	}
	...
	{
		return CQt.QColumnView_CreateColumn((.)this.ptr, (.)rootIndex?.ObjectPtr);
	}
