...
struct QMessageBox_Ptr
{
	...
	{
		return QMetaObject_Ptr(CQt.QMessageBox_MetaObject((.)this.Ptr));
	}
	...
	{
		return QPushButton_Ptr(CQt.QMessageBox_AddButton2((.)this.Ptr, libqt_string(text), role));
	}
	public QPushButton_Ptr AddButton3(QMessageBox_StandardButton button)
	{
		return QPushButton_Ptr(CQt.QMessageBox_AddButton3((.)this.Ptr, button));
	}
	...
	{
		return QAbstractButton_Ptr(CQt.QMessageBox_Button((.)this.Ptr, which));
	}
	public QPushButton_Ptr DefaultButton()
	{
		return QPushButton_Ptr(CQt.QMessageBox_DefaultButton((.)this.Ptr));
	}
	...
	{
		return QAbstractButton_Ptr(CQt.QMessageBox_EscapeButton((.)this.Ptr));
	}
	...
	{
		return QAbstractButton_Ptr(CQt.QMessageBox_ClickedButton((.)this.Ptr));
	}
	public void Text(String outStr)
	{
		CQt.QMessageBox_Text((.)this.Ptr);
	}
	...
	{
		return QPixmap_Ptr(CQt.QMessageBox_IconPixmap((.)this.Ptr));
	}
	...
	{
		return QCheckBox_Ptr(CQt.QMessageBox_CheckBox((.)this.Ptr));
	}
	...
	public void ButtonText(String outStr, c_int button)
	{
		CQt.QMessageBox_ButtonText((.)this.Ptr, button);
	}
	public void SetButtonText(c_int button, String text)
	{
		CQt.QMessageBox_SetButtonText((.)this.Ptr, button, libqt_string(text));
	}
	public void InformativeText(String outStr)
	{
		CQt.QMessageBox_InformativeText((.)this.Ptr);
	}
	public void SetInformativeText(String text)
	{
		CQt.QMessageBox_SetInformativeText((.)this.Ptr, libqt_string(text));
	}
	public void DetailedText(String outStr)
	{
		CQt.QMessageBox_DetailedText((.)this.Ptr);
	}
	...
	{
		return QPixmap_Ptr(CQt.QMessageBox_StandardIcon(icon));
	}
	...
	{
		CQt.QMessageBox_Tr2(s, c);
	}
	public void Tr3(String outStr, c_char* s, c_char* c, c_int n)
	{
		CQt.QMessageBox_Tr3(s, c, n);
	}
	...
	{
		return CQt.QMessageBox_EventFilter((.)this.Ptr, (.)watched?.ObjectPtr, (.)event?.ObjectPtr);
	}
	...
	{
		CQt.QMessageBox_TimerEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ChildEvent(IQChildEvent event)
	{
		CQt.QMessageBox_ChildEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void CustomEvent(IQEvent event)
	{
		CQt.QMessageBox_CustomEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ConnectNotify(IQMetaMethod signal)
	{
		CQt.QMessageBox_ConnectNotify((.)this.Ptr, (.)signal?.ObjectPtr);
	}
	public void DisconnectNotify(IQMetaMethod signal)
	{
		CQt.QMessageBox_DisconnectNotify((.)this.Ptr, (.)signal?.ObjectPtr);
	}
	...
	{
		return CQt.QMessageBox_DevType((.)this.Ptr);
	}
	...
	{
		return QPaintEngine_Ptr(CQt.QMessageBox_PaintEngine((.)this.Ptr));
	}
	public c_int Width()
	{
	...
	{
		return CQt.QMessageBox_Metric((.)this.Ptr, metric);
	}
	public void InitPainter(IQPainter painter)
	{
		CQt.QMessageBox_InitPainter((.)this.Ptr, (.)painter?.ObjectPtr);
	}
	public QPaintDevice_Ptr Redirected(IQPoint offset)
	{
		return QPaintDevice_Ptr(CQt.QMessageBox_Redirected((.)this.Ptr, (.)offset?.ObjectPtr));
	}
	public QPainter_Ptr SharedPainter()
	{
		return QPainter_Ptr(CQt.QMessageBox_SharedPainter((.)this.Ptr));
	}
	public void* WinId()
	{
	...
	{
		CQt.QMessageBox_SetVisible((.)this.Ptr, visible);
	}
	...
	{
		return QSize_Ptr(CQt.QMessageBox_SizeHint((.)this.Ptr));
	}
	public QSize_Ptr MinimumSizeHint()
	{
		return QSize_Ptr(CQt.QMessageBox_MinimumSizeHint((.)this.Ptr));
	}
	...
	{
		return CQt.QMessageBox_HeightForWidth((.)this.Ptr, param1);
	}
	public bool HasHeightForWidth()
	{
		return CQt.QMessageBox_HasHeightForWidth((.)this.Ptr);
	}
	...
	{
		CQt.QMessageBox_MousePressEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void MouseReleaseEvent(IQMouseEvent event)
	{
		CQt.QMessageBox_MouseReleaseEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void MouseDoubleClickEvent(IQMouseEvent event)
	{
		CQt.QMessageBox_MouseDoubleClickEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void MouseMoveEvent(IQMouseEvent event)
	{
		CQt.QMessageBox_MouseMoveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void WheelEvent(IQWheelEvent event)
	{
		CQt.QMessageBox_WheelEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void KeyReleaseEvent(IQKeyEvent event)
	{
		CQt.QMessageBox_KeyReleaseEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void FocusInEvent(IQFocusEvent event)
	{
		CQt.QMessageBox_FocusInEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void FocusOutEvent(IQFocusEvent event)
	{
		CQt.QMessageBox_FocusOutEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void EnterEvent(IQEnterEvent event)
	{
		CQt.QMessageBox_EnterEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void LeaveEvent(IQEvent event)
	{
		CQt.QMessageBox_LeaveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent event)
	{
		CQt.QMessageBox_PaintEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void MoveEvent(IQMoveEvent event)
	{
		CQt.QMessageBox_MoveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ContextMenuEvent(IQContextMenuEvent event)
	{
		CQt.QMessageBox_ContextMenuEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void TabletEvent(IQTabletEvent event)
	{
		CQt.QMessageBox_TabletEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ActionEvent(IQActionEvent event)
	{
		CQt.QMessageBox_ActionEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void DragEnterEvent(IQDragEnterEvent event)
	{
		CQt.QMessageBox_DragEnterEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void DragMoveEvent(IQDragMoveEvent event)
	{
		CQt.QMessageBox_DragMoveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void DragLeaveEvent(IQDragLeaveEvent event)
	{
		CQt.QMessageBox_DragLeaveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void DropEvent(IQDropEvent event)
	{
		CQt.QMessageBox_DropEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void HideEvent(IQHideEvent event)
	{
		CQt.QMessageBox_HideEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public bool NativeEvent(void** eventType, void* message, void** result)
	{
		return CQt.QMessageBox_NativeEvent((.)this.Ptr, eventType, message, result);
	}
	public void InputMethodEvent(IQInputMethodEvent param1)
	{
		CQt.QMessageBox_InputMethodEvent((.)this.Ptr, (.)param1?.ObjectPtr);
	}
	public QVariant_Ptr InputMethodQuery(Qt_InputMethodQuery param1)
	{
		return QVariant_Ptr(CQt.QMessageBox_InputMethodQuery((.)this.Ptr, param1));
	}
	...
	{
		return CQt.QMessageBox_FocusNextPrevChild((.)this.Ptr, next);
	}
	...
	public void Open()
	{
		CQt.QMessageBox_Open((.)this.Ptr);
	}
	public c_int Exec()
	{
		return CQt.QMessageBox_Exec((.)this.Ptr);
	}
	public void Done(c_int param1)
	{
		CQt.QMessageBox_Done((.)this.Ptr, param1);
	}
	public void Accept()
	{
		CQt.QMessageBox_Accept((.)this.Ptr);
	}
	public void Reject()
	{
		CQt.QMessageBox_Reject((.)this.Ptr);
	}
...
class QMessageBox : IQMessageBox, IQDialog, IQWidget, IQObject, IQPaintDevice
{
	...
	static void QtBf_ConnectSignals(Self obj)
	{
		...
		CQt.QMessageBox_Connect_ButtonClicked(obj.ObjectPtr,  => QtBeef_QMessageBox_Connect_ButtonClicked);
	...
	static void QtBeef_QMessageBox_Connect_ButtonClicked(void* ptr, void** button)
	{
	...
	public void SetDefaultButton(IQPushButton button)
	{
		this.ptr.SetDefaultButton(button);
	}
	public void SetDefaultButton2(QMessageBox_StandardButton button)
	{
		this.ptr.SetDefaultButton2(button);
	}
	public QAbstractButton_Ptr EscapeButton()
	{
		return this.ptr.EscapeButton();
	}
	public void SetEscapeButton(IQAbstractButton button)
	{
		this.ptr.SetEscapeButton(button);
	}
	public void SetEscapeButton2(QMessageBox_StandardButton button)
	{
		this.ptr.SetEscapeButton2(button);
	}
	public QAbstractButton_Ptr ClickedButton()
	{
		return this.ptr.ClickedButton();
	}
	public void Text(String outStr)
	{
	...
	public QPixmap_Ptr IconPixmap()
	{
		return this.ptr.IconPixmap();
	}
	public void SetIconPixmap(IQPixmap pixmap)
	{
		this.ptr.SetIconPixmap(pixmap);
	}
	public Qt_TextFormat TextFormat()
	{
	...
	public void SetCheckBox(IQCheckBox cb)
	{
		this.ptr.SetCheckBox(cb);
	}
	public QCheckBox_Ptr CheckBox()
	{
		return this.ptr.CheckBox();
	}
	public QMessageBox_StandardButton Information(IQWidget parent, String title, String text)
	{
		return this.ptr.Information(parent, title, text);
	}
	public QMessageBox_StandardButton Information2(IQWidget parent, String title, String text, QMessageBox_StandardButton button0)
	{
		return this.ptr.Information2(parent, title, text, button0);
	}
	public QMessageBox_StandardButton Question(IQWidget parent, String title, String text)
	{
		return this.ptr.Question(parent, title, text);
	}
	public c_int Question2(IQWidget parent, String title, String text, QMessageBox_StandardButton button0, QMessageBox_StandardButton button1)
	{
		return this.ptr.Question2(parent, title, text, button0, button1);
	}
	public QMessageBox_StandardButton Warning(IQWidget parent, String title, String text)
	{
		return this.ptr.Warning(parent, title, text);
	}
	public c_int Warning2(IQWidget parent, String title, String text, QMessageBox_StandardButton button0, QMessageBox_StandardButton button1)
	{
		return this.ptr.Warning2(parent, title, text, button0, button1);
	}
	public QMessageBox_StandardButton Critical(IQWidget parent, String title, String text)
	{
		return this.ptr.Critical(parent, title, text);
	}
	public c_int Critical2(IQWidget parent, String title, String text, QMessageBox_StandardButton button0, QMessageBox_StandardButton button1)
	{
		return this.ptr.Critical2(parent, title, text, button0, button1);
	}
	public void About(IQWidget parent, String title, String text)
	{
		this.ptr.About(parent, title, text);
	}
	public void AboutQt(IQWidget parent)
	{
		this.ptr.AboutQt(parent);
	}
	public c_int Information3(IQWidget parent, String title, String text, c_int button0)
	{
		return this.ptr.Information3(parent, title, text, button0);
	}
	public c_int Information4(IQWidget parent, String title, String text, String button0Text)
	{
		return this.ptr.Information4(parent, title, text, button0Text);
	}
	public c_int Question3(IQWidget parent, String title, String text, c_int button0)
	{
		return this.ptr.Question3(parent, title, text, button0);
	}
	public c_int Question4(IQWidget parent, String title, String text, String button0Text)
	{
		return this.ptr.Question4(parent, title, text, button0Text);
	}
	public c_int Warning3(IQWidget parent, String title, String text, c_int button0, c_int button1)
	{
		return this.ptr.Warning3(parent, title, text, button0, button1);
	}
	public c_int Warning4(IQWidget parent, String title, String text, String button0Text)
	{
		return this.ptr.Warning4(parent, title, text, button0Text);
	}
	public c_int Critical3(IQWidget parent, String title, String text, c_int button0, c_int button1)
	{
		return this.ptr.Critical3(parent, title, text, button0, button1);
	}
	public c_int Critical4(IQWidget parent, String title, String text, String button0Text)
	{
		return this.ptr.Critical4(parent, title, text, button0Text);
	}
	public void ButtonText(String outStr, c_int button)
	{
		this.ptr.ButtonText(outStr, button);
	}
	public void SetButtonText(c_int button, String text)
	{
		this.ptr.SetButtonText(button, text);
	}
	public void InformativeText(String outStr)
	{
		this.ptr.InformativeText(outStr);
	}
	public void SetInformativeText(String text)
	{
		this.ptr.SetInformativeText(text);
	}
	public void DetailedText(String outStr)
	{
		this.ptr.DetailedText(outStr);
	}
	public void SetDetailedText(String text)
	{
		this.ptr.SetDetailedText(text);
	}
	public void SetWindowTitle(String title)
	{
	...
	public QPixmap_Ptr StandardIcon(QMessageBox_Icon icon)
	{
		return this.ptr.StandardIcon(icon);
	}
	public void ButtonClicked(IQAbstractButton button)
	{
		this.ptr.ButtonClicked(button);
	}
	...
	public QMessageBox_StandardButton Information42(IQWidget parent, String title, String text, void* buttons)
	{
		return this.ptr.Information42(parent, title, text, buttons);
	}
	public QMessageBox_StandardButton Information5(IQWidget parent, String title, String text, void* buttons, QMessageBox_StandardButton defaultButton)
	{
		return this.ptr.Information5(parent, title, text, buttons, defaultButton);
	}
	public QMessageBox_StandardButton Information52(IQWidget parent, String title, String text, QMessageBox_StandardButton button0, QMessageBox_StandardButton button1)
	{
		return this.ptr.Information52(parent, title, text, button0, button1);
	}
	public QMessageBox_StandardButton Question42(IQWidget parent, String title, String text, void* buttons)
	{
		return this.ptr.Question42(parent, title, text, buttons);
	}
	public QMessageBox_StandardButton Question5(IQWidget parent, String title, String text, void* buttons, QMessageBox_StandardButton defaultButton)
	{
		return this.ptr.Question5(parent, title, text, buttons, defaultButton);
	}
	public QMessageBox_StandardButton Warning42(IQWidget parent, String title, String text, void* buttons)
	{
		return this.ptr.Warning42(parent, title, text, buttons);
	}
	public QMessageBox_StandardButton Warning5(IQWidget parent, String title, String text, void* buttons, QMessageBox_StandardButton defaultButton)
	{
		return this.ptr.Warning5(parent, title, text, buttons, defaultButton);
	}
	public QMessageBox_StandardButton Critical42(IQWidget parent, String title, String text, void* buttons)
	{
		return this.ptr.Critical42(parent, title, text, buttons);
	}
	public QMessageBox_StandardButton Critical5(IQWidget parent, String title, String text, void* buttons, QMessageBox_StandardButton defaultButton)
	{
		return this.ptr.Critical5(parent, title, text, buttons, defaultButton);
	}
	public void AboutQt2(IQWidget parent, String title)
	{
		this.ptr.AboutQt2(parent, title);
	}
	public c_int Information53(IQWidget parent, String title, String text, c_int button0, c_int button1)
	{
		return this.ptr.Information53(parent, title, text, button0, button1);
	}
	public c_int Information6(IQWidget parent, String title, String text, c_int button0, c_int button1, c_int button2)
	{
		return this.ptr.Information6(parent, title, text, button0, button1, button2);
	}
	public c_int Information54(IQWidget parent, String title, String text, String button0Text, String button1Text)
	{
		return this.ptr.Information54(parent, title, text, button0Text, button1Text);
	}
	public c_int Information62(IQWidget parent, String title, String text, String button0Text, String button1Text, String button2Text)
	{
		return this.ptr.Information62(parent, title, text, button0Text, button1Text, button2Text);
	}
	public c_int Information7(IQWidget parent, String title, String text, String button0Text, String button1Text, String button2Text, c_int defaultButtonNumber)
	{
		return this.ptr.Information7(parent, title, text, button0Text, button1Text, button2Text, defaultButtonNumber);
	}
	public c_int Information8(IQWidget parent, String title, String text, String button0Text, String button1Text, String button2Text, c_int defaultButtonNumber, c_int escapeButtonNumber)
	{
		return this.ptr.Information8(parent, title, text, button0Text, button1Text, button2Text, defaultButtonNumber, escapeButtonNumber);
	}
	public c_int Question52(IQWidget parent, String title, String text, c_int button0, c_int button1)
	{
		return this.ptr.Question52(parent, title, text, button0, button1);
	}
	public c_int Question6(IQWidget parent, String title, String text, c_int button0, c_int button1, c_int button2)
	{
		return this.ptr.Question6(parent, title, text, button0, button1, button2);
	}
	public c_int Question53(IQWidget parent, String title, String text, String button0Text, String button1Text)
	{
		return this.ptr.Question53(parent, title, text, button0Text, button1Text);
	}
	public c_int Question62(IQWidget parent, String title, String text, String button0Text, String button1Text, String button2Text)
	{
		return this.ptr.Question62(parent, title, text, button0Text, button1Text, button2Text);
	}
	public c_int Question7(IQWidget parent, String title, String text, String button0Text, String button1Text, String button2Text, c_int defaultButtonNumber)
	{
		return this.ptr.Question7(parent, title, text, button0Text, button1Text, button2Text, defaultButtonNumber);
	}
	public c_int Question8(IQWidget parent, String title, String text, String button0Text, String button1Text, String button2Text, c_int defaultButtonNumber, c_int escapeButtonNumber)
	{
		return this.ptr.Question8(parent, title, text, button0Text, button1Text, button2Text, defaultButtonNumber, escapeButtonNumber);
	}
	public c_int Warning6(IQWidget parent, String title, String text, c_int button0, c_int button1, c_int button2)
	{
		return this.ptr.Warning6(parent, title, text, button0, button1, button2);
	}
	public c_int Warning52(IQWidget parent, String title, String text, String button0Text, String button1Text)
	{
		return this.ptr.Warning52(parent, title, text, button0Text, button1Text);
	}
	public c_int Warning62(IQWidget parent, String title, String text, String button0Text, String button1Text, String button2Text)
	{
		return this.ptr.Warning62(parent, title, text, button0Text, button1Text, button2Text);
	}
	public c_int Warning7(IQWidget parent, String title, String text, String button0Text, String button1Text, String button2Text, c_int defaultButtonNumber)
	{
		return this.ptr.Warning7(parent, title, text, button0Text, button1Text, button2Text, defaultButtonNumber);
	}
	public c_int Warning8(IQWidget parent, String title, String text, String button0Text, String button1Text, String button2Text, c_int defaultButtonNumber, c_int escapeButtonNumber)
	{
		return this.ptr.Warning8(parent, title, text, button0Text, button1Text, button2Text, defaultButtonNumber, escapeButtonNumber);
	}
	public c_int Critical6(IQWidget parent, String title, String text, c_int button0, c_int button1, c_int button2)
	{
		return this.ptr.Critical6(parent, title, text, button0, button1, button2);
	}
	public c_int Critical52(IQWidget parent, String title, String text, String button0Text, String button1Text)
	{
		return this.ptr.Critical52(parent, title, text, button0Text, button1Text);
	}
	public c_int Critical62(IQWidget parent, String title, String text, String button0Text, String button1Text, String button2Text)
	{
		return this.ptr.Critical62(parent, title, text, button0Text, button1Text, button2Text);
	}
	public c_int Critical7(IQWidget parent, String title, String text, String button0Text, String button1Text, String button2Text, c_int defaultButtonNumber)
	{
		return this.ptr.Critical7(parent, title, text, button0Text, button1Text, button2Text, defaultButtonNumber);
	}
	public c_int Critical8(IQWidget parent, String title, String text, String button0Text, String button1Text, String button2Text, c_int defaultButtonNumber, c_int escapeButtonNumber)
	{
		return this.ptr.Critical8(parent, title, text, button0Text, button1Text, button2Text, defaultButtonNumber, escapeButtonNumber);
	}
...
extension CQt
{
	...
	public static extern QMessageBox_Ptr QMessageBox_new(void** parent);
	...
	public static extern QMessageBox_Ptr QMessageBox_new6(QMessageBox_Icon icon, libqt_string title, libqt_string text, void* buttons, void** parent);
	[LinkName("QMessageBox_new7")]
	public static extern QMessageBox_Ptr QMessageBox_new7(QMessageBox_Icon icon, libqt_string title, libqt_string text, void* buttons, void** parent, void* flags);
	[LinkName("QMessageBox_new8")]
	public static extern QMessageBox_Ptr QMessageBox_new8(libqt_string title, libqt_string text, QMessageBox_Icon icon, c_int button0, c_int button1, c_int button2, void** parent);
	[LinkName("QMessageBox_new9")]
	public static extern QMessageBox_Ptr QMessageBox_new9(libqt_string title, libqt_string text, QMessageBox_Icon icon, c_int button0, c_int button1, c_int button2, void** parent, void* f);
	...
	public static extern void** QMessageBox_MetaObject(void* self);
	...
	public static extern void QMessageBox_AddButton(void* self, void** button, QMessageBox_ButtonRole role);
	[LinkName("QMessageBox_AddButton2")]
	public static extern void** QMessageBox_AddButton2(void* self, libqt_string text, QMessageBox_ButtonRole role);
	[LinkName("QMessageBox_AddButton3")]
	public static extern void** QMessageBox_AddButton3(void* self, QMessageBox_StandardButton button);
	[LinkName("QMessageBox_RemoveButton")]
	public static extern void QMessageBox_RemoveButton(void* self, void** button);
	[LinkName("QMessageBox_Buttons")]
	public static extern void* QMessageBox_Buttons(void* self);
	[LinkName("QMessageBox_ButtonRole")]
	public static extern QMessageBox_ButtonRole QMessageBox_ButtonRole(void* self, void** button);
	[LinkName("QMessageBox_SetStandardButtons")]
	public static extern void QMessageBox_SetStandardButtons(void* self, void* buttons);
	[LinkName("QMessageBox_StandardButtons")]
	public static extern void* QMessageBox_StandardButtons(void* self);
	[LinkName("QMessageBox_StandardButton")]
	public static extern QMessageBox_StandardButton QMessageBox_StandardButton(void* self, void** button);
	[LinkName("QMessageBox_Button")]
	public static extern void** QMessageBox_Button(void* self, QMessageBox_StandardButton which);
	[LinkName("QMessageBox_DefaultButton")]
	public static extern void** QMessageBox_DefaultButton(void* self);
	[LinkName("QMessageBox_SetDefaultButton")]
	public static extern void QMessageBox_SetDefaultButton(void* self, void** button);
	[LinkName("QMessageBox_SetDefaultButton2")]
	public static extern void QMessageBox_SetDefaultButton2(void* self, QMessageBox_StandardButton button);
	[LinkName("QMessageBox_EscapeButton")]
	public static extern void** QMessageBox_EscapeButton(void* self);
	[LinkName("QMessageBox_SetEscapeButton")]
	public static extern void QMessageBox_SetEscapeButton(void* self, void** button);
	[LinkName("QMessageBox_SetEscapeButton2")]
	public static extern void QMessageBox_SetEscapeButton2(void* self, QMessageBox_StandardButton button);
	[LinkName("QMessageBox_ClickedButton")]
	public static extern void** QMessageBox_ClickedButton(void* self);
	[LinkName("QMessageBox_Text")]
	public static extern libqt_string QMessageBox_Text(void* self);
	[LinkName("QMessageBox_SetText")]
	public static extern void QMessageBox_SetText(void* self, libqt_string text);
	[LinkName("QMessageBox_Icon")]
	public static extern QMessageBox_Icon QMessageBox_Icon(void* self);
	[LinkName("QMessageBox_SetIcon")]
	public static extern void QMessageBox_SetIcon(void* self, QMessageBox_Icon icon);
	[LinkName("QMessageBox_IconPixmap")]
	public static extern void* QMessageBox_IconPixmap(void* self);
	[LinkName("QMessageBox_SetIconPixmap")]
	public static extern void QMessageBox_SetIconPixmap(void* self, void** pixmap);
	[LinkName("QMessageBox_TextFormat")]
	public static extern Qt_TextFormat QMessageBox_TextFormat(void* self);
	[LinkName("QMessageBox_SetTextFormat")]
	public static extern void QMessageBox_SetTextFormat(void* self, Qt_TextFormat format);
	[LinkName("QMessageBox_SetTextInteractionFlags")]
	public static extern void QMessageBox_SetTextInteractionFlags(void* self, void* flags);
	[LinkName("QMessageBox_TextInteractionFlags")]
	public static extern void* QMessageBox_TextInteractionFlags(void* self);
	[LinkName("QMessageBox_SetCheckBox")]
	public static extern void QMessageBox_SetCheckBox(void* self, void** cb);
	[LinkName("QMessageBox_CheckBox")]
	public static extern void** QMessageBox_CheckBox(void* self);
	[LinkName("QMessageBox_Information")]
	public static extern QMessageBox_StandardButton QMessageBox_Information(void** parent, libqt_string title, libqt_string text);
	[LinkName("QMessageBox_Information2")]
	public static extern QMessageBox_StandardButton QMessageBox_Information2(void** parent, libqt_string title, libqt_string text, QMessageBox_StandardButton button0);
	[LinkName("QMessageBox_Question")]
	public static extern QMessageBox_StandardButton QMessageBox_Question(void** parent, libqt_string title, libqt_string text);
	[LinkName("QMessageBox_Question2")]
	public static extern c_int QMessageBox_Question2(void** parent, libqt_string title, libqt_string text, QMessageBox_StandardButton button0, QMessageBox_StandardButton button1);
	[LinkName("QMessageBox_Warning")]
	public static extern QMessageBox_StandardButton QMessageBox_Warning(void** parent, libqt_string title, libqt_string text);
	[LinkName("QMessageBox_Warning2")]
	public static extern c_int QMessageBox_Warning2(void** parent, libqt_string title, libqt_string text, QMessageBox_StandardButton button0, QMessageBox_StandardButton button1);
	[LinkName("QMessageBox_Critical")]
	public static extern QMessageBox_StandardButton QMessageBox_Critical(void** parent, libqt_string title, libqt_string text);
	[LinkName("QMessageBox_Critical2")]
	public static extern c_int QMessageBox_Critical2(void** parent, libqt_string title, libqt_string text, QMessageBox_StandardButton button0, QMessageBox_StandardButton button1);
	...
	public static extern c_int QMessageBox_Information3(void** parent, libqt_string title, libqt_string text, c_int button0);
	[LinkName("QMessageBox_Information4")]
	public static extern c_int QMessageBox_Information4(void** parent, libqt_string title, libqt_string text, libqt_string button0Text);
	[LinkName("QMessageBox_Question3")]
	public static extern c_int QMessageBox_Question3(void** parent, libqt_string title, libqt_string text, c_int button0);
	[LinkName("QMessageBox_Question4")]
	public static extern c_int QMessageBox_Question4(void** parent, libqt_string title, libqt_string text, libqt_string button0Text);
	[LinkName("QMessageBox_Warning3")]
	public static extern c_int QMessageBox_Warning3(void** parent, libqt_string title, libqt_string text, c_int button0, c_int button1);
	[LinkName("QMessageBox_Warning4")]
	public static extern c_int QMessageBox_Warning4(void** parent, libqt_string title, libqt_string text, libqt_string button0Text);
	[LinkName("QMessageBox_Critical3")]
	public static extern c_int QMessageBox_Critical3(void** parent, libqt_string title, libqt_string text, c_int button0, c_int button1);
	[LinkName("QMessageBox_Critical4")]
	public static extern c_int QMessageBox_Critical4(void** parent, libqt_string title, libqt_string text, libqt_string button0Text);
	[LinkName("QMessageBox_ButtonText")]
	public static extern libqt_string QMessageBox_ButtonText(void* self, c_int button);
	[LinkName("QMessageBox_SetButtonText")]
	public static extern void QMessageBox_SetButtonText(void* self, c_int button, libqt_string text);
	[LinkName("QMessageBox_InformativeText")]
	public static extern libqt_string QMessageBox_InformativeText(void* self);
	[LinkName("QMessageBox_SetInformativeText")]
	public static extern void QMessageBox_SetInformativeText(void* self, libqt_string text);
	[LinkName("QMessageBox_DetailedText")]
	public static extern libqt_string QMessageBox_DetailedText(void* self);
	[LinkName("QMessageBox_SetDetailedText")]
	public static extern void QMessageBox_SetDetailedText(void* self, libqt_string text);
	[LinkName("QMessageBox_SetWindowTitle")]
	public static extern void QMessageBox_SetWindowTitle(void* self, libqt_string title);
	[LinkName("QMessageBox_SetWindowModality")]
	public static extern void QMessageBox_SetWindowModality(void* self, Qt_WindowModality windowModality);
	...
	public function void QMessageBox_Connect_ButtonClicked_action(void* self, void** button);
	[LinkName("QMessageBox_Connect_ButtonClicked")]
	public static extern void QMessageBox_Connect_ButtonClicked(void* self, QMessageBox_Connect_ButtonClicked_action _action);
	...
	public static extern QMessageBox_StandardButton QMessageBox_Information42(void** parent, libqt_string title, libqt_string text, void* buttons);
	[LinkName("QMessageBox_Information5")]
	public static extern QMessageBox_StandardButton QMessageBox_Information5(void** parent, libqt_string title, libqt_string text, void* buttons, QMessageBox_StandardButton defaultButton);
	[LinkName("QMessageBox_Information52")]
	public static extern QMessageBox_StandardButton QMessageBox_Information52(void** parent, libqt_string title, libqt_string text, QMessageBox_StandardButton button0, QMessageBox_StandardButton button1);
	[LinkName("QMessageBox_Question42")]
	public static extern QMessageBox_StandardButton QMessageBox_Question42(void** parent, libqt_string title, libqt_string text, void* buttons);
	[LinkName("QMessageBox_Question5")]
	public static extern QMessageBox_StandardButton QMessageBox_Question5(void** parent, libqt_string title, libqt_string text, void* buttons, QMessageBox_StandardButton defaultButton);
	[LinkName("QMessageBox_Warning42")]
	public static extern QMessageBox_StandardButton QMessageBox_Warning42(void** parent, libqt_string title, libqt_string text, void* buttons);
	[LinkName("QMessageBox_Warning5")]
	public static extern QMessageBox_StandardButton QMessageBox_Warning5(void** parent, libqt_string title, libqt_string text, void* buttons, QMessageBox_StandardButton defaultButton);
	[LinkName("QMessageBox_Critical42")]
	public static extern QMessageBox_StandardButton QMessageBox_Critical42(void** parent, libqt_string title, libqt_string text, void* buttons);
	[LinkName("QMessageBox_Critical5")]
	public static extern QMessageBox_StandardButton QMessageBox_Critical5(void** parent, libqt_string title, libqt_string text, void* buttons, QMessageBox_StandardButton defaultButton);
	...
	public static extern c_int QMessageBox_Information53(void** parent, libqt_string title, libqt_string text, c_int button0, c_int button1);
	[LinkName("QMessageBox_Information6")]
	public static extern c_int QMessageBox_Information6(void** parent, libqt_string title, libqt_string text, c_int button0, c_int button1, c_int button2);
	[LinkName("QMessageBox_Information54")]
	public static extern c_int QMessageBox_Information54(void** parent, libqt_string title, libqt_string text, libqt_string button0Text, libqt_string button1Text);
	[LinkName("QMessageBox_Information62")]
	public static extern c_int QMessageBox_Information62(void** parent, libqt_string title, libqt_string text, libqt_string button0Text, libqt_string button1Text, libqt_string button2Text);
	[LinkName("QMessageBox_Information7")]
	public static extern c_int QMessageBox_Information7(void** parent, libqt_string title, libqt_string text, libqt_string button0Text, libqt_string button1Text, libqt_string button2Text, c_int defaultButtonNumber);
	[LinkName("QMessageBox_Information8")]
	public static extern c_int QMessageBox_Information8(void** parent, libqt_string title, libqt_string text, libqt_string button0Text, libqt_string button1Text, libqt_string button2Text, c_int defaultButtonNumber, c_int escapeButtonNumber);
	[LinkName("QMessageBox_Question52")]
	public static extern c_int QMessageBox_Question52(void** parent, libqt_string title, libqt_string text, c_int button0, c_int button1);
	[LinkName("QMessageBox_Question6")]
	public static extern c_int QMessageBox_Question6(void** parent, libqt_string title, libqt_string text, c_int button0, c_int button1, c_int button2);
	[LinkName("QMessageBox_Question53")]
	public static extern c_int QMessageBox_Question53(void** parent, libqt_string title, libqt_string text, libqt_string button0Text, libqt_string button1Text);
	[LinkName("QMessageBox_Question62")]
	public static extern c_int QMessageBox_Question62(void** parent, libqt_string title, libqt_string text, libqt_string button0Text, libqt_string button1Text, libqt_string button2Text);
	[LinkName("QMessageBox_Question7")]
	public static extern c_int QMessageBox_Question7(void** parent, libqt_string title, libqt_string text, libqt_string button0Text, libqt_string button1Text, libqt_string button2Text, c_int defaultButtonNumber);
	[LinkName("QMessageBox_Question8")]
	public static extern c_int QMessageBox_Question8(void** parent, libqt_string title, libqt_string text, libqt_string button0Text, libqt_string button1Text, libqt_string button2Text, c_int defaultButtonNumber, c_int escapeButtonNumber);
	[LinkName("QMessageBox_Warning6")]
	public static extern c_int QMessageBox_Warning6(void** parent, libqt_string title, libqt_string text, c_int button0, c_int button1, c_int button2);
	[LinkName("QMessageBox_Warning52")]
	public static extern c_int QMessageBox_Warning52(void** parent, libqt_string title, libqt_string text, libqt_string button0Text, libqt_string button1Text);
	[LinkName("QMessageBox_Warning62")]
	public static extern c_int QMessageBox_Warning62(void** parent, libqt_string title, libqt_string text, libqt_string button0Text, libqt_string button1Text, libqt_string button2Text);
	[LinkName("QMessageBox_Warning7")]
	public static extern c_int QMessageBox_Warning7(void** parent, libqt_string title, libqt_string text, libqt_string button0Text, libqt_string button1Text, libqt_string button2Text, c_int defaultButtonNumber);
	[LinkName("QMessageBox_Warning8")]
	public static extern c_int QMessageBox_Warning8(void** parent, libqt_string title, libqt_string text, libqt_string button0Text, libqt_string button1Text, libqt_string button2Text, c_int defaultButtonNumber, c_int escapeButtonNumber);
	[LinkName("QMessageBox_Critical6")]
	public static extern c_int QMessageBox_Critical6(void** parent, libqt_string title, libqt_string text, c_int button0, c_int button1, c_int button2);
	[LinkName("QMessageBox_Critical52")]
	public static extern c_int QMessageBox_Critical52(void** parent, libqt_string title, libqt_string text, libqt_string button0Text, libqt_string button1Text);
	[LinkName("QMessageBox_Critical62")]
	public static extern c_int QMessageBox_Critical62(void** parent, libqt_string title, libqt_string text, libqt_string button0Text, libqt_string button1Text, libqt_string button2Text);
	[LinkName("QMessageBox_Critical7")]
	public static extern c_int QMessageBox_Critical7(void** parent, libqt_string title, libqt_string text, libqt_string button0Text, libqt_string button1Text, libqt_string button2Text, c_int defaultButtonNumber);
	[LinkName("QMessageBox_Critical8")]
	public static extern c_int QMessageBox_Critical8(void** parent, libqt_string title, libqt_string text, libqt_string button0Text, libqt_string button1Text, libqt_string button2Text, c_int defaultButtonNumber, c_int escapeButtonNumber);
	[LinkName("QMessageBox_EventFilter")]
	public static extern bool QMessageBox_EventFilter(void* self, void** watched, void** event);
