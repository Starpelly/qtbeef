...
class QOffscreenSurface : IQOffscreenSurface, IQObject, IQSurface
{
	...
	{
		return QMetaObject_Ptr(CQt.QOffscreenSurface_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QOffscreenSurface_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QOffscreenSurface_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return CQt.QOffscreenSurface_SurfaceType((.)this.ptr.Ptr);
	}
	public void Create()
	{
		CQt.QOffscreenSurface_Create((.)this.ptr.Ptr);
	}
	public void Destroy()
	{
		CQt.QOffscreenSurface_Destroy((.)this.ptr.Ptr);
	}
	public bool IsValid()
	{
		return CQt.QOffscreenSurface_IsValid((.)this.ptr.Ptr);
	}
	public void SetFormat(IQSurfaceFormat format)
	{
		CQt.QOffscreenSurface_SetFormat((.)this.ptr.Ptr, (.)format?.ObjectPtr);
	}
	public QSurfaceFormat_Ptr Format()
	{
		return QSurfaceFormat_Ptr(CQt.QOffscreenSurface_Format((.)this.ptr.Ptr));
	}
	public QSurfaceFormat_Ptr RequestedFormat()
	{
		return QSurfaceFormat_Ptr(CQt.QOffscreenSurface_RequestedFormat((.)this.ptr.Ptr));
	}
	public QSize_Ptr Size()
	{
		return QSize_Ptr(CQt.QOffscreenSurface_Size((.)this.ptr.Ptr));
	}
	public QScreen_Ptr Screen()
	{
		return QScreen_Ptr(CQt.QOffscreenSurface_Screen((.)this.ptr.Ptr));
	}
	public void SetScreen(IQScreen screen)
	{
		CQt.QOffscreenSurface_SetScreen((.)this.ptr.Ptr, (.)screen?.ObjectPtr);
	}
	public void* ResolveInterface(c_char* name, c_int revision)
	{
		return CQt.QOffscreenSurface_ResolveInterface((.)this.ptr.Ptr, name, revision);
	}
	public void ScreenChanged(IQScreen screen)
	{
		CQt.QOffscreenSurface_ScreenChanged((.)this.ptr.Ptr, (.)screen?.ObjectPtr);
	}
