...
struct QSystemTrayIcon_Ptr
{
	...
	{
		return QMetaObject_Ptr(CQt.QSystemTrayIcon_MetaObject((.)this.Ptr));
	}
	...
	{
		return QMenu_Ptr(CQt.QSystemTrayIcon_ContextMenu((.)this.Ptr));
	}
	public QIcon_Ptr Icon()
	{
		return QIcon_Ptr(CQt.QSystemTrayIcon_Icon((.)this.Ptr));
	}
	...
	{
		CQt.QSystemTrayIcon_ToolTip((.)this.Ptr);
	}
	...
	{
		return QRect_Ptr(CQt.QSystemTrayIcon_Geometry((.)this.Ptr));
	}
	...
	{
		return CQt.QSystemTrayIcon_EventFilter((.)this.Ptr, (.)watched?.ObjectPtr, (.)event?.ObjectPtr);
	}
	...
	{
		CQt.QSystemTrayIcon_TimerEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ChildEvent(IQChildEvent event)
	{
		CQt.QSystemTrayIcon_ChildEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void CustomEvent(IQEvent event)
	{
		CQt.QSystemTrayIcon_CustomEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ConnectNotify(IQMetaMethod signal)
	{
		CQt.QSystemTrayIcon_ConnectNotify((.)this.Ptr, (.)signal?.ObjectPtr);
	}
	public void DisconnectNotify(IQMetaMethod signal)
	{
		CQt.QSystemTrayIcon_DisconnectNotify((.)this.Ptr, (.)signal?.ObjectPtr);
	}
...
class QSystemTrayIcon : IQSystemTrayIcon, IQObject
{
	...
	static void QtBf_ConnectSignals(Self obj)
	{
		...
		CQt.QSystemTrayIcon_Connect_Activated(obj.ObjectPtr,  => QtBeef_QSystemTrayIcon_Connect_Activated);
	...
	static void QtBeef_QSystemTrayIcon_Connect_Activated(void* ptr, QSystemTrayIcon_ActivationReason reason)
	{
		let obj = CQt.ObjectHandleMap[ptr] as Self;
		obj.OnActivated.Invoke(reason);
	}
	static void QtBeef_QSystemTrayIcon_Connect_MessageClicked(void* ptr)
	{
		let obj = CQt.ObjectHandleMap[ptr] as Self;
	...
	public void SetContextMenu(IQMenu menu)
	{
		this.ptr.SetContextMenu(menu);
	}
	public QMenu_Ptr ContextMenu()
	{
		return this.ptr.ContextMenu();
	}
	public QIcon_Ptr Icon()
	{
	...
	public bool IsSystemTrayAvailable()
	{
		return this.ptr.IsSystemTrayAvailable();
	}
	public bool SupportsMessages()
	{
		return this.ptr.SupportsMessages();
	}
	public QRect_Ptr Geometry()
	{
	...
	public void ShowMessage(String title, String msg, IQIcon icon)
	{
		this.ptr.ShowMessage(title, msg, icon);
	}
	public void ShowMessage2(String title, String msg)
	{
		this.ptr.ShowMessage2(title, msg);
	}
	public void Activated(QSystemTrayIcon_ActivationReason reason)
	{
		this.ptr.Activated(reason);
	}
	public void MessageClicked()
	{
		this.ptr.MessageClicked();
	}
	...
	public void ShowMessage4(String title, String msg, IQIcon icon, c_int msecs)
	{
		this.ptr.ShowMessage4(title, msg, icon, msecs);
	}
	public void ShowMessage3(String title, String msg, QSystemTrayIcon_MessageIcon icon)
	{
		this.ptr.ShowMessage3(title, msg, icon);
	}
	public void ShowMessage42(String title, String msg, QSystemTrayIcon_MessageIcon icon, c_int msecs)
	{
		this.ptr.ShowMessage42(title, msg, icon, msecs);
	}
...
extension CQt
{
	...
	public function void QSystemTrayIcon_Connect_Activated_action(void* self, QSystemTrayIcon_ActivationReason reason);
	[LinkName("QSystemTrayIcon_Connect_Activated")]
	public static extern void QSystemTrayIcon_Connect_Activated(void* self, QSystemTrayIcon_Connect_Activated_action _action);
	[LinkName("QSystemTrayIcon_MessageClicked")]
	public static extern void QSystemTrayIcon_MessageClicked(void* self);
	
	public function void QSystemTrayIcon_Connect_MessageClicked_action(void* self);
	[LinkName("QSystemTrayIcon_Connect_MessageClicked")]
	public static extern void QSystemTrayIcon_Connect_MessageClicked(void* self, QSystemTrayIcon_Connect_MessageClicked_action _action);
	...
	[LinkName("QSystemTrayIcon_EventFilter")]
	public static extern bool QSystemTrayIcon_EventFilter(void* self, void** watched, void** event);
