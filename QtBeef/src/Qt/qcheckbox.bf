...
class QCheckBox : IQCheckBox, IQAbstractButton, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QCheckBox_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QCheckBox_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QCheckBox_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return QSize_Ptr(CQt.QCheckBox_SizeHint((.)this.ptr.Ptr));
	}
	public QSize_Ptr MinimumSizeHint()
	{
		return QSize_Ptr(CQt.QCheckBox_MinimumSizeHint((.)this.ptr.Ptr));
	}
	public void SetTristate()
	{
		CQt.QCheckBox_SetTristate((.)this.ptr.Ptr);
	}
	public bool IsTristate()
	{
		return CQt.QCheckBox_IsTristate((.)this.ptr.Ptr);
	}
	public Qt_CheckState CheckState()
	{
		return CQt.QCheckBox_CheckState((.)this.ptr.Ptr);
	}
	public void SetCheckState(Qt_CheckState state)
	{
		CQt.QCheckBox_SetCheckState((.)this.ptr.Ptr, state);
	}
	public void StateChanged(c_int param1)
	{
		CQt.QCheckBox_StateChanged((.)this.ptr.Ptr, param1);
	}
	public bool Event(IQEvent e)
	{
		return CQt.QCheckBox_Event((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public bool HitButton(IQPoint pos)
	{
		return CQt.QCheckBox_HitButton((.)this.ptr.Ptr, (.)pos?.ObjectPtr);
	}
	public void CheckStateSet()
	{
		CQt.QCheckBox_CheckStateSet((.)this.ptr.Ptr);
	}
	public void NextCheckState()
	{
		CQt.QCheckBox_NextCheckState((.)this.ptr.Ptr);
	}
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QCheckBox_PaintEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void MouseMoveEvent(IQMouseEvent param1)
	{
		CQt.QCheckBox_MouseMoveEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void InitStyleOption(IQStyleOptionButton option)
	{
		CQt.QCheckBox_InitStyleOption((.)this.ptr.Ptr, (.)option?.ObjectPtr);
	}
	...
	{
		CQt.QCheckBox_SetTristate1((.)this.ptr.Ptr, y);
	}
