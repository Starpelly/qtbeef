...
class QRubberBand : IQRubberBand, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QRubberBand_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QRubberBand_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QRubberBand_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return CQt.QRubberBand_Shape((.)this.ptr.Ptr);
	}
	public void SetGeometry(IQRect r)
	{
		CQt.QRubberBand_SetGeometry((.)this.ptr.Ptr, (.)r?.ObjectPtr);
	}
	public void SetGeometry2(c_int x, c_int y, c_int w, c_int h)
	{
		CQt.QRubberBand_SetGeometry2((.)this.ptr.Ptr, x, y, w, h);
	}
	public void Move(c_int x, c_int y)
	{
		CQt.QRubberBand_Move((.)this.ptr.Ptr, x, y);
	}
	public void Move2(IQPoint p)
	{
		CQt.QRubberBand_Move2((.)this.ptr.Ptr, (.)p?.ObjectPtr);
	}
	public void Resize(c_int w, c_int h)
	{
		CQt.QRubberBand_Resize((.)this.ptr.Ptr, w, h);
	}
	public void Resize2(IQSize s)
	{
		CQt.QRubberBand_Resize2((.)this.ptr.Ptr, (.)s?.ObjectPtr);
	}
	public bool Event(IQEvent e)
	{
		return CQt.QRubberBand_Event((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QRubberBand_PaintEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void ChangeEvent(IQEvent param1)
	{
		CQt.QRubberBand_ChangeEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void ShowEvent(IQShowEvent param1)
	{
		CQt.QRubberBand_ShowEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void ResizeEvent(IQResizeEvent param1)
	{
		CQt.QRubberBand_ResizeEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void MoveEvent(IQMoveEvent param1)
	{
		CQt.QRubberBand_MoveEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void InitStyleOption(IQStyleOptionRubberBand option)
	{
		CQt.QRubberBand_InitStyleOption((.)this.ptr.Ptr, (.)option?.ObjectPtr);
	}
