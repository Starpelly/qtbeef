...
class QObjectCleanupHandler : IQObjectCleanupHandler, IQObject
{
	...
	{
		return QMetaObject_Ptr(CQt.QObjectCleanupHandler_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QObjectCleanupHandler_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QObjectCleanupHandler_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return QObject_Ptr(CQt.QObjectCleanupHandler_Add((.)this.ptr.Ptr, (.)object?.ObjectPtr));
	}
	public void Remove(IQObject object)
	{
		CQt.QObjectCleanupHandler_Remove((.)this.ptr.Ptr, (.)object?.ObjectPtr);
	}
	public bool IsEmpty()
	{
		return CQt.QObjectCleanupHandler_IsEmpty((.)this.ptr.Ptr);
	}
	public void Clear()
	{
		CQt.QObjectCleanupHandler_Clear((.)this.ptr.Ptr);
	}
