...
class QJsonObject : IQJsonObject
{
	...
	{
		CQt.QJsonObject_Swap((.)this.ptr.Ptr, (.)other?.ObjectPtr);
	}
	...
	{
		return CQt.QJsonObject_ToVariantMap((.)this.ptr.Ptr);
	}
	...
	{
		return CQt.QJsonObject_ToVariantHash((.)this.ptr.Ptr);
	}
	public void* Keys()
	{
		return CQt.QJsonObject_Keys((.)this.ptr.Ptr);
	}
	public void* Size()
	{
		return CQt.QJsonObject_Size((.)this.ptr.Ptr);
	}
	public void* Count()
	{
		return CQt.QJsonObject_Count((.)this.ptr.Ptr);
	}
	public void* Length()
	{
		return CQt.QJsonObject_Length((.)this.ptr.Ptr);
	}
	public bool IsEmpty()
	{
		return CQt.QJsonObject_IsEmpty((.)this.ptr.Ptr);
	}
	public QJsonValue_Ptr Value(String key)
	{
		return QJsonValue_Ptr(CQt.QJsonObject_Value((.)this.ptr.Ptr, libqt_string(key)));
	}
	public QJsonValueRef_Ptr OperatorSubscript2(String key)
	{
		return QJsonValueRef_Ptr(CQt.QJsonObject_OperatorSubscript2((.)this.ptr.Ptr, libqt_string(key)));
	}
	public void Remove(String key)
	{
		CQt.QJsonObject_Remove((.)this.ptr.Ptr, libqt_string(key));
	}
	public QJsonValue_Ptr Take(String key)
	{
		return QJsonValue_Ptr(CQt.QJsonObject_Take((.)this.ptr.Ptr, libqt_string(key)));
	}
	public bool Contains(String key)
	{
		return CQt.QJsonObject_Contains((.)this.ptr.Ptr, libqt_string(key));
	}
	public QJsonObject_iterator_Ptr Begin()
	{
		return QJsonObject_iterator_Ptr(CQt.QJsonObject_Begin((.)this.ptr.Ptr));
	}
	public QJsonObject_const_iterator_Ptr Begin2()
	{
		return QJsonObject_const_iterator_Ptr(CQt.QJsonObject_Begin2((.)this.ptr.Ptr));
	}
	public QJsonObject_const_iterator_Ptr ConstBegin()
	{
		return QJsonObject_const_iterator_Ptr(CQt.QJsonObject_ConstBegin((.)this.ptr.Ptr));
	}
	public QJsonObject_iterator_Ptr End()
	{
		return QJsonObject_iterator_Ptr(CQt.QJsonObject_End((.)this.ptr.Ptr));
	}
	public QJsonObject_const_iterator_Ptr End2()
	{
		return QJsonObject_const_iterator_Ptr(CQt.QJsonObject_End2((.)this.ptr.Ptr));
	}
	public QJsonObject_const_iterator_Ptr ConstEnd()
	{
		return QJsonObject_const_iterator_Ptr(CQt.QJsonObject_ConstEnd((.)this.ptr.Ptr));
	}
	public QJsonObject_iterator_Ptr Erase(IQJsonObject_iterator it)
	{
		return QJsonObject_iterator_Ptr(CQt.QJsonObject_Erase((.)this.ptr.Ptr, (.)it?.ObjectPtr));
	}
	public QJsonObject_iterator_Ptr Find(String key)
	{
		return QJsonObject_iterator_Ptr(CQt.QJsonObject_Find((.)this.ptr.Ptr, libqt_string(key)));
	}
	public QJsonObject_const_iterator_Ptr Find2(String key)
	{
		return QJsonObject_const_iterator_Ptr(CQt.QJsonObject_Find2((.)this.ptr.Ptr, libqt_string(key)));
	}
	public QJsonObject_const_iterator_Ptr ConstFind(String key)
	{
		return QJsonObject_const_iterator_Ptr(CQt.QJsonObject_ConstFind((.)this.ptr.Ptr, libqt_string(key)));
	}
	public QJsonObject_iterator_Ptr Insert(String key, IQJsonValue value)
	{
		return QJsonObject_iterator_Ptr(CQt.QJsonObject_Insert((.)this.ptr.Ptr, libqt_string(key), (.)value?.ObjectPtr));
	}
	public bool Empty()
	{
		return CQt.QJsonObject_Empty((.)this.ptr.Ptr);
	}
}
...
class QJsonObject_iterator : IQJsonObject_iterator
{
	...
	{
		CQt.QJsonObject_Iterator_Key((.)this.ptr.Ptr);
	}
	public QJsonValueRef_Ptr Value()
	{
		return QJsonValueRef_Ptr(CQt.QJsonObject_Iterator_Value((.)this.ptr.Ptr));
	}
	public QJsonValueRef_Ptr OperatorMinusGreater2()
	{
		return QJsonValueRef_Ptr(CQt.QJsonObject_Iterator_OperatorMinusGreater2((.)this.ptr.Ptr));
	}
	public QJsonObject_iterator_Ptr OperatorPlusPlus2(c_int param1)
	{
		return QJsonObject_iterator_Ptr(CQt.QJsonObject_Iterator_OperatorPlusPlus2((.)this.ptr.Ptr, param1));
	}
	public QJsonObject_iterator_Ptr OperatorMinusMinus2(c_int param1)
	{
		return QJsonObject_iterator_Ptr(CQt.QJsonObject_Iterator_OperatorMinusMinus2((.)this.ptr.Ptr, param1));
	}
	public void* OperatorMinus2(IQJsonObject_iterator j)
	{
		return CQt.QJsonObject_Iterator_OperatorMinus2((.)this.ptr.Ptr, (.)j?.ObjectPtr);
	}
	public bool OperatorEqual2(IQJsonObject_const_iterator other)
	{
		return CQt.QJsonObject_Iterator_OperatorEqual2((.)this.ptr.Ptr, (.)other?.ObjectPtr);
	}
	public bool OperatorNotEqual2(IQJsonObject_const_iterator other)
	{
		return CQt.QJsonObject_Iterator_OperatorNotEqual2((.)this.ptr.Ptr, (.)other?.ObjectPtr);
	}
	public bool OperatorLesser2(IQJsonObject_const_iterator other)
	{
		return CQt.QJsonObject_Iterator_OperatorLesser2((.)this.ptr.Ptr, (.)other?.ObjectPtr);
	}
	public bool OperatorLesserOrEqual2(IQJsonObject_const_iterator other)
	{
		return CQt.QJsonObject_Iterator_OperatorLesserOrEqual2((.)this.ptr.Ptr, (.)other?.ObjectPtr);
	}
	public bool OperatorGreater2(IQJsonObject_const_iterator other)
	{
		return CQt.QJsonObject_Iterator_OperatorGreater2((.)this.ptr.Ptr, (.)other?.ObjectPtr);
	}
	public bool OperatorGreaterOrEqual2(IQJsonObject_const_iterator other)
	{
		return CQt.QJsonObject_Iterator_OperatorGreaterOrEqual2((.)this.ptr.Ptr, (.)other?.ObjectPtr);
	}
}
...
class QJsonObject_const_iterator : IQJsonObject_const_iterator
{
	...
	public void Key(String outStr)
	{
		CQt.QJsonObject_Const_Iterator_Key((.)this.ptr.Ptr);
	}
	public QJsonValueConstRef_Ptr Value()
	{
		return QJsonValueConstRef_Ptr(CQt.QJsonObject_Const_Iterator_Value((.)this.ptr.Ptr));
	}
	public QJsonObject_const_iterator_Ptr OperatorPlusPlus2(c_int param1)
	{
		return QJsonObject_const_iterator_Ptr(CQt.QJsonObject_Const_Iterator_OperatorPlusPlus2((.)this.ptr.Ptr, param1));
	}
	public QJsonObject_const_iterator_Ptr OperatorMinusMinus2(c_int param1)
	{
		return QJsonObject_const_iterator_Ptr(CQt.QJsonObject_Const_Iterator_OperatorMinusMinus2((.)this.ptr.Ptr, param1));
	}
	public void* OperatorMinus2(IQJsonObject_const_iterator j)
	{
		return CQt.QJsonObject_Const_Iterator_OperatorMinus2((.)this.ptr.Ptr, (.)j?.ObjectPtr);
	}
	public bool OperatorEqual2(IQJsonObject_iterator other)
	{
		return CQt.QJsonObject_Const_Iterator_OperatorEqual2((.)this.ptr.Ptr, (.)other?.ObjectPtr);
	}
	public bool OperatorNotEqual2(IQJsonObject_iterator other)
	{
		return CQt.QJsonObject_Const_Iterator_OperatorNotEqual2((.)this.ptr.Ptr, (.)other?.ObjectPtr);
	}
	public bool OperatorLesser2(IQJsonObject_iterator other)
	{
		return CQt.QJsonObject_Const_Iterator_OperatorLesser2((.)this.ptr.Ptr, (.)other?.ObjectPtr);
	}
	public bool OperatorLesserOrEqual2(IQJsonObject_iterator other)
	{
		return CQt.QJsonObject_Const_Iterator_OperatorLesserOrEqual2((.)this.ptr.Ptr, (.)other?.ObjectPtr);
	}
	public bool OperatorGreater2(IQJsonObject_iterator other)
	{
		return CQt.QJsonObject_Const_Iterator_OperatorGreater2((.)this.ptr.Ptr, (.)other?.ObjectPtr);
	}
	public bool OperatorGreaterOrEqual2(IQJsonObject_iterator other)
	{
		return CQt.QJsonObject_Const_Iterator_OperatorGreaterOrEqual2((.)this.ptr.Ptr, (.)other?.ObjectPtr);
	}
}
