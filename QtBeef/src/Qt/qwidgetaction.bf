...
struct QWidgetAction_Ptr
{
	...
	{
		CQt.QWidgetAction_TimerEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ChildEvent(IQChildEvent event)
	{
		CQt.QWidgetAction_ChildEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void CustomEvent(IQEvent event)
	{
		CQt.QWidgetAction_CustomEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ConnectNotify(IQMetaMethod signal)
	{
		CQt.QWidgetAction_ConnectNotify((.)this.Ptr, (.)signal?.ObjectPtr);
	}
	public void DisconnectNotify(IQMetaMethod signal)
	{
		CQt.QWidgetAction_DisconnectNotify((.)this.Ptr, (.)signal?.ObjectPtr);
	}
...
class QWidgetAction : IQWidgetAction, IQAction, IQObject
{
	...
	public  virtual void OnDeleteWidget(void** widget)
	{
	}
	public void* CreatedWidgets()
	{
...
extension CQt
{
	...
	[LinkName("QWidgetAction_TimerEvent")]
	public static extern void QWidgetAction_TimerEvent(void* self, void** event);
