...
class QSpinBox : IQSpinBox, IQAbstractSpinBox, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QSpinBox_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QSpinBox_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QSpinBox_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	public c_int Value()
	{
		return CQt.QSpinBox_Value((.)this.ptr.Ptr);
	}
	public void Prefix(String outStr)
	{
		CQt.QSpinBox_Prefix((.)this.ptr.Ptr);
	}
	public void SetPrefix(String prefix)
	{
		CQt.QSpinBox_SetPrefix((.)this.ptr.Ptr, libqt_string(prefix));
	}
	public void Suffix(String outStr)
	{
		CQt.QSpinBox_Suffix((.)this.ptr.Ptr);
	}
	public void SetSuffix(String suffix)
	{
		CQt.QSpinBox_SetSuffix((.)this.ptr.Ptr, libqt_string(suffix));
	}
	public void CleanText(String outStr)
	{
		CQt.QSpinBox_CleanText((.)this.ptr.Ptr);
	}
	public c_int SingleStep()
	{
		return CQt.QSpinBox_SingleStep((.)this.ptr.Ptr);
	}
	public void SetSingleStep(c_int val)
	{
		CQt.QSpinBox_SetSingleStep((.)this.ptr.Ptr, val);
	}
	public c_int Minimum()
	{
		return CQt.QSpinBox_Minimum((.)this.ptr.Ptr);
	}
	public void SetMinimum(c_int min)
	{
		CQt.QSpinBox_SetMinimum((.)this.ptr.Ptr, min);
	}
	public c_int Maximum()
	{
		return CQt.QSpinBox_Maximum((.)this.ptr.Ptr);
	}
	public void SetMaximum(c_int max)
	{
		CQt.QSpinBox_SetMaximum((.)this.ptr.Ptr, max);
	}
	public void SetRange(c_int min, c_int max)
	{
		CQt.QSpinBox_SetRange((.)this.ptr.Ptr, min, max);
	}
	public QAbstractSpinBox_StepType StepType()
	{
		return CQt.QSpinBox_StepType((.)this.ptr.Ptr);
	}
	public void SetStepType(QAbstractSpinBox_StepType stepType)
	{
		CQt.QSpinBox_SetStepType((.)this.ptr.Ptr, stepType);
	}
	public c_int DisplayIntegerBase()
	{
		return CQt.QSpinBox_DisplayIntegerBase((.)this.ptr.Ptr);
	}
	public void SetDisplayIntegerBase(c_int _base)
	{
		CQt.QSpinBox_SetDisplayIntegerBase((.)this.ptr.Ptr, _base);
	}
	public bool Event(IQEvent event)
	{
		return CQt.QSpinBox_Event((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public QValidator_State Validate(String input, c_int* pos)
	{
		return CQt.QSpinBox_Validate((.)this.ptr.Ptr, libqt_string(input), pos);
	}
	public c_int ValueFromText(String text)
	{
		return CQt.QSpinBox_ValueFromText((.)this.ptr.Ptr, libqt_string(text));
	}
	public void TextFromValue(String outStr, c_int val)
	{
		CQt.QSpinBox_TextFromValue((.)this.ptr.Ptr, val);
	}
	public void Fixup(String str)
	{
		CQt.QSpinBox_Fixup((.)this.ptr.Ptr, libqt_string(str));
	}
	public void SetValue(c_int val)
	{
		CQt.QSpinBox_SetValue((.)this.ptr.Ptr, val);
	}
	public void ValueChanged(c_int param1)
	{
		CQt.QSpinBox_ValueChanged((.)this.ptr.Ptr, param1);
	}
	public void TextChanged(String param1)
	{
		CQt.QSpinBox_TextChanged((.)this.ptr.Ptr, libqt_string(param1));
	}
...
class QDoubleSpinBox : IQDoubleSpinBox, IQAbstractSpinBox, IQWidget, IQObject, IQPaintDevice
{
	...
	public QMetaObject_Ptr MetaObject()
	{
		return QMetaObject_Ptr(CQt.QDoubleSpinBox_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QDoubleSpinBox_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QDoubleSpinBox_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	public void Tr(String outStr, c_char* s)
	{
	...
	public double Value()
	{
		return CQt.QDoubleSpinBox_Value((.)this.ptr.Ptr);
	}
	public void Prefix(String outStr)
	{
		CQt.QDoubleSpinBox_Prefix((.)this.ptr.Ptr);
	}
	public void SetPrefix(String prefix)
	{
		CQt.QDoubleSpinBox_SetPrefix((.)this.ptr.Ptr, libqt_string(prefix));
	}
	public void Suffix(String outStr)
	{
		CQt.QDoubleSpinBox_Suffix((.)this.ptr.Ptr);
	}
	public void SetSuffix(String suffix)
	{
		CQt.QDoubleSpinBox_SetSuffix((.)this.ptr.Ptr, libqt_string(suffix));
	}
	public void CleanText(String outStr)
	{
		CQt.QDoubleSpinBox_CleanText((.)this.ptr.Ptr);
	}
	public double SingleStep()
	{
		return CQt.QDoubleSpinBox_SingleStep((.)this.ptr.Ptr);
	}
	public void SetSingleStep(double val)
	{
		CQt.QDoubleSpinBox_SetSingleStep((.)this.ptr.Ptr, val);
	}
	public double Minimum()
	{
		return CQt.QDoubleSpinBox_Minimum((.)this.ptr.Ptr);
	}
	public void SetMinimum(double min)
	{
		CQt.QDoubleSpinBox_SetMinimum((.)this.ptr.Ptr, min);
	}
	public double Maximum()
	{
		return CQt.QDoubleSpinBox_Maximum((.)this.ptr.Ptr);
	}
	public void SetMaximum(double max)
	{
		CQt.QDoubleSpinBox_SetMaximum((.)this.ptr.Ptr, max);
	}
	public void SetRange(double min, double max)
	{
		CQt.QDoubleSpinBox_SetRange((.)this.ptr.Ptr, min, max);
	}
	public QAbstractSpinBox_StepType StepType()
	{
		return CQt.QDoubleSpinBox_StepType((.)this.ptr.Ptr);
	}
	public void SetStepType(QAbstractSpinBox_StepType stepType)
	{
		CQt.QDoubleSpinBox_SetStepType((.)this.ptr.Ptr, stepType);
	}
	public c_int Decimals()
	{
		return CQt.QDoubleSpinBox_Decimals((.)this.ptr.Ptr);
	}
	public void SetDecimals(c_int prec)
	{
		CQt.QDoubleSpinBox_SetDecimals((.)this.ptr.Ptr, prec);
	}
	public QValidator_State Validate(String input, c_int* pos)
	{
		return CQt.QDoubleSpinBox_Validate((.)this.ptr.Ptr, libqt_string(input), pos);
	}
	public double ValueFromText(String text)
	{
		return CQt.QDoubleSpinBox_ValueFromText((.)this.ptr.Ptr, libqt_string(text));
	}
	public void TextFromValue(String outStr, double val)
	{
		CQt.QDoubleSpinBox_TextFromValue((.)this.ptr.Ptr, val);
	}
	public void Fixup(String str)
	{
		CQt.QDoubleSpinBox_Fixup((.)this.ptr.Ptr, libqt_string(str));
	}
	public void SetValue(double val)
	{
		CQt.QDoubleSpinBox_SetValue((.)this.ptr.Ptr, val);
	}
	public void ValueChanged(double param1)
	{
		CQt.QDoubleSpinBox_ValueChanged((.)this.ptr.Ptr, param1);
	}
	public void TextChanged(String param1)
	{
		CQt.QDoubleSpinBox_TextChanged((.)this.ptr.Ptr, libqt_string(param1));
	}
	public void Tr2(String outStr, c_char* s, c_char* c)
	{
