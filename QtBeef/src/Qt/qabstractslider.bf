...
class QAbstractSlider : IQAbstractSlider, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		QAbstractSlider_valueChanged,
		QAbstractSlider_sliderPressed,
		QAbstractSlider_sliderMoved,
		QAbstractSlider_sliderReleased,
		QAbstractSlider_rangeChanged,
		QAbstractSlider_actionTriggered,
		QAbstractSlider_windowTitleChanged,
		QAbstractSlider_windowIconChanged,
		QAbstractSlider_windowIconTextChanged,
		QAbstractSlider_customContextMenuRequested,
		QAbstractSlider_destroyed,
		QAbstractSlider_destroyed1,
	}
	...
	public void SliderChange(QAbstractSlider_SliderChange change)
	{
		this.ptr.SliderChange(change);
	}
	public void KeyPressEvent(IQKeyEvent ev)
	{
		this.ptr.KeyPressEvent(ev);
	}
	public void TimerEvent(IQTimerEvent param1)
	{
...
extension CQt
{
	...
	public static extern void QAbstractSlider_Connect_ValueChanged(void* self, QAbstractSlider_valueChanged_action _action);
	...
	public static extern void QAbstractSlider_Connect_SliderMoved(void* self, QAbstractSlider_sliderMoved_action _action);
	...
	public static extern void QAbstractSlider_Connect_RangeChanged(void* self, QAbstractSlider_rangeChanged_action _action);
	...
	public static extern void QAbstractSlider_Connect_ActionTriggered(void* self, QAbstractSlider_actionTriggered_action _action);
