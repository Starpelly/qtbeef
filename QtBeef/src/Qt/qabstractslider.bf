...
class QAbstractSlider : IQAbstractSlider, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QAbstractSlider_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QAbstractSlider_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QAbstractSlider_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return CQt.QAbstractSlider_Orientation((.)this.ptr.Ptr);
	}
	public void SetMinimum(c_int minimum)
	{
		CQt.QAbstractSlider_SetMinimum((.)this.ptr.Ptr, minimum);
	}
	public c_int Minimum()
	{
		return CQt.QAbstractSlider_Minimum((.)this.ptr.Ptr);
	}
	public void SetMaximum(c_int maximum)
	{
		CQt.QAbstractSlider_SetMaximum((.)this.ptr.Ptr, maximum);
	}
	public c_int Maximum()
	{
		return CQt.QAbstractSlider_Maximum((.)this.ptr.Ptr);
	}
	public void SetSingleStep(c_int singleStep)
	{
		CQt.QAbstractSlider_SetSingleStep((.)this.ptr.Ptr, singleStep);
	}
	public c_int SingleStep()
	{
		return CQt.QAbstractSlider_SingleStep((.)this.ptr.Ptr);
	}
	public void SetPageStep(c_int pageStep)
	{
		CQt.QAbstractSlider_SetPageStep((.)this.ptr.Ptr, pageStep);
	}
	public c_int PageStep()
	{
		return CQt.QAbstractSlider_PageStep((.)this.ptr.Ptr);
	}
	public void SetTracking(bool enable)
	{
		CQt.QAbstractSlider_SetTracking((.)this.ptr.Ptr, enable);
	}
	public bool HasTracking()
	{
		return CQt.QAbstractSlider_HasTracking((.)this.ptr.Ptr);
	}
	public void SetSliderDown(bool sliderDown)
	{
		CQt.QAbstractSlider_SetSliderDown((.)this.ptr.Ptr, sliderDown);
	}
	public bool IsSliderDown()
	{
		return CQt.QAbstractSlider_IsSliderDown((.)this.ptr.Ptr);
	}
	public void SetSliderPosition(c_int sliderPosition)
	{
		CQt.QAbstractSlider_SetSliderPosition((.)this.ptr.Ptr, sliderPosition);
	}
	public c_int SliderPosition()
	{
		return CQt.QAbstractSlider_SliderPosition((.)this.ptr.Ptr);
	}
	public void SetInvertedAppearance(bool invertedAppearance)
	{
		CQt.QAbstractSlider_SetInvertedAppearance((.)this.ptr.Ptr, invertedAppearance);
	}
	public bool InvertedAppearance()
	{
		return CQt.QAbstractSlider_InvertedAppearance((.)this.ptr.Ptr);
	}
	public void SetInvertedControls(bool invertedControls)
	{
		CQt.QAbstractSlider_SetInvertedControls((.)this.ptr.Ptr, invertedControls);
	}
	public bool InvertedControls()
	{
		return CQt.QAbstractSlider_InvertedControls((.)this.ptr.Ptr);
	}
	public c_int Value()
	{
		return CQt.QAbstractSlider_Value((.)this.ptr.Ptr);
	}
	public void TriggerAction(QAbstractSlider_SliderAction action)
	{
		CQt.QAbstractSlider_TriggerAction((.)this.ptr.Ptr, action);
	}
	public void SetValue(c_int value)
	{
		CQt.QAbstractSlider_SetValue((.)this.ptr.Ptr, value);
	}
	public void SetOrientation(Qt_Orientation orientation)
	{
		CQt.QAbstractSlider_SetOrientation((.)this.ptr.Ptr, orientation);
	}
	public void SetRange(c_int min, c_int max)
	{
		CQt.QAbstractSlider_SetRange((.)this.ptr.Ptr, min, max);
	}
	public void ValueChanged(c_int value)
	{
		CQt.QAbstractSlider_ValueChanged((.)this.ptr.Ptr, value);
	}
	public void SliderPressed()
	{
		CQt.QAbstractSlider_SliderPressed((.)this.ptr.Ptr);
	}
	public void SliderMoved(c_int position)
	{
		CQt.QAbstractSlider_SliderMoved((.)this.ptr.Ptr, position);
	}
	public void SliderReleased()
	{
		CQt.QAbstractSlider_SliderReleased((.)this.ptr.Ptr);
	}
	public void RangeChanged(c_int min, c_int max)
	{
		CQt.QAbstractSlider_RangeChanged((.)this.ptr.Ptr, min, max);
	}
	public void ActionTriggered(c_int action)
	{
		CQt.QAbstractSlider_ActionTriggered((.)this.ptr.Ptr, action);
	}
	public bool Event(IQEvent e)
	{
		return CQt.QAbstractSlider_Event((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void SetRepeatAction(QAbstractSlider_SliderAction action)
	{
		CQt.QAbstractSlider_SetRepeatAction((.)this.ptr.Ptr, action);
	}
	public QAbstractSlider_SliderAction RepeatAction()
	{
		return CQt.QAbstractSlider_RepeatAction((.)this.ptr.Ptr);
	}
	public void SliderChange(QAbstractSlider_SliderChange change)
	{
		CQt.QAbstractSlider_SliderChange((.)this.ptr.Ptr, change);
	}
	public void KeyPressEvent(IQKeyEvent ev)
	{
		CQt.QAbstractSlider_KeyPressEvent((.)this.ptr.Ptr, (.)ev?.ObjectPtr);
	}
	public void TimerEvent(IQTimerEvent param1)
	{
		CQt.QAbstractSlider_TimerEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void WheelEvent(IQWheelEvent e)
	{
		CQt.QAbstractSlider_WheelEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void ChangeEvent(IQEvent e)
	{
		CQt.QAbstractSlider_ChangeEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	...
	{
		CQt.QAbstractSlider_SetRepeatAction2((.)this.ptr.Ptr, action, thresholdTime);
	}
	public void SetRepeatAction3(QAbstractSlider_SliderAction action, c_int thresholdTime, c_int repeatTime)
	{
		CQt.QAbstractSlider_SetRepeatAction3((.)this.ptr.Ptr, action, thresholdTime, repeatTime);
	}
