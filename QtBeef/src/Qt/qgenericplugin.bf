...
struct QGenericPlugin_Ptr
{
	...
	{
		return QMetaObject_Ptr(CQt.QGenericPlugin_MetaObject((.)this.Ptr));
	}
	...
	{
		CQt.QGenericPlugin_Tr(s);
	}
	public QObject_Ptr Create(String name, String spec)
	{
		return QObject_Ptr(CQt.QGenericPlugin_Create((.)this.Ptr, libqt_string(name), libqt_string(spec)));
	}
	public void Tr2(String outStr, c_char* s, c_char* c)
	{
		CQt.QGenericPlugin_Tr2(s, c);
	}
	public void Tr3(String outStr, c_char* s, c_char* c, c_int n)
	{
		CQt.QGenericPlugin_Tr3(s, c, n);
	}
	public bool Event(IQEvent event)
	{
		return CQt.QGenericPlugin_Event((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public bool EventFilter(IQObject watched, IQEvent event)
	{
		return CQt.QGenericPlugin_EventFilter((.)this.Ptr, (.)watched?.ObjectPtr, (.)event?.ObjectPtr);
	}
	...
	{
		CQt.QGenericPlugin_TimerEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ChildEvent(IQChildEvent event)
	{
		CQt.QGenericPlugin_ChildEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void CustomEvent(IQEvent event)
	{
		CQt.QGenericPlugin_CustomEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ConnectNotify(IQMetaMethod signal)
	{
		CQt.QGenericPlugin_ConnectNotify((.)this.Ptr, (.)signal?.ObjectPtr);
	}
	public void DisconnectNotify(IQMetaMethod signal)
	{
		CQt.QGenericPlugin_DisconnectNotify((.)this.Ptr, (.)signal?.ObjectPtr);
	}
...
class QGenericPlugin : IQGenericPlugin, IQObject
{
	...
	{
		this.ptr = CQt.QGenericPlugin_new2((.)parent?.ObjectPtr);
	}
	public ~this()
	{
	...
	public  virtual QObject_Ptr OnCreate(libqt_string name, libqt_string spec)
	{
		return default;
	}
	public void Tr2(String outStr, c_char* s, c_char* c)
...
interface IQGenericPlugin : IQtObjectInterface
{
}
extension CQt
{
	...
	public static extern QGenericPlugin_Ptr QGenericPlugin_new2(void** parent);
	...
	public static extern void** QGenericPlugin_MetaObject(void* self);
	...
	public static extern void** QGenericPlugin_Create(void* self, libqt_string name, libqt_string spec);
	...
	[LinkName("QGenericPlugin_Event")]
	public static extern bool QGenericPlugin_Event(void* self, void** event);
