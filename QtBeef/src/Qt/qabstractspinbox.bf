...
class QAbstractSpinBox : IQAbstractSpinBox, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		QAbstractSpinBox_editingFinished,
		QAbstractSpinBox_windowTitleChanged,
		QAbstractSpinBox_windowIconChanged,
		QAbstractSpinBox_windowIconTextChanged,
		QAbstractSpinBox_customContextMenuRequested,
		QAbstractSpinBox_destroyed,
		QAbstractSpinBox_destroyed1,
	}
