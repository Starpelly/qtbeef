...
struct QProgressBar_Ptr
{
	...
	{
		return QMetaObject_Ptr(CQt.QProgressBar_MetaObject((.)this.Ptr));
	}
	...
	{
		CQt.QProgressBar_Text((.)this.Ptr);
	}
	...
	{
		return QSize_Ptr(CQt.QProgressBar_SizeHint((.)this.Ptr));
	}
	public QSize_Ptr MinimumSizeHint()
	{
		return QSize_Ptr(CQt.QProgressBar_MinimumSizeHint((.)this.Ptr));
	}
	...
	{
		CQt.QProgressBar_SetFormat((.)this.Ptr, libqt_string(format));
	}
	public void ResetFormat()
	{
		CQt.QProgressBar_ResetFormat((.)this.Ptr);
	}
	public void Format(String outStr)
	{
		CQt.QProgressBar_Format((.)this.Ptr);
	}
	public void Reset()
	{
	...
	{
		return CQt.QProgressBar_Event((.)this.Ptr, (.)e?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QProgressBar_PaintEvent((.)this.Ptr, (.)param1?.ObjectPtr);
	}
	public void InitStyleOption(IQStyleOptionProgressBar option)
	{
		CQt.QProgressBar_InitStyleOption((.)this.Ptr, (.)option?.ObjectPtr);
	}
	public void Tr2(String outStr, c_char* s, c_char* c)
	{
		CQt.QProgressBar_Tr2(s, c);
	}
	public void Tr3(String outStr, c_char* s, c_char* c, c_int n)
	{
		CQt.QProgressBar_Tr3(s, c, n);
	}
	public bool EventFilter(IQObject watched, IQEvent event)
	{
		return CQt.QProgressBar_EventFilter((.)this.Ptr, (.)watched?.ObjectPtr, (.)event?.ObjectPtr);
	}
	...
	{
		CQt.QProgressBar_TimerEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ChildEvent(IQChildEvent event)
	{
		CQt.QProgressBar_ChildEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void CustomEvent(IQEvent event)
	{
		CQt.QProgressBar_CustomEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ConnectNotify(IQMetaMethod signal)
	{
		CQt.QProgressBar_ConnectNotify((.)this.Ptr, (.)signal?.ObjectPtr);
	}
	public void DisconnectNotify(IQMetaMethod signal)
	{
		CQt.QProgressBar_DisconnectNotify((.)this.Ptr, (.)signal?.ObjectPtr);
	}
	...
	{
		return CQt.QProgressBar_DevType((.)this.Ptr);
	}
	...
	{
		return QPaintEngine_Ptr(CQt.QProgressBar_PaintEngine((.)this.Ptr));
	}
	public c_int Width()
	{
	...
	{
		return CQt.QProgressBar_Metric((.)this.Ptr, metric);
	}
	public void InitPainter(IQPainter painter)
	{
		CQt.QProgressBar_InitPainter((.)this.Ptr, (.)painter?.ObjectPtr);
	}
	public QPaintDevice_Ptr Redirected(IQPoint offset)
	{
		return QPaintDevice_Ptr(CQt.QProgressBar_Redirected((.)this.Ptr, (.)offset?.ObjectPtr));
	}
	public QPainter_Ptr SharedPainter()
	{
		return QPainter_Ptr(CQt.QProgressBar_SharedPainter((.)this.Ptr));
	}
	public void* WinId()
	{
	...
	{
		CQt.QProgressBar_SetVisible((.)this.Ptr, visible);
	}
	...
	{
		return CQt.QProgressBar_HeightForWidth((.)this.Ptr, param1);
	}
	public bool HasHeightForWidth()
	{
		return CQt.QProgressBar_HasHeightForWidth((.)this.Ptr);
	}
	...
	{
		CQt.QProgressBar_MousePressEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void MouseReleaseEvent(IQMouseEvent event)
	{
		CQt.QProgressBar_MouseReleaseEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void MouseDoubleClickEvent(IQMouseEvent event)
	{
		CQt.QProgressBar_MouseDoubleClickEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void MouseMoveEvent(IQMouseEvent event)
	{
		CQt.QProgressBar_MouseMoveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void WheelEvent(IQWheelEvent event)
	{
		CQt.QProgressBar_WheelEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void KeyPressEvent(IQKeyEvent event)
	{
		CQt.QProgressBar_KeyPressEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void KeyReleaseEvent(IQKeyEvent event)
	{
		CQt.QProgressBar_KeyReleaseEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void FocusInEvent(IQFocusEvent event)
	{
		CQt.QProgressBar_FocusInEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void FocusOutEvent(IQFocusEvent event)
	{
		CQt.QProgressBar_FocusOutEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void EnterEvent(IQEnterEvent event)
	{
		CQt.QProgressBar_EnterEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void LeaveEvent(IQEvent event)
	{
		CQt.QProgressBar_LeaveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void MoveEvent(IQMoveEvent event)
	{
		CQt.QProgressBar_MoveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ResizeEvent(IQResizeEvent event)
	{
		CQt.QProgressBar_ResizeEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void CloseEvent(IQCloseEvent event)
	{
		CQt.QProgressBar_CloseEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ContextMenuEvent(IQContextMenuEvent event)
	{
		CQt.QProgressBar_ContextMenuEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void TabletEvent(IQTabletEvent event)
	{
		CQt.QProgressBar_TabletEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ActionEvent(IQActionEvent event)
	{
		CQt.QProgressBar_ActionEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void DragEnterEvent(IQDragEnterEvent event)
	{
		CQt.QProgressBar_DragEnterEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void DragMoveEvent(IQDragMoveEvent event)
	{
		CQt.QProgressBar_DragMoveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void DragLeaveEvent(IQDragLeaveEvent event)
	{
		CQt.QProgressBar_DragLeaveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void DropEvent(IQDropEvent event)
	{
		CQt.QProgressBar_DropEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ShowEvent(IQShowEvent event)
	{
		CQt.QProgressBar_ShowEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void HideEvent(IQHideEvent event)
	{
		CQt.QProgressBar_HideEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public bool NativeEvent(void** eventType, void* message, void** result)
	{
		return CQt.QProgressBar_NativeEvent((.)this.Ptr, eventType, message, result);
	}
	public void ChangeEvent(IQEvent param1)
	{
		CQt.QProgressBar_ChangeEvent((.)this.Ptr, (.)param1?.ObjectPtr);
	}
	public void InputMethodEvent(IQInputMethodEvent param1)
	{
		CQt.QProgressBar_InputMethodEvent((.)this.Ptr, (.)param1?.ObjectPtr);
	}
	public QVariant_Ptr InputMethodQuery(Qt_InputMethodQuery param1)
	{
		return QVariant_Ptr(CQt.QProgressBar_InputMethodQuery((.)this.Ptr, param1));
	}
	...
	{
		return CQt.QProgressBar_FocusNextPrevChild((.)this.Ptr, next);
	}
...
class QProgressBar : IQProgressBar, IQWidget, IQObject, IQPaintDevice
{
	...
	static void QtBf_ConnectSignals(Self obj)
	{
		...
		CQt.QProgressBar_Connect_ValueChanged(obj.ObjectPtr,  => QtBeef_QProgressBar_Connect_ValueChanged);
	...
	static void QtBeef_QProgressBar_Connect_ValueChanged(void* ptr, c_int value)
	{
	...
	{
		this.ptr = CQt.QProgressBar_new((.)parent?.ObjectPtr);
		QtBf_ConnectSignals(this);
	}
	public this()
	{
	...
	public  virtual void OnText(String outStr)
	{
	}
	public void SetTextVisible(bool visible)
	{
		this.ptr.SetTextVisible(visible);
	}
	public bool IsTextVisible()
	{
		return this.ptr.IsTextVisible();
	}
	public void* Alignment()
	{
	...
	public void SetInvertedAppearance(bool invert)
	{
		this.ptr.SetInvertedAppearance(invert);
	}
	public bool InvertedAppearance()
	{
	...
	public void SetTextDirection(QProgressBar_Direction textDirection)
	{
		this.ptr.SetTextDirection(textDirection);
	}
	public QProgressBar_Direction TextDirection()
	{
	...
	public void ResetFormat()
	{
		this.ptr.ResetFormat();
	}
	public void Format(String outStr)
	{
		this.ptr.Format(outStr);
	}
	public void Reset()
	{
		this.ptr.Reset();
...
interface IQProgressBar : IQtObjectInterface
{
}
extension CQt
{
	[LinkName("QProgressBar_new")]
	public static extern QProgressBar_Ptr QProgressBar_new(void** parent);
	...
	public static extern void** QProgressBar_MetaObject(void* self);
	...
	public static extern c_int QProgressBar_Minimum(void* self);
	[LinkName("QProgressBar_Maximum")]
	public static extern c_int QProgressBar_Maximum(void* self);
	[LinkName("QProgressBar_Value")]
	public static extern c_int QProgressBar_Value(void* self);
	[LinkName("QProgressBar_Text")]
	public static extern libqt_string QProgressBar_Text(void* self);
	...
	public static extern bool QProgressBar_IsTextVisible(void* self);
	[LinkName("QProgressBar_Alignment")]
	public static extern void* QProgressBar_Alignment(void* self);
	[LinkName("QProgressBar_SetAlignment")]
	public static extern void QProgressBar_SetAlignment(void* self, void* alignment);
	[LinkName("QProgressBar_SizeHint")]
	public static extern void* QProgressBar_SizeHint(void* self);
	...
	public static extern void QProgressBar_SetInvertedAppearance(void* self, bool invert);
	[LinkName("QProgressBar_InvertedAppearance")]
	public static extern bool QProgressBar_InvertedAppearance(void* self);
	[LinkName("QProgressBar_SetTextDirection")]
	public static extern void QProgressBar_SetTextDirection(void* self, QProgressBar_Direction textDirection);
	[LinkName("QProgressBar_TextDirection")]
	public static extern QProgressBar_Direction QProgressBar_TextDirection(void* self);
	[LinkName("QProgressBar_SetFormat")]
	public static extern void QProgressBar_SetFormat(void* self, libqt_string format);
	[LinkName("QProgressBar_ResetFormat")]
	public static extern void QProgressBar_ResetFormat(void* self);
	[LinkName("QProgressBar_Format")]
	public static extern libqt_string QProgressBar_Format(void* self);
	[LinkName("QProgressBar_Reset")]
	public static extern void QProgressBar_Reset(void* self);
	[LinkName("QProgressBar_SetRange")]
	public static extern void QProgressBar_SetRange(void* self, c_int minimum, c_int maximum);
	[LinkName("QProgressBar_SetMinimum")]
	public static extern void QProgressBar_SetMinimum(void* self, c_int minimum);
	[LinkName("QProgressBar_SetMaximum")]
	public static extern void QProgressBar_SetMaximum(void* self, c_int maximum);
	[LinkName("QProgressBar_SetValue")]
	public static extern void QProgressBar_SetValue(void* self, c_int value);
	...
	public function void QProgressBar_Connect_ValueChanged_action(void* self, c_int value);
	[LinkName("QProgressBar_Connect_ValueChanged")]
	public static extern void QProgressBar_Connect_ValueChanged(void* self, QProgressBar_Connect_ValueChanged_action _action);
	...
	[LinkName("QProgressBar_EventFilter")]
	public static extern bool QProgressBar_EventFilter(void* self, void** watched, void** event);
