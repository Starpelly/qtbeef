...
class QProgressBar : IQProgressBar, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QProgressBar_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QProgressBar_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QProgressBar_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return CQt.QProgressBar_Minimum((.)this.ptr.Ptr);
	}
	public c_int Maximum()
	{
		return CQt.QProgressBar_Maximum((.)this.ptr.Ptr);
	}
	public c_int Value()
	{
		return CQt.QProgressBar_Value((.)this.ptr.Ptr);
	}
	public void Text(String outStr)
	{
		CQt.QProgressBar_Text((.)this.ptr.Ptr);
	}
	public void SetTextVisible(bool visible)
	{
		CQt.QProgressBar_SetTextVisible((.)this.ptr.Ptr, visible);
	}
	public bool IsTextVisible()
	{
		return CQt.QProgressBar_IsTextVisible((.)this.ptr.Ptr);
	}
	public void* Alignment()
	{
		return CQt.QProgressBar_Alignment((.)this.ptr.Ptr);
	}
	public void SetAlignment(void* alignment)
	{
		CQt.QProgressBar_SetAlignment((.)this.ptr.Ptr, alignment);
	}
	public QSize_Ptr SizeHint()
	{
		return QSize_Ptr(CQt.QProgressBar_SizeHint((.)this.ptr.Ptr));
	}
	public QSize_Ptr MinimumSizeHint()
	{
		return QSize_Ptr(CQt.QProgressBar_MinimumSizeHint((.)this.ptr.Ptr));
	}
	public Qt_Orientation Orientation()
	{
		return CQt.QProgressBar_Orientation((.)this.ptr.Ptr);
	}
	public void SetInvertedAppearance(bool invert)
	{
		CQt.QProgressBar_SetInvertedAppearance((.)this.ptr.Ptr, invert);
	}
	public bool InvertedAppearance()
	{
		return CQt.QProgressBar_InvertedAppearance((.)this.ptr.Ptr);
	}
	public void SetTextDirection(QProgressBar_Direction textDirection)
	{
		CQt.QProgressBar_SetTextDirection((.)this.ptr.Ptr, textDirection);
	}
	public QProgressBar_Direction TextDirection()
	{
		return CQt.QProgressBar_TextDirection((.)this.ptr.Ptr);
	}
	public void SetFormat(String format)
	{
		CQt.QProgressBar_SetFormat((.)this.ptr.Ptr, libqt_string(format));
	}
	public void ResetFormat()
	{
		CQt.QProgressBar_ResetFormat((.)this.ptr.Ptr);
	}
	public void Format(String outStr)
	{
		CQt.QProgressBar_Format((.)this.ptr.Ptr);
	}
	public void Reset()
	{
		CQt.QProgressBar_Reset((.)this.ptr.Ptr);
	}
	public void SetRange(c_int minimum, c_int maximum)
	{
		CQt.QProgressBar_SetRange((.)this.ptr.Ptr, minimum, maximum);
	}
	public void SetMinimum(c_int minimum)
	{
		CQt.QProgressBar_SetMinimum((.)this.ptr.Ptr, minimum);
	}
	public void SetMaximum(c_int maximum)
	{
		CQt.QProgressBar_SetMaximum((.)this.ptr.Ptr, maximum);
	}
	public void SetValue(c_int value)
	{
		CQt.QProgressBar_SetValue((.)this.ptr.Ptr, value);
	}
	public void SetOrientation(Qt_Orientation orientation)
	{
		CQt.QProgressBar_SetOrientation((.)this.ptr.Ptr, orientation);
	}
	public void ValueChanged(c_int value)
	{
		CQt.QProgressBar_ValueChanged((.)this.ptr.Ptr, value);
	}
	public bool Event(IQEvent e)
	{
		return CQt.QProgressBar_Event((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QProgressBar_PaintEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void InitStyleOption(IQStyleOptionProgressBar option)
	{
		CQt.QProgressBar_InitStyleOption((.)this.ptr.Ptr, (.)option?.ObjectPtr);
	}
