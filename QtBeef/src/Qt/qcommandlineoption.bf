...
class QCommandLineOption
{
	...
	{
		this.ptr = CQt.QCommandLineOption_new(name);
	}
	public this(void** names)
	{
		this.ptr = CQt.QCommandLineOption_new2(names);
	}
	public this(libqt_string* name, libqt_string* description)
	{
		this.ptr = CQt.QCommandLineOption_new3(name, description);
	}
	public this(void** names, libqt_string* description)
	{
		this.ptr = CQt.QCommandLineOption_new4(names, description);
	}
	public this(QCommandLineOption_Ptr* other)
	{
		this.ptr = CQt.QCommandLineOption_new5(other);
	}
	public this(libqt_string* name, libqt_string* description, libqt_string* valueName)
	{
		this.ptr = CQt.QCommandLineOption_new6(name, description, valueName);
	}
	public this(libqt_string* name, libqt_string* description, libqt_string* valueName, libqt_string* defaultValue)
	{
		this.ptr = CQt.QCommandLineOption_new7(name, description, valueName, defaultValue);
	}
	public this(void** names, libqt_string* description, libqt_string* valueName)
	{
		this.ptr = CQt.QCommandLineOption_new8(names, description, valueName);
	}
	public this(void** names, libqt_string* description, libqt_string* valueName, libqt_string* defaultValue)
	{
		this.ptr = CQt.QCommandLineOption_new9(names, description, valueName, defaultValue);
	}
	public ~this()
	{
