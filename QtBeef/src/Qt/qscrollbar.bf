...
class QScrollBar : IQScrollBar, IQAbstractSlider, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QScrollBar_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QScrollBar_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QScrollBar_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return QSize_Ptr(CQt.QScrollBar_SizeHint((.)this.ptr.Ptr));
	}
	public bool Event(IQEvent event)
	{
		return CQt.QScrollBar_Event((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void WheelEvent(IQWheelEvent param1)
	{
		CQt.QScrollBar_WheelEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QScrollBar_PaintEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void MousePressEvent(IQMouseEvent param1)
	{
		CQt.QScrollBar_MousePressEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void MouseReleaseEvent(IQMouseEvent param1)
	{
		CQt.QScrollBar_MouseReleaseEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void MouseMoveEvent(IQMouseEvent param1)
	{
		CQt.QScrollBar_MouseMoveEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void HideEvent(IQHideEvent param1)
	{
		CQt.QScrollBar_HideEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void SliderChange(QAbstractSlider_SliderChange change)
	{
		CQt.QScrollBar_SliderChange((.)this.ptr.Ptr, change);
	}
	public void ContextMenuEvent(IQContextMenuEvent param1)
	{
		CQt.QScrollBar_ContextMenuEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void InitStyleOption(IQStyleOptionSlider option)
	{
		CQt.QScrollBar_InitStyleOption((.)this.ptr.Ptr, (.)option?.ObjectPtr);
	}
