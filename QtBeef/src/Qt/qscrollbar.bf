...
class QScrollBar : IQScrollBar, IQAbstractSlider, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		QScrollBar_valueChanged,
		QScrollBar_sliderPressed,
		QScrollBar_sliderMoved,
		QScrollBar_sliderReleased,
		QScrollBar_rangeChanged,
		QScrollBar_actionTriggered,
		QScrollBar_windowTitleChanged,
		QScrollBar_windowIconChanged,
		QScrollBar_windowIconTextChanged,
		QScrollBar_customContextMenuRequested,
		QScrollBar_destroyed,
		QScrollBar_destroyed1,
	}
