...
class QButtonGroup : IQButtonGroup, IQObject
{
	...
	{
		return QMetaObject_Ptr(CQt.QButtonGroup_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QButtonGroup_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QButtonGroup_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		CQt.QButtonGroup_SetExclusive((.)this.ptr.Ptr, exclusive);
	}
	public bool Exclusive()
	{
		return CQt.QButtonGroup_Exclusive((.)this.ptr.Ptr);
	}
	public void AddButton(IQAbstractButton param1)
	{
		CQt.QButtonGroup_AddButton((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void RemoveButton(IQAbstractButton param1)
	{
		CQt.QButtonGroup_RemoveButton((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void* Buttons()
	{
		return CQt.QButtonGroup_Buttons((.)this.ptr.Ptr);
	}
	public QAbstractButton_Ptr CheckedButton()
	{
		return QAbstractButton_Ptr(CQt.QButtonGroup_CheckedButton((.)this.ptr.Ptr));
	}
	public QAbstractButton_Ptr Button(c_int id)
	{
		return QAbstractButton_Ptr(CQt.QButtonGroup_Button((.)this.ptr.Ptr, id));
	}
	public void SetId(IQAbstractButton button, c_int id)
	{
		CQt.QButtonGroup_SetId((.)this.ptr.Ptr, (.)button?.ObjectPtr, id);
	}
	public c_int Id(IQAbstractButton button)
	{
		return CQt.QButtonGroup_Id((.)this.ptr.Ptr, (.)button?.ObjectPtr);
	}
	public c_int CheckedId()
	{
		return CQt.QButtonGroup_CheckedId((.)this.ptr.Ptr);
	}
	public void ButtonClicked(IQAbstractButton param1)
	{
		CQt.QButtonGroup_ButtonClicked((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void ButtonPressed(IQAbstractButton param1)
	{
		CQt.QButtonGroup_ButtonPressed((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void ButtonReleased(IQAbstractButton param1)
	{
		CQt.QButtonGroup_ButtonReleased((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void ButtonToggled(IQAbstractButton param1, bool param2)
	{
		CQt.QButtonGroup_ButtonToggled((.)this.ptr.Ptr, (.)param1?.ObjectPtr, param2);
	}
	public void IdClicked(c_int param1)
	{
		CQt.QButtonGroup_IdClicked((.)this.ptr.Ptr, param1);
	}
	public void IdPressed(c_int param1)
	{
		CQt.QButtonGroup_IdPressed((.)this.ptr.Ptr, param1);
	}
	public void IdReleased(c_int param1)
	{
		CQt.QButtonGroup_IdReleased((.)this.ptr.Ptr, param1);
	}
	public void IdToggled(c_int param1, bool param2)
	{
		CQt.QButtonGroup_IdToggled((.)this.ptr.Ptr, param1, param2);
	}
	...
	{
		CQt.QButtonGroup_AddButton2((.)this.ptr.Ptr, (.)param1?.ObjectPtr, id);
	}
