...
class QSignalMapper : IQSignalMapper, IQObject
{
	...
	{
		return QMetaObject_Ptr(CQt.QSignalMapper_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QSignalMapper_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QSignalMapper_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		CQt.QSignalMapper_SetMapping((.)this.ptr.Ptr, (.)sender?.ObjectPtr, id);
	}
	public void SetMapping2(IQObject sender, String text)
	{
		CQt.QSignalMapper_SetMapping2((.)this.ptr.Ptr, (.)sender?.ObjectPtr, libqt_string(text));
	}
	public void SetMapping3(IQObject sender, IQObject object)
	{
		CQt.QSignalMapper_SetMapping3((.)this.ptr.Ptr, (.)sender?.ObjectPtr, (.)object?.ObjectPtr);
	}
	public void RemoveMappings(IQObject sender)
	{
		CQt.QSignalMapper_RemoveMappings((.)this.ptr.Ptr, (.)sender?.ObjectPtr);
	}
	public QObject_Ptr Mapping(c_int id)
	{
		return QObject_Ptr(CQt.QSignalMapper_Mapping((.)this.ptr.Ptr, id));
	}
	public QObject_Ptr Mapping2(String text)
	{
		return QObject_Ptr(CQt.QSignalMapper_Mapping2((.)this.ptr.Ptr, libqt_string(text)));
	}
	public QObject_Ptr Mapping3(IQObject object)
	{
		return QObject_Ptr(CQt.QSignalMapper_Mapping3((.)this.ptr.Ptr, (.)object?.ObjectPtr));
	}
	public void MappedInt(c_int param1)
	{
		CQt.QSignalMapper_MappedInt((.)this.ptr.Ptr, param1);
	}
	public void MappedString(String param1)
	{
		CQt.QSignalMapper_MappedString((.)this.ptr.Ptr, libqt_string(param1));
	}
	public void MappedObject(IQObject param1)
	{
		CQt.QSignalMapper_MappedObject((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void Map()
	{
		CQt.QSignalMapper_Map((.)this.ptr.Ptr);
	}
	public void Map2(IQObject sender)
	{
		CQt.QSignalMapper_Map2((.)this.ptr.Ptr, (.)sender?.ObjectPtr);
	}
