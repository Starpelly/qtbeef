...
class QRadioButton : IQRadioButton, IQAbstractButton, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QRadioButton_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QRadioButton_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QRadioButton_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return QSize_Ptr(CQt.QRadioButton_SizeHint((.)this.ptr.Ptr));
	}
	public QSize_Ptr MinimumSizeHint()
	{
		return QSize_Ptr(CQt.QRadioButton_MinimumSizeHint((.)this.ptr.Ptr));
	}
	public bool Event(IQEvent e)
	{
		return CQt.QRadioButton_Event((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public bool HitButton(IQPoint param1)
	{
		return CQt.QRadioButton_HitButton((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QRadioButton_PaintEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void MouseMoveEvent(IQMouseEvent param1)
	{
		CQt.QRadioButton_MouseMoveEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void InitStyleOption(IQStyleOptionButton button)
	{
		CQt.QRadioButton_InitStyleOption((.)this.ptr.Ptr, (.)button?.ObjectPtr);
	}
