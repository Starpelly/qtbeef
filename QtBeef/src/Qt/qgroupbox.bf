...
class QGroupBox : IQGroupBox, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QGroupBox_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QGroupBox_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QGroupBox_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		CQt.QGroupBox_Title((.)this.ptr.Ptr);
	}
	public void SetTitle(String title)
	{
		CQt.QGroupBox_SetTitle((.)this.ptr.Ptr, libqt_string(title));
	}
	public void* Alignment()
	{
		return CQt.QGroupBox_Alignment((.)this.ptr.Ptr);
	}
	public void SetAlignment(c_int alignment)
	{
		CQt.QGroupBox_SetAlignment((.)this.ptr.Ptr, alignment);
	}
	public QSize_Ptr MinimumSizeHint()
	{
		return QSize_Ptr(CQt.QGroupBox_MinimumSizeHint((.)this.ptr.Ptr));
	}
	public bool IsFlat()
	{
		return CQt.QGroupBox_IsFlat((.)this.ptr.Ptr);
	}
	public void SetFlat(bool flat)
	{
		CQt.QGroupBox_SetFlat((.)this.ptr.Ptr, flat);
	}
	public bool IsCheckable()
	{
		return CQt.QGroupBox_IsCheckable((.)this.ptr.Ptr);
	}
	public void SetCheckable(bool checkable)
	{
		CQt.QGroupBox_SetCheckable((.)this.ptr.Ptr, checkable);
	}
	public bool IsChecked()
	{
		return CQt.QGroupBox_IsChecked((.)this.ptr.Ptr);
	}
	public void SetChecked(bool _checked)
	{
		CQt.QGroupBox_SetChecked((.)this.ptr.Ptr, _checked);
	}
	public void Clicked()
	{
		CQt.QGroupBox_Clicked((.)this.ptr.Ptr);
	}
	public void Toggled(bool param1)
	{
		CQt.QGroupBox_Toggled((.)this.ptr.Ptr, param1);
	}
	public bool Event(IQEvent event)
	{
		return CQt.QGroupBox_Event((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void ChildEvent(IQChildEvent event)
	{
		CQt.QGroupBox_ChildEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void ResizeEvent(IQResizeEvent event)
	{
		CQt.QGroupBox_ResizeEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent event)
	{
		CQt.QGroupBox_PaintEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void FocusInEvent(IQFocusEvent event)
	{
		CQt.QGroupBox_FocusInEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void ChangeEvent(IQEvent event)
	{
		CQt.QGroupBox_ChangeEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void MousePressEvent(IQMouseEvent event)
	{
		CQt.QGroupBox_MousePressEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void MouseMoveEvent(IQMouseEvent event)
	{
		CQt.QGroupBox_MouseMoveEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void MouseReleaseEvent(IQMouseEvent event)
	{
		CQt.QGroupBox_MouseReleaseEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void InitStyleOption(IQStyleOptionGroupBox option)
	{
		CQt.QGroupBox_InitStyleOption((.)this.ptr.Ptr, (.)option?.ObjectPtr);
	}
	...
	{
		CQt.QGroupBox_Clicked1((.)this.ptr.Ptr, _checked);
	}
