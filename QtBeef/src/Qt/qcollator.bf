...
class QCollatorSortKey : IQCollatorSortKey
{
	...
	{
		CQt.QCollatorSortKey_Swap((.)this.ptr.Ptr, (.)other?.ObjectPtr);
	}
	public c_int Compare(IQCollatorSortKey key)
	{
		return CQt.QCollatorSortKey_Compare((.)this.ptr.Ptr, (.)key?.ObjectPtr);
	}
}
...
class QCollator : IQCollator
{
	...
	{
		CQt.QCollator_Swap((.)this.ptr.Ptr, (.)other?.ObjectPtr);
	}
	public void SetLocale(IQLocale locale)
	{
		CQt.QCollator_SetLocale((.)this.ptr.Ptr, (.)locale?.ObjectPtr);
	}
	public QLocale_Ptr Locale()
	{
		return QLocale_Ptr(CQt.QCollator_Locale((.)this.ptr.Ptr));
	}
	public Qt_CaseSensitivity CaseSensitivity()
	{
		return CQt.QCollator_CaseSensitivity((.)this.ptr.Ptr);
	}
	public void SetCaseSensitivity(Qt_CaseSensitivity cs)
	{
		CQt.QCollator_SetCaseSensitivity((.)this.ptr.Ptr, cs);
	}
	public void SetNumericMode(bool on)
	{
		CQt.QCollator_SetNumericMode((.)this.ptr.Ptr, on);
	}
	public bool NumericMode()
	{
		return CQt.QCollator_NumericMode((.)this.ptr.Ptr);
	}
	public void SetIgnorePunctuation(bool on)
	{
		CQt.QCollator_SetIgnorePunctuation((.)this.ptr.Ptr, on);
	}
	public bool IgnorePunctuation()
	{
		return CQt.QCollator_IgnorePunctuation((.)this.ptr.Ptr);
	}
	public c_int Compare(String s1, String s2)
	{
		return CQt.QCollator_Compare((.)this.ptr.Ptr, libqt_string(s1), libqt_string(s2));
	}
	public c_int Compare2(IQChar s1, void* len1, IQChar s2, void* len2)
	{
		return CQt.QCollator_Compare2((.)this.ptr.Ptr, (.)s1?.ObjectPtr, len1, (.)s2?.ObjectPtr, len2);
	}
	public QCollatorSortKey_Ptr SortKey(String stringVal)
	{
		return QCollatorSortKey_Ptr(CQt.QCollator_SortKey((.)this.ptr.Ptr, libqt_string(stringVal)));
	}
}
