...
class QIdentityProxyModel : IQIdentityProxyModel, IQAbstractProxyModel, IQAbstractItemModel, IQObject
{
	...
	{
		return CQt.QIdentityProxyModel_Index((.)this.ptr, row, column, (.)parent?.ObjectPtr);
	}
	public QModelIndex_Ptr* MapFromSource(IQModelIndex sourceIndex)
	{
		return CQt.QIdentityProxyModel_MapFromSource((.)this.ptr, (.)sourceIndex?.ObjectPtr);
	}
	public QModelIndex_Ptr* MapToSource(IQModelIndex proxyIndex)
	{
		return CQt.QIdentityProxyModel_MapToSource((.)this.ptr, (.)proxyIndex?.ObjectPtr);
	}
	public QModelIndex_Ptr* Parent(IQModelIndex child)
	{
		return CQt.QIdentityProxyModel_Parent((.)this.ptr, (.)child?.ObjectPtr);
	}
	...
	{
		return CQt.QIdentityProxyModel_Sibling((.)this.ptr, row, column, (.)idx?.ObjectPtr);
	}
	public QItemSelection_Ptr* MapSelectionFromSource(IQItemSelection selection)
	{
		return CQt.QIdentityProxyModel_MapSelectionFromSource((.)this.ptr, (.)selection?.ObjectPtr);
	}
	public QItemSelection_Ptr* MapSelectionToSource(IQItemSelection selection)
	{
		return CQt.QIdentityProxyModel_MapSelectionToSource((.)this.ptr, (.)selection?.ObjectPtr);
	}
