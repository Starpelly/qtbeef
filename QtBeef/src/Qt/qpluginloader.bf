...
struct QPluginLoader_Ptr
{
	...
	{
		return QObject_Ptr(CQt.QPluginLoader_Instance((.)this.Ptr));
	}
	public QJsonObject_Ptr MetaData()
	{
		return QJsonObject_Ptr(CQt.QPluginLoader_MetaData((.)this.Ptr));
	}
	...
	{
		CQt.QPluginLoader_FileName((.)this.Ptr);
	}
	public void ErrorString(String outStr)
	{
		CQt.QPluginLoader_ErrorString((.)this.Ptr);
	}
...
class QPluginLoader : IQPluginLoader, IQObject
{
	...
	public void* StaticInstances()
	{
		return this.ptr.StaticInstances();
	}
	public void* StaticPlugins()
	{
		return this.ptr.StaticPlugins();
	}
	public bool Load()
	{
	...
	public void SetLoadHints(void* loadHints)
	{
		this.ptr.SetLoadHints(loadHints);
	}
	public void* LoadHints()
	{
