...
class QToolBox : IQToolBox, IQFrame, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		QToolBox_currentChanged,
		QToolBox_windowTitleChanged,
		QToolBox_windowIconChanged,
		QToolBox_windowIconTextChanged,
		QToolBox_customContextMenuRequested,
		QToolBox_destroyed,
		QToolBox_destroyed1,
	}
	...
	static void QtBf_ConnectSignals(Self obj)
	{
		...
		CQt.QToolBox_Connect_CurrentChanged(obj.ObjectPtr,  => QtBeef_QToolBox_currentChanged);
	...
	static void QtBeef_QToolBox_currentChanged(void* ptr, c_int index)
	{
	...
	public void ItemInserted(c_int index)
	{
		this.ptr.ItemInserted(index);
	}
	public void ItemRemoved(c_int index)
	{
		this.ptr.ItemRemoved(index);
	}
	public void ShowEvent(IQShowEvent e)
	{
...
extension CQt
{
	...
	public static extern void QToolBox_Connect_CurrentChanged(void* self, QToolBox_currentChanged_action _action);
