...
class QToolBox : IQToolBox, IQFrame, IQWidget, IQObject, IQPaintDevice
{
	...
	static void QtBf_ConnectSignals(Self obj)
	{
		...
		CQt.QToolBox_Connect_CurrentChanged(obj.ObjectPtr,  => QtBeef_QToolBox_Connect_CurrentChanged);
	...
	static void QtBeef_QToolBox_Connect_CurrentChanged(void* ptr, c_int index)
	{
