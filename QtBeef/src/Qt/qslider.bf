...
class QSlider : IQSlider, IQAbstractSlider, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QSlider_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QSlider_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QSlider_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return QSize_Ptr(CQt.QSlider_SizeHint((.)this.ptr.Ptr));
	}
	public QSize_Ptr MinimumSizeHint()
	{
		return QSize_Ptr(CQt.QSlider_MinimumSizeHint((.)this.ptr.Ptr));
	}
	public void SetTickPosition(QSlider_TickPosition position)
	{
		CQt.QSlider_SetTickPosition((.)this.ptr.Ptr, position);
	}
	public QSlider_TickPosition TickPosition()
	{
		return CQt.QSlider_TickPosition((.)this.ptr.Ptr);
	}
	public void SetTickInterval(c_int ti)
	{
		CQt.QSlider_SetTickInterval((.)this.ptr.Ptr, ti);
	}
	public c_int TickInterval()
	{
		return CQt.QSlider_TickInterval((.)this.ptr.Ptr);
	}
	public bool Event(IQEvent event)
	{
		return CQt.QSlider_Event((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent ev)
	{
		CQt.QSlider_PaintEvent((.)this.ptr.Ptr, (.)ev?.ObjectPtr);
	}
	public void MousePressEvent(IQMouseEvent ev)
	{
		CQt.QSlider_MousePressEvent((.)this.ptr.Ptr, (.)ev?.ObjectPtr);
	}
	public void MouseReleaseEvent(IQMouseEvent ev)
	{
		CQt.QSlider_MouseReleaseEvent((.)this.ptr.Ptr, (.)ev?.ObjectPtr);
	}
	public void MouseMoveEvent(IQMouseEvent ev)
	{
		CQt.QSlider_MouseMoveEvent((.)this.ptr.Ptr, (.)ev?.ObjectPtr);
	}
	public void InitStyleOption(IQStyleOptionSlider option)
	{
		CQt.QSlider_InitStyleOption((.)this.ptr.Ptr, (.)option?.ObjectPtr);
	}
