...
struct QSlider_Ptr
{
	...
	{
		return QMetaObject_Ptr(CQt.QSlider_MetaObject((.)this.Ptr));
	}
	...
	{
		return QSize_Ptr(CQt.QSlider_SizeHint((.)this.Ptr));
	}
	public QSize_Ptr MinimumSizeHint()
	{
		return QSize_Ptr(CQt.QSlider_MinimumSizeHint((.)this.Ptr));
	}
	...
	{
		return CQt.QSlider_Event((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent ev)
	{
		CQt.QSlider_PaintEvent((.)this.Ptr, (.)ev?.ObjectPtr);
	}
	public void MousePressEvent(IQMouseEvent ev)
	{
		CQt.QSlider_MousePressEvent((.)this.Ptr, (.)ev?.ObjectPtr);
	}
	public void MouseReleaseEvent(IQMouseEvent ev)
	{
		CQt.QSlider_MouseReleaseEvent((.)this.Ptr, (.)ev?.ObjectPtr);
	}
	public void MouseMoveEvent(IQMouseEvent ev)
	{
		CQt.QSlider_MouseMoveEvent((.)this.Ptr, (.)ev?.ObjectPtr);
	}
	public void InitStyleOption(IQStyleOptionSlider option)
	{
		CQt.QSlider_InitStyleOption((.)this.Ptr, (.)option?.ObjectPtr);
	}
	...
	{
		CQt.QSlider_Tr3(s, c, n);
	}
	public bool EventFilter(IQObject watched, IQEvent event)
	{
		return CQt.QSlider_EventFilter((.)this.Ptr, (.)watched?.ObjectPtr, (.)event?.ObjectPtr);
	}
	...
	{
		CQt.QSlider_TimerEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ChildEvent(IQChildEvent event)
	{
		CQt.QSlider_ChildEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void CustomEvent(IQEvent event)
	{
		CQt.QSlider_CustomEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ConnectNotify(IQMetaMethod signal)
	{
		CQt.QSlider_ConnectNotify((.)this.Ptr, (.)signal?.ObjectPtr);
	}
	public void DisconnectNotify(IQMetaMethod signal)
	{
		CQt.QSlider_DisconnectNotify((.)this.Ptr, (.)signal?.ObjectPtr);
	}
	...
	{
		return CQt.QSlider_DevType((.)this.Ptr);
	}
	...
	{
		return QPaintEngine_Ptr(CQt.QSlider_PaintEngine((.)this.Ptr));
	}
	public c_int Width()
	{
	...
	{
		return CQt.QSlider_Metric((.)this.Ptr, metric);
	}
	public void InitPainter(IQPainter painter)
	{
		CQt.QSlider_InitPainter((.)this.Ptr, (.)painter?.ObjectPtr);
	}
	public QPaintDevice_Ptr Redirected(IQPoint offset)
	{
		return QPaintDevice_Ptr(CQt.QSlider_Redirected((.)this.Ptr, (.)offset?.ObjectPtr));
	}
	public QPainter_Ptr SharedPainter()
	{
		return QPainter_Ptr(CQt.QSlider_SharedPainter((.)this.Ptr));
	}
	public void* WinId()
	{
	...
	{
		CQt.QSlider_SetVisible((.)this.Ptr, visible);
	}
	...
	{
		return CQt.QSlider_HeightForWidth((.)this.Ptr, param1);
	}
	public bool HasHeightForWidth()
	{
		return CQt.QSlider_HasHeightForWidth((.)this.Ptr);
	}
	...
	{
		CQt.QSlider_MouseDoubleClickEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void WheelEvent(IQWheelEvent event)
	{
		CQt.QSlider_WheelEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void KeyPressEvent(IQKeyEvent event)
	{
		CQt.QSlider_KeyPressEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void KeyReleaseEvent(IQKeyEvent event)
	{
		CQt.QSlider_KeyReleaseEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void FocusInEvent(IQFocusEvent event)
	{
		CQt.QSlider_FocusInEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void FocusOutEvent(IQFocusEvent event)
	{
		CQt.QSlider_FocusOutEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void EnterEvent(IQEnterEvent event)
	{
		CQt.QSlider_EnterEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void LeaveEvent(IQEvent event)
	{
		CQt.QSlider_LeaveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void MoveEvent(IQMoveEvent event)
	{
		CQt.QSlider_MoveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ResizeEvent(IQResizeEvent event)
	{
		CQt.QSlider_ResizeEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void CloseEvent(IQCloseEvent event)
	{
		CQt.QSlider_CloseEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ContextMenuEvent(IQContextMenuEvent event)
	{
		CQt.QSlider_ContextMenuEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void TabletEvent(IQTabletEvent event)
	{
		CQt.QSlider_TabletEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ActionEvent(IQActionEvent event)
	{
		CQt.QSlider_ActionEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void DragEnterEvent(IQDragEnterEvent event)
	{
		CQt.QSlider_DragEnterEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void DragMoveEvent(IQDragMoveEvent event)
	{
		CQt.QSlider_DragMoveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void DragLeaveEvent(IQDragLeaveEvent event)
	{
		CQt.QSlider_DragLeaveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void DropEvent(IQDropEvent event)
	{
		CQt.QSlider_DropEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ShowEvent(IQShowEvent event)
	{
		CQt.QSlider_ShowEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void HideEvent(IQHideEvent event)
	{
		CQt.QSlider_HideEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public bool NativeEvent(void** eventType, void* message, void** result)
	{
		return CQt.QSlider_NativeEvent((.)this.Ptr, eventType, message, result);
	}
	public void ChangeEvent(IQEvent param1)
	{
		CQt.QSlider_ChangeEvent((.)this.Ptr, (.)param1?.ObjectPtr);
	}
	public void InputMethodEvent(IQInputMethodEvent param1)
	{
		CQt.QSlider_InputMethodEvent((.)this.Ptr, (.)param1?.ObjectPtr);
	}
	public QVariant_Ptr InputMethodQuery(Qt_InputMethodQuery param1)
	{
		return QVariant_Ptr(CQt.QSlider_InputMethodQuery((.)this.Ptr, param1));
	}
	...
	{
		return CQt.QSlider_FocusNextPrevChild((.)this.Ptr, next);
	}
	...
	{
		CQt.QSlider_SliderChange((.)this.Ptr, change);
	}
...
class QSlider : IQSlider, IQAbstractSlider, IQWidget, IQObject, IQPaintDevice
{
	...
	public void SetTickPosition(QSlider_TickPosition position)
	{
		this.ptr.SetTickPosition(position);
	}
	public QSlider_TickPosition TickPosition()
	{
	...
	public  virtual void OnPaintEvent(void** ev)
	{
	}
...
interface IQSlider : IQtObjectInterface
{
}
extension CQt
{
	[LinkName("QSlider_new")]
	public static extern QSlider_Ptr QSlider_new(void** parent);
	...
	public static extern QSlider_Ptr QSlider_new4(Qt_Orientation orientation, void** parent);
	[LinkName("QSlider_Delete")]
	public static extern void QSlider_Delete(QSlider_Ptr self);
	[LinkName("QSlider_MetaObject")]
	public static extern void** QSlider_MetaObject(void* self);
	...
	public static extern void* QSlider_SizeHint(void* self);
	...
	public static extern QSlider_TickPosition QSlider_TickPosition(void* self);
	[LinkName("QSlider_SetTickInterval")]
	public static extern void QSlider_SetTickInterval(void* self, c_int ti);
	[LinkName("QSlider_TickInterval")]
	public static extern c_int QSlider_TickInterval(void* self);
	[LinkName("QSlider_Event")]
	public static extern bool QSlider_Event(void* self, void** event);
	...
	[LinkName("QSlider_EventFilter")]
	public static extern bool QSlider_EventFilter(void* self, void** watched, void** event);
