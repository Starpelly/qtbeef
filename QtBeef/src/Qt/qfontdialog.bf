...
class QFontDialog : IQFontDialog, IQDialog, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QFontDialog_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QFontDialog_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QFontDialog_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		CQt.QFontDialog_SetCurrentFont((.)this.ptr.Ptr, (.)font?.ObjectPtr);
	}
	public QFont_Ptr CurrentFont()
	{
		return QFont_Ptr(CQt.QFontDialog_CurrentFont((.)this.ptr.Ptr));
	}
	public QFont_Ptr SelectedFont()
	{
		return QFont_Ptr(CQt.QFontDialog_SelectedFont((.)this.ptr.Ptr));
	}
	public void SetOption(QFontDialog_FontDialogOption option)
	{
		CQt.QFontDialog_SetOption((.)this.ptr.Ptr, option);
	}
	public bool TestOption(QFontDialog_FontDialogOption option)
	{
		return CQt.QFontDialog_TestOption((.)this.ptr.Ptr, option);
	}
	public void SetOptions(void* options)
	{
		CQt.QFontDialog_SetOptions((.)this.ptr.Ptr, options);
	}
	public void* Options()
	{
		return CQt.QFontDialog_Options((.)this.ptr.Ptr);
	}
	public void SetVisible(bool visible)
	{
		CQt.QFontDialog_SetVisible((.)this.ptr.Ptr, visible);
	}
	...
	{
		CQt.QFontDialog_CurrentFontChanged((.)this.ptr.Ptr, (.)font?.ObjectPtr);
	}
	public void FontSelected(IQFont font)
	{
		CQt.QFontDialog_FontSelected((.)this.ptr.Ptr, (.)font?.ObjectPtr);
	}
	public void ChangeEvent(IQEvent event)
	{
		CQt.QFontDialog_ChangeEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void Done(c_int result)
	{
		CQt.QFontDialog_Done((.)this.ptr.Ptr, result);
	}
	public bool EventFilter(IQObject object, IQEvent event)
	{
		return CQt.QFontDialog_EventFilter((.)this.ptr.Ptr, (.)object?.ObjectPtr, (.)event?.ObjectPtr);
	}
	...
	{
		CQt.QFontDialog_SetOption2((.)this.ptr.Ptr, option, on);
	}
