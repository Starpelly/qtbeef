...
class QFontDialog : IQFontDialog, IQDialog, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return CQt.QFontDialog_GetFont2(ok, (.)initial?.ObjectPtr);
	}
	...
	{
		return CQt.QFontDialog_GetFont22(ok, (.)parent?.ObjectPtr);
	}
	public QFont_Ptr* GetFont3(bool* ok, IQFont initial, IQWidget parent)
	{
		return CQt.QFontDialog_GetFont3(ok, (.)initial?.ObjectPtr, (.)parent?.ObjectPtr);
	}
	public QFont_Ptr* GetFont4(bool* ok, IQFont initial, IQWidget parent, String title)
	{
		return CQt.QFontDialog_GetFont4(ok, (.)initial?.ObjectPtr, (.)parent?.ObjectPtr, libqt_string(title));
	}
	public QFont_Ptr* GetFont5(bool* ok, IQFont initial, IQWidget parent, String title, void* options)
	{
		return CQt.QFontDialog_GetFont5(ok, (.)initial?.ObjectPtr, (.)parent?.ObjectPtr, libqt_string(title), options);
	}
	public c_int Result()
	{
