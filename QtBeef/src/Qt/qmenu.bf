...
class QMenu : IQMenu, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return CQt.QMenu_AddMenu((.)this.ptr, (.)menu?.ObjectPtr);
	}
	public QMenu_Ptr** AddMenu2(String title)
	{
		return CQt.QMenu_AddMenu2((.)this.ptr, libqt_string(title));
	}
	public QMenu_Ptr** AddMenu3(IQIcon icon, String title)
	{
		return CQt.QMenu_AddMenu3((.)this.ptr, (.)icon?.ObjectPtr, libqt_string(title));
	}
	...
	{
		return CQt.QMenu_AddSection((.)this.ptr, libqt_string(text));
	}
	public QAction_Ptr** AddSection2(IQIcon icon, String text)
	{
		return CQt.QMenu_AddSection2((.)this.ptr, (.)icon?.ObjectPtr, libqt_string(text));
	}
	public QAction_Ptr** InsertMenu(IQAction before, IQMenu menu)
	{
		return CQt.QMenu_InsertMenu((.)this.ptr, (.)before?.ObjectPtr, (.)menu?.ObjectPtr);
	}
	public QAction_Ptr** InsertSeparator(IQAction before)
	{
		return CQt.QMenu_InsertSeparator((.)this.ptr, (.)before?.ObjectPtr);
	}
	public QAction_Ptr** InsertSection(IQAction before, String text)
	{
		return CQt.QMenu_InsertSection((.)this.ptr, (.)before?.ObjectPtr, libqt_string(text));
	}
	public QAction_Ptr** InsertSection2(IQAction before, IQIcon icon, String text)
	{
		return CQt.QMenu_InsertSection2((.)this.ptr, (.)before?.ObjectPtr, (.)icon?.ObjectPtr, libqt_string(text));
	}
	public bool IsEmpty()
	{
	...
	{
		return CQt.QMenu_Exec2((.)this.ptr, (.)pos?.ObjectPtr);
	}
	public QAction_Ptr** Exec3(void** actions, IQPoint pos)
	{
		return CQt.QMenu_Exec3(actions, (.)pos?.ObjectPtr);
	}
	...
	{
		return CQt.QMenu_ActionGeometry((.)this.ptr, (.)param1?.ObjectPtr);
	}
	public QAction_Ptr** ActionAt(IQPoint param1)
	{
		return CQt.QMenu_ActionAt((.)this.ptr, (.)param1?.ObjectPtr);
	}
	...
	{
		return CQt.QMenu_MenuInAction((.)action?.ObjectPtr);
	}
	...
	{
		return CQt.QMenu_Exec22((.)this.ptr, (.)pos?.ObjectPtr, (.)at?.ObjectPtr);
	}
	public QAction_Ptr** Exec32(void** actions, IQPoint pos, IQAction at)
	{
		return CQt.QMenu_Exec32(actions, (.)pos?.ObjectPtr, (.)at?.ObjectPtr);
	}
	public QAction_Ptr** Exec4(void** actions, IQPoint pos, IQAction at, IQWidget parent)
	{
		return CQt.QMenu_Exec4(actions, (.)pos?.ObjectPtr, (.)at?.ObjectPtr, (.)parent?.ObjectPtr);
	}
