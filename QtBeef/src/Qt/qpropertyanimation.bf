...
class QPropertyAnimation : IQPropertyAnimation, IQVariantAnimation, IQAbstractAnimation, IQObject
{
	...
	{
		QPropertyAnimation_valueChanged,
		QPropertyAnimation_finished,
		QPropertyAnimation_stateChanged,
		QPropertyAnimation_currentLoopChanged,
		QPropertyAnimation_directionChanged,
		QPropertyAnimation_destroyed,
		QPropertyAnimation_destroyed1,
	}
