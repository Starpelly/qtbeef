...
class QFileDevice : IQFileDevice, IQIODevice, IQObject, IQIODeviceBase
{
	...
	{
		QFileDevice_readyRead,
		QFileDevice_channelReadyRead,
		QFileDevice_bytesWritten,
		QFileDevice_channelBytesWritten,
		QFileDevice_aboutToClose,
		QFileDevice_readChannelFinished,
		QFileDevice_destroyed,
		QFileDevice_destroyed1,
	}
