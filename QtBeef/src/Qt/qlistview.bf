...
class QListView : IQListView, IQAbstractItemView, IQAbstractScrollArea, IQFrame, IQWidget, IQObject, IQPaintDevice
{
	...
	static void QtBf_ConnectSignals(Self obj)
	{
		...
		CQt.QListView_Connect_IndexesMoved(obj.ObjectPtr,  => QtBeef_QListView_Connect_IndexesMoved);
	...
	static void QtBeef_QListView_Connect_IndexesMoved(void* ptr, void** indexes)
	{
