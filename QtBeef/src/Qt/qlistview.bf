...
class QListView : IQListView, IQAbstractItemView, IQAbstractScrollArea, IQFrame, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QListView_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QListView_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QListView_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		CQt.QListView_SetMovement((.)this.ptr.Ptr, movement);
	}
	public void* Movement()
	{
		return CQt.QListView_Movement((.)this.ptr.Ptr);
	}
	public void SetFlow(void* flow)
	{
		CQt.QListView_SetFlow((.)this.ptr.Ptr, flow);
	}
	public void* Flow()
	{
		return CQt.QListView_Flow((.)this.ptr.Ptr);
	}
	public void SetWrapping(bool enable)
	{
		CQt.QListView_SetWrapping((.)this.ptr.Ptr, enable);
	}
	public bool IsWrapping()
	{
		return CQt.QListView_IsWrapping((.)this.ptr.Ptr);
	}
	public void SetResizeMode(void* mode)
	{
		CQt.QListView_SetResizeMode((.)this.ptr.Ptr, mode);
	}
	public void* ResizeMode()
	{
		return CQt.QListView_ResizeMode((.)this.ptr.Ptr);
	}
	public void SetLayoutMode(void* mode)
	{
		CQt.QListView_SetLayoutMode((.)this.ptr.Ptr, mode);
	}
	public void* LayoutMode()
	{
		return CQt.QListView_LayoutMode((.)this.ptr.Ptr);
	}
	public void SetSpacing(c_int space)
	{
		CQt.QListView_SetSpacing((.)this.ptr.Ptr, space);
	}
	public c_int Spacing()
	{
		return CQt.QListView_Spacing((.)this.ptr.Ptr);
	}
	public void SetBatchSize(c_int batchSize)
	{
		CQt.QListView_SetBatchSize((.)this.ptr.Ptr, batchSize);
	}
	public c_int BatchSize()
	{
		return CQt.QListView_BatchSize((.)this.ptr.Ptr);
	}
	public void SetGridSize(IQSize size)
	{
		CQt.QListView_SetGridSize((.)this.ptr.Ptr, (.)size?.ObjectPtr);
	}
	public QSize_Ptr GridSize()
	{
		return QSize_Ptr(CQt.QListView_GridSize((.)this.ptr.Ptr));
	}
	public void SetViewMode(void* mode)
	{
		CQt.QListView_SetViewMode((.)this.ptr.Ptr, mode);
	}
	public void* ViewMode()
	{
		return CQt.QListView_ViewMode((.)this.ptr.Ptr);
	}
	public void ClearPropertyFlags()
	{
		CQt.QListView_ClearPropertyFlags((.)this.ptr.Ptr);
	}
	public bool IsRowHidden(c_int row)
	{
		return CQt.QListView_IsRowHidden((.)this.ptr.Ptr, row);
	}
	public void SetRowHidden(c_int row, bool hide)
	{
		CQt.QListView_SetRowHidden((.)this.ptr.Ptr, row, hide);
	}
	public void SetModelColumn(c_int column)
	{
		CQt.QListView_SetModelColumn((.)this.ptr.Ptr, column);
	}
	public c_int ModelColumn()
	{
		return CQt.QListView_ModelColumn((.)this.ptr.Ptr);
	}
	public void SetUniformItemSizes(bool enable)
	{
		CQt.QListView_SetUniformItemSizes((.)this.ptr.Ptr, enable);
	}
	public bool UniformItemSizes()
	{
		return CQt.QListView_UniformItemSizes((.)this.ptr.Ptr);
	}
	public void SetWordWrap(bool on)
	{
		CQt.QListView_SetWordWrap((.)this.ptr.Ptr, on);
	}
	public bool WordWrap()
	{
		return CQt.QListView_WordWrap((.)this.ptr.Ptr);
	}
	public void SetSelectionRectVisible(bool show)
	{
		CQt.QListView_SetSelectionRectVisible((.)this.ptr.Ptr, show);
	}
	public bool IsSelectionRectVisible()
	{
		return CQt.QListView_IsSelectionRectVisible((.)this.ptr.Ptr);
	}
	public void SetItemAlignment(void* alignment)
	{
		CQt.QListView_SetItemAlignment((.)this.ptr.Ptr, alignment);
	}
	public void* ItemAlignment()
	{
		return CQt.QListView_ItemAlignment((.)this.ptr.Ptr);
	}
	public QRect_Ptr VisualRect(IQModelIndex index)
	{
		return QRect_Ptr(CQt.QListView_VisualRect((.)this.ptr.Ptr, (.)index?.ObjectPtr));
	}
	public void ScrollTo(IQModelIndex index, QAbstractItemView_ScrollHint hint)
	{
		CQt.QListView_ScrollTo((.)this.ptr.Ptr, (.)index?.ObjectPtr, hint);
	}
	public QModelIndex_Ptr IndexAt(IQPoint p)
	{
		return QModelIndex_Ptr(CQt.QListView_IndexAt((.)this.ptr.Ptr, (.)p?.ObjectPtr));
	}
	public void DoItemsLayout()
	{
		CQt.QListView_DoItemsLayout((.)this.ptr.Ptr);
	}
	public void Reset()
	{
		CQt.QListView_Reset((.)this.ptr.Ptr);
	}
	public void SetRootIndex(IQModelIndex index)
	{
		CQt.QListView_SetRootIndex((.)this.ptr.Ptr, (.)index?.ObjectPtr);
	}
	public void IndexesMoved(void** indexes)
	{
		CQt.QListView_IndexesMoved((.)this.ptr.Ptr, indexes);
	}
	public bool Event(IQEvent e)
	{
		return CQt.QListView_Event((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void ScrollContentsBy(c_int dx, c_int dy)
	{
		CQt.QListView_ScrollContentsBy((.)this.ptr.Ptr, dx, dy);
	}
	public void ResizeContents(c_int width, c_int height)
	{
		CQt.QListView_ResizeContents((.)this.ptr.Ptr, width, height);
	}
	public QSize_Ptr ContentsSize()
	{
		return QSize_Ptr(CQt.QListView_ContentsSize((.)this.ptr.Ptr));
	}
	public void DataChanged(IQModelIndex topLeft, IQModelIndex bottomRight, void** roles)
	{
		CQt.QListView_DataChanged((.)this.ptr.Ptr, (.)topLeft?.ObjectPtr, (.)bottomRight?.ObjectPtr, roles);
	}
	public void RowsInserted(IQModelIndex parent, c_int start, c_int end)
	{
		CQt.QListView_RowsInserted((.)this.ptr.Ptr, (.)parent?.ObjectPtr, start, end);
	}
	public void RowsAboutToBeRemoved(IQModelIndex parent, c_int start, c_int end)
	{
		CQt.QListView_RowsAboutToBeRemoved((.)this.ptr.Ptr, (.)parent?.ObjectPtr, start, end);
	}
	public void MouseMoveEvent(IQMouseEvent e)
	{
		CQt.QListView_MouseMoveEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void MouseReleaseEvent(IQMouseEvent e)
	{
		CQt.QListView_MouseReleaseEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void WheelEvent(IQWheelEvent e)
	{
		CQt.QListView_WheelEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void TimerEvent(IQTimerEvent e)
	{
		CQt.QListView_TimerEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void ResizeEvent(IQResizeEvent e)
	{
		CQt.QListView_ResizeEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void DragMoveEvent(IQDragMoveEvent e)
	{
		CQt.QListView_DragMoveEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void DragLeaveEvent(IQDragLeaveEvent e)
	{
		CQt.QListView_DragLeaveEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void DropEvent(IQDropEvent e)
	{
		CQt.QListView_DropEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void StartDrag(void* supportedActions)
	{
		CQt.QListView_StartDrag((.)this.ptr.Ptr, supportedActions);
	}
	public void InitViewItemOption(IQStyleOptionViewItem option)
	{
		CQt.QListView_InitViewItemOption((.)this.ptr.Ptr, (.)option?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent e)
	{
		CQt.QListView_PaintEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public c_int HorizontalOffset()
	{
		return CQt.QListView_HorizontalOffset((.)this.ptr.Ptr);
	}
	public c_int VerticalOffset()
	{
		return CQt.QListView_VerticalOffset((.)this.ptr.Ptr);
	}
	public QModelIndex_Ptr MoveCursor(QAbstractItemView_CursorAction cursorAction, void* modifiers)
	{
		return QModelIndex_Ptr(CQt.QListView_MoveCursor((.)this.ptr.Ptr, cursorAction, modifiers));
	}
	public QRect_Ptr RectForIndex(IQModelIndex index)
	{
		return QRect_Ptr(CQt.QListView_RectForIndex((.)this.ptr.Ptr, (.)index?.ObjectPtr));
	}
	public void SetPositionForIndex(IQPoint position, IQModelIndex index)
	{
		CQt.QListView_SetPositionForIndex((.)this.ptr.Ptr, (.)position?.ObjectPtr, (.)index?.ObjectPtr);
	}
	public void SetSelection(IQRect rect, void* command)
	{
		CQt.QListView_SetSelection((.)this.ptr.Ptr, (.)rect?.ObjectPtr, command);
	}
	public QRegion_Ptr VisualRegionForSelection(IQItemSelection selection)
	{
		return QRegion_Ptr(CQt.QListView_VisualRegionForSelection((.)this.ptr.Ptr, (.)selection?.ObjectPtr));
	}
	public void* SelectedIndexes()
	{
		return CQt.QListView_SelectedIndexes((.)this.ptr.Ptr);
	}
	public void UpdateGeometries()
	{
		CQt.QListView_UpdateGeometries((.)this.ptr.Ptr);
	}
	public bool IsIndexHidden(IQModelIndex index)
	{
		return CQt.QListView_IsIndexHidden((.)this.ptr.Ptr, (.)index?.ObjectPtr);
	}
	public void SelectionChanged(IQItemSelection selected, IQItemSelection deselected)
	{
		CQt.QListView_SelectionChanged((.)this.ptr.Ptr, (.)selected?.ObjectPtr, (.)deselected?.ObjectPtr);
	}
	public void CurrentChanged(IQModelIndex current, IQModelIndex previous)
	{
		CQt.QListView_CurrentChanged((.)this.ptr.Ptr, (.)current?.ObjectPtr, (.)previous?.ObjectPtr);
	}
	public QSize_Ptr ViewportSizeHint()
	{
		return QSize_Ptr(CQt.QListView_ViewportSizeHint((.)this.ptr.Ptr));
	}
