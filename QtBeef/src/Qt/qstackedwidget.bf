...
class QStackedWidget : IQStackedWidget, IQFrame, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QStackedWidget_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QStackedWidget_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QStackedWidget_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return CQt.QStackedWidget_AddWidget((.)this.ptr.Ptr, (.)w?.ObjectPtr);
	}
	public c_int InsertWidget(c_int index, IQWidget w)
	{
		return CQt.QStackedWidget_InsertWidget((.)this.ptr.Ptr, index, (.)w?.ObjectPtr);
	}
	public void RemoveWidget(IQWidget w)
	{
		CQt.QStackedWidget_RemoveWidget((.)this.ptr.Ptr, (.)w?.ObjectPtr);
	}
	public QWidget_Ptr CurrentWidget()
	{
		return QWidget_Ptr(CQt.QStackedWidget_CurrentWidget((.)this.ptr.Ptr));
	}
	public c_int CurrentIndex()
	{
		return CQt.QStackedWidget_CurrentIndex((.)this.ptr.Ptr);
	}
	public c_int IndexOf(IQWidget param1)
	{
		return CQt.QStackedWidget_IndexOf((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public QWidget_Ptr Widget(c_int param1)
	{
		return QWidget_Ptr(CQt.QStackedWidget_Widget((.)this.ptr.Ptr, param1));
	}
	public c_int Count()
	{
		return CQt.QStackedWidget_Count((.)this.ptr.Ptr);
	}
	public void SetCurrentIndex(c_int index)
	{
		CQt.QStackedWidget_SetCurrentIndex((.)this.ptr.Ptr, index);
	}
	public void SetCurrentWidget(IQWidget w)
	{
		CQt.QStackedWidget_SetCurrentWidget((.)this.ptr.Ptr, (.)w?.ObjectPtr);
	}
	public void CurrentChanged(c_int param1)
	{
		CQt.QStackedWidget_CurrentChanged((.)this.ptr.Ptr, param1);
	}
	public void WidgetRemoved(c_int index)
	{
		CQt.QStackedWidget_WidgetRemoved((.)this.ptr.Ptr, index);
	}
	public bool Event(IQEvent e)
	{
		return CQt.QStackedWidget_Event((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
