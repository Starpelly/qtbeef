...
struct QCalendarWidget_Ptr
{
	...
	{
		return QSize_Ptr(CQt.QCalendarWidget_SizeHint((.)this.Ptr));
	}
	public QSize_Ptr MinimumSizeHint()
	{
		return QSize_Ptr(CQt.QCalendarWidget_MinimumSizeHint((.)this.Ptr));
	}
	public QDate_Ptr SelectedDate()
	{
		return QDate_Ptr(CQt.QCalendarWidget_SelectedDate((.)this.Ptr));
	}
	...
	{
		return QDate_Ptr(CQt.QCalendarWidget_MinimumDate((.)this.Ptr));
	}
	public void SetMinimumDate(IQDate date)
	{
		CQt.QCalendarWidget_SetMinimumDate((.)this.Ptr, (.)date?.ObjectPtr);
	}
	public QDate_Ptr MaximumDate()
	{
		return QDate_Ptr(CQt.QCalendarWidget_MaximumDate((.)this.Ptr));
	}
	public void SetMaximumDate(IQDate date)
	{
		CQt.QCalendarWidget_SetMaximumDate((.)this.Ptr, (.)date?.ObjectPtr);
	}
	...
	{
		return QCalendar_Ptr(CQt.QCalendarWidget_Calendar((.)this.Ptr));
	}
	public void SetCalendar(IQCalendar calendar)
	{
		CQt.QCalendarWidget_SetCalendar((.)this.Ptr, (.)calendar?.ObjectPtr);
	}
	...
	{
		return QTextCharFormat_Ptr(CQt.QCalendarWidget_HeaderTextFormat((.)this.Ptr));
	}
	public void SetHeaderTextFormat(IQTextCharFormat format)
	{
		CQt.QCalendarWidget_SetHeaderTextFormat((.)this.Ptr, (.)format?.ObjectPtr);
	}
	public QTextCharFormat_Ptr WeekdayTextFormat(Qt_DayOfWeek dayOfWeek)
	{
		return QTextCharFormat_Ptr(CQt.QCalendarWidget_WeekdayTextFormat((.)this.Ptr, dayOfWeek));
	}
	public void SetWeekdayTextFormat(Qt_DayOfWeek dayOfWeek, IQTextCharFormat format)
	{
		CQt.QCalendarWidget_SetWeekdayTextFormat((.)this.Ptr, dayOfWeek, (.)format?.ObjectPtr);
	}
	...
	{
		return QTextCharFormat_Ptr(CQt.QCalendarWidget_DateTextFormat2((.)this.Ptr, (.)date?.ObjectPtr));
	}
	public void SetDateTextFormat(IQDate date, IQTextCharFormat format)
	{
		CQt.QCalendarWidget_SetDateTextFormat((.)this.Ptr, (.)date?.ObjectPtr, (.)format?.ObjectPtr);
	}
	...
	{
		return CQt.QCalendarWidget_Event((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public bool EventFilter(IQObject watched, IQEvent event)
	{
		return CQt.QCalendarWidget_EventFilter((.)this.Ptr, (.)watched?.ObjectPtr, (.)event?.ObjectPtr);
	}
	public void MousePressEvent(IQMouseEvent event)
	{
		CQt.QCalendarWidget_MousePressEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ResizeEvent(IQResizeEvent event)
	{
		CQt.QCalendarWidget_ResizeEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void KeyPressEvent(IQKeyEvent event)
	{
		CQt.QCalendarWidget_KeyPressEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void PaintCell(IQPainter painter, IQRect rect, IQDate date)
	{
		CQt.QCalendarWidget_PaintCell((.)this.Ptr, (.)painter?.ObjectPtr, (.)rect?.ObjectPtr, (.)date?.ObjectPtr);
	}
	public void UpdateCell(IQDate date)
	{
		CQt.QCalendarWidget_UpdateCell((.)this.Ptr, (.)date?.ObjectPtr);
	}
	...
	{
		CQt.QCalendarWidget_SetSelectedDate((.)this.Ptr, (.)date?.ObjectPtr);
	}
	public void SetDateRange(IQDate min, IQDate max)
	{
		CQt.QCalendarWidget_SetDateRange((.)this.Ptr, (.)min?.ObjectPtr, (.)max?.ObjectPtr);
	}
	...
	{
		CQt.QCalendarWidget_Clicked((.)this.Ptr, (.)date?.ObjectPtr);
	}
	public void Activated(IQDate date)
	{
		CQt.QCalendarWidget_Activated((.)this.Ptr, (.)date?.ObjectPtr);
	}
...
class QCalendarWidget : IQCalendarWidget, IQWidget, IQObject, IQPaintDevice
{
	...
	static void QtBf_ConnectSignals(Self obj)
	{
		...
		CQt.QCalendarWidget_Connect_SelectionChanged(obj.ObjectPtr,  => QtBeef_QCalendarWidget_Connect_SelectionChanged);
		CQt.QCalendarWidget_Connect_Clicked(obj.ObjectPtr,  => QtBeef_QCalendarWidget_Connect_Clicked);
		CQt.QCalendarWidget_Connect_Activated(obj.ObjectPtr,  => QtBeef_QCalendarWidget_Connect_Activated);
		CQt.QCalendarWidget_Connect_CurrentPageChanged(obj.ObjectPtr,  => QtBeef_QCalendarWidget_Connect_CurrentPageChanged);
	...
	static void QtBeef_QCalendarWidget_Connect_SelectionChanged(void* ptr)
	{
		let obj = CQt.ObjectHandleMap[ptr] as Self;
		obj.OnSelectionChanged.Invoke();
	}
	static void QtBeef_QCalendarWidget_Connect_Clicked(void* ptr, void* date)
	{
		let obj = CQt.ObjectHandleMap[ptr] as Self;
		obj.OnClicked.Invoke(date);
	}
	static void QtBeef_QCalendarWidget_Connect_Activated(void* ptr, void* date)
	{
		let obj = CQt.ObjectHandleMap[ptr] as Self;
		obj.OnActivated.Invoke(date);
	}
	static void QtBeef_QCalendarWidget_Connect_CurrentPageChanged(void* ptr, c_int year, c_int month)
	{
		let obj = CQt.ObjectHandleMap[ptr] as Self;
	...
	public QDate_Ptr SelectedDate()
	{
		return this.ptr.SelectedDate();
	}
	public c_int YearShown()
	{
		return this.ptr.YearShown();
	}
	public c_int MonthShown()
	{
		return this.ptr.MonthShown();
	}
	public QDate_Ptr MinimumDate()
	{
	...
	public void SetFirstDayOfWeek(Qt_DayOfWeek dayOfWeek)
	{
		this.ptr.SetFirstDayOfWeek(dayOfWeek);
	}
	public bool IsNavigationBarVisible()
	{
		return this.ptr.IsNavigationBarVisible();
	}
	public bool IsGridVisible()
	{
		return this.ptr.IsGridVisible();
	}
	public QCalendar_Ptr Calendar()
	{
	...
	public QCalendarWidget_HorizontalHeaderFormat HorizontalHeaderFormat()
	{
		return this.ptr.HorizontalHeaderFormat();
	}
	public void SetHorizontalHeaderFormat(QCalendarWidget_HorizontalHeaderFormat format)
	{
		this.ptr.SetHorizontalHeaderFormat(format);
	}
	public QCalendarWidget_VerticalHeaderFormat VerticalHeaderFormat()
	{
		return this.ptr.VerticalHeaderFormat();
	}
	public void SetVerticalHeaderFormat(QCalendarWidget_VerticalHeaderFormat format)
	{
		this.ptr.SetVerticalHeaderFormat(format);
	}
	public QTextCharFormat_Ptr HeaderTextFormat()
	{
		return this.ptr.HeaderTextFormat();
	}
	public void SetHeaderTextFormat(IQTextCharFormat format)
	{
		this.ptr.SetHeaderTextFormat(format);
	}
	public QTextCharFormat_Ptr WeekdayTextFormat(Qt_DayOfWeek dayOfWeek)
	{
		return this.ptr.WeekdayTextFormat(dayOfWeek);
	}
	public void SetWeekdayTextFormat(Qt_DayOfWeek dayOfWeek, IQTextCharFormat format)
	{
		this.ptr.SetWeekdayTextFormat(dayOfWeek, format);
	}
	public void* DateTextFormat()
	{
		return this.ptr.DateTextFormat();
	}
	public QTextCharFormat_Ptr DateTextFormat2(IQDate date)
	{
		return this.ptr.DateTextFormat2(date);
	}
	public void SetDateTextFormat(IQDate date, IQTextCharFormat format)
	{
		this.ptr.SetDateTextFormat(date, format);
	}
	public bool IsDateEditEnabled()
	{
		return this.ptr.IsDateEditEnabled();
	}
	public void SetDateEditEnabled(bool enable)
	{
		this.ptr.SetDateEditEnabled(enable);
	}
	public c_int DateEditAcceptDelay()
	{
		return this.ptr.DateEditAcceptDelay();
	}
	public void SetDateEditAcceptDelay(c_int delay)
	{
	...
	public void UpdateCell(IQDate date)
	{
		this.ptr.UpdateCell(date);
	}
	public void UpdateCells()
	{
		this.ptr.UpdateCells();
	}
	public void SetSelectedDate(IQDate date)
	{
		this.ptr.SetSelectedDate(date);
	}
	public void SetDateRange(IQDate min, IQDate max)
	{
	...
	public void SetCurrentPage(c_int year, c_int month)
	{
		this.ptr.SetCurrentPage(year, month);
	}
	public void SetGridVisible(bool show)
	{
		this.ptr.SetGridVisible(show);
	}
	public void SetNavigationBarVisible(bool visible)
	{
		this.ptr.SetNavigationBarVisible(visible);
	}
	public void ShowNextMonth()
	{
		this.ptr.ShowNextMonth();
	}
	public void ShowPreviousMonth()
	{
		this.ptr.ShowPreviousMonth();
	}
	public void ShowNextYear()
	{
		this.ptr.ShowNextYear();
	}
	public void ShowPreviousYear()
	{
		this.ptr.ShowPreviousYear();
	}
	public void ShowSelectedDate()
	{
		this.ptr.ShowSelectedDate();
	}
	public void ShowToday()
	{
		this.ptr.ShowToday();
	...
	public void Clicked(IQDate date)
	{
		this.ptr.Clicked(date);
	}
	public void Activated(IQDate date)
	{
		this.ptr.Activated(date);
	}
	public void CurrentPageChanged(c_int year, c_int month)
	{
		this.ptr.CurrentPageChanged(year, month);
	}
	public void Tr2(String outStr, c_char* s, c_char* c)
	{
