...
extension CQt
{
	...
	public static extern QCalendarWidget_Ptr QCalendarWidget_new(void** parent);
	...
	public static extern c_int QCalendarWidget_YearShown(void* self);
	[LinkName("QCalendarWidget_MonthShown")]
	public static extern c_int QCalendarWidget_MonthShown(void* self);
	[LinkName("QCalendarWidget_MinimumDate")]
	public static extern void* QCalendarWidget_MinimumDate(void* self);
	[LinkName("QCalendarWidget_SetMinimumDate")]
	public static extern void QCalendarWidget_SetMinimumDate(void* self, void* date);
	[LinkName("QCalendarWidget_MaximumDate")]
	public static extern void* QCalendarWidget_MaximumDate(void* self);
	[LinkName("QCalendarWidget_SetMaximumDate")]
	public static extern void QCalendarWidget_SetMaximumDate(void* self, void* date);
	[LinkName("QCalendarWidget_FirstDayOfWeek")]
	public static extern Qt_DayOfWeek QCalendarWidget_FirstDayOfWeek(void* self);
	[LinkName("QCalendarWidget_SetFirstDayOfWeek")]
	public static extern void QCalendarWidget_SetFirstDayOfWeek(void* self, Qt_DayOfWeek dayOfWeek);
	[LinkName("QCalendarWidget_IsNavigationBarVisible")]
	public static extern bool QCalendarWidget_IsNavigationBarVisible(void* self);
	[LinkName("QCalendarWidget_IsGridVisible")]
	public static extern bool QCalendarWidget_IsGridVisible(void* self);
	[LinkName("QCalendarWidget_Calendar")]
	public static extern void* QCalendarWidget_Calendar(void* self);
	[LinkName("QCalendarWidget_SetCalendar")]
	public static extern void QCalendarWidget_SetCalendar(void* self, void* calendar);
	[LinkName("QCalendarWidget_SelectionMode")]
	public static extern QCalendarWidget_SelectionMode QCalendarWidget_SelectionMode(void* self);
	[LinkName("QCalendarWidget_SetSelectionMode")]
	public static extern void QCalendarWidget_SetSelectionMode(void* self, QCalendarWidget_SelectionMode mode);
	[LinkName("QCalendarWidget_HorizontalHeaderFormat")]
	public static extern QCalendarWidget_HorizontalHeaderFormat QCalendarWidget_HorizontalHeaderFormat(void* self);
	[LinkName("QCalendarWidget_SetHorizontalHeaderFormat")]
	public static extern void QCalendarWidget_SetHorizontalHeaderFormat(void* self, QCalendarWidget_HorizontalHeaderFormat format);
	[LinkName("QCalendarWidget_VerticalHeaderFormat")]
	public static extern QCalendarWidget_VerticalHeaderFormat QCalendarWidget_VerticalHeaderFormat(void* self);
	[LinkName("QCalendarWidget_SetVerticalHeaderFormat")]
	public static extern void QCalendarWidget_SetVerticalHeaderFormat(void* self, QCalendarWidget_VerticalHeaderFormat format);
	[LinkName("QCalendarWidget_HeaderTextFormat")]
	public static extern void* QCalendarWidget_HeaderTextFormat(void* self);
	[LinkName("QCalendarWidget_SetHeaderTextFormat")]
	public static extern void QCalendarWidget_SetHeaderTextFormat(void* self, void** format);
	[LinkName("QCalendarWidget_WeekdayTextFormat")]
	public static extern void* QCalendarWidget_WeekdayTextFormat(void* self, Qt_DayOfWeek dayOfWeek);
	[LinkName("QCalendarWidget_SetWeekdayTextFormat")]
	public static extern void QCalendarWidget_SetWeekdayTextFormat(void* self, Qt_DayOfWeek dayOfWeek, void** format);
	[LinkName("QCalendarWidget_DateTextFormat")]
	public static extern void* QCalendarWidget_DateTextFormat(void* self);
	[LinkName("QCalendarWidget_DateTextFormat2")]
	public static extern void* QCalendarWidget_DateTextFormat2(void* self, void* date);
	[LinkName("QCalendarWidget_SetDateTextFormat")]
	public static extern void QCalendarWidget_SetDateTextFormat(void* self, void* date, void** format);
	[LinkName("QCalendarWidget_IsDateEditEnabled")]
	public static extern bool QCalendarWidget_IsDateEditEnabled(void* self);
	[LinkName("QCalendarWidget_SetDateEditEnabled")]
	public static extern void QCalendarWidget_SetDateEditEnabled(void* self, bool enable);
	[LinkName("QCalendarWidget_DateEditAcceptDelay")]
	public static extern c_int QCalendarWidget_DateEditAcceptDelay(void* self);
	...
	public static extern void QCalendarWidget_UpdateCells(void* self);
	[LinkName("QCalendarWidget_SetSelectedDate")]
	public static extern void QCalendarWidget_SetSelectedDate(void* self, void* date);
	[LinkName("QCalendarWidget_SetDateRange")]
	public static extern void QCalendarWidget_SetDateRange(void* self, void* min, void* max);
	[LinkName("QCalendarWidget_SetCurrentPage")]
	public static extern void QCalendarWidget_SetCurrentPage(void* self, c_int year, c_int month);
	[LinkName("QCalendarWidget_SetGridVisible")]
	public static extern void QCalendarWidget_SetGridVisible(void* self, bool show);
	[LinkName("QCalendarWidget_SetNavigationBarVisible")]
	public static extern void QCalendarWidget_SetNavigationBarVisible(void* self, bool visible);
	[LinkName("QCalendarWidget_ShowNextMonth")]
	public static extern void QCalendarWidget_ShowNextMonth(void* self);
	[LinkName("QCalendarWidget_ShowPreviousMonth")]
	public static extern void QCalendarWidget_ShowPreviousMonth(void* self);
	[LinkName("QCalendarWidget_ShowNextYear")]
	public static extern void QCalendarWidget_ShowNextYear(void* self);
	[LinkName("QCalendarWidget_ShowPreviousYear")]
	public static extern void QCalendarWidget_ShowPreviousYear(void* self);
	[LinkName("QCalendarWidget_ShowSelectedDate")]
	public static extern void QCalendarWidget_ShowSelectedDate(void* self);
...
class QCalendarWidget : IQCalendarWidget, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QCalendarWidget_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QCalendarWidget_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QCalendarWidget_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	public void Tr(String outStr, c_char* s)
	{
		CQt.QCalendarWidget_Tr(s);
	}
	public QSize_Ptr SizeHint()
	{
		return QSize_Ptr(CQt.QCalendarWidget_SizeHint((.)this.ptr.Ptr));
	}
	public QSize_Ptr MinimumSizeHint()
	{
		return QSize_Ptr(CQt.QCalendarWidget_MinimumSizeHint((.)this.ptr.Ptr));
	}
	public QDate_Ptr SelectedDate()
	{
		return QDate_Ptr(CQt.QCalendarWidget_SelectedDate((.)this.ptr.Ptr));
	}
	public c_int YearShown()
	{
		return CQt.QCalendarWidget_YearShown((.)this.ptr.Ptr);
	}
	public c_int MonthShown()
	{
		return CQt.QCalendarWidget_MonthShown((.)this.ptr.Ptr);
	}
	public QDate_Ptr MinimumDate()
	{
		return QDate_Ptr(CQt.QCalendarWidget_MinimumDate((.)this.ptr.Ptr));
	}
	public void SetMinimumDate(IQDate date)
	{
		CQt.QCalendarWidget_SetMinimumDate((.)this.ptr.Ptr, (.)date?.ObjectPtr);
	}
	public QDate_Ptr MaximumDate()
	{
		return QDate_Ptr(CQt.QCalendarWidget_MaximumDate((.)this.ptr.Ptr));
	}
	public void SetMaximumDate(IQDate date)
	{
		CQt.QCalendarWidget_SetMaximumDate((.)this.ptr.Ptr, (.)date?.ObjectPtr);
	}
	public Qt_DayOfWeek FirstDayOfWeek()
	{
		return CQt.QCalendarWidget_FirstDayOfWeek((.)this.ptr.Ptr);
	}
	public void SetFirstDayOfWeek(Qt_DayOfWeek dayOfWeek)
	{
		CQt.QCalendarWidget_SetFirstDayOfWeek((.)this.ptr.Ptr, dayOfWeek);
	}
	public bool IsNavigationBarVisible()
	{
		return CQt.QCalendarWidget_IsNavigationBarVisible((.)this.ptr.Ptr);
	}
	public bool IsGridVisible()
	{
		return CQt.QCalendarWidget_IsGridVisible((.)this.ptr.Ptr);
	}
	public QCalendar_Ptr Calendar()
	{
		return QCalendar_Ptr(CQt.QCalendarWidget_Calendar((.)this.ptr.Ptr));
	}
	public void SetCalendar(IQCalendar calendar)
	{
		CQt.QCalendarWidget_SetCalendar((.)this.ptr.Ptr, (.)calendar?.ObjectPtr);
	}
	public QCalendarWidget_SelectionMode SelectionMode()
	{
		return CQt.QCalendarWidget_SelectionMode((.)this.ptr.Ptr);
	}
	public void SetSelectionMode(QCalendarWidget_SelectionMode mode)
	{
		CQt.QCalendarWidget_SetSelectionMode((.)this.ptr.Ptr, mode);
	}
	public QCalendarWidget_HorizontalHeaderFormat HorizontalHeaderFormat()
	{
		return CQt.QCalendarWidget_HorizontalHeaderFormat((.)this.ptr.Ptr);
	}
	public void SetHorizontalHeaderFormat(QCalendarWidget_HorizontalHeaderFormat format)
	{
		CQt.QCalendarWidget_SetHorizontalHeaderFormat((.)this.ptr.Ptr, format);
	}
	public QCalendarWidget_VerticalHeaderFormat VerticalHeaderFormat()
	{
		return CQt.QCalendarWidget_VerticalHeaderFormat((.)this.ptr.Ptr);
	}
	public void SetVerticalHeaderFormat(QCalendarWidget_VerticalHeaderFormat format)
	{
		CQt.QCalendarWidget_SetVerticalHeaderFormat((.)this.ptr.Ptr, format);
	}
	public QTextCharFormat_Ptr HeaderTextFormat()
	{
		return QTextCharFormat_Ptr(CQt.QCalendarWidget_HeaderTextFormat((.)this.ptr.Ptr));
	}
	public void SetHeaderTextFormat(IQTextCharFormat format)
	{
		CQt.QCalendarWidget_SetHeaderTextFormat((.)this.ptr.Ptr, (.)format?.ObjectPtr);
	}
	public QTextCharFormat_Ptr WeekdayTextFormat(Qt_DayOfWeek dayOfWeek)
	{
		return QTextCharFormat_Ptr(CQt.QCalendarWidget_WeekdayTextFormat((.)this.ptr.Ptr, dayOfWeek));
	}
	public void SetWeekdayTextFormat(Qt_DayOfWeek dayOfWeek, IQTextCharFormat format)
	{
		CQt.QCalendarWidget_SetWeekdayTextFormat((.)this.ptr.Ptr, dayOfWeek, (.)format?.ObjectPtr);
	}
	public void* DateTextFormat()
	{
		return CQt.QCalendarWidget_DateTextFormat((.)this.ptr.Ptr);
	}
	public QTextCharFormat_Ptr DateTextFormat2(IQDate date)
	{
		return QTextCharFormat_Ptr(CQt.QCalendarWidget_DateTextFormat2((.)this.ptr.Ptr, (.)date?.ObjectPtr));
	}
	public void SetDateTextFormat(IQDate date, IQTextCharFormat format)
	{
		CQt.QCalendarWidget_SetDateTextFormat((.)this.ptr.Ptr, (.)date?.ObjectPtr, (.)format?.ObjectPtr);
	}
	public bool IsDateEditEnabled()
	{
		return CQt.QCalendarWidget_IsDateEditEnabled((.)this.ptr.Ptr);
	}
	public void SetDateEditEnabled(bool enable)
	{
		CQt.QCalendarWidget_SetDateEditEnabled((.)this.ptr.Ptr, enable);
	}
	public c_int DateEditAcceptDelay()
	{
		return CQt.QCalendarWidget_DateEditAcceptDelay((.)this.ptr.Ptr);
	}
	public void SetDateEditAcceptDelay(c_int delay)
	{
		CQt.QCalendarWidget_SetDateEditAcceptDelay((.)this.ptr.Ptr, delay);
	}
	public bool Event(IQEvent event)
	{
		return CQt.QCalendarWidget_Event((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public bool EventFilter(IQObject watched, IQEvent event)
	{
		return CQt.QCalendarWidget_EventFilter((.)this.ptr.Ptr, (.)watched?.ObjectPtr, (.)event?.ObjectPtr);
	}
	public void MousePressEvent(IQMouseEvent event)
	{
		CQt.QCalendarWidget_MousePressEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void ResizeEvent(IQResizeEvent event)
	{
		CQt.QCalendarWidget_ResizeEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void KeyPressEvent(IQKeyEvent event)
	{
		CQt.QCalendarWidget_KeyPressEvent((.)this.ptr.Ptr, (.)event?.ObjectPtr);
	}
	public void PaintCell(IQPainter painter, IQRect rect, IQDate date)
	{
		CQt.QCalendarWidget_PaintCell((.)this.ptr.Ptr, (.)painter?.ObjectPtr, (.)rect?.ObjectPtr, (.)date?.ObjectPtr);
	}
	public void UpdateCell(IQDate date)
	{
		CQt.QCalendarWidget_UpdateCell((.)this.ptr.Ptr, (.)date?.ObjectPtr);
	}
	public void UpdateCells()
	{
		CQt.QCalendarWidget_UpdateCells((.)this.ptr.Ptr);
	}
	public void SetSelectedDate(IQDate date)
	{
		CQt.QCalendarWidget_SetSelectedDate((.)this.ptr.Ptr, (.)date?.ObjectPtr);
	}
	public void SetDateRange(IQDate min, IQDate max)
	{
		CQt.QCalendarWidget_SetDateRange((.)this.ptr.Ptr, (.)min?.ObjectPtr, (.)max?.ObjectPtr);
	}
	public void SetCurrentPage(c_int year, c_int month)
	{
		CQt.QCalendarWidget_SetCurrentPage((.)this.ptr.Ptr, year, month);
	}
	public void SetGridVisible(bool show)
	{
		CQt.QCalendarWidget_SetGridVisible((.)this.ptr.Ptr, show);
	}
	public void SetNavigationBarVisible(bool visible)
	{
		CQt.QCalendarWidget_SetNavigationBarVisible((.)this.ptr.Ptr, visible);
	}
	public void ShowNextMonth()
	{
		CQt.QCalendarWidget_ShowNextMonth((.)this.ptr.Ptr);
	}
	public void ShowPreviousMonth()
	{
		CQt.QCalendarWidget_ShowPreviousMonth((.)this.ptr.Ptr);
	}
	public void ShowNextYear()
	{
		CQt.QCalendarWidget_ShowNextYear((.)this.ptr.Ptr);
	}
	public void ShowPreviousYear()
	{
		CQt.QCalendarWidget_ShowPreviousYear((.)this.ptr.Ptr);
	}
	public void ShowSelectedDate()
	{
		CQt.QCalendarWidget_ShowSelectedDate((.)this.ptr.Ptr);
	}
	public void ShowToday()
	{
		CQt.QCalendarWidget_ShowToday((.)this.ptr.Ptr);
	}
	public void SelectionChanged()
	{
		CQt.QCalendarWidget_SelectionChanged((.)this.ptr.Ptr);
	}
	public void Clicked(IQDate date)
	{
		CQt.QCalendarWidget_Clicked((.)this.ptr.Ptr, (.)date?.ObjectPtr);
	}
	public void Activated(IQDate date)
	{
		CQt.QCalendarWidget_Activated((.)this.ptr.Ptr, (.)date?.ObjectPtr);
	}
	public void CurrentPageChanged(c_int year, c_int month)
	{
		CQt.QCalendarWidget_CurrentPageChanged((.)this.ptr.Ptr, year, month);
	}
	public void Tr2(String outStr, c_char* s, c_char* c)
	{
		CQt.QCalendarWidget_Tr2(s, c);
	}
