...
class QDial : IQDial, IQAbstractSlider, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QDial_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QDial_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QDial_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return CQt.QDial_Wrapping((.)this.ptr.Ptr);
	}
	public c_int NotchSize()
	{
		return CQt.QDial_NotchSize((.)this.ptr.Ptr);
	}
	public void SetNotchTarget(double target)
	{
		CQt.QDial_SetNotchTarget((.)this.ptr.Ptr, target);
	}
	public double NotchTarget()
	{
		return CQt.QDial_NotchTarget((.)this.ptr.Ptr);
	}
	public bool NotchesVisible()
	{
		return CQt.QDial_NotchesVisible((.)this.ptr.Ptr);
	}
	public QSize_Ptr SizeHint()
	{
		return QSize_Ptr(CQt.QDial_SizeHint((.)this.ptr.Ptr));
	}
	public QSize_Ptr MinimumSizeHint()
	{
		return QSize_Ptr(CQt.QDial_MinimumSizeHint((.)this.ptr.Ptr));
	}
	public void SetNotchesVisible(bool visible)
	{
		CQt.QDial_SetNotchesVisible((.)this.ptr.Ptr, visible);
	}
	public void SetWrapping(bool on)
	{
		CQt.QDial_SetWrapping((.)this.ptr.Ptr, on);
	}
	public bool Event(IQEvent e)
	{
		return CQt.QDial_Event((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void ResizeEvent(IQResizeEvent re)
	{
		CQt.QDial_ResizeEvent((.)this.ptr.Ptr, (.)re?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent pe)
	{
		CQt.QDial_PaintEvent((.)this.ptr.Ptr, (.)pe?.ObjectPtr);
	}
	public void MousePressEvent(IQMouseEvent me)
	{
		CQt.QDial_MousePressEvent((.)this.ptr.Ptr, (.)me?.ObjectPtr);
	}
	public void MouseReleaseEvent(IQMouseEvent me)
	{
		CQt.QDial_MouseReleaseEvent((.)this.ptr.Ptr, (.)me?.ObjectPtr);
	}
	public void MouseMoveEvent(IQMouseEvent me)
	{
		CQt.QDial_MouseMoveEvent((.)this.ptr.Ptr, (.)me?.ObjectPtr);
	}
	public void SliderChange(QAbstractSlider_SliderChange change)
	{
		CQt.QDial_SliderChange((.)this.ptr.Ptr, change);
	}
	public void InitStyleOption(IQStyleOptionSlider option)
	{
		CQt.QDial_InitStyleOption((.)this.ptr.Ptr, (.)option?.ObjectPtr);
	}
