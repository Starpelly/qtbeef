...
class QColor : IQColor
{
	...
	public bool IsValid()
	{
		return CQt.QColor_IsValid((.)this.ptr.Ptr);
	}
	public void Name(String outStr)
	{
		CQt.QColor_Name((.)this.ptr.Ptr);
	}
	public void SetNamedColor(String name)
	{
		CQt.QColor_SetNamedColor((.)this.ptr.Ptr, libqt_string(name));
	}
	...
	{
		return CQt.QColor_Spec((.)this.ptr.Ptr);
	}
	public c_int Alpha()
	{
		return CQt.QColor_Alpha((.)this.ptr.Ptr);
	}
	public void SetAlpha(c_int alpha)
	{
		CQt.QColor_SetAlpha((.)this.ptr.Ptr, alpha);
	}
	public float AlphaF()
	{
		return CQt.QColor_AlphaF((.)this.ptr.Ptr);
	}
	public void SetAlphaF(float alpha)
	{
		CQt.QColor_SetAlphaF((.)this.ptr.Ptr, alpha);
	}
	public c_int Red()
	{
		return CQt.QColor_Red((.)this.ptr.Ptr);
	}
	public c_int Green()
	{
		return CQt.QColor_Green((.)this.ptr.Ptr);
	}
	public c_int Blue()
	{
		return CQt.QColor_Blue((.)this.ptr.Ptr);
	}
	public void SetRed(c_int red)
	{
		CQt.QColor_SetRed((.)this.ptr.Ptr, red);
	}
	public void SetGreen(c_int green)
	{
		CQt.QColor_SetGreen((.)this.ptr.Ptr, green);
	}
	public void SetBlue(c_int blue)
	{
		CQt.QColor_SetBlue((.)this.ptr.Ptr, blue);
	}
	public float RedF()
	{
		return CQt.QColor_RedF((.)this.ptr.Ptr);
	}
	public float GreenF()
	{
		return CQt.QColor_GreenF((.)this.ptr.Ptr);
	}
	public float BlueF()
	{
		return CQt.QColor_BlueF((.)this.ptr.Ptr);
	}
	public void SetRedF(float red)
	{
		CQt.QColor_SetRedF((.)this.ptr.Ptr, red);
	}
	public void SetGreenF(float green)
	{
		CQt.QColor_SetGreenF((.)this.ptr.Ptr, green);
	}
	public void SetBlueF(float blue)
	{
		CQt.QColor_SetBlueF((.)this.ptr.Ptr, blue);
	}
	public void GetRgb(c_int* r, c_int* g, c_int* b)
	{
		CQt.QColor_GetRgb((.)this.ptr.Ptr, r, g, b);
	}
	public void SetRgb(c_int r, c_int g, c_int b)
	{
		CQt.QColor_SetRgb((.)this.ptr.Ptr, r, g, b);
	}
	public void GetRgbF(float* r, float* g, float* b)
	{
		CQt.QColor_GetRgbF((.)this.ptr.Ptr, r, g, b);
	}
	public void SetRgbF(float r, float g, float b)
	{
		CQt.QColor_SetRgbF((.)this.ptr.Ptr, r, g, b);
	}
	public QRgba64_Ptr Rgba64()
	{
		return QRgba64_Ptr(CQt.QColor_Rgba64((.)this.ptr.Ptr));
	}
	public void SetRgba64(IQRgba64 rgba)
	{
		CQt.QColor_SetRgba64((.)this.ptr.Ptr, (.)rgba?.ObjectPtr);
	}
	public c_uint Rgba()
	{
		return CQt.QColor_Rgba((.)this.ptr.Ptr);
	}
	public void SetRgba(c_uint rgba)
	{
		CQt.QColor_SetRgba((.)this.ptr.Ptr, rgba);
	}
	public c_uint Rgb()
	{
		return CQt.QColor_Rgb((.)this.ptr.Ptr);
	}
	public void SetRgb2(c_uint rgb)
	{
		CQt.QColor_SetRgb2((.)this.ptr.Ptr, rgb);
	}
	public c_int Hue()
	{
		return CQt.QColor_Hue((.)this.ptr.Ptr);
	}
	public c_int Saturation()
	{
		return CQt.QColor_Saturation((.)this.ptr.Ptr);
	}
	public c_int HsvHue()
	{
		return CQt.QColor_HsvHue((.)this.ptr.Ptr);
	}
	public c_int HsvSaturation()
	{
		return CQt.QColor_HsvSaturation((.)this.ptr.Ptr);
	}
	public c_int Value()
	{
		return CQt.QColor_Value((.)this.ptr.Ptr);
	}
	public float HueF()
	{
		return CQt.QColor_HueF((.)this.ptr.Ptr);
	}
	public float SaturationF()
	{
		return CQt.QColor_SaturationF((.)this.ptr.Ptr);
	}
	public float HsvHueF()
	{
		return CQt.QColor_HsvHueF((.)this.ptr.Ptr);
	}
	public float HsvSaturationF()
	{
		return CQt.QColor_HsvSaturationF((.)this.ptr.Ptr);
	}
	public float ValueF()
	{
		return CQt.QColor_ValueF((.)this.ptr.Ptr);
	}
	public void GetHsv(c_int* h, c_int* s, c_int* v)
	{
		CQt.QColor_GetHsv((.)this.ptr.Ptr, h, s, v);
	}
	public void SetHsv(c_int h, c_int s, c_int v)
	{
		CQt.QColor_SetHsv((.)this.ptr.Ptr, h, s, v);
	}
	public void GetHsvF(float* h, float* s, float* v)
	{
		CQt.QColor_GetHsvF((.)this.ptr.Ptr, h, s, v);
	}
	public void SetHsvF(float h, float s, float v)
	{
		CQt.QColor_SetHsvF((.)this.ptr.Ptr, h, s, v);
	}
	public c_int Cyan()
	{
		return CQt.QColor_Cyan((.)this.ptr.Ptr);
	}
	public c_int Magenta()
	{
		return CQt.QColor_Magenta((.)this.ptr.Ptr);
	}
	public c_int Yellow()
	{
		return CQt.QColor_Yellow((.)this.ptr.Ptr);
	}
	public c_int Black()
	{
		return CQt.QColor_Black((.)this.ptr.Ptr);
	}
	public float CyanF()
	{
		return CQt.QColor_CyanF((.)this.ptr.Ptr);
	}
	public float MagentaF()
	{
		return CQt.QColor_MagentaF((.)this.ptr.Ptr);
	}
	public float YellowF()
	{
		return CQt.QColor_YellowF((.)this.ptr.Ptr);
	}
	public float BlackF()
	{
		return CQt.QColor_BlackF((.)this.ptr.Ptr);
	}
	public void GetCmyk(c_int* c, c_int* m, c_int* y, c_int* k)
	{
		CQt.QColor_GetCmyk((.)this.ptr.Ptr, c, m, y, k);
	}
	public void SetCmyk(c_int c, c_int m, c_int y, c_int k)
	{
		CQt.QColor_SetCmyk((.)this.ptr.Ptr, c, m, y, k);
	}
	public void GetCmykF(float* c, float* m, float* y, float* k)
	{
		CQt.QColor_GetCmykF((.)this.ptr.Ptr, c, m, y, k);
	}
	public void SetCmykF(float c, float m, float y, float k)
	{
		CQt.QColor_SetCmykF((.)this.ptr.Ptr, c, m, y, k);
	}
	public c_int HslHue()
	{
		return CQt.QColor_HslHue((.)this.ptr.Ptr);
	}
	public c_int HslSaturation()
	{
		return CQt.QColor_HslSaturation((.)this.ptr.Ptr);
	}
	public c_int Lightness()
	{
		return CQt.QColor_Lightness((.)this.ptr.Ptr);
	}
	public float HslHueF()
	{
		return CQt.QColor_HslHueF((.)this.ptr.Ptr);
	}
	public float HslSaturationF()
	{
		return CQt.QColor_HslSaturationF((.)this.ptr.Ptr);
	}
	public float LightnessF()
	{
		return CQt.QColor_LightnessF((.)this.ptr.Ptr);
	}
	public void GetHsl(c_int* h, c_int* s, c_int* l)
	{
		CQt.QColor_GetHsl((.)this.ptr.Ptr, h, s, l);
	}
	public void SetHsl(c_int h, c_int s, c_int l)
	{
		CQt.QColor_SetHsl((.)this.ptr.Ptr, h, s, l);
	}
	public void GetHslF(float* h, float* s, float* l)
	{
		CQt.QColor_GetHslF((.)this.ptr.Ptr, h, s, l);
	}
	public void SetHslF(float h, float s, float l)
	{
		CQt.QColor_SetHslF((.)this.ptr.Ptr, h, s, l);
	}
	public QColor_Ptr ToRgb()
	{
		return QColor_Ptr(CQt.QColor_ToRgb((.)this.ptr.Ptr));
	}
	public QColor_Ptr ToHsv()
	{
		return QColor_Ptr(CQt.QColor_ToHsv((.)this.ptr.Ptr));
	}
	public QColor_Ptr ToCmyk()
	{
		return QColor_Ptr(CQt.QColor_ToCmyk((.)this.ptr.Ptr));
	}
	public QColor_Ptr ToHsl()
	{
		return QColor_Ptr(CQt.QColor_ToHsl((.)this.ptr.Ptr));
	}
	public QColor_Ptr ToExtendedRgb()
	{
		return QColor_Ptr(CQt.QColor_ToExtendedRgb((.)this.ptr.Ptr));
	}
	public QColor_Ptr ConvertTo(QColor_Spec colorSpec)
	{
		return QColor_Ptr(CQt.QColor_ConvertTo((.)this.ptr.Ptr, colorSpec));
	}
	...
	{
		return QColor_Ptr(CQt.QColor_Lighter((.)this.ptr.Ptr));
	}
	public QColor_Ptr Darker()
	{
		return QColor_Ptr(CQt.QColor_Darker((.)this.ptr.Ptr));
	}
	...
	{
		return QColor_Ptr(CQt.QColor_Lighter1((.)this.ptr.Ptr, f));
	}
	public QColor_Ptr Darker1(c_int f)
	{
		return QColor_Ptr(CQt.QColor_Darker1((.)this.ptr.Ptr, f));
	}
}
