...
class QFileDialog : IQFileDialog, IQDialog, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QFileDialog_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QFileDialog_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QFileDialog_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		CQt.QFileDialog_SetDirectory((.)this.ptr.Ptr, libqt_string(directory));
	}
	public void SetDirectory2(IQDir directory)
	{
		CQt.QFileDialog_SetDirectory2((.)this.ptr.Ptr, (.)directory?.ObjectPtr);
	}
	public QDir_Ptr Directory()
	{
		return QDir_Ptr(CQt.QFileDialog_Directory((.)this.ptr.Ptr));
	}
	public void SetDirectoryUrl(IQUrl directory)
	{
		CQt.QFileDialog_SetDirectoryUrl((.)this.ptr.Ptr, (.)directory?.ObjectPtr);
	}
	public QUrl_Ptr DirectoryUrl()
	{
		return QUrl_Ptr(CQt.QFileDialog_DirectoryUrl((.)this.ptr.Ptr));
	}
	public void SelectFile(String filename)
	{
		CQt.QFileDialog_SelectFile((.)this.ptr.Ptr, libqt_string(filename));
	}
	public void* SelectedFiles()
	{
		return CQt.QFileDialog_SelectedFiles((.)this.ptr.Ptr);
	}
	public void SelectUrl(IQUrl url)
	{
		CQt.QFileDialog_SelectUrl((.)this.ptr.Ptr, (.)url?.ObjectPtr);
	}
	public void* SelectedUrls()
	{
		return CQt.QFileDialog_SelectedUrls((.)this.ptr.Ptr);
	}
	public void SetNameFilter(String filter)
	{
		CQt.QFileDialog_SetNameFilter((.)this.ptr.Ptr, libqt_string(filter));
	}
	public void SetNameFilters(void** filters)
	{
		CQt.QFileDialog_SetNameFilters((.)this.ptr.Ptr, filters);
	}
	public void* NameFilters()
	{
		return CQt.QFileDialog_NameFilters((.)this.ptr.Ptr);
	}
	public void SelectNameFilter(String filter)
	{
		CQt.QFileDialog_SelectNameFilter((.)this.ptr.Ptr, libqt_string(filter));
	}
	public void SelectedMimeTypeFilter(String outStr)
	{
		CQt.QFileDialog_SelectedMimeTypeFilter((.)this.ptr.Ptr);
	}
	public void SelectedNameFilter(String outStr)
	{
		CQt.QFileDialog_SelectedNameFilter((.)this.ptr.Ptr);
	}
	public void SetMimeTypeFilters(void** filters)
	{
		CQt.QFileDialog_SetMimeTypeFilters((.)this.ptr.Ptr, filters);
	}
	public void* MimeTypeFilters()
	{
		return CQt.QFileDialog_MimeTypeFilters((.)this.ptr.Ptr);
	}
	public void SelectMimeTypeFilter(String filter)
	{
		CQt.QFileDialog_SelectMimeTypeFilter((.)this.ptr.Ptr, libqt_string(filter));
	}
	public void* Filter()
	{
		return CQt.QFileDialog_Filter((.)this.ptr.Ptr);
	}
	public void SetFilter(void* filters)
	{
		CQt.QFileDialog_SetFilter((.)this.ptr.Ptr, filters);
	}
	public void SetViewMode(QFileDialog_ViewMode mode)
	{
		CQt.QFileDialog_SetViewMode((.)this.ptr.Ptr, mode);
	}
	public QFileDialog_ViewMode ViewMode()
	{
		return CQt.QFileDialog_ViewMode((.)this.ptr.Ptr);
	}
	public void SetFileMode(QFileDialog_FileMode mode)
	{
		CQt.QFileDialog_SetFileMode((.)this.ptr.Ptr, mode);
	}
	public QFileDialog_FileMode FileMode()
	{
		return CQt.QFileDialog_FileMode((.)this.ptr.Ptr);
	}
	public void SetAcceptMode(QFileDialog_AcceptMode mode)
	{
		CQt.QFileDialog_SetAcceptMode((.)this.ptr.Ptr, mode);
	}
	public QFileDialog_AcceptMode AcceptMode()
	{
		return CQt.QFileDialog_AcceptMode((.)this.ptr.Ptr);
	}
	public void SetSidebarUrls(void** urls)
	{
		CQt.QFileDialog_SetSidebarUrls((.)this.ptr.Ptr, urls);
	}
	public void* SidebarUrls()
	{
		return CQt.QFileDialog_SidebarUrls((.)this.ptr.Ptr);
	}
	public void* SaveState()
	{
		return CQt.QFileDialog_SaveState((.)this.ptr.Ptr);
	}
	public bool RestoreState(void** state)
	{
		return CQt.QFileDialog_RestoreState((.)this.ptr.Ptr, state);
	}
	public void SetDefaultSuffix(String suffix)
	{
		CQt.QFileDialog_SetDefaultSuffix((.)this.ptr.Ptr, libqt_string(suffix));
	}
	public void DefaultSuffix(String outStr)
	{
		CQt.QFileDialog_DefaultSuffix((.)this.ptr.Ptr);
	}
	public void SetHistory(void** paths)
	{
		CQt.QFileDialog_SetHistory((.)this.ptr.Ptr, paths);
	}
	public void* History()
	{
		return CQt.QFileDialog_History((.)this.ptr.Ptr);
	}
	public void SetItemDelegate(IQAbstractItemDelegate _delegate)
	{
		CQt.QFileDialog_SetItemDelegate((.)this.ptr.Ptr, (.)_delegate?.ObjectPtr);
	}
	public QAbstractItemDelegate_Ptr ItemDelegate()
	{
		return QAbstractItemDelegate_Ptr(CQt.QFileDialog_ItemDelegate((.)this.ptr.Ptr));
	}
	public void SetIconProvider(IQAbstractFileIconProvider provider)
	{
		CQt.QFileDialog_SetIconProvider((.)this.ptr.Ptr, (.)provider?.ObjectPtr);
	}
	public QAbstractFileIconProvider_Ptr IconProvider()
	{
		return QAbstractFileIconProvider_Ptr(CQt.QFileDialog_IconProvider((.)this.ptr.Ptr));
	}
	public void SetLabelText(QFileDialog_DialogLabel label, String text)
	{
		CQt.QFileDialog_SetLabelText((.)this.ptr.Ptr, label, libqt_string(text));
	}
	public void LabelText(String outStr, QFileDialog_DialogLabel label)
	{
		CQt.QFileDialog_LabelText((.)this.ptr.Ptr, label);
	}
	public void SetSupportedSchemes(void** schemes)
	{
		CQt.QFileDialog_SetSupportedSchemes((.)this.ptr.Ptr, schemes);
	}
	public void* SupportedSchemes()
	{
		return CQt.QFileDialog_SupportedSchemes((.)this.ptr.Ptr);
	}
	public void SetProxyModel(IQAbstractProxyModel model)
	{
		CQt.QFileDialog_SetProxyModel((.)this.ptr.Ptr, (.)model?.ObjectPtr);
	}
	public QAbstractProxyModel_Ptr ProxyModel()
	{
		return QAbstractProxyModel_Ptr(CQt.QFileDialog_ProxyModel((.)this.ptr.Ptr));
	}
	public void SetOption(QFileDialog_Option option)
	{
		CQt.QFileDialog_SetOption((.)this.ptr.Ptr, option);
	}
	public bool TestOption(QFileDialog_Option option)
	{
		return CQt.QFileDialog_TestOption((.)this.ptr.Ptr, option);
	}
	public void SetOptions(void* options)
	{
		CQt.QFileDialog_SetOptions((.)this.ptr.Ptr, options);
	}
	public void* Options()
	{
		return CQt.QFileDialog_Options((.)this.ptr.Ptr);
	}
	public void SetVisible(bool visible)
	{
		CQt.QFileDialog_SetVisible((.)this.ptr.Ptr, visible);
	}
	public void FileSelected(String file)
	{
		CQt.QFileDialog_FileSelected((.)this.ptr.Ptr, libqt_string(file));
	}
	public void FilesSelected(void** files)
	{
		CQt.QFileDialog_FilesSelected((.)this.ptr.Ptr, files);
	}
	public void CurrentChanged(String path)
	{
		CQt.QFileDialog_CurrentChanged((.)this.ptr.Ptr, libqt_string(path));
	}
	public void DirectoryEntered(String directory)
	{
		CQt.QFileDialog_DirectoryEntered((.)this.ptr.Ptr, libqt_string(directory));
	}
	public void UrlSelected(IQUrl url)
	{
		CQt.QFileDialog_UrlSelected((.)this.ptr.Ptr, (.)url?.ObjectPtr);
	}
	public void UrlsSelected(void** urls)
	{
		CQt.QFileDialog_UrlsSelected((.)this.ptr.Ptr, urls);
	}
	public void CurrentUrlChanged(IQUrl url)
	{
		CQt.QFileDialog_CurrentUrlChanged((.)this.ptr.Ptr, (.)url?.ObjectPtr);
	}
	public void DirectoryUrlEntered(IQUrl directory)
	{
		CQt.QFileDialog_DirectoryUrlEntered((.)this.ptr.Ptr, (.)directory?.ObjectPtr);
	}
	public void FilterSelected(String filter)
	{
		CQt.QFileDialog_FilterSelected((.)this.ptr.Ptr, libqt_string(filter));
	}
	...
	{
		CQt.QFileDialog_Done((.)this.ptr.Ptr, result);
	}
	public void Accept()
	{
		CQt.QFileDialog_Accept((.)this.ptr.Ptr);
	}
	public void ChangeEvent(IQEvent e)
	{
		CQt.QFileDialog_ChangeEvent((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	...
	{
		CQt.QFileDialog_SetOption2((.)this.ptr.Ptr, option, on);
	}
