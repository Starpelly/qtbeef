...
class QLayoutItem
{
	...
	public this(QLayoutItem_Ptr* param1)
	{
		this.ptr = CQt.QLayoutItem_new2(param1);
	}
	...
	{
		CQt.QLayoutItem_SetGeometry(this.ptr, geometry);
	}
...
class QSpacerItem
{
	...
	public this(QSpacerItem_Ptr* param1)
	{
		this.ptr = CQt.QSpacerItem_new2(param1);
	}
	...
	public void SetGeometry(QRect_Ptr* geometry)
	{
		CQt.QSpacerItem_SetGeometry(this.ptr, geometry);
	}
	public QRect_Ptr Geometry()
	{
...
class QWidgetItem
{
	...
	{
		this.ptr = CQt.QWidgetItem_new(w);
	}
	public ~this()
	{
	...
	public void SetGeometry(QRect_Ptr* geometry)
	{
		CQt.QWidgetItem_SetGeometry(this.ptr, geometry);
	}
	public QRect_Ptr Geometry()
	{
...
class QWidgetItemV2
{
	...
	public this(QWidget_Ptr* widget)
	{
		this.ptr = CQt.QWidgetItemV2_new(widget);
	}
	public ~this()
	{
