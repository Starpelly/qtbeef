...
class QFocusFrame : IQFocusFrame, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QFocusFrame_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QFocusFrame_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QFocusFrame_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		CQt.QFocusFrame_SetWidget((.)this.ptr.Ptr, (.)widget?.ObjectPtr);
	}
	public QWidget_Ptr Widget()
	{
		return QWidget_Ptr(CQt.QFocusFrame_Widget((.)this.ptr.Ptr));
	}
	public bool Event(IQEvent e)
	{
		return CQt.QFocusFrame_Event((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public bool EventFilter(IQObject param1, IQEvent param2)
	{
		return CQt.QFocusFrame_EventFilter((.)this.ptr.Ptr, (.)param1?.ObjectPtr, (.)param2?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QFocusFrame_PaintEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void InitStyleOption(IQStyleOption option)
	{
		CQt.QFocusFrame_InitStyleOption((.)this.ptr.Ptr, (.)option?.ObjectPtr);
	}
