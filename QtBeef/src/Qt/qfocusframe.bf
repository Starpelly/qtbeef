...
class QFocusFrame : IQFocusFrame, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		QFocusFrame_windowTitleChanged,
		QFocusFrame_windowIconChanged,
		QFocusFrame_windowIconTextChanged,
		QFocusFrame_customContextMenuRequested,
		QFocusFrame_destroyed,
		QFocusFrame_destroyed1,
	}
