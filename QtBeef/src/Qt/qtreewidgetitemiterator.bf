...
class QTreeWidgetItemIterator : IQTreeWidgetItemIterator
{
	...
	{
		return QTreeWidgetItemIterator_Ptr(CQt.QTreeWidgetItemIterator_OperatorPlusPlus2((.)this.ptr.Ptr, param1));
	}
	public QTreeWidgetItemIterator_Ptr OperatorMinusMinus2(c_int param1)
	{
		return QTreeWidgetItemIterator_Ptr(CQt.QTreeWidgetItemIterator_OperatorMinusMinus2((.)this.ptr.Ptr, param1));
	}
}
