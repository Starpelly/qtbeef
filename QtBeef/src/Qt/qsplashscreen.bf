...
struct QSplashScreen_Ptr
{
	...
	{
		CQt.QSplashScreen_SetPixmap((.)this.Ptr, (.)pixmap?.ObjectPtr);
	}
	public QPixmap_Ptr Pixmap()
	{
		return QPixmap_Ptr(CQt.QSplashScreen_Pixmap((.)this.Ptr));
	}
	public void Finish(IQWidget w)
	{
		CQt.QSplashScreen_Finish((.)this.Ptr, (.)w?.ObjectPtr);
	}
	public void Repaint()
	{
	...
	{
		CQt.QSplashScreen_Message((.)this.Ptr);
	}
	public void ShowMessage(String message)
	{
		CQt.QSplashScreen_ShowMessage((.)this.Ptr, libqt_string(message));
	}
	...
	{
		CQt.QSplashScreen_MessageChanged((.)this.Ptr, libqt_string(message));
	}
	public bool Event(IQEvent e)
	{
		return CQt.QSplashScreen_Event((.)this.Ptr, (.)e?.ObjectPtr);
	}
	public void DrawContents(IQPainter painter)
	{
		CQt.QSplashScreen_DrawContents((.)this.Ptr, (.)painter?.ObjectPtr);
	}
	public void MousePressEvent(IQMouseEvent param1)
	{
		CQt.QSplashScreen_MousePressEvent((.)this.Ptr, (.)param1?.ObjectPtr);
	}
	...
	{
		CQt.QSplashScreen_ShowMessage2((.)this.Ptr, libqt_string(message), alignment);
	}
...
class QSplashScreen : IQSplashScreen, IQWidget, IQObject, IQPaintDevice
{
	...
	static void QtBf_ConnectSignals(Self obj)
	{
		...
		CQt.QSplashScreen_Connect_MessageChanged(obj.ObjectPtr,  => QtBeef_QSplashScreen_Connect_MessageChanged);
	...
	static void QtBeef_QSplashScreen_Connect_MessageChanged(void* ptr, libqt_string message)
	{
	...
	public void ShowMessage2(String message, c_int alignment)
	{
		this.ptr.ShowMessage2(message, alignment);
	}
	public void ShowMessage3(String message, c_int alignment, IQColor color)
	{
