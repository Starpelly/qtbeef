...
extension CQt
{
	...
	public static extern QSplashScreen_Ptr QSplashScreen_new2(void** screen);
	[LinkName("QSplashScreen_new3")]
	public static extern QSplashScreen_Ptr QSplashScreen_new3(void** pixmap);
	[LinkName("QSplashScreen_new4")]
	public static extern QSplashScreen_Ptr QSplashScreen_new4(void** pixmap, void* f);
	[LinkName("QSplashScreen_new5")]
	public static extern QSplashScreen_Ptr QSplashScreen_new5(void** screen, void** pixmap);
	[LinkName("QSplashScreen_new6")]
	public static extern QSplashScreen_Ptr QSplashScreen_new6(void** screen, void** pixmap, void* f);
	...
	public static extern void QSplashScreen_SetPixmap(void* self, void** pixmap);
	[LinkName("QSplashScreen_Pixmap")]
	public static extern void* QSplashScreen_Pixmap(void* self);
	[LinkName("QSplashScreen_Finish")]
	public static extern void QSplashScreen_Finish(void* self, void** w);
	[LinkName("QSplashScreen_Repaint")]
	public static extern void QSplashScreen_Repaint(void* self);
	[LinkName("QSplashScreen_Message")]
	public static extern libqt_string QSplashScreen_Message(void* self);
	[LinkName("QSplashScreen_ShowMessage")]
	public static extern void QSplashScreen_ShowMessage(void* self, libqt_string message);
...
class QSplashScreen : IQSplashScreen, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QSplashScreen_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QSplashScreen_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QSplashScreen_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	public void Tr(String outStr, c_char* s)
	{
		CQt.QSplashScreen_Tr(s);
	}
	public void SetPixmap(IQPixmap pixmap)
	{
		CQt.QSplashScreen_SetPixmap((.)this.ptr.Ptr, (.)pixmap?.ObjectPtr);
	}
	public QPixmap_Ptr Pixmap()
	{
		return QPixmap_Ptr(CQt.QSplashScreen_Pixmap((.)this.ptr.Ptr));
	}
	public void Finish(IQWidget w)
	{
		CQt.QSplashScreen_Finish((.)this.ptr.Ptr, (.)w?.ObjectPtr);
	}
	public void Repaint()
	{
		CQt.QSplashScreen_Repaint((.)this.ptr.Ptr);
	}
	public void Message(String outStr)
	{
		CQt.QSplashScreen_Message((.)this.ptr.Ptr);
	}
	public void ShowMessage(String message)
	{
		CQt.QSplashScreen_ShowMessage((.)this.ptr.Ptr, libqt_string(message));
	}
	public void ClearMessage()
	{
		CQt.QSplashScreen_ClearMessage((.)this.ptr.Ptr);
	}
	public void MessageChanged(String message)
	{
		CQt.QSplashScreen_MessageChanged((.)this.ptr.Ptr, libqt_string(message));
	}
	public bool Event(IQEvent e)
	{
		return CQt.QSplashScreen_Event((.)this.ptr.Ptr, (.)e?.ObjectPtr);
	}
	public void DrawContents(IQPainter painter)
	{
		CQt.QSplashScreen_DrawContents((.)this.ptr.Ptr, (.)painter?.ObjectPtr);
	}
	public void MousePressEvent(IQMouseEvent param1)
	{
		CQt.QSplashScreen_MousePressEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void Tr2(String outStr, c_char* s, c_char* c)
	{
		CQt.QSplashScreen_Tr2(s, c);
	}
	public void Tr3(String outStr, c_char* s, c_char* c, c_int n)
	{
		CQt.QSplashScreen_Tr3(s, c, n);
	}
	public void ShowMessage2(String message, c_int alignment)
	{
		CQt.QSplashScreen_ShowMessage2((.)this.ptr.Ptr, libqt_string(message), alignment);
	}
	public void ShowMessage3(String message, c_int alignment, IQColor color)
	{
		CQt.QSplashScreen_ShowMessage3((.)this.ptr.Ptr, libqt_string(message), alignment, (.)color?.ObjectPtr);
	}
