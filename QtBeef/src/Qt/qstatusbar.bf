...
struct QStatusBar_Ptr
{
	...
	{
		return QMetaObject_Ptr(CQt.QStatusBar_MetaObject((.)this.Ptr));
	}
	...
	{
		CQt.QStatusBar_AddWidget((.)this.Ptr, (.)widget?.ObjectPtr);
	}
	public c_int InsertWidget(c_int index, IQWidget widget)
	{
		return CQt.QStatusBar_InsertWidget((.)this.Ptr, index, (.)widget?.ObjectPtr);
	}
	public void AddPermanentWidget(IQWidget widget)
	{
		CQt.QStatusBar_AddPermanentWidget((.)this.Ptr, (.)widget?.ObjectPtr);
	}
	public c_int InsertPermanentWidget(c_int index, IQWidget widget)
	{
		return CQt.QStatusBar_InsertPermanentWidget((.)this.Ptr, index, (.)widget?.ObjectPtr);
	}
	public void RemoveWidget(IQWidget widget)
	{
		CQt.QStatusBar_RemoveWidget((.)this.Ptr, (.)widget?.ObjectPtr);
	}
	...
	public void CurrentMessage(String outStr)
	{
		CQt.QStatusBar_CurrentMessage((.)this.Ptr);
	}
	public void ShowMessage(String text)
	{
		CQt.QStatusBar_ShowMessage((.)this.Ptr, libqt_string(text));
	}
	...
	{
		CQt.QStatusBar_MessageChanged((.)this.Ptr, libqt_string(text));
	}
	public void ShowEvent(IQShowEvent param1)
	{
		CQt.QStatusBar_ShowEvent((.)this.Ptr, (.)param1?.ObjectPtr);
	}
	public void PaintEvent(IQPaintEvent param1)
	{
		CQt.QStatusBar_PaintEvent((.)this.Ptr, (.)param1?.ObjectPtr);
	}
	public void ResizeEvent(IQResizeEvent param1)
	{
		CQt.QStatusBar_ResizeEvent((.)this.Ptr, (.)param1?.ObjectPtr);
	}
	...
	{
		return CQt.QStatusBar_Event((.)this.Ptr, (.)param1?.ObjectPtr);
	}
	public void Tr2(String outStr, c_char* s, c_char* c)
	{
		CQt.QStatusBar_Tr2(s, c);
	}
	public void Tr3(String outStr, c_char* s, c_char* c, c_int n)
	{
		CQt.QStatusBar_Tr3(s, c, n);
	}
	public void AddWidget2(IQWidget widget, c_int stretch)
	{
		CQt.QStatusBar_AddWidget2((.)this.Ptr, (.)widget?.ObjectPtr, stretch);
	}
	public c_int InsertWidget3(c_int index, IQWidget widget, c_int stretch)
	{
		return CQt.QStatusBar_InsertWidget3((.)this.Ptr, index, (.)widget?.ObjectPtr, stretch);
	}
	public void AddPermanentWidget2(IQWidget widget, c_int stretch)
	{
		CQt.QStatusBar_AddPermanentWidget2((.)this.Ptr, (.)widget?.ObjectPtr, stretch);
	}
	public c_int InsertPermanentWidget3(c_int index, IQWidget widget, c_int stretch)
	{
		return CQt.QStatusBar_InsertPermanentWidget3((.)this.Ptr, index, (.)widget?.ObjectPtr, stretch);
	}
	public void ShowMessage2(String text, c_int timeout)
	{
		CQt.QStatusBar_ShowMessage2((.)this.Ptr, libqt_string(text), timeout);
	}
	public bool EventFilter(IQObject watched, IQEvent event)
	{
		return CQt.QStatusBar_EventFilter((.)this.Ptr, (.)watched?.ObjectPtr, (.)event?.ObjectPtr);
	}
	...
	{
		CQt.QStatusBar_TimerEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ChildEvent(IQChildEvent event)
	{
		CQt.QStatusBar_ChildEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void CustomEvent(IQEvent event)
	{
		CQt.QStatusBar_CustomEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ConnectNotify(IQMetaMethod signal)
	{
		CQt.QStatusBar_ConnectNotify((.)this.Ptr, (.)signal?.ObjectPtr);
	}
	public void DisconnectNotify(IQMetaMethod signal)
	{
		CQt.QStatusBar_DisconnectNotify((.)this.Ptr, (.)signal?.ObjectPtr);
	}
	...
	{
		return CQt.QStatusBar_DevType((.)this.Ptr);
	}
	...
	{
		return QPaintEngine_Ptr(CQt.QStatusBar_PaintEngine((.)this.Ptr));
	}
	public c_int Width()
	{
	...
	{
		return CQt.QStatusBar_Metric((.)this.Ptr, metric);
	}
	public void InitPainter(IQPainter painter)
	{
		CQt.QStatusBar_InitPainter((.)this.Ptr, (.)painter?.ObjectPtr);
	}
	public QPaintDevice_Ptr Redirected(IQPoint offset)
	{
		return QPaintDevice_Ptr(CQt.QStatusBar_Redirected((.)this.Ptr, (.)offset?.ObjectPtr));
	}
	public QPainter_Ptr SharedPainter()
	{
		return QPainter_Ptr(CQt.QStatusBar_SharedPainter((.)this.Ptr));
	}
	public void* WinId()
	{
	...
	{
		CQt.QStatusBar_SetVisible((.)this.Ptr, visible);
	}
	...
	{
		return QSize_Ptr(CQt.QStatusBar_SizeHint((.)this.Ptr));
	}
	public QSize_Ptr MinimumSizeHint()
	{
		return QSize_Ptr(CQt.QStatusBar_MinimumSizeHint((.)this.Ptr));
	}
	...
	{
		return CQt.QStatusBar_HeightForWidth((.)this.Ptr, param1);
	}
	public bool HasHeightForWidth()
	{
		return CQt.QStatusBar_HasHeightForWidth((.)this.Ptr);
	}
	...
	{
		CQt.QStatusBar_MousePressEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void MouseReleaseEvent(IQMouseEvent event)
	{
		CQt.QStatusBar_MouseReleaseEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void MouseDoubleClickEvent(IQMouseEvent event)
	{
		CQt.QStatusBar_MouseDoubleClickEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void MouseMoveEvent(IQMouseEvent event)
	{
		CQt.QStatusBar_MouseMoveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void WheelEvent(IQWheelEvent event)
	{
		CQt.QStatusBar_WheelEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void KeyPressEvent(IQKeyEvent event)
	{
		CQt.QStatusBar_KeyPressEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void KeyReleaseEvent(IQKeyEvent event)
	{
		CQt.QStatusBar_KeyReleaseEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void FocusInEvent(IQFocusEvent event)
	{
		CQt.QStatusBar_FocusInEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void FocusOutEvent(IQFocusEvent event)
	{
		CQt.QStatusBar_FocusOutEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void EnterEvent(IQEnterEvent event)
	{
		CQt.QStatusBar_EnterEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void LeaveEvent(IQEvent event)
	{
		CQt.QStatusBar_LeaveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void MoveEvent(IQMoveEvent event)
	{
		CQt.QStatusBar_MoveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void CloseEvent(IQCloseEvent event)
	{
		CQt.QStatusBar_CloseEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ContextMenuEvent(IQContextMenuEvent event)
	{
		CQt.QStatusBar_ContextMenuEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void TabletEvent(IQTabletEvent event)
	{
		CQt.QStatusBar_TabletEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void ActionEvent(IQActionEvent event)
	{
		CQt.QStatusBar_ActionEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void DragEnterEvent(IQDragEnterEvent event)
	{
		CQt.QStatusBar_DragEnterEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void DragMoveEvent(IQDragMoveEvent event)
	{
		CQt.QStatusBar_DragMoveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void DragLeaveEvent(IQDragLeaveEvent event)
	{
		CQt.QStatusBar_DragLeaveEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void DropEvent(IQDropEvent event)
	{
		CQt.QStatusBar_DropEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public void HideEvent(IQHideEvent event)
	{
		CQt.QStatusBar_HideEvent((.)this.Ptr, (.)event?.ObjectPtr);
	}
	public bool NativeEvent(void** eventType, void* message, void** result)
	{
		return CQt.QStatusBar_NativeEvent((.)this.Ptr, eventType, message, result);
	}
	public void ChangeEvent(IQEvent param1)
	{
		CQt.QStatusBar_ChangeEvent((.)this.Ptr, (.)param1?.ObjectPtr);
	}
	public void InputMethodEvent(IQInputMethodEvent param1)
	{
		CQt.QStatusBar_InputMethodEvent((.)this.Ptr, (.)param1?.ObjectPtr);
	}
	public QVariant_Ptr InputMethodQuery(Qt_InputMethodQuery param1)
	{
		return QVariant_Ptr(CQt.QStatusBar_InputMethodQuery((.)this.Ptr, param1));
	}
	...
	{
		return CQt.QStatusBar_FocusNextPrevChild((.)this.Ptr, next);
	}
...
class QStatusBar : IQStatusBar, IQWidget, IQObject, IQPaintDevice
{
	...
	static void QtBf_ConnectSignals(Self obj)
	{
		...
		CQt.QStatusBar_Connect_MessageChanged(obj.ObjectPtr,  => QtBeef_QStatusBar_Connect_MessageChanged);
	...
	static void QtBeef_QStatusBar_Connect_MessageChanged(void* ptr, libqt_string text)
	{
	...
	public c_int InsertWidget(c_int index, IQWidget widget)
	{
		return this.ptr.InsertWidget(index, widget);
	}
	public void AddPermanentWidget(IQWidget widget)
	{
		this.ptr.AddPermanentWidget(widget);
	}
	public c_int InsertPermanentWidget(c_int index, IQWidget widget)
	{
		return this.ptr.InsertPermanentWidget(index, widget);
	}
	public void RemoveWidget(IQWidget widget)
	{
		this.ptr.RemoveWidget(widget);
	}
	public void SetSizeGripEnabled(bool sizeGripEnabled)
	{
	...
	public void CurrentMessage(String outStr)
	{
		this.ptr.CurrentMessage(outStr);
	}
	public void ShowMessage(String text)
	{
		this.ptr.ShowMessage(text);
	}
	public void ClearMessage()
	{
		this.ptr.ClearMessage();
	}
	public void MessageChanged(String text)
	{
		this.ptr.MessageChanged(text);
	}
	...
	public void AddWidget2(IQWidget widget, c_int stretch)
	{
		this.ptr.AddWidget2(widget, stretch);
	}
	public c_int InsertWidget3(c_int index, IQWidget widget, c_int stretch)
	{
		return this.ptr.InsertWidget3(index, widget, stretch);
	}
	public void AddPermanentWidget2(IQWidget widget, c_int stretch)
	{
		this.ptr.AddPermanentWidget2(widget, stretch);
	}
	public c_int InsertPermanentWidget3(c_int index, IQWidget widget, c_int stretch)
	{
		return this.ptr.InsertPermanentWidget3(index, widget, stretch);
	}
	public void ShowMessage2(String text, c_int timeout)
	{
		this.ptr.ShowMessage2(text, timeout);
	}
...
interface IQStatusBar : IQtObjectInterface
{
}
extension CQt
{
	[LinkName("QStatusBar_new")]
	public static extern QStatusBar_Ptr QStatusBar_new(void** parent);
	...
	public static extern void** QStatusBar_MetaObject(void* self);
	...
	public static extern void QStatusBar_AddWidget(void* self, void** widget);
	[LinkName("QStatusBar_InsertWidget")]
	public static extern c_int QStatusBar_InsertWidget(void* self, c_int index, void** widget);
	[LinkName("QStatusBar_AddPermanentWidget")]
	public static extern void QStatusBar_AddPermanentWidget(void* self, void** widget);
	[LinkName("QStatusBar_InsertPermanentWidget")]
	public static extern c_int QStatusBar_InsertPermanentWidget(void* self, c_int index, void** widget);
	[LinkName("QStatusBar_RemoveWidget")]
	public static extern void QStatusBar_RemoveWidget(void* self, void** widget);
	[LinkName("QStatusBar_SetSizeGripEnabled")]
	public static extern void QStatusBar_SetSizeGripEnabled(void* self, bool sizeGripEnabled);
	[LinkName("QStatusBar_IsSizeGripEnabled")]
	public static extern bool QStatusBar_IsSizeGripEnabled(void* self);
	[LinkName("QStatusBar_CurrentMessage")]
	public static extern libqt_string QStatusBar_CurrentMessage(void* self);
	[LinkName("QStatusBar_ShowMessage")]
	public static extern void QStatusBar_ShowMessage(void* self, libqt_string text);
	...
	public function void QStatusBar_Connect_MessageChanged_action(void* self, libqt_string text);
	[LinkName("QStatusBar_Connect_MessageChanged")]
	public static extern void QStatusBar_Connect_MessageChanged(void* self, QStatusBar_Connect_MessageChanged_action _action);
	...
	public static extern void QStatusBar_HideOrShow(void* self);
	[LinkName("QStatusBar_Event")]
	public static extern bool QStatusBar_Event(void* self, void** param1);
	...
	public static extern void QStatusBar_AddWidget2(void* self, void** widget, c_int stretch);
	[LinkName("QStatusBar_InsertWidget3")]
	public static extern c_int QStatusBar_InsertWidget3(void* self, c_int index, void** widget, c_int stretch);
	[LinkName("QStatusBar_AddPermanentWidget2")]
	public static extern void QStatusBar_AddPermanentWidget2(void* self, void** widget, c_int stretch);
	[LinkName("QStatusBar_InsertPermanentWidget3")]
	public static extern c_int QStatusBar_InsertPermanentWidget3(void* self, c_int index, void** widget, c_int stretch);
	[LinkName("QStatusBar_ShowMessage2")]
	public static extern void QStatusBar_ShowMessage2(void* self, libqt_string text, c_int timeout);
	[LinkName("QStatusBar_EventFilter")]
	public static extern bool QStatusBar_EventFilter(void* self, void** watched, void** event);
