...
class QPageLayout
{
	...
	public this(QPageSize_Ptr* pageSize, QPageLayout_Orientation orientation, QMarginsF_Ptr* margins)
	{
		this.ptr = CQt.QPageLayout_new2(pageSize, orientation, margins);
	}
	public this(QPageLayout_Ptr* other)
	{
		this.ptr = CQt.QPageLayout_new3(other);
	}
	public this(QPageSize_Ptr* pageSize, QPageLayout_Orientation orientation, QMarginsF_Ptr* margins, QPageLayout_Unit units)
	{
		this.ptr = CQt.QPageLayout_new4(pageSize, orientation, margins, units);
	}
	public this(QPageSize_Ptr* pageSize, QPageLayout_Orientation orientation, QMarginsF_Ptr* margins, QPageLayout_Unit units, QMarginsF_Ptr* minMargins)
	{
		this.ptr = CQt.QPageLayout_new5(pageSize, orientation, margins, units, minMargins);
	}
	public ~this()
	{
...
interface IQPageLayout
{
	...
	public bool SetLeftMargin();
	public bool SetRightMargin();
	public bool SetTopMargin();
	public bool SetBottomMargin();
	public QMarginsF Margins();
	public QMarginsF Margins2();
	public QMargins MarginsPoints();
	public QMargins MarginsPixels();
	public void SetMinimumMargins();
	public QMarginsF MinimumMargins();
	public QMarginsF MaximumMargins();
	public QRectF FullRect();
	public QRectF FullRect2();
	public QRect FullRectPoints();
	public QRect FullRectPixels();
	public QRectF PaintRect();
	public QRectF PaintRect2();
	public QRect PaintRectPoints();
	public QRect PaintRectPixels();
	public void SetPageSize2();
}
[AllowDuplicates]
