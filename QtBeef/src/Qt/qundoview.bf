...
class QUndoView
{
	...
	{
		this.ptr = CQt.QUndoView_new(parent);
	}
	public this()
	{
		this.ptr = CQt.QUndoView_new2();
	}
	public this(QUndoStack_Ptr* stack)
	{
		this.ptr = CQt.QUndoView_new3(stack);
	}
	public this(QUndoGroup_Ptr* group)
	{
		this.ptr = CQt.QUndoView_new4(group);
	}
	public this(QUndoStack_Ptr* stack, QWidget_Ptr* parent)
	{
		this.ptr = CQt.QUndoView_new5(stack, parent);
	}
	public this(QUndoGroup_Ptr* group, QWidget_Ptr* parent)
	{
		this.ptr = CQt.QUndoView_new6(group, parent);
	}
	public ~this()
	{
