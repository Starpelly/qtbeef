...
class QKeySequenceEdit : IQKeySequenceEdit, IQWidget, IQObject, IQPaintDevice
{
	...
	{
		return QMetaObject_Ptr(CQt.QKeySequenceEdit_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QKeySequenceEdit_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QKeySequenceEdit_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		return QKeySequence_Ptr(CQt.QKeySequenceEdit_KeySequence((.)this.ptr.Ptr));
	}
	public void SetClearButtonEnabled(bool enable)
	{
		CQt.QKeySequenceEdit_SetClearButtonEnabled((.)this.ptr.Ptr, enable);
	}
	public bool IsClearButtonEnabled()
	{
		return CQt.QKeySequenceEdit_IsClearButtonEnabled((.)this.ptr.Ptr);
	}
	public void SetKeySequence(IQKeySequence keySequence)
	{
		CQt.QKeySequenceEdit_SetKeySequence((.)this.ptr.Ptr, (.)keySequence?.ObjectPtr);
	}
	public void Clear()
	{
		CQt.QKeySequenceEdit_Clear((.)this.ptr.Ptr);
	}
	public void EditingFinished()
	{
		CQt.QKeySequenceEdit_EditingFinished((.)this.ptr.Ptr);
	}
	public void KeySequenceChanged(IQKeySequence keySequence)
	{
		CQt.QKeySequenceEdit_KeySequenceChanged((.)this.ptr.Ptr, (.)keySequence?.ObjectPtr);
	}
	public bool Event(IQEvent param1)
	{
		return CQt.QKeySequenceEdit_Event((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void KeyPressEvent(IQKeyEvent param1)
	{
		CQt.QKeySequenceEdit_KeyPressEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void KeyReleaseEvent(IQKeyEvent param1)
	{
		CQt.QKeySequenceEdit_KeyReleaseEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void TimerEvent(IQTimerEvent param1)
	{
		CQt.QKeySequenceEdit_TimerEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
	public void FocusOutEvent(IQFocusEvent param1)
	{
		CQt.QKeySequenceEdit_FocusOutEvent((.)this.ptr.Ptr, (.)param1?.ObjectPtr);
	}
