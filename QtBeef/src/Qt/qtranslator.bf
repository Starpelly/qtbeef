...
class QTranslator : IQTranslator, IQObject
{
	...
	{
		return QMetaObject_Ptr(CQt.QTranslator_MetaObject((.)this.ptr.Ptr));
	}
	public void* Qt_metacast(c_char* param1)
	{
		return CQt.QTranslator_Qt_Metacast((.)this.ptr.Ptr, param1);
	}
	public c_int Qt_metacall(QMetaObject_Call param1, c_int param2, void** param3)
	{
		return CQt.QTranslator_Qt_Metacall((.)this.ptr.Ptr, param1, param2, param3);
	}
	...
	{
		CQt.QTranslator_Translate((.)this.ptr.Ptr, context, sourceText, disambiguation, n);
	}
	public bool IsEmpty()
	{
		return CQt.QTranslator_IsEmpty((.)this.ptr.Ptr);
	}
	public void Language(String outStr)
	{
		CQt.QTranslator_Language((.)this.ptr.Ptr);
	}
	public void FilePath(String outStr)
	{
		CQt.QTranslator_FilePath((.)this.ptr.Ptr);
	}
	public bool Load(String filename)
	{
		return CQt.QTranslator_Load((.)this.ptr.Ptr, libqt_string(filename));
	}
	public bool Load2(IQLocale locale, String filename)
	{
		return CQt.QTranslator_Load2((.)this.ptr.Ptr, (.)locale?.ObjectPtr, libqt_string(filename));
	}
	public bool Load3(c_uchar* data, c_int lenVal)
	{
		return CQt.QTranslator_Load3((.)this.ptr.Ptr, data, lenVal);
	}
	...
	{
		return CQt.QTranslator_Load22((.)this.ptr.Ptr, libqt_string(filename), libqt_string(directory));
	}
	public bool Load32(String filename, String directory, String search_delimiters)
	{
		return CQt.QTranslator_Load32((.)this.ptr.Ptr, libqt_string(filename), libqt_string(directory), libqt_string(search_delimiters));
	}
	public bool Load4(String filename, String directory, String search_delimiters, String suffix)
	{
		return CQt.QTranslator_Load4((.)this.ptr.Ptr, libqt_string(filename), libqt_string(directory), libqt_string(search_delimiters), libqt_string(suffix));
	}
	public bool Load33(IQLocale locale, String filename, String prefix)
	{
		return CQt.QTranslator_Load33((.)this.ptr.Ptr, (.)locale?.ObjectPtr, libqt_string(filename), libqt_string(prefix));
	}
	public bool Load42(IQLocale locale, String filename, String prefix, String directory)
	{
		return CQt.QTranslator_Load42((.)this.ptr.Ptr, (.)locale?.ObjectPtr, libqt_string(filename), libqt_string(prefix), libqt_string(directory));
	}
	public bool Load5(IQLocale locale, String filename, String prefix, String directory, String suffix)
	{
		return CQt.QTranslator_Load5((.)this.ptr.Ptr, (.)locale?.ObjectPtr, libqt_string(filename), libqt_string(prefix), libqt_string(directory), libqt_string(suffix));
	}
	public bool Load34(c_uchar* data, c_int lenVal, String directory)
	{
		return CQt.QTranslator_Load34((.)this.ptr.Ptr, data, lenVal, libqt_string(directory));
	}
