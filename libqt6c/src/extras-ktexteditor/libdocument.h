...
/// @param text const char**
///
bool k_texteditor__document_set_text2(void* self, const char* text[1]);
...
/// @param block bool
///
bool k_texteditor__document_insert_text2(void* self, void* position, const char* text[1], bool block);
...
/// @param block bool
///
bool k_texteditor__document_replace_text2(void* self, void* range, const char* text[1], bool block);
...
/// @param text const char**
///
bool k_texteditor__document_insert_lines(void* self, int line, const char* text[1]);
...
///
const char* k_texteditor__document_find_most_recent_x_m_l_file(const char* files[1], const char* doc);
