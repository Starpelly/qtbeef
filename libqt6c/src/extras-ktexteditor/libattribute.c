...
void k_texteditor__attribute_set_font_families(void* self, const char* families[1]) {
...
void k_texteditor__attribute_set_anchor_names(void* self, const char* names[1]) {
