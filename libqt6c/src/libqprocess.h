...
///
void q_process_set_arguments(void* self, const char* arguments[1]);
...
///
void q_process_set_environment(void* self, const char* environment[1]);
...
/// @param arguments const char**
///
void q_process_start22(void* self, const char* program, const char* arguments[1]);
...
/// @param mode flag of enum QIODeviceBase__OpenModeFlag
///
void q_process_start3(void* self, const char* program, const char* arguments[1], int32_t mode);
...
/// @param arguments const char**
///
int32_t q_process_execute2(const char* program, const char* arguments[1]);
...
/// @param arguments const char**
///
bool q_process_start_detached22(const char* program, const char* arguments[1]);
...
///
bool q_process_start_detached3(const char* program, const char* arguments[1], const char* workingDirectory);
...
/// @param pid long long*
///
bool q_process_start_detached4(const char* program, const char* arguments[1], const char* workingDirectory, long long* pid);
