...
void k_nscore__entry_set_installed_files(void* self, const char* files[1]) {
...
void k_nscore__entry_set_tags(void* self, const char* tags[1]) {
...
void k_nscore__entry__downloadlinkinformation_set_tags(void* self, const char* tags[1]) {
    size_t tags_len = libqt_strv_length(tags);
    libqt_string* tags_qstr = (libqt_string*)malloc(tags_len * sizeof(libqt_string));
    if (tags_qstr == NULL) {
