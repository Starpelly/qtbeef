...
///
KNSCore__TagsFilterChecker* k_nscore__tagsfilterchecker_new(const char* tagFilter[1]);
...
///
bool k_nscore__tagsfilterchecker_filter_accepts(void* self, const char* tags[1]);
