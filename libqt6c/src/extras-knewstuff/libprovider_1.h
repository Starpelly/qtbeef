...
///
void k_nscore__provider_set_tag_filter(void* self, const char* tagFilter[1]);
...
///
void k_nscore__provider_set_download_tag_filter(void* self, const char* downloadTagFilter[1]);
...
///
KNSCore__Provider__SearchRequest* k_nscore__provider__searchrequest_new6(int32_t sortMode_, int32_t filter_, const char* searchTerm_, const char* categories_[1]);
...
/// @param page_ int
///
KNSCore__Provider__SearchRequest* k_nscore__provider__searchrequest_new7(int32_t sortMode_, int32_t filter_, const char* searchTerm_, const char* categories_[1], int page_);
...
/// @param pageSize_ int
///
KNSCore__Provider__SearchRequest* k_nscore__provider__searchrequest_new8(int32_t sortMode_, int32_t filter_, const char* searchTerm_, const char* categories_[1], int page_, int pageSize_);
...
///
void k_nscore__provider__searchrequest_set_categories(void* self, const char* categories[1]);
