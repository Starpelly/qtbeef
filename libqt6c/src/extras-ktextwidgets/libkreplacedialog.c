...
KReplaceDialog* k_replacedialog_new4(void* parent, long options, const char* findStrings[1]) {
...
KReplaceDialog* k_replacedialog_new5(void* parent, long options, const char* findStrings[1], const char* replaceStrings[1]) {
    size_t findStrings_len = libqt_strv_length(findStrings);
    libqt_string* findStrings_qstr = (libqt_string*)malloc(findStrings_len * sizeof(libqt_string));
    if (findStrings_qstr == NULL) {
...
KReplaceDialog* k_replacedialog_new6(void* parent, long options, const char* findStrings[1], const char* replaceStrings[1], bool hasSelection) {
    size_t findStrings_len = libqt_strv_length(findStrings);
    libqt_string* findStrings_qstr = (libqt_string*)malloc(findStrings_len * sizeof(libqt_string));
    if (findStrings_qstr == NULL) {
...
void k_replacedialog_set_replacement_history(void* self, const char* history[1]) {
...
void k_replacedialog_set_find_history(void* self, const char* history[1]) {
    size_t history_len = libqt_strv_length(history);
    libqt_string* history_qstr = (libqt_string*)malloc(history_len * sizeof(libqt_string));
    if (history_qstr == NULL) {
