...
///
void q_sessionmanager_set_restart_command(void* self, const char* restartCommand[1]);
...
///
void q_sessionmanager_set_discard_command(void* self, const char* discardCommand[1]);
...
/// @param value const char**
///
void q_sessionmanager_set_manager_property2(void* self, const char* name, const char* value[1]);
