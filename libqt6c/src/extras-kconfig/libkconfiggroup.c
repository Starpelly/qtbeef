...
const char** k_configgroup_read_entry9(void* self, const char* key, const char* aDefault[1]) {
...
const char** k_configgroup_read_entry10(void* self, const char* key, const char* aDefault[1]) {
    size_t aDefault_len = libqt_strv_length(aDefault);
    libqt_string* aDefault_qstr = (libqt_string*)malloc(aDefault_len * sizeof(libqt_string));
    if (aDefault_qstr == NULL) {
...
const char** k_configgroup_read_path_entry3(void* self, const char* pKey, const char* aDefault[1]) {
    size_t aDefault_len = libqt_strv_length(aDefault);
    libqt_string* aDefault_qstr = (libqt_string*)malloc(aDefault_len * sizeof(libqt_string));
    if (aDefault_qstr == NULL) {
...
const char** k_configgroup_read_path_entry4(void* self, const char* key, const char* aDefault[1]) {
    size_t aDefault_len = libqt_strv_length(aDefault);
    libqt_string* aDefault_qstr = (libqt_string*)malloc(aDefault_len * sizeof(libqt_string));
    if (aDefault_qstr == NULL) {
...
void k_configgroup_write_entry9(void* self, const char* key, const char* value[1]) {
...
void k_configgroup_write_entry10(void* self, const char* key, const char* value[1]) {
    size_t value_len = libqt_strv_length(value);
    libqt_string* value_qstr = (libqt_string*)malloc(value_len * sizeof(libqt_string));
    if (value_qstr == NULL) {
...
void k_configgroup_write_xdg_list_entry(void* self, const char* pKey, const char* value[1]) {
    size_t value_len = libqt_strv_length(value);
    libqt_string* value_qstr = (libqt_string*)malloc(value_len * sizeof(libqt_string));
    if (value_qstr == NULL) {
...
void k_configgroup_write_xdg_list_entry2(void* self, const char* key, const char* value[1]) {
    size_t value_len = libqt_strv_length(value);
    libqt_string* value_qstr = (libqt_string*)malloc(value_len * sizeof(libqt_string));
    if (value_qstr == NULL) {
...
void k_configgroup_write_path_entry3(void* self, const char* pKey, const char* value[1]) {
    size_t value_len = libqt_strv_length(value);
    libqt_string* value_qstr = (libqt_string*)malloc(value_len * sizeof(libqt_string));
    if (value_qstr == NULL) {
...
void k_configgroup_write_path_entry4(void* self, const char* key, const char* value[1]) {
    size_t value_len = libqt_strv_length(value);
    libqt_string* value_qstr = (libqt_string*)malloc(value_len * sizeof(libqt_string));
    if (value_qstr == NULL) {
...
const char** k_configgroup_read_xdg_list_entry22(void* self, const char* pKey, const char* aDefault[1]) {
    size_t aDefault_len = libqt_strv_length(aDefault);
    libqt_string* aDefault_qstr = (libqt_string*)malloc(aDefault_len * sizeof(libqt_string));
    if (aDefault_qstr == NULL) {
...
const char** k_configgroup_read_xdg_list_entry23(void* self, const char* key, const char* aDefault[1]) {
    size_t aDefault_len = libqt_strv_length(aDefault);
    libqt_string* aDefault_qstr = (libqt_string*)malloc(aDefault_len * sizeof(libqt_string));
    if (aDefault_qstr == NULL) {
...
void k_configgroup_write_entry310(void* self, const char* key, const char* value[1], int32_t pFlags) {
    size_t value_len = libqt_strv_length(value);
    libqt_string* value_qstr = (libqt_string*)malloc(value_len * sizeof(libqt_string));
    if (value_qstr == NULL) {
...
void k_configgroup_write_entry311(void* self, const char* key, const char* value[1], int32_t pFlags) {
    size_t value_len = libqt_strv_length(value);
    libqt_string* value_qstr = (libqt_string*)malloc(value_len * sizeof(libqt_string));
    if (value_qstr == NULL) {
...
void k_configgroup_write_xdg_list_entry3(void* self, const char* pKey, const char* value[1], int32_t pFlags) {
    size_t value_len = libqt_strv_length(value);
    libqt_string* value_qstr = (libqt_string*)malloc(value_len * sizeof(libqt_string));
    if (value_qstr == NULL) {
...
void k_configgroup_write_xdg_list_entry32(void* self, const char* key, const char* value[1], int32_t pFlags) {
    size_t value_len = libqt_strv_length(value);
    libqt_string* value_qstr = (libqt_string*)malloc(value_len * sizeof(libqt_string));
    if (value_qstr == NULL) {
...
void k_configgroup_write_path_entry34(void* self, const char* pKey, const char* value[1], int32_t pFlags) {
    size_t value_len = libqt_strv_length(value);
    libqt_string* value_qstr = (libqt_string*)malloc(value_len * sizeof(libqt_string));
    if (value_qstr == NULL) {
...
void k_configgroup_write_path_entry35(void* self, const char* key, const char* value[1], int32_t pFlags) {
    size_t value_len = libqt_strv_length(value);
    libqt_string* value_qstr = (libqt_string*)malloc(value_len * sizeof(libqt_string));
    if (value_qstr == NULL) {
