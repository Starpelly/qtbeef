...
KFileFilter* k_filefilter_new2(const char* label, const char* filePatterns[1], const char* mimePatterns[1]) {
...
libqt_list /* of KFileFilter* */ k_filefilter_from_mime_types(const char* mimeTypes[1]) {
