...
KIO__PreviewJob* k_io__previewjob_new2(void* items, void* size, const char* enabledPlugins[1]) {
...
KIO__PreviewJob* k_io_file_preview(void* param1, void* param2, const char* param3[1]) {
