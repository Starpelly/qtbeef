...
void k_filefiltercombo_add_items(void* self, const char* texts[1]) {
...
void k_filefiltercombo_insert_items(void* self, int index, const char* texts[1]) {
    size_t texts_len = libqt_strv_length(texts);
    libqt_string* texts_qstr = (libqt_string*)malloc(texts_len * sizeof(libqt_string));
    if (texts_qstr == NULL) {
...
void k_filefiltercombo_set_completed_items(void* self, const char* items[1], bool autoSuggest) {
...
void k_filefiltercombo_super_set_completed_items(void* self, const char* items[1], bool autoSuggest) {
    size_t items_len = libqt_strv_length(items);
    libqt_string* items_qstr = (libqt_string*)malloc(items_len * sizeof(libqt_string));
    if (items_qstr == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in k_filefiltercombo_set_completed_items\n");
