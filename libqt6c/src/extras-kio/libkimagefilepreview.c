...
void k_imagefilepreview_set_supported_mime_types(void* self, const char* mimeTypes[1]) {
...
void k_imagefilepreview_super_set_supported_mime_types(void* self, const char* mimeTypes[1]) {
    size_t mimeTypes_len = libqt_strv_length(mimeTypes);
    libqt_string* mimeTypes_qstr = (libqt_string*)malloc(mimeTypes_len * sizeof(libqt_string));
    if (mimeTypes_qstr == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in k_imagefilepreview_set_supported_mime_types\n");
