...
void k_urlcombobox_set_urls(void* self, const char* urls[1]) {
...
void k_urlcombobox_set_urls2(void* self, const char* urls[1], int32_t remove) {
    size_t urls_len = libqt_strv_length(urls);
    libqt_string* urls_qstr = (libqt_string*)malloc(urls_len * sizeof(libqt_string));
    if (urls_qstr == NULL) {
...
void k_urlcombobox_add_items(void* self, const char* texts[1]) {
...
void k_urlcombobox_insert_items(void* self, int index, const char* texts[1]) {
    size_t texts_len = libqt_strv_length(texts);
    libqt_string* texts_qstr = (libqt_string*)malloc(texts_len * sizeof(libqt_string));
    if (texts_qstr == NULL) {
...
void k_urlcombobox_set_completed_items(void* self, const char* items[1], bool autoSuggest) {
...
void k_urlcombobox_super_set_completed_items(void* self, const char* items[1], bool autoSuggest) {
    size_t items_len = libqt_strv_length(items);
    libqt_string* items_qstr = (libqt_string*)malloc(items_len * sizeof(libqt_string));
    if (items_qstr == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in k_urlcombobox_set_completed_items\n");
