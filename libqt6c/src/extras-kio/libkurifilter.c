...
void k_urifiltersearchprovider_set_keys(void* self, const char* keys[1]) {
...
void k_urifiltersearchprovider_super_set_keys(void* self, const char* keys[1]) {
    size_t keys_len = libqt_strv_length(keys);
    libqt_string* keys_qstr = (libqt_string*)malloc(keys_len * sizeof(libqt_string));
    if (keys_qstr == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in k_urifiltersearchprovider_set_keys\n");
...
void k_urifilterdata_set_alternate_search_providers(void* self, const char* providers[1]) {
...
bool k_urifilter_filter_uri22(void* self, void* data, const char* filters[1]) {
...
bool k_urifilter_filter_uri23(void* self, void* uri, const char* filters[1]) {
    size_t filters_len = libqt_strv_length(filters);
    libqt_string* filters_qstr = (libqt_string*)malloc(filters_len * sizeof(libqt_string));
    if (filters_qstr == NULL) {
...
bool k_urifilter_filter_uri24(void* self, const char* uri, const char* filters[1]) {
    size_t filters_len = libqt_strv_length(filters);
    libqt_string* filters_qstr = (libqt_string*)malloc(filters_len * sizeof(libqt_string));
    if (filters_qstr == NULL) {
...
QUrl* k_urifilter_filtered_uri22(void* self, void* uri, const char* filters[1]) {
    size_t filters_len = libqt_strv_length(filters);
    libqt_string* filters_qstr = (libqt_string*)malloc(filters_len * sizeof(libqt_string));
    if (filters_qstr == NULL) {
...
const char* k_urifilter_filtered_uri23(void* self, const char* uri, const char* filters[1]) {
    size_t filters_len = libqt_strv_length(filters);
    libqt_string* filters_qstr = (libqt_string*)malloc(filters_len * sizeof(libqt_string));
    if (filters_qstr == NULL) {
