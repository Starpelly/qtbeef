...
void k_diroperator_set_mime_filter(void* self, const char* mimetypes[1]) {
...
void k_diroperator_set_new_file_menu_supported_mime_types(void* self, const char* mime[1]) {
...
void k_diroperator_set_supported_schemes(void* self, const char* schemes[1]) {
