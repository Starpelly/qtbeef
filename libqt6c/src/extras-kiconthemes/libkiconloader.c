...
KIconLoader* k_iconloader_new3(const char* appname, const char* extraSearchPaths[1]) {
...
KIconLoader* k_iconloader_new4(const char* appname, const char* extraSearchPaths[1], void* parent) {
    size_t extraSearchPaths_len = libqt_strv_length(extraSearchPaths);
    libqt_string* extraSearchPaths_qstr = (libqt_string*)malloc(extraSearchPaths_len * sizeof(libqt_string));
    if (extraSearchPaths_qstr == NULL) {
...
void k_iconloader_draw_overlays(void* self, const char* overlays[1], void* pixmap, int32_t group) {
...
QPixmap* k_iconloader_load_icon5(void* self, const char* name, int32_t group, int size, int state, const char* overlays[1]) {
    size_t overlays_len = libqt_strv_length(overlays);
    libqt_string* overlays_qstr = (libqt_string*)malloc(overlays_len * sizeof(libqt_string));
    if (overlays_qstr == NULL) {
...
QPixmap* k_iconloader_load_mime_type_icon5(void* self, const char* iconName, int32_t group, int size, int state, const char* overlays[1]) {
    size_t overlays_len = libqt_strv_length(overlays);
    libqt_string* overlays_qstr = (libqt_string*)malloc(overlays_len * sizeof(libqt_string));
    if (overlays_qstr == NULL) {
...
void k_iconloader_reconfigure2(void* self, const char* appname, const char* extraSearchPaths[1]) {
    size_t extraSearchPaths_len = libqt_strv_length(extraSearchPaths);
    libqt_string* extraSearchPaths_qstr = (libqt_string*)malloc(extraSearchPaths_len * sizeof(libqt_string));
    if (extraSearchPaths_qstr == NULL) {
...
void k_iconloader_draw_overlays4(void* self, const char* overlays[1], void* pixmap, int32_t group, int state) {
    size_t overlays_len = libqt_strv_length(overlays);
    libqt_string* overlays_qstr = (libqt_string*)malloc(overlays_len * sizeof(libqt_string));
    if (overlays_qstr == NULL) {
...
QIcon* k_de_icon3(const char* param1, const char* param2[1], void* param3) {
