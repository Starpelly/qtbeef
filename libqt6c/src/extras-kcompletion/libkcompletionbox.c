...
void k_completionbox_insert_items(void* self, const char* items[1]) {
...
void k_completionbox_set_items(void* self, const char* items[1]) {
    size_t items_len = libqt_strv_length(items);
    libqt_string* items_qstr = (libqt_string*)malloc(items_len * sizeof(libqt_string));
    if (items_qstr == NULL) {
...
void k_completionbox_insert_items2(void* self, const char* items[1], int index) {
    size_t items_len = libqt_strv_length(items);
    libqt_string* items_qstr = (libqt_string*)malloc(items_len * sizeof(libqt_string));
    if (items_qstr == NULL) {
...
void k_completionbox_add_items(void* self, const char* labels[1]) {
