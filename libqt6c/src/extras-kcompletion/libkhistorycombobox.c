...
void k_historycombobox_set_history_items(void* self, const char* items[1]) {
...
void k_historycombobox_set_history_items2(void* self, const char* items[1], bool setCompletionList) {
    size_t items_len = libqt_strv_length(items);
    libqt_string* items_qstr = (libqt_string*)malloc(items_len * sizeof(libqt_string));
    if (items_qstr == NULL) {
...
void k_historycombobox_insert_items(void* self, const char* items[1]) {
    size_t items_len = libqt_strv_length(items);
    libqt_string* items_qstr = (libqt_string*)malloc(items_len * sizeof(libqt_string));
    if (items_qstr == NULL) {
...
void k_historycombobox_super_insert_items(void* self, const char* items[1]) {
    size_t items_len = libqt_strv_length(items);
    libqt_string* items_qstr = (libqt_string*)malloc(items_len * sizeof(libqt_string));
    if (items_qstr == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in k_historycombobox_insert_items\n");
...
void k_historycombobox_add_items(void* self, const char* texts[1]) {
...
void k_historycombobox_set_completed_items(void* self, const char* items[1], bool autoSuggest) {
    size_t items_len = libqt_strv_length(items);
    libqt_string* items_qstr = (libqt_string*)malloc(items_len * sizeof(libqt_string));
    if (items_qstr == NULL) {
...
void k_historycombobox_super_set_completed_items(void* self, const char* items[1], bool autoSuggest) {
    size_t items_len = libqt_strv_length(items);
    libqt_string* items_qstr = (libqt_string*)malloc(items_len * sizeof(libqt_string));
    if (items_qstr == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in k_historycombobox_set_completed_items\n");
