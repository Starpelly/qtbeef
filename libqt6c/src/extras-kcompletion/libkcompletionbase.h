...
///
void k_completionbase_set_completed_items(void* self, const char* items[1], bool autoSuggest);
...
/// @param autoSuggest bool
///
void k_completionbase_super_set_completed_items(void* self, const char* items[1], bool autoSuggest);
