...
///
void k_combobox_set_completed_items(void* self, const char* items[1], bool autoSuggest);
...
/// @param autoSuggest bool
///
void k_combobox_super_set_completed_items(void* self, const char* items[1], bool autoSuggest);
...
///
void k_combobox_add_items(void* self, const char* texts[1]);
...
/// @param texts const char**
///
void k_combobox_insert_items(void* self, int index, const char* texts[1]);
