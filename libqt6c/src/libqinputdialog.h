...
///
void q_inputdialog_set_combo_box_items(void* self, const char* items[1]);
...
/// @param items const char**
///
const char* q_inputdialog_get_item(void* parent, const char* title, const char* label, const char* items[1]);
...
/// @param current int
///
const char* q_inputdialog_get_item5(void* parent, const char* title, const char* label, const char* items[1], int current);
...
/// @param editable bool
///
const char* q_inputdialog_get_item6(void* parent, const char* title, const char* label, const char* items[1], int current, bool editable);
...
/// @param ok bool*
///
const char* q_inputdialog_get_item7(void* parent, const char* title, const char* label, const char* items[1], int current, bool editable, bool* ok);
...
/// @param flags flag of enum Qt__WindowType
///
const char* q_inputdialog_get_item8(void* parent, const char* title, const char* label, const char* items[1], int current, bool editable, bool* ok, int32_t flags);
...
/// @param inputMethodHints flag of enum Qt__InputMethodHint
///
const char* q_inputdialog_get_item9(void* parent, const char* title, const char* label, const char* items[1], int current, bool editable, bool* ok, int32_t flags, int32_t inputMethodHints);
