...
void q_textcharformat_set_font_families(void* self, const char* families[1]) {
...
void q_textcharformat_set_anchor_names(void* self, const char* names[1]) {
...
void q_textimageformat_set_font_families(void* self, const char* families[1]) {
    size_t families_len = libqt_strv_length(families);
    libqt_string* families_qstr = (libqt_string*)malloc(families_len * sizeof(libqt_string));
    if (families_qstr == NULL) {
...
void q_textimageformat_set_anchor_names(void* self, const char* names[1]) {
    size_t names_len = libqt_strv_length(names);
    libqt_string* names_qstr = (libqt_string*)malloc(names_len * sizeof(libqt_string));
    if (names_qstr == NULL) {
...
void q_texttablecellformat_set_font_families(void* self, const char* families[1]) {
    size_t families_len = libqt_strv_length(families);
    libqt_string* families_qstr = (libqt_string*)malloc(families_len * sizeof(libqt_string));
    if (families_qstr == NULL) {
...
void q_texttablecellformat_set_anchor_names(void* self, const char* names[1]) {
    size_t names_len = libqt_strv_length(names);
    libqt_string* names_qstr = (libqt_string*)malloc(names_len * sizeof(libqt_string));
    if (names_qstr == NULL) {
