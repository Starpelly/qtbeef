...
void q_sciscintilla_set_auto_completion_word_separators(void* self, const char* separators[1]) {
...
void q_sciscintilla_show_user_list(void* self, int id, const char* list[1]) {
