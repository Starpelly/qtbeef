...
void q_sciapis_update_auto_completion_list(void* self, const char* context[1], const char* list[1]) {
...
void q_sciapis_super_update_auto_completion_list(void* self, const char* context[1], const char* list[1]) {
    size_t context_len = libqt_strv_length(context);
    libqt_string* context_qstr = (libqt_string*)malloc(context_len * sizeof(libqt_string));
    if (context_qstr == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in q_sciapis_update_auto_completion_list\n");
...
const char** q_sciapis_call_tips(void* self, const char* context[1], int commas, int32_t style, libqt_list /* of int */ shifts) {
    size_t context_len = libqt_strv_length(context);
    libqt_string* context_qstr = (libqt_string*)malloc(context_len * sizeof(libqt_string));
    if (context_qstr == NULL) {
...
const char** q_sciapis_super_call_tips(void* self, const char* context[1], int commas, int32_t style, libqt_list /* of int */ shifts) {
    size_t context_len = libqt_strv_length(context);
    libqt_string* context_qstr = (libqt_string*)malloc(context_len * sizeof(libqt_string));
    if (context_qstr == NULL) {
        fprintf(stderr, "Failed to allocate memory for string list in q_sciapis_call_tips\n");
