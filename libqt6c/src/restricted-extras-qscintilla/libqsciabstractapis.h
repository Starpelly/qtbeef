...
///
const char** q_sciabstractapis_call_tips(void* self, const char* context[1], int commas, int32_t style, libqt_list shifts);
...
/// @param shifts libqt_list of int
///
const char** q_sciabstractapis_super_call_tips(void* self, const char* context[1], int commas, int32_t style, libqt_list shifts);
