...
///
const char** q_sciapis_call_tips(void* self, const char* context[1], int commas, int32_t style, libqt_list shifts);
...
/// @param shifts libqt_list of int
///
const char** q_sciapis_super_call_tips(void* self, const char* context[1], int commas, int32_t style, libqt_list shifts);
