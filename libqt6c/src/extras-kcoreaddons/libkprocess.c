...
void k_process_set_program2(void* self, const char* argv[1]) {
...
KProcess* k_process_operator_shift_left2(void* self, const char* args[1]) {
...
int32_t k_process_execute3(const char* argv[1]) {
    size_t argv_len = libqt_strv_length(argv);
    libqt_string* argv_qstr = (libqt_string*)malloc(argv_len * sizeof(libqt_string));
    if (argv_qstr == NULL) {
...
int32_t k_process_start_detached3(const char* argv[1]) {
    size_t argv_len = libqt_strv_length(argv);
    libqt_string* argv_qstr = (libqt_string*)malloc(argv_len * sizeof(libqt_string));
    if (argv_qstr == NULL) {
...
void k_process_set_program22(void* self, const char* exe, const char* args[1]) {
    size_t args_len = libqt_strv_length(args);
    libqt_string* args_qstr = (libqt_string*)malloc(args_len * sizeof(libqt_string));
    if (args_qstr == NULL) {
...
int32_t k_process_execute22(const char* exe, const char* args[1]) {
    size_t args_len = libqt_strv_length(args);
    libqt_string* args_qstr = (libqt_string*)malloc(args_len * sizeof(libqt_string));
    if (args_qstr == NULL) {
...
int32_t k_process_execute32(const char* exe, const char* args[1], int msecs) {
    size_t args_len = libqt_strv_length(args);
    libqt_string* args_qstr = (libqt_string*)malloc(args_len * sizeof(libqt_string));
    if (args_qstr == NULL) {
...
int32_t k_process_execute23(const char* argv[1], int msecs) {
    size_t argv_len = libqt_strv_length(argv);
    libqt_string* argv_qstr = (libqt_string*)malloc(argv_len * sizeof(libqt_string));
    if (argv_qstr == NULL) {
...
int32_t k_process_start_detached22(const char* exe, const char* args[1]) {
    size_t args_len = libqt_strv_length(args);
    libqt_string* args_qstr = (libqt_string*)malloc(args_len * sizeof(libqt_string));
    if (args_qstr == NULL) {
...
void k_process_set_arguments(void* self, const char* arguments[1]) {
...
void k_process_set_environment(void* self, const char* environment[1]) {
...
void k_process_start22(void* self, const char* program, const char* arguments[1]) {
    size_t arguments_len = libqt_strv_length(arguments);
    libqt_string* arguments_qstr = (libqt_string*)malloc(arguments_len * sizeof(libqt_string));
    if (arguments_qstr == NULL) {
...
void k_process_start3(void* self, const char* program, const char* arguments[1], int32_t mode) {
    size_t arguments_len = libqt_strv_length(arguments);
    libqt_string* arguments_qstr = (libqt_string*)malloc(arguments_len * sizeof(libqt_string));
    if (arguments_qstr == NULL) {
...
bool k_process_start_detached4(const char* program, const char* arguments[1], const char* workingDirectory, long long* pid) {
    size_t arguments_len = libqt_strv_length(arguments);
    libqt_string* arguments_qstr = (libqt_string*)malloc(arguments_len * sizeof(libqt_string));
    if (arguments_qstr == NULL) {
