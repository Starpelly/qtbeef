...
///
QCommandLineOption* q_commandlineoption_new2(const char* names[1]);
...
/// @param description const char*
///
QCommandLineOption* q_commandlineoption_new4(const char* names[1], const char* description);
...
/// @param valueName const char*
///
QCommandLineOption* q_commandlineoption_new8(const char* names[1], const char* description, const char* valueName);
...
/// @param defaultValue const char*
///
QCommandLineOption* q_commandlineoption_new9(const char* names[1], const char* description, const char* valueName, const char* defaultValue);
...
///
void q_commandlineoption_set_default_values(void* self, const char* defaultValues[1]);
