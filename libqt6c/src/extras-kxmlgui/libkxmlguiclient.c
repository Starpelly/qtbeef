...
const char* k_xmlguiclient_find_most_recent_x_m_l_file(const char* files[1], const char* doc) {
...
void k_xmlguiclient__statechange_set_actions_to_enable(void* self, const char* actionsToEnable[1]) {
...
void k_xmlguiclient__statechange_set_actions_to_disable(void* self, const char* actionsToDisable[1]) {
