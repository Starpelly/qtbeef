...
void k_onsole__regexpfilter__hotspot_set_captured_texts(void* self, const char* texts[1]) {
...
void k_onsole__urlfilter__hotspot_set_captured_texts(void* self, const char* texts[1]) {
    size_t texts_len = libqt_strv_length(texts);
    libqt_string* texts_qstr = (libqt_string*)malloc(texts_len * sizeof(libqt_string));
    if (texts_qstr == NULL) {
