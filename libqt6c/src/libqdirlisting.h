...
///
QDirListing* q_dirlisting_new2(const char* path, const char* nameFilters[1]);
...
/// @param flags flag of enum QDirListing__IteratorFlag
///
QDirListing* q_dirlisting_new4(const char* path, const char* nameFilters[1], int32_t flags);
