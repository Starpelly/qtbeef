...
QFont* q_font_new3(const char* families[1]) {
...
QFont* q_font_new9(const char* families[1], int pointSize) {
    size_t families_len = libqt_strv_length(families);
    libqt_string* families_qstr = (libqt_string*)malloc(families_len * sizeof(libqt_string));
    if (families_qstr == NULL) {
...
QFont* q_font_new10(const char* families[1], int pointSize, int weight) {
    size_t families_len = libqt_strv_length(families);
    libqt_string* families_qstr = (libqt_string*)malloc(families_len * sizeof(libqt_string));
    if (families_qstr == NULL) {
...
QFont* q_font_new11(const char* families[1], int pointSize, int weight, bool italic) {
    size_t families_len = libqt_strv_length(families);
    libqt_string* families_qstr = (libqt_string*)malloc(families_len * sizeof(libqt_string));
    if (families_qstr == NULL) {
...
void q_font_set_families(void* self, const char* families[1]) {
    size_t families_len = libqt_strv_length(families);
    libqt_string* families_qstr = (libqt_string*)malloc(families_len * sizeof(libqt_string));
    if (families_qstr == NULL) {
...
void q_font_insert_substitutions(const char* param1, const char* param2[1]) {
