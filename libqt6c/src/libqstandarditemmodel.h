...
///
void q_standarditemmodel_set_horizontal_header_labels(void* self, const char* labels[1]);
...
/// @param labels const char**
///
void q_standarditemmodel_set_vertical_header_labels(void* self, const char* labels[1]);
