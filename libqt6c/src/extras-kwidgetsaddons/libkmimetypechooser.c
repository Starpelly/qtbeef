...
KMimeTypeChooser* k_mimetypechooser_new3(const char* text, const char* selectedMimeTypes[1]) {
...
KMimeTypeChooser* k_mimetypechooser_new4(const char* text, const char* selectedMimeTypes[1], const char* defaultGroup) {
    size_t selectedMimeTypes_len = libqt_strv_length(selectedMimeTypes);
    libqt_string* selectedMimeTypes_qstr = (libqt_string*)malloc(selectedMimeTypes_len * sizeof(libqt_string));
    if (selectedMimeTypes_qstr == NULL) {
...
KMimeTypeChooser* k_mimetypechooser_new5(const char* text, const char* selectedMimeTypes[1], const char* defaultGroup, const char* groupsToShow[1]) {
    size_t selectedMimeTypes_len = libqt_strv_length(selectedMimeTypes);
    libqt_string* selectedMimeTypes_qstr = (libqt_string*)malloc(selectedMimeTypes_len * sizeof(libqt_string));
    if (selectedMimeTypes_qstr == NULL) {
...
KMimeTypeChooser* k_mimetypechooser_new6(const char* text, const char* selectedMimeTypes[1], const char* defaultGroup, const char* groupsToShow[1], int visuals) {
    size_t selectedMimeTypes_len = libqt_strv_length(selectedMimeTypes);
    libqt_string* selectedMimeTypes_qstr = (libqt_string*)malloc(selectedMimeTypes_len * sizeof(libqt_string));
    if (selectedMimeTypes_qstr == NULL) {
...
KMimeTypeChooser* k_mimetypechooser_new7(const char* text, const char* selectedMimeTypes[1], const char* defaultGroup, const char* groupsToShow[1], int visuals, void* parent) {
    size_t selectedMimeTypes_len = libqt_strv_length(selectedMimeTypes);
    libqt_string* selectedMimeTypes_qstr = (libqt_string*)malloc(selectedMimeTypes_len * sizeof(libqt_string));
    if (selectedMimeTypes_qstr == NULL) {
...
KMimeTypeChooserDialog* k_mimetypechooserdialog_new2(const char* title, const char* text, const char* selectedMimeTypes[1], const char* defaultGroup) {
    size_t selectedMimeTypes_len = libqt_strv_length(selectedMimeTypes);
    libqt_string* selectedMimeTypes_qstr = (libqt_string*)malloc(selectedMimeTypes_len * sizeof(libqt_string));
    if (selectedMimeTypes_qstr == NULL) {
...
KMimeTypeChooserDialog* k_mimetypechooserdialog_new5(const char* title, const char* text, const char* selectedMimeTypes[1]) {
    size_t selectedMimeTypes_len = libqt_strv_length(selectedMimeTypes);
    libqt_string* selectedMimeTypes_qstr = (libqt_string*)malloc(selectedMimeTypes_len * sizeof(libqt_string));
    if (selectedMimeTypes_qstr == NULL) {
...
KMimeTypeChooserDialog* k_mimetypechooserdialog_new6(const char* title, const char* text, const char* selectedMimeTypes[1], const char* defaultGroup) {
    size_t selectedMimeTypes_len = libqt_strv_length(selectedMimeTypes);
    libqt_string* selectedMimeTypes_qstr = (libqt_string*)malloc(selectedMimeTypes_len * sizeof(libqt_string));
    if (selectedMimeTypes_qstr == NULL) {
...
KMimeTypeChooserDialog* k_mimetypechooserdialog_new7(const char* title, const char* text, const char* selectedMimeTypes[1], const char* defaultGroup, const char* groupsToShow[1]) {
    size_t selectedMimeTypes_len = libqt_strv_length(selectedMimeTypes);
    libqt_string* selectedMimeTypes_qstr = (libqt_string*)malloc(selectedMimeTypes_len * sizeof(libqt_string));
    if (selectedMimeTypes_qstr == NULL) {
...
KMimeTypeChooserDialog* k_mimetypechooserdialog_new8(const char* title, const char* text, const char* selectedMimeTypes[1], const char* defaultGroup, const char* groupsToShow[1], int visuals) {
    size_t selectedMimeTypes_len = libqt_strv_length(selectedMimeTypes);
    libqt_string* selectedMimeTypes_qstr = (libqt_string*)malloc(selectedMimeTypes_len * sizeof(libqt_string));
    if (selectedMimeTypes_qstr == NULL) {
...
KMimeTypeChooserDialog* k_mimetypechooserdialog_new9(const char* title, const char* text, const char* selectedMimeTypes[1], const char* defaultGroup, const char* groupsToShow[1], int visuals, void* parent) {
    size_t selectedMimeTypes_len = libqt_strv_length(selectedMimeTypes);
    libqt_string* selectedMimeTypes_qstr = (libqt_string*)malloc(selectedMimeTypes_len * sizeof(libqt_string));
    if (selectedMimeTypes_qstr == NULL) {
...
KMimeTypeChooserDialog* k_mimetypechooserdialog_new10(const char* title, const char* text, const char* selectedMimeTypes[1], const char* defaultGroup, void* parent) {
    size_t selectedMimeTypes_len = libqt_strv_length(selectedMimeTypes);
    libqt_string* selectedMimeTypes_qstr = (libqt_string*)malloc(selectedMimeTypes_len * sizeof(libqt_string));
    if (selectedMimeTypes_qstr == NULL) {
