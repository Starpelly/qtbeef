...
///
void k_viewstateserializer_restore_selection(void* self, const char* indexStrings[1]);
...
/// @param indexStrings const char**
///
void k_viewstateserializer_restore_expanded(void* self, const char* indexStrings[1]);
