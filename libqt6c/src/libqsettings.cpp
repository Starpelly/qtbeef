...
QStringList QSettings_AllKeys(const QSettings* self) {
    return self->allKeys();
}

QStringList QSettings_ChildKeys(const QSettings* self) {
    return self->childKeys();
}

QStringList QSettings_ChildGroups(const QSettings* self) {
