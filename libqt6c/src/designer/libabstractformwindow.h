...
///
void q_designerformwindowinterface_set_include_hints(void* self, const char* includeHints[1]);
...
///
void q_designerformwindowinterface_activate_resource_file_paths(void* self, const char* paths[1]);
...
///
void q_designerformwindowinterface_activate_resource_file_paths2(void* self, const char* paths[1], int* errorCount);
