...
///
void q_packagekit__transaction_files(void* self, const char* packageID, const char* filenames[1]);
...
///
void q_packagekit__transaction_update_detail(void* self, const char* packageID, const char* updates[1], const char* obsoletes[1], const char* vendorUrls[1], const char* bugzillaUrls[1], const char* cveUrls[1], int32_t restart, const char* updateText, const char* changelog, int32_t state, void* issued, void* updated);
