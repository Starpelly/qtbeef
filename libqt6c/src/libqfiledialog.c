...
void q_filedialog_set_name_filters(void* self, const char* filters[1]) {
...
void q_filedialog_set_mime_type_filters(void* self, const char* filters[1]) {
    size_t filters_len = libqt_strv_length(filters);
    libqt_string* filters_qstr = (libqt_string*)malloc(filters_len * sizeof(libqt_string));
    if (filters_qstr == NULL) {
...
void q_filedialog_set_history(void* self, const char* paths[1]) {
...
void q_filedialog_set_supported_schemes(void* self, const char* schemes[1]) {
...
void q_filedialog_files_selected(void* self, const char* files[1]) {
...
QUrl* q_filedialog_get_existing_directory_url5(void* parent, const char* caption, void* dir, int32_t options, const char* supportedSchemes[1]) {
