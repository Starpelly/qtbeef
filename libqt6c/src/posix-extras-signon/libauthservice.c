...
void q_signon__authservice_methods_available(void* self, const char* methods[1]) {
...
void q_signon__authservice_mechanisms_available(void* self, const char* method, const char* mechanisms[1]) {
