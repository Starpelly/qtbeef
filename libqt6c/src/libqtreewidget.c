...
QTreeWidgetItem* q_treewidgetitem_new2(const char* strings[1]) {
...
QTreeWidgetItem* q_treewidgetitem_new4(void* treeview, const char* strings[1]) {
    size_t strings_len = libqt_strv_length(strings);
    libqt_string* strings_qstr = (libqt_string*)malloc(strings_len * sizeof(libqt_string));
    if (strings_qstr == NULL) {
...
QTreeWidgetItem* q_treewidgetitem_new7(void* parent, const char* strings[1]) {
    size_t strings_len = libqt_strv_length(strings);
    libqt_string* strings_qstr = (libqt_string*)malloc(strings_len * sizeof(libqt_string));
    if (strings_qstr == NULL) {
...
QTreeWidgetItem* q_treewidgetitem_new11(const char* strings[1], int type) {
    size_t strings_len = libqt_strv_length(strings);
    libqt_string* strings_qstr = (libqt_string*)malloc(strings_len * sizeof(libqt_string));
    if (strings_qstr == NULL) {
...
QTreeWidgetItem* q_treewidgetitem_new13(void* treeview, const char* strings[1], int type) {
    size_t strings_len = libqt_strv_length(strings);
    libqt_string* strings_qstr = (libqt_string*)malloc(strings_len * sizeof(libqt_string));
    if (strings_qstr == NULL) {
...
QTreeWidgetItem* q_treewidgetitem_new16(void* parent, const char* strings[1], int type) {
    size_t strings_len = libqt_strv_length(strings);
    libqt_string* strings_qstr = (libqt_string*)malloc(strings_len * sizeof(libqt_string));
    if (strings_qstr == NULL) {
...
void q_treewidget_set_header_labels(void* self, const char* labels[1]) {
