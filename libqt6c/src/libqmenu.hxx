...
class VirtualQMenu final : public QMenu {
  ...
  public:
    ...
    friend int QMenu_SuperColumnCount(const QMenu* self);
    friend void QMenu_UpdateMicroFocus(QMenu* self);
    friend void QMenu_SuperUpdateMicroFocus(QMenu* self);
    friend void QMenu_Create(QMenu* self);
    friend void QMenu_SuperCreate(QMenu* self);
    friend void QMenu_Destroy(QMenu* self);
    friend void QMenu_SuperDestroy(QMenu* self);
    friend bool QMenu_FocusNextChild(QMenu* self);
    friend bool QMenu_SuperFocusNextChild(QMenu* self);
    friend bool QMenu_FocusPreviousChild(QMenu* self);
    friend bool QMenu_SuperFocusPreviousChild(QMenu* self);
    friend QObject* QMenu_Sender(const QMenu* self);
    friend QObject* QMenu_SuperSender(const QMenu* self);
    friend int QMenu_SenderSignalIndex(const QMenu* self);
    friend int QMenu_SuperSenderSignalIndex(const QMenu* self);
