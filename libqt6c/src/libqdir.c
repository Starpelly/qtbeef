...
void q_dir_set_search_paths(const char* prefix, const char* searchPaths[1]) {
...
void q_dir_set_name_filters(void* self, const char* nameFilters[1]) {
...
const char** q_dir_entry_list2(void* self, const char* nameFilters[1]) {
    size_t nameFilters_len = libqt_strv_length(nameFilters);
    libqt_string* nameFilters_qstr = (libqt_string*)malloc(nameFilters_len * sizeof(libqt_string));
    if (nameFilters_qstr == NULL) {
...
libqt_list /* of QFileInfo* */ q_dir_entry_info_list2(void* self, const char* nameFilters[1]) {
    size_t nameFilters_len = libqt_strv_length(nameFilters);
    libqt_string* nameFilters_qstr = (libqt_string*)malloc(nameFilters_len * sizeof(libqt_string));
    if (nameFilters_qstr == NULL) {
...
bool q_dir_match(const char* filters[1], const char* fileName) {
...
const char** q_dir_entry_list23(void* self, const char* nameFilters[1], int32_t filters) {
    size_t nameFilters_len = libqt_strv_length(nameFilters);
    libqt_string* nameFilters_qstr = (libqt_string*)malloc(nameFilters_len * sizeof(libqt_string));
    if (nameFilters_qstr == NULL) {
...
const char** q_dir_entry_list3(void* self, const char* nameFilters[1], int32_t filters, int32_t sort) {
    size_t nameFilters_len = libqt_strv_length(nameFilters);
    libqt_string* nameFilters_qstr = (libqt_string*)malloc(nameFilters_len * sizeof(libqt_string));
    if (nameFilters_qstr == NULL) {
...
libqt_list /* of QFileInfo* */ q_dir_entry_info_list23(void* self, const char* nameFilters[1], int32_t filters) {
    size_t nameFilters_len = libqt_strv_length(nameFilters);
    libqt_string* nameFilters_qstr = (libqt_string*)malloc(nameFilters_len * sizeof(libqt_string));
    if (nameFilters_qstr == NULL) {
...
libqt_list /* of QFileInfo* */ q_dir_entry_info_list3(void* self, const char* nameFilters[1], int32_t filters, int32_t sort) {
    size_t nameFilters_len = libqt_strv_length(nameFilters);
    libqt_string* nameFilters_qstr = (libqt_string*)malloc(nameFilters_len * sizeof(libqt_string));
    if (nameFilters_qstr == NULL) {
