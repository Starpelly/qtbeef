...
void k_sonnet__configview_set_preferred_languages(void* self, const char* ignoreList[1]) {
...
void k_sonnet__configview_set_ignore_list(void* self, const char* ignoreList[1]) {
    size_t ignoreList_len = libqt_strv_length(ignoreList);
    libqt_string* ignoreList_qstr = (libqt_string*)malloc(ignoreList_len * sizeof(libqt_string));
    if (ignoreList_qstr == NULL) {
