...
void k_sonnet__dictionarycombobox_add_items(void* self, const char* texts[1]) {
...
void k_sonnet__dictionarycombobox_insert_items(void* self, int index, const char* texts[1]) {
    size_t texts_len = libqt_strv_length(texts);
    libqt_string* texts_qstr = (libqt_string*)malloc(texts_len * sizeof(libqt_string));
    if (texts_qstr == NULL) {
