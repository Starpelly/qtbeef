...
const char* k_localizedstring_to_string2(void* self, const char* languages[1]) {
...
KLocalizedString* k_localizedstring_with_languages(void* self, const char* languages[1]) {
    size_t languages_len = libqt_strv_length(languages);
    libqt_string* languages_qstr = (libqt_string*)malloc(languages_len * sizeof(libqt_string));
    if (languages_qstr == NULL) {
...
void k_localizedstring_set_languages(const char* languages[1]) {
    size_t languages_len = libqt_strv_length(languages);
    libqt_string* languages_qstr = (libqt_string*)malloc(languages_len * sizeof(libqt_string));
    if (languages_qstr == NULL) {
