...
/// @return libqt_list of QFileInfo*
///
libqt_list q_dir_entry_info_list2(void* self, const char* nameFilters[1]);
...
/// @return libqt_list of QFileInfo*
///
libqt_list q_dir_entry_info_list23(void* self, const char* nameFilters[1], int32_t filters);
...
/// @return libqt_list of QFileInfo*
///
libqt_list q_dir_entry_info_list3(void* self, const char* nameFilters[1], int32_t filters, int32_t sort);
