...
///
void k_editlistwidget_insert_string_list(void* self, const char* list[1]);
...
///
void k_editlistwidget_set_items(void* self, const char* items[1]);
...
/// @param index int
///
void k_editlistwidget_insert_string_list2(void* self, const char* list[1], int index);
