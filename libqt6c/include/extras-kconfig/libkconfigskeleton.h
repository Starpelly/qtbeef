...
/// @param reference const char**
///
KCoreConfigSkeleton__ItemStringList* k_configskeleton_add_item_string_list(void* self, const char* name, const char* reference[1]);
...
/// @param defaultValue const char**
///
KCoreConfigSkeleton__ItemStringList* k_configskeleton_add_item_string_list3(void* self, const char* name, const char* reference[1], const char* defaultValue[1]);
...
/// @param key const char*
///
KCoreConfigSkeleton__ItemStringList* k_configskeleton_add_item_string_list4(void* self, const char* name, const char* reference[1], const char* defaultValue[1], const char* key);
