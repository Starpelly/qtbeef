...
///
const char** q_webenginepage_choose_files(void* self, int32_t mode, const char* oldFiles[1], const char* acceptedMimeTypes[1]);
...
/// @param acceptedMimeTypes const char**
///
const char** q_webenginepage_super_choose_files(void* self, int32_t mode, const char* oldFiles[1], const char* acceptedMimeTypes[1]);
