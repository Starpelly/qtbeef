...
///
KNSCore__SearchRequest* k_nscore__searchrequest_new6(int32_t sortMode_, int32_t filter_, const char* searchTerm_, const char* categories_[1]);
...
/// @param page_ int
///
KNSCore__SearchRequest* k_nscore__searchrequest_new7(int32_t sortMode_, int32_t filter_, const char* searchTerm_, const char* categories_[1], int page_);
...
/// @param pageSize_ int
///
KNSCore__SearchRequest* k_nscore__searchrequest_new8(int32_t sortMode_, int32_t filter_, const char* searchTerm_, const char* categories_[1], int page_, int pageSize_);
