...
///
const char* k_lazylocalizedstring_to_string2(void* self, const char* languages[1]);
...
/// @param languages const char**
///
KLocalizedString* k_lazylocalizedstring_with_languages(void* self, const char* languages[1]);
