...
///
QFileSystemWatcher* q_filesystemwatcher_new2(const char* paths[1]);
...
/// @param parent QObject*
///
QFileSystemWatcher* q_filesystemwatcher_new4(const char* paths[1], void* parent);
...
///
const char** q_filesystemwatcher_add_paths(void* self, const char* files[1]);
...
/// @param files const char**
///
const char** q_filesystemwatcher_remove_paths(void* self, const char* files[1]);
