...
///
void q_packagekit__daemon_set_hints(const char* hints[1]);
...
///
PackageKit__Transaction* q_packagekit__daemon_download_packages(const char* packageIDs[1]);
...
/// @param packageIDs const char**
///
PackageKit__Transaction* q_packagekit__daemon_depends_on(const char* packageIDs[1]);
...
/// @param packageIDs const char**
///
PackageKit__Transaction* q_packagekit__daemon_get_details(const char* packageIDs[1]);
...
///
PackageKit__Transaction* q_packagekit__daemon_get_details_local(const char* files[1]);
...
/// @param packageIDs const char**
///
PackageKit__Transaction* q_packagekit__daemon_get_files(const char* packageIDs[1]);
...
/// @param files const char**
///
PackageKit__Transaction* q_packagekit__daemon_get_files_local(const char* files[1]);
...
/// @param packageIDs const char**
///
PackageKit__Transaction* q_packagekit__daemon_required_by(const char* packageIDs[1]);
...
/// @param packageIDs const char**
///
PackageKit__Transaction* q_packagekit__daemon_get_updates_details(const char* packageIDs[1]);
...
/// @param files const char**
///
PackageKit__Transaction* q_packagekit__daemon_install_files(const char* files[1]);
...
/// @param packageIDs const char**
///
PackageKit__Transaction* q_packagekit__daemon_install_packages(const char* packageIDs[1]);
...
/// @param packageIDs const char**
///
PackageKit__Transaction* q_packagekit__daemon_remove_packages(const char* packageIDs[1]);
...
///
PackageKit__Transaction* q_packagekit__daemon_resolve(const char* packageNames[1]);
...
///
PackageKit__Transaction* q_packagekit__daemon_search_files(const char* search[1]);
...
/// @param search const char**
///
PackageKit__Transaction* q_packagekit__daemon_search_details(const char* search[1]);
...
///
PackageKit__Transaction* q_packagekit__daemon_search_groups(const char* groups[1]);
...
/// @param search const char**
///
PackageKit__Transaction* q_packagekit__daemon_search_names(const char* search[1]);
...
/// @param packageIDs const char**
///
PackageKit__Transaction* q_packagekit__daemon_update_packages(const char* packageIDs[1]);
...
/// @param search const char**
///
PackageKit__Transaction* q_packagekit__daemon_what_provides(const char* search[1]);
...
///
void q_packagekit__daemon_transaction_list_changed(void* self, const char* tids[1]);
...
///
PackageKit__Transaction* q_packagekit__daemon_download_packages2(const char* packageIDs[1], bool storeInCache);
...
///
PackageKit__Transaction* q_packagekit__daemon_depends_on22(const char* packageIDs[1], int32_t filters);
...
///
PackageKit__Transaction* q_packagekit__daemon_depends_on3(const char* packageIDs[1], int32_t filters, bool recursive);
...
/// @param filters flag of enum PackageKit__Transaction__Filter
///
PackageKit__Transaction* q_packagekit__daemon_required_by22(const char* packageIDs[1], int32_t filters);
...
/// @param recursive bool
///
PackageKit__Transaction* q_packagekit__daemon_required_by3(const char* packageIDs[1], int32_t filters, bool recursive);
...
/// @param flags flag of enum PackageKit__Transaction__TransactionFlag
///
PackageKit__Transaction* q_packagekit__daemon_install_files2(const char* files[1], int32_t flags);
...
/// @param flags flag of enum PackageKit__Transaction__TransactionFlag
///
PackageKit__Transaction* q_packagekit__daemon_install_packages2(const char* packageIDs[1], int32_t flags);
...
///
PackageKit__Transaction* q_packagekit__daemon_remove_packages2(const char* packageIDs[1], bool allowDeps);
...
/// @param autoRemove bool
///
PackageKit__Transaction* q_packagekit__daemon_remove_packages3(const char* packageIDs[1], bool allowDeps, bool autoRemove);
...
/// @param flags flag of enum PackageKit__Transaction__TransactionFlag
///
PackageKit__Transaction* q_packagekit__daemon_remove_packages4(const char* packageIDs[1], bool allowDeps, bool autoRemove, int32_t flags);
...
/// @param filters flag of enum PackageKit__Transaction__Filter
///
PackageKit__Transaction* q_packagekit__daemon_resolve22(const char* packageNames[1], int32_t filters);
...
/// @param filters flag of enum PackageKit__Transaction__Filter
///
PackageKit__Transaction* q_packagekit__daemon_search_files22(const char* search[1], int32_t filters);
...
/// @param filters flag of enum PackageKit__Transaction__Filter
///
PackageKit__Transaction* q_packagekit__daemon_search_details22(const char* search[1], int32_t filters);
...
/// @param filters flag of enum PackageKit__Transaction__Filter
///
PackageKit__Transaction* q_packagekit__daemon_search_groups22(const char* groups[1], int32_t filters);
...
/// @param filters flag of enum PackageKit__Transaction__Filter
///
PackageKit__Transaction* q_packagekit__daemon_search_names22(const char* search[1], int32_t filters);
...
/// @param flags flag of enum PackageKit__Transaction__TransactionFlag
///
PackageKit__Transaction* q_packagekit__daemon_update_packages2(const char* packageIDs[1], int32_t flags);
...
/// @param filters flag of enum PackageKit__Transaction__Filter
///
PackageKit__Transaction* q_packagekit__daemon_what_provides22(const char* search[1], int32_t filters);
