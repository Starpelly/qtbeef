...
///
void q_designerintegrationinterface_emit_navigate_to_slot(void* self, const char* objectName, const char* signalSignature, const char* parameterNames[1]);
...
/// @param parameterNames const char**
///
void q_designerintegrationinterface_navigate_to_slot(void* self, const char* objectName, const char* signalSignature, const char* parameterNames[1]);
...
/// @param parameterNames const char**
///
void q_designerintegration_emit_navigate_to_slot(void* self, const char* objectName, const char* signalSignature, const char* parameterNames[1]);
...
/// @param parameterNames const char**
///
void q_designerintegration_navigate_to_slot(void* self, const char* objectName, const char* signalSignature, const char* parameterNames[1]);
