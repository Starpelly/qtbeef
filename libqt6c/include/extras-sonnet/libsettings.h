...
/// @param lang const char**
///
void k_sonnet__settings_set_preferred_languages(void* self, const char* lang[1]);
...
///
void k_sonnet__settings_set_current_ignore_list(void* self, const char* ignores[1]);
