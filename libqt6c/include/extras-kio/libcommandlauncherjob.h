...
///
KIO__CommandLauncherJob* k_io__commandlauncherjob_new2(const char* executable, const char* args[1]);
...
/// @param parent QObject*
///
KIO__CommandLauncherJob* k_io__commandlauncherjob_new4(const char* executable, const char* args[1], void* parent);
