...
///
void k_previewwidgetbase_set_supported_mime_types(void* self, const char* mimeTypes[1]);
...
/// @param mimeTypes const char**
///
void k_previewwidgetbase_super_set_supported_mime_types(void* self, const char* mimeTypes[1]);
