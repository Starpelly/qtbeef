...
/// @param slot const char*
///
bool q_dbusconnection_connect3(void* self, const char* service, const char* path, const char* interface, const char* name, const char* argumentMatch[1], const char* signature, void* receiver, const char* slot);
...
/// @param slot const char*
///
bool q_dbusconnection_disconnect3(void* self, const char* service, const char* path, const char* interface, const char* name, const char* argumentMatch[1], const char* signature, void* receiver, const char* slot);
