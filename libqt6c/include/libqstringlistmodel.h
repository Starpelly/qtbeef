...
///
QStringListModel* q_stringlistmodel_new2(const char* strings[1]);
...
/// @param parent QObject*
///
QStringListModel* q_stringlistmodel_new4(const char* strings[1], void* parent);
...
/// @param strings const char**
///
void q_stringlistmodel_set_string_list(void* self, const char* strings[1]);
