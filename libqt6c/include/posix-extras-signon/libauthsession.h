...
///
void q_signon__authsession_mechanisms_available(void* self, const char* mechanisms[1]);
...
///
void q_signon__authsession_query_available_mechanisms1(void* self, const char* wantedMechanisms[1]);
