...
///
KFindDialog* k_finddialog_new4(void* parent, long options, const char* findStrings[1]);
...
///
KFindDialog* k_finddialog_new5(void* parent, long options, const char* findStrings[1], bool hasSelection);
...
///
KFindDialog* k_finddialog_new6(void* parent, long options, const char* findStrings[1], bool hasSelection, bool replaceDialog);
...
///
void k_finddialog_set_find_history(void* self, const char* history[1]);
